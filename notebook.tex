...
% The only exceptions are fullref and some missing trigonometric functions.
...
\include{src/language_of_propositional_logic}
\include{src/language_of_first_order_logic}
