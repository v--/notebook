...
\begin{abstract}
  ...
  See the remark in the introduction of the \hyperref[sec:mathematical_logic]{section on mathematical logic} for clarification regarding seemingly random jumps between logical formulas and axioms defined in prose.
\end{abstract}
