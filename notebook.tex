...
\section{Analysis}\label{src:analysis}
...
\section{Algebra}\label{src:algebra}
\include{src/groups}
\include{src/rings}
\include{src/fields}
\include{src/modules}
...
\section{General topology}\label{src:general_topology}
...
\section{Metric spaces}\label{src:metric_spaces}
