...
\begin{abstract}
  ...
  See the remark in the introduction of the \hyperref[sec:mathematical_logic]{section on mathematical logic} for clarification regarding circular logical definitions and seemingly random jumps between logical formulas and axioms defined in prose.
\end{abstract}
...
\include{src/logical_derivation_systems}
