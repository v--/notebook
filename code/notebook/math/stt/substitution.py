...
class SubstitutionError(STTError):
    pass
...
class TermSubstitution(AbstractTermSubstitution):
    ...
    def modify_at(self, var: Variable, replacement: LambdaTerm) -> 'TermSubstitution':
        return TermSubstitution({**self.mapping, var: replacement})
...
def apply_term_substitution(term: LambdaTerm, substitution: TermSubstitution) -> LambdaTerm:
