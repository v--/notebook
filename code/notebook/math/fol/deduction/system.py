...
class NaturalDeductionSystem:
    rules: Collection[NaturalDeductionRule]

    def __init__(self, rules: Collection[NaturalDeductionRule]) -> None:
        self.rules = rules

    def __getitem__(self, rule_name: str) -> NaturalDeductionRule:
