...
def test_is_formula_quantifierless_success(formula: str, dummy_signature: FOLSignature) -> None:
...
def test_is_formula_quantifierless_failure(formula: str, dummy_signature: FOLSignature) -> None:
...
def test_is_formula_in_pnf_success(formula: str, dummy_signature: FOLSignature) -> None:
...
def test_is_formula_in_pnf_failure(formula: str, dummy_signature: FOLSignature) -> None:
...
def test_remove_conditionals_success(formula: str, expected: str, dummy_signature: FOLSignature) -> None:
...
def test_move_negations_success(formula: str, expected: str, dummy_signature: FOLSignature) -> None:
    assert str(remove_conditionals(parse_formula(dummy_signature, formula))) == expected
...
def test_move_negations(formula: str, expected: str, dummy_signature: FOLSignature) -> None:
    assert str(move_negations(parse_formula(dummy_signature, formula))) == expected


def test_move_negations_conditional(dummy_signature: FOLSignature) -> None:
...
def test_move_negations_biconditional(dummy_signature: FOLSignature) -> None:
    formula = parse_formula(dummy_signature, '¬(p₁(x) ↔ p₁(y))')
...
def test_move_quantifiers(formula: str, expected: str, dummy_signature: FOLSignature) -> None:
    assert str(move_quantifiers(parse_formula(dummy_signature, formula))) == expected


def test_move_quantifiers_conditional(dummy_signature: FOLSignature) -> None:
    formula = parse_formula(dummy_signature, '¬(p₁(x) → p₁(y))')
...
def test_move_quantifiers_biconditional(dummy_signature: FOLSignature) -> None:
    formula = parse_formula(dummy_signature, '¬(p₁(x) ↔ p₁(y))')
...
def test_to_pnf(formula: str, expected: str, dummy_signature: FOLSignature) -> None:
