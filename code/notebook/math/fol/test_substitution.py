...
def test_substitute_in_term(term: str, from_: str, to: str, expected: str, dummy_signature: FOLSignature) -> None:
    actual = str(
        substitute_in_term(
...
def test_substitute_in_formula(formula: str, from_: str, to: str, expected: str, dummy_signature: FOLSignature) -> None:
    actual = str(
