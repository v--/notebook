...
\begin{definition}\label{def:language}
  ...
  \begin{DefEnum}
    ...
    \ILabel{def:language/language} A \Def{language} over \( \CA \) is any subset of \( \CA^{\ast} \). Note that, in some contexts like \hyperref[subsec:language_of_propositional_logic]{propositional logic} or \hyperref[subsec:language_of_first_order_logic]{first-order logic}, the term \enquote{language} may refer to the alphabet itself (see \fullref{rem:propositional_language_is_alphabet}).
  \end{DefEnum}
\end{definition}
