...
\begin{definition}\label{def:functor}\mcite[def. 1.2.1 \\ def. 1.2.10]{Leinster2014}
...
\begin{definition}\label{def:opposite_functor}\mcite[def. 5.2.1]{Leinster2014}
...
\begin{proposition}\label{thm:functors_preserve_isomorphisms}\mcite[exer. 1.2.21]{Leinster2014}
...
\begin{definition}\label{def:presheaf}\mcite[def. 1.2.15]{Leinster2014}
...
\begin{example}\label{ex:topological_space_presheaf}\mcite[24]{Leinster2014}
...
\begin{definition}\label{def:faithful_full_functor}\mcite[def. 1.2.16]{Leinster2014}
...
\begin{example}\label{def:subcategory_functors}\mcite[25]{Leinster2014}
...
\begin{definition}\label{def:natural_transformation}\mcite[def. 1.3.1]{Leinster2014}
...
\begin{definition}\label{def:natural_transformation_horizontal_composition}\mcite[rem. 1.3.24]{Leinster2014}
...
\begin{definition}\label{def:comma_category}\mcite[def. 2.3.1]{Leinster2014}
