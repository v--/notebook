...
\begin{definition}\label{def:concrete_category}
  A category \( \Bold C \) is called \Def{concrete} is it is equipped with a forgetful\Tinyref{remark:forgetful_free_functor} faithful\Tinyref{def:faithful_full_functor} functor \( F: \Cat{C} \to \Bold{Set} \).
