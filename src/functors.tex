...
\begin{definition}\label{def:commutative_diagram}
  A diagram \( D \) is said to be \textbf{commutative} if, whenever we have two chains of morphisms
  \begin{align*}
  ...
  \begin{equation*}
    \begin{mplibcode}
      beginfig(1);
        ...
        label.bot("$h$", line_midpoint of a3);
      endfig;
    \end{mplibcode}
  \end{equation*}
  ...
  \begin{equation*}
    \begin{mplibcode}
      beginfig(1);
        ...
        n1 := thelabel("$F(A)$", origin);
        n2 := thelabel("$G(A)$", (0, -1) * u);
        n3 := thelabel("$F(A')$", (2, 0) * u);
        n4 := thelabel("$G(A')$", (2, -1) * u);
        ...
        label.lft("$\alpha_A$", line_midpoint of a1);
        label.top("$F(f)$", line_midpoint of a2);
        label.bot("$G(f)$", line_midpoint of a3);
        label.rt("$\alpha_{A'}$", line_midpoint of a4);
      endfig;
    \end{mplibcode}
  \end{equation*}
  commutes.
  ...
  \begin{equation*}
    \begin{mplibcode}
      ...
      beginfig(1);
        ...
        n1 := thelabel("$\mathbf{A}$", origin);
        n2 := thelabel("$\mathbf{B}$", (2, 0) * u);

        a1 := curved_arrow(n1, n2, (0, safe_arrow_curvature));
        a2 := curved_arrow(n1, n2, (0, -safe_arrow_curvature));

        draw_nodes(n);
        draw_arrows(a);

        label.top("$F$", curve_midpoint of a1);
        label.bot("$G$", curve_midpoint of a2);

        draw_vertical_double_arrow((1, 0) * u);
        label.rt("$\alpha$", (1, 0) * u);
      endfig;
    \end{mplibcode}
  \end{equation*}
  ...
  \begin{equation*}
    \begin{mplibcode}
      ...
      beginfig(1);
        ...
        n1 := thelabel("$\mathbf{A}$", origin);
        n2 := thelabel("$\mathbf{B}$", (2, 0) * u);
        n3 := thelabel("$\mathbf{C}$", (4, 0) * u);

        a1 := curved_arrow(n1, n2, (0, safe_arrow_curvature));
        a2 := curved_arrow(n1, n2, (0, -safe_arrow_curvature));
        a3 := curved_arrow(n2, n3, (0, safe_arrow_curvature));
        a4 := curved_arrow(n2, n3, (0, -safe_arrow_curvature));
        ...
        label.top("$F$", curve_midpoint of a1);
        label.bot("$G$", curve_midpoint of a2);
        label.top("$F'$", curve_midpoint of a3);
        label.bot("$G'$", curve_midpoint of a4);

        draw_vertical_double_arrow((1, 0) * u);
        label.rt("$\alpha$", (1, 0) * u);

        draw_vertical_double_arrow((3, 0) * u);
        label.rt("$\alpha'$", (3, 0) * u);
      endfig;
    \end{mplibcode}
  \end{equation*}
    ...
    \begin{equation}\label{def:comma_category/universal_property}
      \begin{mplibcode}
        beginfig(1);
          ...
          n1 := thelabel("$F(A)$", origin);
          n2 := thelabel("$G(B)$", (0, -1) * u);
          n3 := thelabel("$F(A')$", (2, 0) * u);
          n4 := thelabel("$G(B')$", (2, -1) * u);
          ...
          label.lft("$h$", line_midpoint of a1);
          label.top("$F(f)$", line_midpoint of a2);
          label.bot("$G(g)$", line_midpoint of a3);
          label.rt("$h'$", line_midpoint of a4);
        endfig;
      \end{mplibcode}
    \end{equation}
  \end{itemize}
  ...
  \begin{equation*}
    \begin{mplibcode}
      beginfig(1);
        ...
        n1 := thelabel("$C$", origin);
        n2 := thelabel("$G(B)$", (-1, -1) * u);
        n3 := thelabel("$G(B')$", (1, -1) * u);
        ...
        label.ulft("$h$", line_midpoint of a1);
        label.urt("$h'$", line_midpoint of a2);
        label.bot("$G(g)$", line_midpoint of a3);
      endfig;
    \end{mplibcode}
  \end{equation*}
  ...
  \begin{equation*}
    \begin{mplibcode}
      beginfig(1);
        ...
        n1 := thelabel("$H_A(A)$", origin);
        n2 := thelabel("$H_{A'}(A)$", (0, -1) * u);
        n3 := thelabel("$H_A(A')$", (2, 0) * u);
        n4 := thelabel("$H_{A'}(A')$", (2, -1) * u);
        ...
        label.lft("$\alpha_A$", line_midpoint of a1);
        label.top("$H_A(f)$", line_midpoint of a2);
        label.bot("$H_{A'}(f)$", line_midpoint of a3);
        label.rt("$\alpha_{A'}$", line_midpoint of a4);
      endfig;
    \end{mplibcode}
  \end{equation*}
  ...
  \begin{equation*}
    \begin{mplibcode}
      beginfig(1);
        ...
        n1 := thelabel("$g \circ f$", origin);
        n2 := thelabel("$\alpha_A(g \circ f) = H_{A'}(f)(\Id_{A'}) = f$", (-1, -1) * u);
        n3 := thelabel("$g$", (3, 0) * u);
        n4 := thelabel("$\alpha_{A'}(\alpha_{A'}^{-1}(\Id_{A'})) = \Id_{A'}$", (4, -1) * u);
        ...
        label.ulft("$\alpha_A$", line_midpoint of a1);
        label.top("$H_A(f)$", line_midpoint of a2);
        label.bot("$H_{A'}(f)$", line_midpoint of a3);
        label.urt("$\alpha_{A'}$", line_midpoint of a4);
      endfig;
    \end{mplibcode},
  \end{equation*}
  that is,
