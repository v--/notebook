...
\begin{remark}\label{rem:contravariant_functor}\mcite[def. 1.2.10]{Leinster2016Basic}
  ...
  The usage of the terms are entirely dictated by context. Unless necessary, we will avoid speaking about contravariant functors to avoid confusion. An example where they are useful is \fullref{ex:rem:contravariant_functor}.
\end{remark}
...
\begin{remark}\label{rem:category_similarity}
  ...
  \begin{thmenum}
    ...
    Examples of isomorphic categories include \fullref{thm:preorder_category_isomorphism} and \fullref{ex:isomorphism_of_categories}.
