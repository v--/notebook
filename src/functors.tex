...
\begin{definition}\label{def:diagonal_functor}\mcite[143]{Leinster2016Basic}
  ...
  Given two objects \( A \) and \( B \) in \( \cat{C} \), a natural transformation \( \alpha: \Delta_A^{\cat{I}} \Rightarrow \Delta_B^{\cat{I}} \) is an \hyperref[def:tuple_and_cartesian_product/indexed_family]{indexed family} that gives the same morphism for every object of the index category \( \cat{I} \).
  ...
  \begin{equation*}
    \begin{aligned}
      ...
      &\Delta^{\cat{I}}(f: A \to B) \coloneqq \seq{ f: A \to B }_{X \in \cat{I}}.
    \end{aligned}
  \end{equation*}
