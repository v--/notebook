...
\begin{definition}\label{def:lattice}
  ...
  \begin{description}
    \DItem{bottom}{def:lattice/top} a \textbf{top element} \( \top \), such that \( \top = \lor X \) (in particular, \( \lor X \) exists).
    \DItem{top}{def:lattice/bottom} a \textbf{bottom element} \( \bot \), such that \( \bot = \land X \).
