...
\begin{proof}
  ...
  \begin{description}
    ...
    \RItem{def:order/partial/antisymmetry} Let \( x \leq y \) and \( y \leq x \), that is, \( x \vee y = y \) and \( y \vee x = x \). By \fullref{def:binary_join_meet/commutativity}, \( x = y \vee x = x \vee y = y \).
    \RItem{def:order/partial/transitivity} Let \( x \leq y \) and \( y \leq z \), that is, \( x \vee y = y \) and \( y \vee z = z \). Then, by \fullref{def:binary_join_meet/associativity},
    \begin{equation*}
