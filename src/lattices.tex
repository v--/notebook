...
\begin{definition}\label{def:binary_lattice_operations}
  ...
  \begin{thmenum}
    \thmitem{def:binary_lattice_operations/join} The \term{join} of \( x \) and \( y \), denoted as \( x \vee y \).
    \thmitem{def:binary_lattice_operations/meet} The \term{meet} of \( x \) and \( y \), denoted as \( x \wedge y \).
    \thmitem{def:binary_lattice_operations/absorption} The following \term{absorption laws} hold:
    \begin{balign*}
      x \vee (y \wedge x) = x
       &  &
      x \wedge (y \vee x) = x.
...
\begin{proposition}\label{thm:binary_lattice_operations_properties}
  ...
  \begin{thmenum}
    \thmitem{thm:binary_lattice_operations_properties/idempotence} Both operations are \term{idempotent}, i.e. \( x \vee x = x = x \wedge x \).
  \end{thmenum}
\end{proposition}
\begin{proof}
...
\begin{definition}\label{def:lattice}
  ...
  \begin{thmenum}
    \thmitem{def:lattice/top} The \hyperref[def:preordered_set/largest_smallest_element]{global maximum} \( \vee \mscrX \) exists. We call it the \term{top element} \( \top \).

    \thmitem{def:lattice/bottom} The \hyperref[def:preordered_set/largest_smallest_element]{global minimum} \( \wedge \mscrX \) exists. We call it the \term{bottom element} \( \bot \).

    \thmitem{def:lattice/finite_join} All finite \hyperref[def:binary_lattice_operations]{joins} exist.
    \thmitem{def:lattice/finite_meet} All finite \hyperref[def:binary_lattice_operations]{meets} exist.
  \end{thmenum}
...
\begin{proposition}\label{thm:lattice_homomorphism}
  ...
  \begin{thmenum}
    \thmitem{thm:lattice_homomorphism/respects_joins} \( f(x \vee_{\mscrX} y) = f(x) \vee_{\mscrY} f(y) \)
    \thmitem{thm:lattice_homomorphism/respects_meets} \( f(x \wedge_{\mscrX} y) = f(x) \wedge_{\mscrY} f(y) \)
    \thmitem{thm:lattice_homomorphism/respects_top} \( f(\top_{\mscrX}) = \top_{\mscrY} \)
    \thmitem{thm:lattice_homomorphism/respects_bot} \( f(\bot_{\mscrX}) = \bot_{\mscrY} \)
  \end{thmenum}
...
\begin{proposition}\label{thm:boolean_algebra_properties}
  ...
  \begin{thmenum}
    \thmitem{thm:boolean_algebra_properties/unique_complement} For each \( x \in \mscrX \), there exists a unique complement \( \overline x \).
    \thmitem{thm:boolean_algebra_properties/double_complement} For each \( x \in \mscrX \), we have \( x = \overline{\overline x} \).
  \end{thmenum}
\end{proposition}
\begin{proof}
