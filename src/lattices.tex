...
\begin{proposition}\label{thm:lattice_ideals}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:lattice_ideals/direct}\mcite[17]{Gratzer1978} \( I \) is a \hyperref[def:semilattice/submodel]{join-sub-semilattice} and \( i \in I \) and \( l \in L \) imply \( i \wedge l \in I \). If \( L \) has a \hyperref[def:partially_ordered_set_extremal_points/top_and_bottom]{bottom}, it must belong to \( I \).
...
\begin{proof}
  ...
  \ImplicationSubProof{thm:lattice_ideals/direct}{thm:lattice_ideals/order} Suppose that \( I \) is a join-sub-semilattice and \( i \in I \) and \( l \in L \) imply \( i \wedge l \in I \).
  \begin{itemize}
...
\begin{proposition}\label{thm:lattice_filters}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:lattice_ideals/direct}\mcite[19]{Gratzer1978} \( F \) is a \hyperref[def:semilattice/submodel]{meet-sub-semilattice} and \( i \in I \) and \( l \in L \) imply \( i \vee l \in I \). If \( L \) has a \hyperref[def:partially_ordered_set_extremal_points/top_and_bottom]{top}, it must belong to \( I \).
...
\end{proposition}
\begin{proof}
  The proof is \hyperref[def:semilattice/duality]{dual} to \fullref{thm:lattice_ideals}.
\end{proof}
