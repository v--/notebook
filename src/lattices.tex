...
\begin{definition}\label{def:lattice}
  ...
  \begin{description}
    \DItem{def:lattice/top}[bottom] a \Def{top element} \( \top \), such that \( \top = \lor X \) (in particular, \( \lor X \) exists).
    \DItem{def:lattice/bottom}[top] a \Def{bottom element} \( \bot \), such that \( \bot = \land X \).
