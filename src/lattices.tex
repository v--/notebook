...
\begin{definition}\label{def:lattice}\cite[28]{Lectures:general_topology}
  ...
  \begin{description}
    \DItem{Bottom}{def:lattice/top} a \uline{top element} $\top$, such that $\top = \lor X$ (in particular, $\lor X$ exists).
