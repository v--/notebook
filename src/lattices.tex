...
\begin{proposition}\label{thm:binary_lattice_operations}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:binary_lattice_operations/identity} If \( P \) is a (semi)lattice, the constants act as \hyperref[def:magma_identity]{magma identities}. That is, for each \( x \in P \),
    \begin{align}
