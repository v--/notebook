...
\end{definition}
\begin{proof}
  \SubProofImplies{def:preordered_set/nonstrict}{def:preordered_set/strict} Let \( \leq \) be a nonstrict partial order. We will show that \( < \) is a strict partial order.
  ...
  \SubProofImplies{def:preordered_set/strict}{def:preordered_set/nonstrict} Let \( < \) be a strict partial order. We will show that \( \leq \) is a nonstrict partial order.
