...
\begin{definition}\label{def:totally_bounded_set}
  ...
  Totally bounded sets are sometimes called \Def{precompact}\Tinyref{def:compact_space} because of \cref{thm:metric_compact_iff_sequentially_compact}. This equivalence requires the metric space to be complete, however.
\end{definition}
\begin{proof}
  \begin{description}
