...
\begin{proof}
  \begin{description}
    ...
    \Implies[def:totally_bounded_set/sets][def:totally_bounded_set/epsilon_net] Fix \( \varepsilon > 0 \) and \( \mu \in (0, \varepsilon) \) and let \( A_1, \ldots, A_n \subseteq \Power X \) be a finite cover of \( A \) with sets of diameter at most \( \mu \).
