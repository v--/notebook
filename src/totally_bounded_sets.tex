...
Let \( (X, \rho) \) be a metric space\Tinyref{def:metric_space}.
...
\begin{definition}\label{def:totally_bounded_set}
  ...
  \begin{defenum}
    ...
    \DItem{def:totally_bounded_set/fundamental_subsequences} Every sequence in \( A \) admits a fundamental subsequence\Tinyref{def:fundamental_net}.
  \end{defenum}

  Totally bounded sets are sometimes called \Def{precompact}\Tinyref{def:compact_space} because of \fullref{thm:metric_compact_iff_sequentially_compact}. This equivalence requires the metric space to be complete, however.
\end{definition}
\begin{proof}\mbox{}
  \begin{description}
...
\begin{corollary}\label{thm:complete_metric_space_compact_conditions}
  ...
  \begin{defenum}
    \DItem{thm:complete_metric_space_compact_conditions/compact} \( A \) is compact\Tinyref{def:compact_space}
    \DItem{thm:complete_metric_space_compact_conditions/sequentially_compact} \( A \) is sequentially compact\Tinyref{def:compact_space/convergent_nets}.
    \DItem{thm:complete_metric_space_compact_conditions/closed_totally_bounded} \( A \) is closed and totally bounded\Tinyref{def:totally_bounded_set}.
  \end{defenum}
\end{corollary}
\begin{proof}
