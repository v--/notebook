...
\end{Definition}
\begin{RefListProof}
    \IIff{def:totally_bounded_set/sets}{def:totally_bounded_set/zero_noncompactness/sets} Straightforward.

    \IIff{def:totally_bounded_set/epsilon_net}{def:totally_bounded_set/zero_noncompactness/balls} Straightforward.

    \IImplies{def:totally_bounded_set/epsilon_net}{def:totally_bounded_set/sets} Given \( \varepsilon > 0 \), any cover of \( A \) with balls of radius \( \frac \varepsilon 2 \) is a cover with sets of diameter \( \varepsilon \).

    \IImplies{def:totally_bounded_set/sets}{def:totally_bounded_set/epsilon_net} Fix \( \varepsilon > 0 \) and \( \rho \in (0, \varepsilon) \) and let \( A_1, \ldots, A_n \subseteq \Pow X \) be a finite cover of \( A \) with sets of diameter at most \( \rho \).
    ...
    \IImplies{def:totally_bounded_set/epsilon_net}{def:totally_bounded_set/fundamental_subsequences} Let \( \{ x_n \} \subseteq A \) be any sequence.
    ...
    \IImplies{def:totally_bounded_set/fundamental_subsequences}{def:totally_bounded_set/epsilon_net} Assume\LEM that there exists \( \varepsilon_0 > 0 \), such that \( A \) admits no finite cover by \( \varepsilon_0 \)-balls.
...
\end{Corollary}
\begin{proof}
  \IIff{thm:complete_metric_space_compact_conditions/compact}{thm:complete_metric_space_compact_conditions/sequentially_compact} The equivalence is given by \fullref{thm:metric_compact_iff_sequentially_compact}.

  \IImplies{thm:complete_metric_space_compact_conditions/sequentially_compact}{thm:complete_metric_space_compact_conditions/closed_totally_bounded} The equivalence is given by \fullref{thm:metric_space_compact_iff_closed_totally_bounded}.
\end{proof}
