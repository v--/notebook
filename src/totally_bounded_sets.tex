...
\begin{proof}
  \begin{description}
    ...
    By the Lebesgue covering lemma (\fullref{thm:lebesgue_covering_lemma}), there exists \( \delta > 0 \) such that for every \( x \in A \), the ball \( B(x, \delta) \) is contained in some set of the cover \( \Cal{F} \). Let \( x_1, \ldots, x_n \) be a cover of \( A \) with \( \delta \)-balls.
