...
Let \( (X, \mu) \) be a metric space\Tinyref{def:metric_space}. Let \( \Cal{B} \) be the family of bounded sets in \( X \).

\begin{definition}\label{def:totally_bounded_set}
  The space \( A \subseteq X \) is called \textbf{totally bounded} if any of the following equivalent conditions hold:
  ...
  \begin{defenum}
    ...
    \DItem{def:totally_bounded_set/balls} For every \( \varepsilon > 0 \) there exists a finite cover of \( A \) with balls of radius \( \varepsilon \).
  ...
  Totally bounded sets are sometimes called \textbf{precompact}\Tinyref{def:compact_set} because of~\cref{thm:metric_compact_iff_sequentially_compact}. This equivalence requires the metric space to be complete, however.
\end{definition}
\begin{proof}
  \begin{description}
    \Iff[def:totally_bounded_set/sets][def:totally_bounded_set/zero_noncompactness/sets] Straightforward.

    \Iff[def:totally_bounded_set/balls][def:totally_bounded_set/zero_noncompactness/balls] Straightforward.

    \Implies[def:totally_bounded_set/balls][def:totally_bounded_set/sets] Given \( \varepsilon > 0 \), any cover of \( A \) with balls of radius \( \frac \varepsilon 2 \) is a cover with sets of diameter \( \varepsilon \).

    \Implies[def:totally_bounded_set/sets][def:totally_bounded_set/balls] Fix \( \varepsilon > 0 \) and \( \mu \in (0, \varepsilon) \) and let \( A_1, \ldots, A_n \subseteq \Power X \) be a finite cover of \( A \) with sets of diameter at most \( \mu \).
    ...
    \Implies[def:totally_bounded_set/balls][def:totally_bounded_set/fundamental_subsequences] Let \( \{ x_n \} \subseteq A \) be any sequence.
    ...
    \Implies[def:totally_bounded_set/fundamental_subsequences][def:totally_bounded_set/balls] Assume\LEM that there exists \( \varepsilon_0 > 0 \), such that \( A \) admits no finite cover by \( \varepsilon_0 \)-balls.
