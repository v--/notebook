...
\begin{remark}\label{rem:algebraic_structures}
  Modern algebra takes its roots in abstracting \hyperref[def:set_of_integers]{integers} and \hyperref[def:set_of_real_numbers]{real numbers} and their addition and multiplication. Both of these operations are commutative and, if we want to generalize their properties, it is sensible to study commutative operations.
