...
\begin{definition}\label{def:graph_geometric_realization}
  ...
  \begin{thmenum}
    \thmitem{def:graph_geometric_realization/drawing} Although it is not standardized terminology, we will say that any \hyperref[def:homeomorphism]{homeomorphism} of \( \coprod_{e \in E} [0, 1] / {\sim} \) is called a \term{graph drawing}.
