...
\begin{definition}\label{def:graph_incidence}
  Let \( G = (V, E) \) be a directed graph. We define the multivalued functions\Tinyref{def:function/multivalued} with signature \( \Pow(V) \MultTo E \):
  \begin{align*}
...
\begin{definition}\label{def:category_of_graphs}
  ...
  \begin{itemize}
    ...
    \item the morphisms between two graphs the homomorphisms between them, with morphism composition being the usual function composition\Tinyref{def:function/composition}.
  \end{itemize}
