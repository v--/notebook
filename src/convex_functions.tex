Let $X$ be a Hausdorff topological vector space\Tinyref{def:topological_vector_space} and $D$ be a convex subset\Tinyref{def:analysis/linear_combination_sets} of $X$.
