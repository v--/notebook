...
\begin{definition}\label{def:affine_functions_concave_and_convex}
  \hyperref[def:affine_operator]{Affine functions} \( f: X \to \BR \) are simultaneously convex and concave.
\end{definition}

\begin{proposition}\label{thm:convex_subdifferential_is_convex_and_weak*_closed}\MarginCite[exer. 1.10]{Phelps1993}
...
\begin{theorem}\label{thm:rn_continuous_convex_partial_derivatives_imply_gateaux}\MarginCite[exer. 1.15(b]{Phelps1993})
...
\begin{proof}
  ...
  \begin{BreakableAlign}\label{thm:rn_continuous_convex_partial_derivatives_imply_gateaux/diff_dominated}
    f_+'(x)(h)
     & =
...
\begin{theorem}\label{thm:rn_continuous_convex_gateaux_implies_frechet}\MarginCite[exer. 1.15(a]{Phelps1993})
...
\begin{proof}
  ...
  \begin{BreakableAlign}\label{thm:rn_continuous_convex_gateaux_implies_frechet/frechet_assumption}
  ...
  \begin{BreakableAlign}\label{thm:rn_continuous_convex_gateaux_implies_frechet/frechet_estimate}
...
\begin{theorem}\label{thm:rn_continuous_convex_frechet_almost_everywhere}\MarginCite[exer. 1.17]{Phelps1993}
...
\begin{proof}
  ...
  Denote
  \begin{BreakableAlign*}
     & H \coloneqq \Span\{ h \} \cong \BR^1,
    \\
     & H^\perp \cong \BR^{n-1} \text{ - the orthogonal complement of \( H \) in \( \BR^n \)},
    \\
