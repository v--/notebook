...
\begin{definition}\label{def:propositional_syntax}
  ...
  \begin{thmenum}
    ...
    The grammar of propositional formulas is unambiguous as shown by \fullref{thm:propositional_formulas_are_unambiguous}, which makes it possible to perform proofs via \hyperref[rem:structural_recursion_and_induction]{structural induction}.
