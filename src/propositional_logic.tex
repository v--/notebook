...
\begin{theorem}[Propositional semantic deduction theorem]\label{thm:propositional_semantic_deduction_theorem}
  ...
  This result allows us to connect deduction in the object language and deduction in the metalanguage (see \fullref{rem:induction}). Compare it with \fullref{thm:first_order_semantic_deduction_theorem} and \fullref{thm:propositional_syntactic_deduction_theorem}.
\end{theorem}
\begin{proof}
