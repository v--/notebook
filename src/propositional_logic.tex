...
\begin{definition}\label{def:inverse_converse_contrapositive}
  Fix the formula \( P \implies Q \).
  \begin{defenum}
    \DItem{def:inverse_converse_contrapositive/inverse} We call the formula \( \neg P \implies \neg Q \) the \Def{inverse} of \( P \implies Q \).

    \DItem{def:inverse_converse_contrapositive/converse} We call the formula \( Q \implies P \) the \Def{converse} of \( P \implies Q \).

    \DItem{def:inverse_converse_contrapositive/contrapositive} We call the formula \( \neg Q \implies \neg P \) the \Def{contrapositive} of \( P \implies Q \). It is Boolean equivalent\Tinyref{def:propositional_interpretation} to the original formula.
  \end{defenum}
\end{definition}
