  ...
  \begin{thmenum}
    ...
    \begin{equation}\label{eq:def:propositional_valuation/formula_interpretation}
      \varphi\Bracks{I} \coloneqq \begin{cases}
        ...
        B_{\bincirc}(\psi\Bracks{I}, \theta\Bracks{I}), &\varphi = \psi \bincirc \theta, \bincirc \in \Sigma,
      \end{cases}
    \end{equation}
  \end{thmenum}
  where \( B_{\bincirc} \) denotes the \hyperref[def:standard_boolean_operators]{Boolean operator} corresponding to the connective \( \bincirc \).
\end{definition}
...
\begin{proposition}[Boolean equivalences]\label{thm:boolean_equivalences}
  ...
  \begin{thmenum}
    ...
    \begin{align}\label{eq:thm:boolean_equivalences/negation_bottom}
    ...
    \begin{align}\label{eq:thm:boolean_equivalences/double_negation}
    ...
    \begin{align}\label{eq:thm:boolean_equivalences/ex_falso_quodlibet}
    ...
    \begin{align}\label{eq:thm:boolean_equivalences/contrapositive}
    ...
    \begin{align}\label{eq:thm:boolean_equivalences/biconditional_via_conditionals}
    ...
    \begin{align}\label{eq:thm:boolean_equivalences/conditional_cnf}
      \mathllap{\varphi \rightarrow \psi} &\gleichstark \mathrlap{ \neg \varphi \vee \psi. }
    \end{align}

    \thmitem{thm:boolean_equivalences/biconditional_dnf} A \hyperref[def:propositional_language/connectives/biconditional]{biconditional} is a \hyperref[def:propositional_language/connectives/disjunction]{disjunction} of \hyperref[def:propositional_language/connectives/conjunction]{conjunctions}:
    \begin{align}\label{eq:thm:boolean_equivalences/biconditional_dnf}
    ...
    \begin{align}\label{eq:thm:boolean_equivalences/biconditional_member_negation}
    ...
    \begin{align}\label{eq:thm:boolean_equivalences/biconditional_negation}
