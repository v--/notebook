...
\begin{definition}\label{def:propositional_syntax}
  ...
  \begin{thmenum}
    ...
    The grammar of propositional formulas is unambiguous as shown by \fullref{thm:propositional_formulas_are_unambiguous}, which makes it possible to perform proofs via \fullref{thm:structural_induction}.
...
\begin{remark}\label{rem:smaller_propositional_language}
  ...
  This is useful in
  \begin{itemize}
    \item Reduction to \hyperref[def:abstract_reduction_system/normal_form]{normal forms} such as the \hyperref[def:conjunctive_disjunctive_normal_form]{conjunctive normal form} in \fullref{alg:conjunctive_normal_form_reduction}.
...
\begin{definition}\label{def:conjunctive_disjunctive_normal_form}
  We will now introduce the conjunctive and disjunctive \hyperref[def:abstract_reduction_system/normal_form]{normal forms}.
...
\begin{algorithm}\label{alg:conjunctive_normal_form_reduction}
  ...
  When regarding the algorithm as the reduction relation of an \hyperref[def:abstract_reduction_system]{abstract reduction system}, the conjunctive normal form is a normal form modulo \( \gleichstark \) in the sense of \fullref{def:abstract_reduction_system/normal_form}.
