...
\begin{definition}\label{def:propositional_syntax}
  ...
  \begin{thmenum}
    ...
    The grammar of propositional formulas is unambiguous as shown by \fullref{thm:propositional_formulas_are_unambiguous}.
...
\begin{theorem}[Propositional semantic deduction theorem]\label{thm:propositional_semantic_deduction_theorem}
  ...
  This result allows us to connect deduction in the object language and deduction in the metalanguage (see \fullref{rem:structural_induction}). Compare it with \fullref{thm:first_order_semantic_deduction_theorem} and \fullref{thm:propositional_syntactic_deduction_theorem}.
\end{theorem}
\begin{proof}
...
\begin{remark}\label{rem:smaller_propositional_language}
  ...
  \begin{itemize}
    ...
    \item \hyperref[def:propositional_semantics/satisfiability]{Satisfiability} proofs that rely on \hyperref[rem:structural_induction]{structural induction} because it allows us to consider less cases in the induction.
