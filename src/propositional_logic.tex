...
\begin{definition}\label{def:conjunctive_disjunctive_normal_form}
  We will now introduce the conjunctive and disjunctive normal forms. The concepts are related but distinct from that of \hyperref[rem:lattice_polynomials]{lattice polynomials}.
