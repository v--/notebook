...
\begin{definition}\label{def:hilberts_derivation_system}\MarginCite[def. 20.5 \\ def. 20.7]{OpenLogic20201202}
  ...
  \begin{RefList}
    ...
    \begin{BreakableAlign}
      ...
      \ForAll{\xi} \varphi                    &\to \varphi[\xi \mapsto \tau],     \hspace{0.95cm} \tau \text{ is a closed term}     \label{def:hilberts_derivation_system/axioms/forall_elim} \\
      \varphi[\xi \mapsto \tau]                         &\to \Exists{\xi} \varphi, \hspace{1.5cm} \tau \text{ is a closed term}     \label{def:hilberts_derivation_system/axioms/exists_intro} \\
