...
\begin{proof}
  ...
  This is a module of \hyperref[thm:commutative_vector_space_dimension]{rank} \( d \).

  Furthermore, there are \( \ifrac {d^2} {(4nm)} \) such polynomials. If \( d > 4nm \), there are more polynomials of the form \( p^l q^k \) than the \hyperref[thm:commutative_vector_space_dimension]{rank} of \( L_d \). Hence, every \( d + 1 \) such polynomials are linearly dependent, and hence there exists some linear combination
  \begin{equation*}
