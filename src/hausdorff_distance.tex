...
\begin{definition}\label{def:hausdorff_distance}\mcite\cite[144]{DontchevRockafellar2014}
  ...
  \begin{balign*}
     ...
     & e(E, F) \coloneqq \begin{cases}
      ...
      0,                                                                                          & E = \varnothing, D \neq \varnothing                   \\
      \sup_{x \in E} \op{dist}(x, F) \overset{*}{=} \inf \{\delta > 0 \colon E \subseteq F_\delta \}, & E \neq \varnothing \nonumber\refstepcounter{equation}
    \end{cases}
  \end{balign*}
