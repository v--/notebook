...
\begin{definition}\label{def:hausdorff_distance}\cite[144]{Dontchev2014}
  ...
  \begin{align}\label{def:hausdorff_distance/excess}
    &e: \Power X \times \Power X \to \BR \cup \{ \infty \} \\ \nonumber
    &e(E, F) \coloneqq \begin{cases}
      +\infty, &E = \varnothing, D = \varnothing \\
      0, &E = \varnothing, D \neq \varnothing \\
      \sup_{x \in E} \Dist(x, F) \stackrel{(\ref{def:hausdorff_distance/excess})}{=} \inf \{\delta > 0 \colon E \subseteq F_\delta \}, &E \neq \varnothing \nonumber\refstepcounter{equation}
    \end{cases}
  \end{align}
  ...
  \end{equation*}
\end{definition}
\begin{proof}(of \fullref{def:hausdorff_distance/excess})
  Note that the set
  \begin{equation*}
