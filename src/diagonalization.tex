...
\begin{proof}
  ...
  Therefore, this is an \hyperref[rem:internal_direct_sum]{internal direct sum} giving \( V \).
...
\begin{definition}\label{def:adjoint_operator}\mcite[sec. 38.1]{Тыртышников2004Лекции}
  ...
  If an adjoint exists, it is unique. But an adjoint may not exist.
...
\end{definition}
\begin{defproof}
  Suppose that, for some linear maps \( R \) and \( S \), for any \( x \in U \) and \( y \in V \) we have
  \begin{equation*}
