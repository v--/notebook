...
\begin{proof}
  ...
  The statement of the theorem now follows from comparison (\fullref{thm:positive_series_comparison}) with the geometric \hyperref[def:geometric_progression/series]{series}.
\end{proof}
...
\begin{proof}
  ...
  Convergence now follows from comparison (\fullref{thm:positive_series_comparison}) of the geometric \hyperref[def:geometric_progression/series]{series} with the subseries of \fullref{def:positive_series_comparison/a} obtained by trimming the first \( k_0 \) elements.
\end{proof}
