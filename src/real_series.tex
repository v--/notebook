...
\begin{theorem}[Riemann's series permutation theorem]\label{thm:riemanns_series_permutation_theorem}\mcite[\textnumero 247]{Фихтенгольц1968/2}
  If the real series
  \begin{equation*}
    \sum_{k=0}^\infty a_k
  \end{equation*}
...
\begin{proposition}\label{thm:positive_series_comparison}\mcite[\textnumero 237]{Фихтенгольц1968/2}
...
\begin{proposition}[Cauchy's root test]\label{thm:cauchys_root_test}\mcite[thm. 3.33]{Rudin1976}
...
\begin{proposition}[d'Alambert's ratio test]\label{thm:dalamberts_ratio_test}\mcite[thm. 3.33]{Rudin1976}
  Consider the nonnegative series \fullref{def:positive_series_comparison/a}. Put
  \begin{equation*}
...
\begin{theorem}\label{thm:weierstrass_series_criterion_nessessity}\mcite[\textnumero 268]{Фихтенгольц1968/2}
