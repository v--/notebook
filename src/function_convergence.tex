...
\begin{proposition}\label{thm:cauchy_function_convergence_via_subbases}
  ...
  Compare this result to \cref{thm:net_convergence_via_subbases}.
\end{proposition}
\begin{proof}
  \begin{description}
    \Implies Obvious consequence of \cref{def:convergence_of_function_at_point/neighborhoods}.
    \ImpliedBy Fix a neighborhood \( V \) of \( x \). We will show that \cref{def:convergence_of_function_at_point/neighborhoods} holds.
    ...
    Therefore \cref{def:convergence_of_function_at_point/neighborhoods} holds.
  \end{description}
\end{proof}
