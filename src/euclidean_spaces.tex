...
\begin{definition}\label{def:rigid_motion}\mimprovised
  ...
  \begin{thmenum}
    ...
    \thmitem{def:rigid_motion/rotation} A \term{rotation} about the point \( O \) is an affine operator with fixed point \( O \) and an \hyperref[def:orthogonal_operator]{orthogonal} linear part with \hyperref[def:matrix_determinant]{determinant} \( 1 \).
