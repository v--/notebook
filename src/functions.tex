...
\begin{definition}\label{def:function}
  ...
  \begin{itemize}
    \item\label{def:function/partial} The function \( f: X \to Y \) is called a\textbf{partial function} if there may exist points \( x \in X \) without a value \( f(x) \). In this context,
    \begin{itemize}
    ...
    \item\label{def:function/multivalued} Functions of the type \( f: X \to \Power Y \), usually denoted as \( f: X \MultTo Y \), are called ~\textbf{multivalued or set-valued mappings} between \( X \) and \( Y \) (these are usually referred to as mappings rather than functions). In this context,
    \begin{itemize}
...
\begin{definition}\label{def:function_invertibility}(Compare with \cref{def:morphism_invertibility})
  ...
  \begin{defenum}
    \item\label{def:function_invertibility/injection} \( f \) is called \textbf{injective}, \textbf{left-invertible} or \textbf{one-to-one} if either
    \begin{itemize}
    ...
    \item\label{def:function_invertibility/surjection} \( f \) is called \textbf{surjective}, \textbf{right-invertible} or \textbf{onto} if either
    \begin{itemize}
    ...
    \item\label{def:function_invertibility/bijection} \( f \) is called \textbf{bijective} or simply \textbf{invertible} if either
    \begin{itemize}
