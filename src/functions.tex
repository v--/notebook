...
\begin{definition}\label{def:function}
  ...
  \begin{thmenum}[resume=def:function]
    ...
    \ilabel{def:function/superposition} Although the terms \enquote{composition} and \enquote{superposition} are used interchangeably (see \cite[44]{Enderton1977Sets} and \cite[\textnumero 25]{Фихтенгольц1968/1}), \enquote{superposition} usually refers to the following special case of composition:
