...
\begin{proposition}\label{thm:def:function_image/properties}
  ...
  Compare this result to the more well-behaved properties of \hyperref[thm:def:function/preimage]{preimages} described in \fullref{thm:def:function_preimage/properties}.
\end{proposition}
\begin{proof}
