...
\begin{example}\label{ex:indexed_families}
  ...
  \begin{defenum}
    ...
    \item In continuous stochastic processes, it is convenient to consider families of random variables \( \{ X_t \}_{t \geq 0} \) indexed by \( I = \BR^+ \). The indexing parameter is often denoted by \( t \geq 0 \) is often interpreted as time.
