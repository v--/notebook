...
\begin{definition}\label{def:undirected_multigraph}
  ...
  \begin{figure}[h]
    \begin{equation}\label{eq:fig:def:undirected_multigraph}
      \begin{aligned}
        \includegraphics[page=1]{figures/def__undirected_multigraph.pdf}
      \end{aligned}
    \end{equation}
...
\begin{example}\label{ex:complete_graph}
  ...
  \begin{figure}
    \begin{equation}\label{eq:fig:ex:complete_graph}
      \begin{aligned}
        \includegraphics[page=1]{figures/ex__complete_graph.pdf}
      \end{aligned}
    \end{equation}
...
\begin{definition}\label{def:undirected_multigraph_path}
  ...
  \begin{figure}
    \begin{equation}\label{eq:fig:def:undirected_multigraph_path}
      \begin{aligned}
        \includegraphics[page=1]{figures/def__undirected_multigraph_path.pdf}
      \end{aligned}
    \end{equation}
