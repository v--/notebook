...
\begin{definition}\label{def:noetherian_module}\mcite\cite[prop. 8.30]{Knapp2016BAlg}
...
\begin{theorem}[Hilbert basis theorem]\label{thm:hilberts_basis_theorem}\mcite\cite[418]{Knapp2016BAlg}
