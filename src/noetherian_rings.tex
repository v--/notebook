...
\begin{theorem}\label{thm:noetherian_rings_closed_under}
  ...
  \begin{defenum}
    ...
    \DItem{thm:noetherian_rings_closed_under/modules}\cite[proposition 8.34]{Knapp2016BAlg} Any \hyperref[def:free_left_module]{finitely generated module} over a Noetherina ring is also \hyperref[def:noetherian_module]{Noetherian}.
