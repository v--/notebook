...
\begin{definition}\label{def:noetherian_module}\mcite[prop. 8.30]{Knapp2016BAlg}
...
\begin{theorem}[Hilbert basis theorem]\label{thm:hilberts_basis_theorem}\mcite[418]{Knapp2016BAlg}
...
\begin{theorem}[Primary decomposition]\label{thm:primary_decomposition}\mcite[thm. 10.6]{Коцев2016}
