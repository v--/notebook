...
\begin{definition}\label{def:noetherian_module}\cite[proposition 8.30]{Knapp2016BAlg}
  ...
  \begin{defenum}
    ...
    \DItem{def:noetherian_module/finite_basis} Every submodule of \( M \) is finitely \hyperref[def:free_left_module]{generated}.
  \end{defenum}
\end{definition}
\begin{proof}\mbox{}
  \begin{description}
...
\begin{theorem}\label{thm:noetherian_rings_closed_under}
  ...
  \begin{defenum}
    \DItem{thm:noetherian_rings_closed_under/localization}\cite[corollary 8.48]{Knapp2016BAlg} The \hyperref[def:ring_localization]{localizations} \( S^{-1} R \) of a Noetherian ring \( R \) are also Noetherian.

    \DItem{thm:noetherian_rings_closed_under/modules}\cite[proposition 8.34]{Knapp2016BAlg} Any finitely generated \hyperref[def:free_left_module]{module} over a Noetherina ring is also \hyperref[def:noetherian_module]{Noetherian}.
