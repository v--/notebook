...
\begin{definition}\label{def:noetherian_module}\mcite[prop. 8.30]{Knapp2016BasicAlgebra}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:noetherian_module/finite_basis} Every submodule of \( M \) is finitely \hyperref[def:free_semimodule]{generated}.
  \end{thmenum}
\end{definition}
\begin{proof}
...
\begin{theorem}\label{thm:noetherian_rings_closed_under}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:noetherian_rings_closed_under/modules}\cite[proposition 8.34]{Knapp2016BasicAlgebra} Any \hyperref[def:free_semimodule]{finitely generated module} over a Noetherina ring is also \hyperref[def:noetherian_module]{Noetherian}.
