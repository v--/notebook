...
\end{definition}
\begin{proof}
  \SubProofImplies{def:noetherian_module/ascending_chain}{def:noetherian_module/finite_basis} We can construct a basis as follows: choose\AOC any element \( x_1 \) of \( M \). Next, choose\AOC an element \( x_2 \in M \setminus \Gen {x_1} \), then \( x_3 \in M \setminus \Gen {x_1, x_2} \) and so on.
  ...
  \SubProofImplies{def:noetherian_module/finite_basis}{def:noetherian_module/ascending_chain} Suppose that all submodules of \( M \) are finitely generated. Let
  \begin{equation*}
    M_1 \subsetneq M_2 \subsetneq \ldots
  \end{equation*}
