...
\begin{example}\label{ex:def:category_of_first_order_models}
  ...
  \begin{itemize}
    ...
    \item The categories \hyperref[def:directed_graph/category]{\( \cat{DGraph} \)} and \hyperref[def:undirected_graph/category]{\( \cat{UGraph} \)} of directed and undirected graphs.
  \end{itemize}
