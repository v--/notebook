...
\begin{example}\label{ex:def:category_of_first_order_models}
  ...
  \begin{itemize}
    ...
    \item The category \hyperref[def:category_of_sets]{\( \cat{Set} \)} of sets with respect to either \logic{ZFC}, \logic{ZFC+U} or na\"ive set theory is not the same as the category of models of set theory. Instead, it is a category within a fixed set theory. Within the metalogic of this document, we work within a fixed model of \logic{ZFC+U} with respect to \hyperref[def:classical_logic]{classical logic}.
