...
\begin{example}\label{ex:def:category_of_first_order_models}
  ...
  \begin{itemize}
    ...
    \item The categories \hyperref[def:graph/directed/category]{\( \cat{DGraph} \)} and \hyperref[def:graph/undirected/category]{\( \cat{UGraph} \)} of directed and undirected graphs.
  \end{itemize}
