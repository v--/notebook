...
\begin{definition}\label{def:category_of_first_order_models}
  ...
  \begin{itemize}
    ...
    \item The \hyperref[def:category/identity]{identity morphism} of a model is the \hyperref[def:multi_valued_function/identity]{identity function} on its universe.
  \end{itemize}
\end{definition}
\begin{proof}
