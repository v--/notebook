...
\begin{proposition}\label{thm:first_order_categorical_invertibility}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:first_order_categorical_invertibility/surjective} \hyperref[thm:categorical_principle_of_duality]{Dually}, every \hyperref[def:first_order_homomorphism_invertibility/projection]{structure projection} (surjective homomorphism) is a \hyperref[def:morphism_invertibility/right_cancellative]{categorical epimorphism}.
