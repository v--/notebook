...
\begin{proof}
  ...
  To show that cancellation is not, consider the group \hyperref[thm:group_of_integers_modulo]{\( \BbbF_2 \)}. It is a cancellative magma by \fullref{thm:def:group/properties/cancellative}. Define the sets \( A \coloneqq \{ 0, 1 \} \) and \( B \coloneqq \{ 0 \} \). Then
  \begin{equation*}
    A + A = A = A + B,
  \end{equation*}
