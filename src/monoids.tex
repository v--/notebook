...
\begin{definition}\label{rem:pointed_set}\mcite[26]{MacLane1994}
  ...
  \begin{thmenum}
    ...
    \thmitem{rem:pointed_set/trivial} The \hyperref[thm:substructures_form_complete_lattice/bottom]{trivial} pointed set is, up to an isomorphism, the set \( \set{ e } \).
...
\begin{definition}\label{def:monoid}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:monoid/trivial} The \hyperref[thm:substructures_form_complete_lattice/bottom]{trivial} monoid is the \hyperref[rem:pointed_set/trivial]{trivial pointed set} \( \set{ e } \).
