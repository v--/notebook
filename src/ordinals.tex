...
\begin{remark}\label{rem:structural_recursion_and_induction}\mimprovised
  ...
  The pair \( (A_0, \to) \) is then an \hyperref[def:abstract_reduction_system]{abstract reduction system}. If it happens to be \hyperref[def:abstract_reduction_system]{unambiguous}, we can use \fullref{thm:structural_induction} to prove universal statements about \( A_0 \).
