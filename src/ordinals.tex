...
\begin{theorem}[Well-ordering theorem]\label{thm:well_ordering_principle}\mcite[thm. 69.6]{OpenLogicFull}
...
\end{theorem}
\begin{proof}
  \ImplicationSubProof[def:zfc/choice]{axiom of choice}[thm:well_ordering_principle]{well-ordering theorem} The empty set is trivially well-ordered.
  ...
  \ImplicationSubProof[thm:well_ordering_principle]{well-ordering theorem}[def:zfc/choice]{axiom of choice} Let \( A \) be any set and suppose that \( < \) well orders \( A \).
