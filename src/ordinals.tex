...
\begin{definition}\label{def:successor_ordinal}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:successor_ordinal/smaller_successor} There exists some \( \beta \in \alpha \) such that \( \op{succ}(\beta) \) does not belong to \( \alpha \).
...
\end{definition}
\begin{proof}
  \ImplicationSubProof{def:successor_ordinal/successor}{def:successor_ordinal/smaller_successor} If \( \alpha = \op{succ}(\beta) \), then \( \beta \) satisfies \fullref{def:successor_ordinal/smaller_successor}.

  \ImplicationSubProof{def:successor_ordinal/smaller_successor}{def:successor_ordinal/successor} Let \( \beta \in \alpha \) be such that \( \op{succ}(\beta) \not\in \alpha \). Then by trichotomy we have that either \( \op{succ}(\beta) = \alpha \) or \( \op{succ}(\beta) > \alpha \).
