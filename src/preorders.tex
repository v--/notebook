...
\begin{definition}\label{def:preordered_set}\mcite{nLab:preorder}
  ...
  \begin{thmenum}[series=def:preordered_set]
    ...
    The \term{theory of preordered sets} is a \hyperref[def:first_order_theory]{first-order theory} in \( \mscrL \) axiomatized by \hyperref[def:binary_relation/reflexive]{reflexivity} and \hyperref[def:binary_relation/transitive]{transitivity} for \( \leq \) and the compatibility axiom
