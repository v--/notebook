...
\begin{proposition}\label{thm:free_monoid_universal_property}
  ...
  Via \fullref{rem:universal_mapping_property}, this makes \( F \) a \hyperref[def:category_adjunction]{left adjoint} to the \hyperref[def:concrete_category]{forgetful functor} \( U: \cat{Set} \to \cat{Mon} \).
\end{proposition}
\begin{proof}
...
\begin{proposition}\label{thm:free_group_universal_property}
  ...
  Via \fullref{rem:universal_mapping_property}, this makes \( F \) a \hyperref[def:category_adjunction]{left adjoint} to the \hyperref[def:concrete_category]{forgetful functor} \( U: \cat{Set} \to \cat{Grp} \).
\end{proposition}
\begin{proof}
...
\begin{definition}\label{def:group_presentation}\mcite[314]{Knapp2016BasicAlgebra}
  Let \( S \) be a set, \( F(S) \) be the \hyperref[def:free_group]{free group} and \( R \subseteq F(S) \) be a subset. Denote by \( N(R) \) the \hyperref[def:group/submodel]{generated} by \( R \) \hyperref[def:normal_subgroup]{normal subgroup}.
...
\begin{proposition}\label{thm:group_categorical_limits}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:group_categorical_limits/coproduct} The \hyperref[def:discrete_category_limits]{categorical coproduct} of the family \( \seq{ G_k }_{k \in \mscrK} \) in \( \cat{Grp} \) is the \hyperref[def:group_free_product]{free product} \( \Ast_{k \in \mscrK} X_k \), the inclusion morphisms being
    \begin{equation*}
      \begin{aligned}
