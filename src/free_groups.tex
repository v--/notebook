...
\begin{proposition}\label{thm:def:group_order/properties}
  ...
  \begin{thmenum}
    \thmitem{thm:def:group_order/properties/divides} For finite groups, the order of a group element divides the order of the group.
  \end{thmenum}
\end{proposition}
\begin{proof}
  \SubProofOf{thm:def:group_order/properties/divides} Follows from \fullref{thm:lagranges_theorem_for_groups}.
\end{proof}
