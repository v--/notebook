...
\begin{definition}\label{def:group_presentation}\mcite[314]{Knapp2016BasicAlgebra}
  ...
  We say that the group \( G \) is \term{finitely generated} if it has a presentation \( \braket{ S \mid R } \) such that \( S \) is a \hyperref[def:set_finiteness]{finite set}. If only \( R \) is finite, we call \( G \) \term{finitely presented}.
