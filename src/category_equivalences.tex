...
\end{proposition}
\begin{proof}
  \SubProofOf[def:binary_relation/reflexivity]{reflexivity} Clearly \( (\id_{\cat{C}}, \id_{\cat{C}}, \id_{\id_{\cat{C}}}, \id_{\id_{\cat{C}}}]) \) is a self-equivalence for the category \( \cat{C} \).
  ...
  \SubProofOf[def:binary_relation/transitivity]{transitivity} By \fullref{thm:def:morphism_invertibility/properties/invertible_composition}, the composition of invertible natural isomorphisms is again a natural isomorphism, hence equivalence in \( \obj(\ucat{Cat}) \) is a transitive relation.
\end{proof}
