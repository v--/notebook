...
\begin{example}\label{ex:infinite_integer_graphs}
  ...
  \begin{equation}\label{eq:ex:infinite_integer_graphs/positive}
    \begin{aligned}
      \includegraphics[page=1]{output/ex__infinite_integer_graph.pdf}
    \end{aligned}
  \end{equation}
  ...
  \begin{equation}\label{eq:ex:infinite_integer_graphs/negative}
    \begin{aligned}
      \includegraphics[page=2]{output/ex__infinite_integer_graph.pdf}
    \end{aligned}
  \end{equation}

  This later graph is more important, and the corresponding \hyperref[def:categorical_diagram]{categorical diagrams} are defined in \fullref{def:tower_diagram}.
  ...
  \begin{equation}\label{eq:ex:infinite_integer_graphs/two_sided}
    \begin{aligned}
      \includegraphics[page=3]{output/ex__infinite_integer_graph.pdf}
    \end{aligned}
  \end{equation}
