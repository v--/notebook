...
\begin{definition}\label{def:quiver_free_category}
  ...
  We will see in \fullref{ex:def:category_adjunction/quiv_cat} that \( F: \ucat{Quiv} \to \ucat{Cat} \) is an adjoint functor to the forgetful functor \( U: \ucat{Cat} \to \ucat{Quiv} \).
