...
\begin{proposition}\label{thm:graph_undirected_iff_adjacency_matrix_is_symmetric}
  Every square finite matrix over the two-element field \hyperref[thm:ring_of_integers_modulo_zero_divisors]{\( \BbbZ_2 \)} corresponds to a \hyperref[def:quiver]{quiver} without parallel arcs.
