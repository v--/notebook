...
\begin{example}\label{ex:tower_diagram_graph}
  ...
  \begin{equation}\label{eq:ex:tower_diagram_graph/forward}
    \begin{aligned}
      \includegraphics[page=1]{output/ex__tower_diagram_graph.pdf}
    \end{aligned}
  \end{equation}
  ...
  \begin{equation}\label{eq:ex:tower_diagram_graph/backward}
    \begin{aligned}
      \includegraphics[page=2]{output/ex__tower_diagram_graph.pdf}
    \end{aligned}
  \end{equation}
  ...
  \begin{equation}\label{eq:ex:tower_diagram_graph/two_sided}
    \begin{aligned}
      \includegraphics[page=3]{output/ex__tower_diagram_graph.pdf}
    \end{aligned}
  \end{equation}
