...
\begin{theorem}\label{thm:power_series_are_locally_uniform_convergent}
  If the power series \cref{def:convergent_power_series/series} has a radius of convergence \( R \), it is locally uniformly convergent\Tinyref{def:function_net_convergence/locally_uniform}.
\end{theorem}
