...
\begin{definition}\label{def:derivatives}
  ...
  \begin{defenum}
    \item\label{def:derivatives/classical} The classical \textbf{two-sided derivative} is defined as
    \begin{align*}
    ...
    \item\label{def:derivatives/onesided}\cite[lemma 1.2]{Phelps1993} The \textbf{one-sided (or right-hand) directional derivative} is defined as
    \begin{align*}
    ...
    \item\label{def:derivatives/dini}\cite[definition 11.18]{Clarke2013} The \textbf{upper (resp. lower) Dini derivative} is defined as
    \begin{align*}
    ...
    \item\label{def:derivatives/clarke}\cite[Section 10.1]{Clarke2013} The \textbf{generalized Clarke derivative} is defined as
    \begin{align*}
      f^\circ(x)(h)
      &\coloneqq
...
\begin{definition}\label{def:differentiability}
  ...
  \begin{defenum}
    ...
    \item\label{def:differentiability/two-sided}\cite[0.2.1]{Ioffe1974} If the two-sided directional derivative \( f'(x)(h) \) exists for all directions \( h \in S_X \), we call it the \textbf{first variation at \( x \)} and denote the corresponding linear operator \( \delta f(x): X \to Y \).
    ...
    \item\label{def:differentiability/strong}\cite[33]{Dontchev2014} We say that \textbf{\( f \) is strictly differentiable at \( x \)} if there exists a continuous linear operator \( f'(x): X \to Y \) such that
    \begin{align*}
