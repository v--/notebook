...
\begin{theorem}\label{thm:aoc}
  ...
  \begin{thmenum}
    \DItem{thm:aoc/transversal}\cite[theorem 6M(4)]{Enderton1977} Every disjoint family of nonempty sets has a minimal transversal\Tinyref{thm:disjoint_minimal_set_transversal}.
    ...
    \DItem{thm:aoc/vector_space_bases} Every vector space has a basis (see \cref{thm:all_vector_spaces_are_free_left_modules}).
