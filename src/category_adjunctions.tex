...
\end{proposition}
\begin{proof}
  We will only prove the statement for left adjoints because right adjoints can be handled similarly in a certain form of \hyperref[rem:categorical_principle_of_duality]{duality}. Suppose that \( (F', G, \eta', \varepsilon') \) and \( (F', G, \eta^\dprime, \varepsilon^\dprime) \) are two unit-counit adjunctions.
