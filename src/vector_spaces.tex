...
\begin{definition}\label{def:vector_space}
  A \Def{vector space} \( (V, +, \cdot) \) is a left module\Tinyref{def:left_module} over a field \( F \). It can also be regarded as a field action, see \cref{remark:module_as_ring_action}.
