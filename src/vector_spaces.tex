...
\begin{definition}\label{def:complex_conjucate_vector_space}
  Let \( V \) be a vector space over the complex numbers \( \BB{C} \). Its \Def{complex conjugate vector space} \( \Ol V \) is the same space but with scalar multiplication defined as
  \begin{equation*}
