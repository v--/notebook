...
\begin{proof}
  ...
  \NecessitySubProof Let \( B \subseteq M \) and \( \linspan{B} = M \). Assume\LEM that there exists a vector \( x \in M \setminus B \) such that the set \( B \cup \{ x \} \) is linearly independent.
