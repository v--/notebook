...
\begin{remark}\label{remark:real_vector_space}
  Outside of algebra, we are usually only interested in vector spaces over the fields \( \R \) or \( \C \). We call them \textbf{real vector spaces} and \textbf{complex vector spaces}, respectively.
\end{remark}
