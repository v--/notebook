...
\begin{proposition}\label{thm:triple_of_points_is_coplanar}
  Three or fewer points are \hyperref[def:coplanar_points]{coplanar}.
\end{proposition}
\begin{proof}
  ...
  \begin{itemize}
    \item If \( \vect{ob} = \lambda d \) is linearly dependent, choose \( e \) as any vector linearly independent from \( d \).
