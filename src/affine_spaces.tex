...
\begin{proposition}\label{thm:pair_of_points_is_collinear}
  Two or fewer points are always collinear. Furthermore, there is exactly one line passing through two distinct points.
...
\begin{proposition}\label{thm:triple_of_points_is_coplanar}
  Three or fewer points are \hyperref[def:coplanar_points]{coplanar}. Furthermore, there is exactly one plane passing through three non-collinear points.
\end{proposition}
\begin{proof}
