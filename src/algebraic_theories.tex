...
\begin{remark}\label{remark:algebra_vs_analysis}
  An distinction is made, out of all areas of mathematics, between \hyperref[sec:real_analysis]{analysis}\Tinyref{sec:nonsmooth_analysis}\Tinyref{sec:functional_analysis} and \hyperref[sec:group_theory]{algebra}\Tinyref{sec:ring_theory}\Tinyref{sec:linear_algebra} and between upholders of the two. The difference seems silly but it comes down to a personal philosophy and worldview. An interesting anecdote about this distinction can be found in \cite{Tilly2010}.
