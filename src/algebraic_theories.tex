...
\begin{definition}\label{def:algebraic_theory}\cite[remark 2.1.4]{Leinster2014}
  ...
  \begin{defenum}
    ...
    \begin{equation*}
      x \odot y = e,
    \end{equation*}
    and simply \Def{invertible} if it is both left and right invertible. If only a fixed element need to be invertible, this can be added as a constant to the theory. If all elements need to be invertible, this can be added as a unary operation \( (\cdot)^{-1} \) to the theory.
