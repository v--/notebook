...
\begin{definition}\label{def:set_with_involution}
  A \term{set with an involution} is quite literally a \hyperref[def:set]{set} \( \mscrX \) with an \hyperref[def:function/involution]{involution}, usually denoted by \( (\placeholder)^{-1} \) or \( \overline \placeholder \).
