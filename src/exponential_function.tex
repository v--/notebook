...
\begin{proposition}\label{thm:exponential-trigonometric_identities}
  ...
  \ILabel{thm:exponential_trigonometric_identities/eulers_formula} (Euler's formula) For any \( z \in \BC \),
  \begin{equation}\label{thm:exponential_trigonometric_identities/eulers_formula/identity}
    e^{iz} = \cos(z) + i \sin(z).
  \end{equation}

  \ILabel{thm:exponential_trigonometric_identities/inverse_eulers_formula} (Inverse Euler's identities) For any \( z \in \BC \),
  \begin{align}
  ...
  \ILabel{thm:exponential_trigonometric_identities/de_moivre} (De Moivre's formula) For any complex number \( z \) and any nonnegative integer \( n \),
