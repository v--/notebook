...
\begin{definition}\label{def:arborescence}\mcite[ch. 4, sec. 3.1]{GondranMinoux1984Graphs}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:arborescence/sub-arborescence} A \hyperref[def:hypergraph/submodel]{subgraph} of an arborescence that is itself an arborescence is called a \term{sub-arborescence}. The same holds for rooted subtrees.
