...
\begin{definition}\label{def:meager_set}\mcite[def. 2.1]{Rudin1991}
...
\begin{proposition}\label{thm:meager_set_properties}\mcite[43]{Rudin1991}
...
\begin{theorem}[Baire category theorem]\label{thm:baire_category_theorem}\mcite{Rudin1991}
  \begin{thmenum}
