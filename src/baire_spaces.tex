...
\begin{definition}\label{def:meager_set}\MarginCite[def. 2.1]{Rudin1991}
  Any countable union of \hyperref[def:topologically_dense_set/nowhere_dense]{nowhere dense sets} is called \Def{meager} or a \Def{first category set} (see \fullref{remark:baire_categories} for terminology). If a set is not meager, we call it \Def{nonmeager} or a \Def{second category set}.
\end{definition}
