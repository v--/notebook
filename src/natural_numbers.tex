...
\begin{proposition}\label{thm:natural_number_divisibility_order}
  ...
  \begin{thmenum}
    \thmitem{thm:natural_number_divisibility_order/join} The \hyperref[def:semilattice/join]{join} of \( n \) and \( m \) is their \hyperref[def:gcd_and_lcm]{least common multiple} \( \lcm\set{ n, m } \) (defined as the smallest element of the ideal \( \braket{ n } + \braket{ m } \)).
    ...
    \thmitem{thm:natural_number_divisibility_order/meet} Dually, the \hyperref[def:semilattice/meet]{meet} of \( n \) and \( m \) is their \hyperref[def:gcd_and_lcm]{greatest common divisor} \( \gcd\set{ n, m } \) (defined as the smallest element of the ideal \( \braket{ n } \cap \braket{ m } \)).
