...
\begin{definition}\label{def:peano_arithmetic}\mcite[exmpl. 17.6]{OpenLogicFull}
  ...
  \begin{thmenum}[resume=def:peano_arithmetic]
    \thmitem{def:peano_arithmetic/PA1} The successor function is \hyperref[thm:function_invertibility_categorical/nonempty_injective]{injective}. This can be stated as follows:
