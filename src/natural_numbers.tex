...
\begin{definition}\label{def:set_of_natural_numbers}
  ...
  See \fullref{ex:natural_number_arithmetic_grammar/backus_naur_form} for a simple \hyperref[def:grammar]{grammar} that produces numeric symbols in their decimal notation.
\end{definition}
