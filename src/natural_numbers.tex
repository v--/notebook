...
\begin{definition}\label{def:peano_arithmetic}\MarginCite[1]{Peano1889}
  ...
  \begin{DefEnum}
    ...
    \begin{equation*}
      \Paren[\Big]{ \varphi[\xi \mapsto 0] \wedge \forall \eta \centerdot (\varphi[\xi \mapsto \eta] \rightarrow \varphi[\xi \mapsto s(\eta)]) } \rightarrow \forall \eta \centerdot (\varphi[\xi \mapsto \eta]).
    \end{equation*}
