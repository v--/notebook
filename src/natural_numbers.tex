...
\begin{proof}
  ...
  \SubProofOf{def:well_ordered_set} Let \( A \subseteq \BbbN \) be a nonempty set. Aiming at a contradiction, suppose\DNE that \( A \) has no \hyperref[def:poset_extremal_points/maximum_and_minimum]{minimum}. In particular, \( 0 \not\in A \).
