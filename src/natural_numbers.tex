...
\begin{definition}\label{def:natural_number_operations}
  Fix any set-theoretic model \( \BN \) of the natural numbers\Tinyref{def:natural_numbers}. We use induction\IND on \( y \in \BN \) to define addition and multiplication:
  \begin{align*}
