...
\begin{definition}\label{def:zerosumfree}\mcite[4]{Golan2010}
  We say that an \hyperref[rem:additive_magma]{additive} \hyperref[def:monoid]{monoid} is \term{zerosumfree} if \( x + y = 0 \) implies \( x = y = 0 \).
...
\begin{proposition}\label{thm:natural_number_multiplication_properties}
  ...
  When combined with addition, the natural numbers become an \hyperref[def:divisibility/zero]{entire} \hyperref[def:semiring/commutative]{commutative semiring}.
