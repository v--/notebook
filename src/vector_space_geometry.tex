...
\begin{definition}\label{def:rigid_motion}\mimprovised
  ...
  \begin{thmenum}
    ...
    \begin{figure}[!ht]
      \centering
      \includegraphics[page=1]{output/def__rigid_motion__3d_translation.pdf}
    ...
    \begin{figure}[!ht]
      \centering
      \includegraphics[page=1]{output/def__rigid_motion__3d_rotation.pdf}
    ...
    \begin{figure}[!ht]
      \centering
      \includegraphics[page=1]{output/def__rigid_motion__3d_reflection.pdf}
