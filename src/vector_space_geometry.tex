...
\begin{proposition}\label{thm:def:convex_set/properties}
  ...
  \begin{thmenum}
    \thmitem{thm:def:convex_set/closed_under_combinations} A convex set is closed under convex \hyperref[def:linear_combination/convex]{combinations}.
    \thmitem{thm:def:convex_set/cone_closed_under_combinations} A closed \hyperref[def:convex_set]{convex} \hyperref[def:geometric_cone]{cone} is closed under conic \hyperref[def:linear_combination/conic]{combinations}.
