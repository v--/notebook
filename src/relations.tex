...
\begin{example}\label{ex:def:binary_relation}
  ...
  \begin{itemize}
    ...
    \item \hyperref[def:graph/directed]{Directed graphs} are commonly defined as binary relations.
...
\begin{proposition}\label{thm:equivalence_partition}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:equivalence_partition/indexed_family} There exists an \hyperref[def:tuple_and_cartesian_product/indexed_family]{indexed family} \( \seq{ x_a }_{a \in A} \subseteq A \) such that \( x_a = x_b \) implies \( x_a \sim x_b \).
  \end{thmenum}
\end{proposition}
\begin{proof}
  ...
  \ImplicationSubProof{thm:equivalence_partition/partition}{thm:equivalence_partition/indexed_family} Let \( \mscrA \) be a partition of \( A \) such that \( x \sim y \) if and only if they both belong to the same set in \( \mscrA \).
  ...
  \ImplicationSubProof{thm:equivalence_partition/indexed_family}{thm:equivalence_partition/equivalence} Follows from the fact that \( = \) is an equivalence relation.
\end{proof}
...
\begin{proposition}\label{thm:of_equivalence_relation}
