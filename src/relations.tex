...
\begin{definition}\label{def:binary_relation}
  ...
  \begin{thmenum}[resume=def:binary_relation]
    ...
    The following formula is used as an axiom for \hyperref[def:equivalence_relation]{equivalence relations}, \hyperref[def:graph/simple_undirected]{undirected graphs} and \hyperref[def:entourage]{entourages}:
...
\begin{example}\label{ex:def:binary_relation}
  ...
  \begin{itemize}
    ...
    \item \hyperref[def:graph/simple_directed]{Directed graphs} are commonly defined as binary relations.
