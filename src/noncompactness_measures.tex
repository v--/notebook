...
\begin{definition}\label{def:noncompactness_measures}\cite[definition 7.1]{Deimling1985}
  Let \( (X, \rho) \) be a metric space\Tinyref{def:metric_space} and let \( \CB \) be the family of bounded sets\Tinyref{def:metric_space/bounded_set} in \( X \). We define the following functions
  \begin{defenum}
