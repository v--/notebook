...
\begin{definition}\label{def:noncompactness_measures}\mcite\cite[def. 7.1]{Deimling1985}
  ...
  \begin{defenum}
    \ilabel{def:noncompactness_measures/sets} The \term{Kuratowski measure of noncompactness},
    \begin{balign*}
    ...
    \ilabel{def:noncompactness_measures/balls} The \term{ball measure of noncompactness},
    \begin{balign*}
...
\begin{example}\label{ex:noncompactness_measures}\mcite\cite[exer. 7.3]{Deimling1985}
...
\begin{theorem}[Kuratowski's noncompactness lemma]\label{thm:noncompact_kuratowskis_lemma}\mcite\cite[exer. 7.4]{Deimling1985}
