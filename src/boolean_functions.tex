...
\begin{definition}\label{def:boolean_closure}
  ...
  If \( B \) is complete, then \( B \) is a Boolean algebra by \fullref{thm:functions_over_model_form_model}. This is used in \fullref{thm:lindenmaum_tarski_algebra_of_full_propositional_logic/bijection}.
\end{definition}
