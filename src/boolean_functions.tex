...
\begin{definition}\label{def:boolean_function}
  ...
  The concrete set \( B \) does not matter much. If \( B \) is a Boolean algebra\Tinyref{def:boolean_algebra}, we can regard it as any of the equivalent Boolean algebras of two elements (see \fullref{thm:binary_boolean_algebras_are_isomorphic}).
\end{definition}
