...
\begin{definition}\label{def:boolean_closure}
  ...
  See \fullref{thm:lindenmaum_tarski_algebra_of_full_propositional_logic/bijection} for a consequence of the fact that the set of all Boolean functions is a Boolean algebra.
\end{definition}
