...
\begin{definition}\label{def:successor_operator}\mcite[68]{Enderton1977Sets}
...
\begin{theorem}\label{thm:ordinals_are_well_ordered}\mcite[thm. 7M]{Enderton1977Sets}
