...
\begin{definition}\label{def:set_naive}\mcite[chapter 1]{Enderton1977}
...
\begin{definition}\label{def:set_zfc}\mcite[271]{Enderton1977}
...
\begin{definition}\label{def:set_intersection}\mcite[24]{Enderton1977}
...
\begin{definition}\label{def:set_union}\mcite[24]{Enderton1977}
...
\begin{definition}\label{def:set_difference}\mcite[27]{Enderton1977}
...
\begin{definition}\label{def:power_set}\mcite[19]{Enderton1977}
...
\begin{definition}\label{def:kuratowski_pair}\mcite[36]{Enderton1977}
...
\begin{definition}\label{def:binary_cartesian_product}\mcite[37]{Enderton1977}
...
\begin{definition}\label{def:cartesian_product}\mcite[54]{Enderton1977}
...
\begin{definition}\label{def:successor_operator}\mcite[68]{Enderton1977}
...
\begin{definition}\label{def:inductive_set}\mcite[68]{Enderton1977}
...
\begin{definition}\label{def:transitive_set}\mcite[71]{Enderton1977}
  A set \( A \) is called \term{transitive} if \( a \in A \) implies \( a \subseteq A \).
\end{definition}

\medskip

\begin{definition}\label{def:ordinal}\mcite[thm. 7L]{Enderton1977}
...
\begin{theorem}\label{thm:ordinals_are_well_ordered}\mcite[thm. 7M]{Enderton1977}
