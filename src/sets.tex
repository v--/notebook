...
\begin{proof}
  ...
  See \cref{ex:categorical_product/set}.
\end{proof}
...
\begin{definition}\label{def:disjoint_union}
  ...
  See \cref{ex:categorical_coproduct/set}.
\end{definition}
...
\begin{definition}\cite[22]{Lectures:general_topology}
  A set $A$ is called \uline{transitive} if $a \in A$ implies $a \subseteq A$.
\end{definition}

\begin{definition}\cite[23]{Lectures:general_topology}
