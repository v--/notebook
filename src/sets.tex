...
\begin{definition}\label{def:set_naive}\mcite\cite[chapter 1]{Enderton1977}
...
\begin{definition}\label{def:set_zfc}\mcite\cite[271]{Enderton1977}
...
\begin{definition}\label{def:set_intersection}\mcite\cite[24]{Enderton1977}
...
\begin{definition}\label{def:set_union}\mcite\cite[24]{Enderton1977}
...
\begin{definition}\label{def:set_difference}\mcite\cite[27]{Enderton1977}
...
\begin{definition}\label{def:power_set}\mcite\cite[19]{Enderton1977}
...
\begin{definition}\label{def:kuratowski_pair}\mcite\cite[36]{Enderton1977}
...
\begin{definition}\label{def:binary_cartesian_product}\mcite\cite[37]{Enderton1977}
...
\begin{definition}\label{def:cartesian_product}\mcite\cite[54]{Enderton1977}
...
\begin{definition}\label{def:successor_operator}\mcite\cite[68]{Enderton1977}
...
\begin{definition}\label{def:inductive_set}\mcite\cite[68]{Enderton1977}
...
\begin{definition}\label{def:transitive_set}\mcite\cite[71]{Enderton1977}
  A set \( A \) is called \term{transitive} if \( a \in A \) implies \( a \subseteq A \).
\end{definition}

\medskip

\begin{definition}\label{def:ordinal}\mcite\cite[thm. 7L]{Enderton1977}
...
\begin{theorem}\label{thm:ordinals_are_well_ordered}\mcite\cite[thm. 7M]{Enderton1977}
