...
\begin{definition}\label{def:set_zfc}\cite[271]{Enderton1997}
...
\begin{definition}\label{def:set_intersection}\cite[24]{Enderton1997}
...
\begin{definition}\label{def:set_union}\cite[24]{Enderton1997}
...
\begin{definition}\label{def:set_difference}\cite[27]{Enderton1997}
...
\begin{definition}\label{def:power_set}\cite[19]{Enderton1997}
...
\begin{definition}\label{def:kuratowski_pair}\cite[36]{Enderton1997}
...
\begin{definition}\label{def:binary_cartesian_product}\cite[37]{Enderton1997}
...
\begin{definition}\label{def:cartesian_product}\cite[54]{Enderton1997}
...
\begin{definition}\label{def:successor_operator}\cite[68]{Enderton1997}
...
\begin{definition}\label{def:inductive_set}\cite[68]{Enderton1997}
...
\begin{definition}\label{def:transitive_set}\cite[71]{Enderton1997}
  A set $A$ is called \uline{transitive} if $a \in A$ implies $a \subseteq A$.
\end{definition}

\begin{definition}\label{def:ordinal}\cite[189]{Enderton1997}
