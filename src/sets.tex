...
\begin{definition}\label{def:naive_set_theory}\mcite[chapter 1]{Enderton1977Sets}
  ...
  Naive set theory easily leads to \hyperref[ex:russels_paradox_sets]{paradoxes}) and so some axiomatization (e.g. \fullref{def:set}) is required.
\end{definition}
...
\begin{remark}\label{rem:family_of_sets}
  In ZFC \fullref{def:set}, everything is a set. However, it is often the case that we are not interested in how a set's elements are represented and only in how they behave, e.g. when working with \hyperref[def:natural_numbers]{natural numbers} we are interested in the elements of \( \BbbN \) and not in the way every element of \( \BbbN \) is encoded as a set.
...
\begin{definition}\label{def:set_intersection}\mcite[24]{Enderton1977Sets}
  ...
  By \fullref{def:zfc/A6}, \( \bigcap A \) is a set.
  ...
  The class \( \{ A, B \} \) is a set by \fullref{def:zfc/A3} and \( A \cup B \) is a set by \fullref{def:zfc/A6}.
...
\begin{definition}\label{def:set_union}\mcite[24]{Enderton1977Sets}
  ...
  By \fullref{def:zfc/A4}, \( \bigcup A \) is a set.
  ...
  The class \( \{ A, B \} \) is a set by \fullref{def:zfc/A3} and \( A \cup B \) is a set by \fullref{def:zfc/A4}.
\end{definition}
...
\begin{definition}\label{def:set_difference}\mcite[27]{Enderton1977Sets}
  ...
  By \fullref{def:zfc/A6}, \( A \setminus B \) is a set.
\end{definition}
...
\begin{definition}\label{def:power_set}\mcite[19]{Enderton1977Sets}
  ...
  By \fullref{def:zfc/A5}, \( \pow(A) \) is a set.
\end{definition}
...
\begin{proposition}\label{thm:boolean_algebra_of_subsets}
  ...
  \begin{thmenum}
    \thmitem{thm:boolean_algebra_of_subsets/join} Joins are given by \hyperref[def:set_union]{unions \( \bigcup \)}.
    \thmitem{thm:boolean_algebra_of_subsets/top} The top element is \( X \).
    \thmitem{thm:boolean_algebra_of_subsets/meet} Meets are given by \hyperref[def:set_intersection]{intersections \( \bigcap \)}.
    \thmitem{thm:boolean_algebra_of_subsets/bottom} The bottom is \( \varnothing \).
  \end{thmenum}
\end{proposition}
\begin{proof}
  The structure is based on \fullref{thm:lindenmaum_tarski_algebra_of_full_propositional_logic/bijection} because every set corresponds to a certain equivalence class of first-order logic formulas.
\end{proof}
...
\begin{definition}\label{def:kuratowski_pair}\mcite[36]{Enderton1977Sets}
  ...
  By \fullref{def:zfc/A3}, \( (A, B) \) is a set.
\end{definition}
