...
\begin{proof}
  ...
  Suppose that \( b \) is not a divisor of \( a \). Note that \( g \geq 0 \) and \( r > 0 \). If \( r \geq b \), this would imply\DNE \( r - b \geq 0 \) and
  \begin{equation*}
  ...
  Suppose that \( b \) is not a divisor of \( a \). Note that \( q \geq 0 \) and \( r < 0 \). If \( r \leq b \), this would imply\DNE \( r - b \leq 0 \) and
  \begin{equation*}
