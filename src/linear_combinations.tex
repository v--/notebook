...
\begin{definition}\label{def:analysis/linear_combination_sets}
  ...
  Since linear sets are themselves linear spaces, they are usually called \uline{linear subspaces}. The term \uline{linear set} is usually refers to chains in partial orders\Tinyref{def:orders:partial}.
