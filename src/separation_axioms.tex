...
\begin{proposition}\label{thm:t2_iff_singleton_limits}
  The space \( (X, \Cal{T}) \) is Hausdorff \( T_2 \)\Tinyref{def:separation_axioms/T2} if and only if every net\Tinyref{def:topological_net} has at most one limit\Tinyref{def:topological_net_convergence/limit}.
\end{proposition}
\begin{proof}
  \begin{description}
