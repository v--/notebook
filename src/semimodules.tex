...
\begin{definition}\label{def:semimodule}
  ...
  \begin{thmenum}
    ...
    Function satisfying additivity and homogeneity are commonly called \term{linear}. These are the basic objects of study in \hyperref[sec:linear_algebra]{linear algebra} and, to a lesser extent, (linear) \hyperref[sec:functional_analysis]{functional analysis}.
