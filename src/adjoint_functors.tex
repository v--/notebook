...
\begin{definition}\label{def:adjoint_functor}\mcite[exer. 4.1.32]{Leinster2016Basic}
...
\begin{example}\label{ex:top_adjoint_functor}\mcite[exmpl. 2.1.5]{Leinster2016Basic}
