...
\begin{proposition}\label{thm:}
  Let \( V \) be a module of finite rank over a commutative ring and let \( L: V \to V \) be a linear endomorphism. Any two matrices representing \( L \) are \hyperref[def:similar_matrices]{similar}.
\end{proposition}
\begin{proof}
