...
\begin{remark}\label{rem:linear_operators_and_matrices}
  Let \( R \) be a \hyperref[def:ring/commutative]{commutative ring}. Unlike in the \( R \)-module \( R^n \) of tuples, in a general \( R \)-module of finite \hyperref[thm:commutative_module_rank]{rank}, we have no concept of a \hyperref[def:standard_basis]{standard basis}. Instead, a linear operator \( T: U \to V \) corresponds to multiple matrix.
