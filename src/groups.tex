...
\begin{definition}\label{def:group}
  ...
  \begin{thmenum}
    \labitem{def:group/theory} We can construct the \hyperref[def:first_order_theory]{theory} of groups by adding a unary \hyperref[def:first_order_language/func]{functional symbol} \( (-)^{-1} \) and the axiom
    ...
    \labitem{def:group/function_parity} A \hyperref[def:function/single_valued]{function} \( f: \mscrG \to \mscrH \) between two groups is called \term{even} if
    ...
    \labitem{def:group/homomorphism} A \hyperref[def:first_order_homomorphism]{homomorphism} between the groups \( \mscrG \) and \( \mscrH \) is an odd \hyperref[def:unital_magma/homomorphism]{unital magma homomorphism}.
    ...
    \labitem{def:group/substructure} The set \( S \subseteq \mscrG \) is a \hyperref[def:first_order_substructure]{subgroup} of \( \mscrG \) if it is a \hyperref[def:unital_magma/substructure]{unital submagma} and if \( S^{-1} = S \), where \( S^{-1} = \{ s^{-1} \colon s \in S \} \).

    \labitem{def:group/category} The \hyperref[def:first_order_model_category]{model category} \( \cat{Grp} \) of groups is \hyperref[def:concrete_category]{concrete} with respect to \hyperref[def:unital_magma/associative]{\( \cat{Mon} \)}.

    \labitem{def:group/exponentiation} We extend \hyperref[def:unital_magma/exponentiation]{unital magma exponentiation} to all integers by setting
    \begin{equation*}
      x^{-n} \coloneqq (x^n)^{-1}.
    \end{equation*}
...
\begin{proposition}\label{thm:group_properties}
  ...
  \begin{thmenum}
    \labitem{thm:group_properties/cancellative} The operation is \hyperref[def:magma/cancellative]{cancellative}.
    \labitem{thm:group_properties/identity_inverse} The identity \( e \) is its own inverse.
    \labitem{thm:group_properties/inverse_composition} \( (xy)^{-1} = y^{-1} x^{-1} \).
    \labitem{thm:group_properties/double_inverse} For any \( x \in \mscrG \), \( x = (x^{-1})^{-1} \)
    \labitem{thm:group_properties/negative_power} For any \( x \in \mscrG \) and positive integer \( n \), \( (x^n)^{-1} = (x^{-1})^n \)
    \labitem{thm:group_properties/subgroup_intersection} The intersection of any two subgroups of \( \mscrG \) is again a subgroup of \( \mscrH \).
    \labitem{thm:group_properties/power_set} The \hyperref[def:magma/power_set]{power set monoid} \( \pow(\mscrG) \) of a group \( \mscrG \) is not a group.
  \end{thmenum}
\end{proposition}
\begin{proof}
...
\begin{definition}\label{def:normal_subgroup}
  ...
  \begin{thmenum}
    \labitem{def:normal_subgroup/direct} For any \( x \in \mscrG \), we have the set equality
    \begin{equation}\label{eq:def:normal_subgroup/direct}
      x \mscrN x^{-1} = \mscrN.
    \end{equation}

    \labitem{def:normal_subgroup/cosets} The partitions induced by the left and rights cosets of \( \mscrN \) coincide.
    \labitem{def:normal_subgroup/kernel} \( \mscrN \) is the \hyperref[def:unital_magma_kernel]{kernel} of some group homomorphism.
  \end{thmenum}
