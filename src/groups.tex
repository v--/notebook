...
\begin{definition}\label{def:group}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:group/trivial} The \hyperref[thm:substructures_form_complete_lattice/bottom]{trivial} group is the \hyperref[rem:pointed_set/trivial]{trivial pointed set} \( \set{ e } \).
