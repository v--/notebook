...
\begin{proof}
  ...
  \SubProofOf[def:semilattice/homomorphism]{lattice compatibility} For the join \( \braket{ K \cup H } \) of two subgroups of \( G \) containing \( N \) we must have the equality
