...
\begin{definition}\label{def:group}(See \cref{ex:algebraic_theory_language})
  ...
  \begin{defenum}
    ...
    \DItem{def:group/subgroup} the subset \( H \subseteq G \) is a \textbf{submagma (resp. subsemigroup, submonoid, subgroup, etc) of \( G \)} if \( H \) is closed under the magma operation, that is, \( ab \in H \) whenever \( a, b \in H \).
