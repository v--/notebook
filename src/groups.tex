...
\begin{definition}\label{def:periodic_function}
  ...
  We refer to \( r \) \enquote{the} period of a function if it is the least\Tinyref{def:poset/largest_smallest_element} of all periods. Technically, all multiples of \( r \) are also periods of \( f \), however we are rarely interested in any period except for the smallest one.
\end{definition}
