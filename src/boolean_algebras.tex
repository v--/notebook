...
\begin{definition}\label{def:boolean_algebra}\mcite[48]{Gratzer1978}
  ...
  The member \( \overline x \) is called the \term{complement} of \( x \). From \fullref{thm:boolean_algebra_properties/unique_complement} it follows that the complement is unique.
  ...
  \begin{thmenum}[resume=def:boolean_algebra]
    ...
    \end{equation*}
    and similarly for \( \wedge \), hence, due to \fullref{thm:boolean_algebra_properties/unique_complement},
    \begin{equation*}
