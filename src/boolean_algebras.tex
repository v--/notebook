...
\begin{definition}\label{def:heyting_algebra}\mcite[10]{BezhanishviliHolliday2019}
  ...
  \begin{thmenum}[resume=def:heyting_algebra]
    ...
    \thmitem{def:heyting_algebra/trivial} The \hyperref[thm:substructures_form_complete_lattice/bottom]{trivial} Heyting algebra is the \hyperref[def:semilattice/trivial]{trivial bounded lattice} \( \set{ \top, \bot } \).
    ...
    \thmitem{def:heyting_algebra/opposite} The \hyperref[def:semilattice/lattice_duality]{principle of duality for lattices} does not hold for Heyting algebras.
  \end{thmenum}
\end{definition}
...
\begin{definition}\label{def:boolean_algebra}\mcite[48]{Gratzer1978}
  ...
  \begin{thmenum}[resume=def:boolean_algebra]
    ...
    \thmitem{def:boolean_algebra/trivial} The \hyperref[thm:substructures_form_complete_lattice/bottom]{trivial} Boolean algebra is the \hyperref[def:semilattice/trivial]{trivial bounded lattice} \( \set{ \top, \bot } \).
    ...
    \thmitem{def:boolean_algebra/opposite} The \hyperref[def:semilattice/lattice_duality]{principle of duality for lattices} holds for Boolean algebras without interchanging complements.
  \end{thmenum}
\end{definition}
...
\begin{example}\label{ex:boolean_algebras}
  ...
  \begin{itemize}
    \thmitem{ex:boolean_algebras/lindenbaum_tarski} The \hyperref[def:lindenbaum_tarski_algebra]{Lindenbaum-Tarski algebras} for propositional theories (see \fullref{thm:intuitionistic_lindenbaum_tarski_algebra}).
    \thmitem{ex:boolean_algebras/f2} The finite field \( \BbbZ_2 \) with suitably defined operations (see \fullref{thm:f2_is_boolean_algebra}).
