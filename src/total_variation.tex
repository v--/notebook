...
\begin{definition}\label{def:riemann_stieltjes_integral}
  ...
  Let \( \mscrX \) be a real \hyperref[def:separation_axioms/T2]{Hausdorff} \hyperref[def:topological_vector_space]{topological vector space}. Fix two \hyperref[def:function/single_valued]{functions} \( f, \alpha: [a, b] \to \mscrX \).
