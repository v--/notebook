...
\begin{definition}\label{def:canonical_duality_pairing}
  We denote by \( \inner \cdot \cdot \) the \term{canonical \hyperref[def:duality_pairing]{duality pairing}}
  \begin{balign*}
...
\begin{definition}\label{def:vector_space_annihilator}\mcite[52]{Knapp2016BAlg}
