...
\begin{theorem}[Axiom of choice equivalences]\label{thm:axiom_of_choice_equivalences}
  ...
  \begin{thmenum}[resume=thm:axiom_of_choice_equivalences]
    ...
    \thmitem{thm:axiom_of_choice_equivalences/krull} \Fullref{thm:krulls_theorem}: Every nontrivial \hyperref[def:ring/commutative]{commutative unital ring} has a \hyperref[def:maximal_ring_ideal]{maximal ideal}.
  \end{thmenum}
\end{theorem}
\begin{proof}
