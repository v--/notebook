...
\begin{definition}\label{def:choice_function}
  ...
  This is formally the same as a tuple defined in \fullref{def:tuple_and_cartesian_product/tuple}.
...
\begin{definition}\label{def:disjoint_union}
  The \term{disjoint union} of the \hyperref[def:tuple_and_cartesian_product/indexed_family]{indexed family} \( \seq{ A_k }_{k \in \mscrK} \) of nonempty sets is
  \begin{equation*}
...
\begin{proof}
  ...
  \SubProofOf{thm:function_invertibility_categorical/left_cancellative} The case with an empty function is handled in \fullref{thm:function_invertibility_categorical/empty}, hence we assume that it is nonempty.
  ...
  Conversely, if \( f \) is injective, it is left-invertible by \fullref{thm:function_invertibility_categorical/nonempty_left_invertible} and left-cancellative by \fullref{thm:morphism_invertibility_properties/split_monomorphism}.
  ...
  \SubProofOf{thm:function_invertibility_categorical/right_cancellative} The case with an empty function is handled in \fullref{thm:function_invertibility_categorical/empty}, hence we assume that it is nonempty.
  ...
  it is right-invertible by \fullref{thm:surjective_functions_are_right_invertible} and right-cancellative by \fullref{thm:morphism_invertibility_properties/split_epimorphism}.
