...
\begin{proposition}\label{thm:zfc_existence_theorems}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:zfc_existence_theorems/cartesian_product} For any indexed family \( \set{ A_k }_{k \in \mscrK} \), their \hyperref[def:tuple_and_cartesian_product]{Cartesian product} \( \bigtimes_{k \in \mscrK} A_k \) exists.
