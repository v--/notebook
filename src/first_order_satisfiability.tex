...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \begin{equation*}
      \parens[\Big]{ \psi[V \mapsto \Theta] }\Bracks{v}
      =
      \parens[\Big]{ \psi_1[\chi \mapsto \theta] }\Bracks{v} \bincirc \parens[\Big]{ \psi_2[\chi \mapsto \theta] }\Bracks{v}
      \reloset {\T{ind.}} =
...
\begin{remark}\label{rem:deduction_with_free_variables}
  In order to highlight the importance of closed formulas in certain theorems, we will take a close look at the proof of \fullref{thm:first_order_semantic_deduction_theorem}.
