...
\begin{proof}
  ...
  See \cref{ex:polynomial_quotient_rings_gaussian_integers} and \cref{ex:polynomial_quotient_rings_q2} for differing ring structures in \( \pi_n(R[X]) \).
\end{proof}
...
\begin{example}\label{ex:polynomial_quotient_rings_q2}
