...
\begin{example}\label{ex:natural_arithmetic_grammar/backus_naur_form}
  ...
  \begin{AlignedEquation}\label{eq:ex:natural_arithmetic_grammar/backus_naur_form/simple}
    &E \to 0 \\
    &E \to 1 \\
    &\phantom{E \to} \vdots \\
    &E \to n \\
...
\begin{definition}\label{def:grammar_derivation}\MarginCite[page 104 \\ page 108]{Sipser2013}
  ...
  \begin{DefEnum}
    ...
    We also say that strings in \( \mscrL(G) \) are \Def{generated} by the grammar \( G \).
