...
\begin{definition}\label{def:subdifferentials}
  ...
  \begin{thmenum}
    \ilabel{def:subdifferentials/convex}\mcite\cite[59]{Clarke2013}We say that \( x^* \in X^* \) is a \term{subgradient of \( f \) at \( x \)} if for every \( y \in D \) we have
    \begin{equation*}
    ...
    \ilabel{def:subdifferentials/clarke}\mcite\cite[def. 10.3]{Clarke2013}We say that \( x^* \in X^* \) is a \term{Clarke (generalized) subgradient of \( f \) at \( x \)} if for every direction \( h \in X \) we have
    \begin{equation*}
    ...
    \ilabel{def:subdifferentials/proximal}\mcite\cite[227]{Clarke2013}We say that \( x^* \in X^* \) is a \term{proximal subgradient of \( f \) at \( x \)} if there exist \( \sigma > 0 \) and a neighborhood \( V \subseteq X \) of \( x \) such that for every \( y \in D \cap V \) we have
    \begin{equation*}
    ...
    \ilabel{def:subdifferentials/limiting}\mcite\cite[def. 11.10]{Clarke2013}Suppose the following are satisfied:
    \begin{enumerate}
