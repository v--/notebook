...
\begin{definition}\label{def:empty_set}
  ...
  Its existence and uniqueness are handled in \fullref{thm:zfc_existence_theorems/empty_set}. We will often refer to \term{nonempty sets}, which is exactly what it sounds --- any set that is not the empty set.
\end{definition}
...
\begin{definition}\label{def:subset}
  ...
  \begin{equation}\label{eq:def:subset/predicate}
