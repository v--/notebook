...
\begin{theorem}[De Morgan's laws for sets]\label{thm:de_morgans_laws_for_sets}
  ...
  \begin{align}
    X \setminus \bigcup \mscrA = \bigcap \set{ X \setminus A \given A \in \mscrA } \label{eq:thm:de_morgans_laws_for_sets/complement_of_join} \\
    X \setminus \bigcap \mscrA = \bigcup \set{ X \setminus A \given A \in \mscrA } \label{eq:thm:de_morgans_laws_for_sets/complement_of_meet}
  \end{align}
\end{theorem}
\begin{proof}
