...
\begin{proof}
  ...
  Therefore, \( A \in V_{\rho + 2} \). Since \( \kappa \) is an infinite cardinal, from \fullref{thm:cardinal_is_infinite_iff_limit_ordinal} it follows that it is a limit ordinal and \( \rho + 1 < \kappa \); then from \fullref{thm:cumulative_hierarchy_properties/subsets} it follows that \( A \in V_\kappa \).
