  ...
  \begin{defenum}
    ...
    \begin{equation*}
      \begin{mplibcode}
        ...
        beginfig(1);
          ...
          label.ulft("$\alpha_{A, B, (C \otimes D)}$", midpoint of a1);
          label.urt("$\alpha_{(A \otimes B), C, D}$", midpoint of a2);
          label.lft("$\Id \otimes \alpha_{B, C, D}$", midpoint of a3);
          label.rt("$\alpha_{A, B, C} \otimes \Id$", midpoint of a4);
          label.bot("$\alpha_{A, (B \otimes C), D}$", midpoint of a5);
        endfig;
      \end{mplibcode}
    \end{equation*}
    ...
    \begin{equation*}
      \begin{mplibcode}
          ...
          label.llft("$\Id \otimes \lambda_b$", midpoint of a1);
          label.lrt("$\rho_a \otimes \Id$", midpoint of a2);
          label.top("$\alpha_{A, 1, B}$", midpoint of a3);
        endfig;
      \end{mplibcode}
    \end{equation*}
  \end{defenum}
    ...
    \begin{equation*}
      \begin{mplibcode}
        ...
        beginfig(1);
          ...
          label.ulft("$\circ_{A, C, D}$", midpoint of a1);
          label.urt("$\circ_{A, B, D}$", midpoint of a2);
          label.lft("$\Id \otimes \circ_{A, B, C}$", midpoint of a3);
          label.rt("$\circ_{B, C, D} \otimes \Id$", midpoint of a4);
          label.bot("$\alpha$", midpoint of a5);
        endfig;
      \end{mplibcode}
    \end{equation*}
    ...
    \begin{equation*}
      \begin{mplibcode}
        ...
        beginfig(1);
          ...
          label.urt("$\circ_{A, B, B}$", midpoint of a1);
          label.ulft("$\circ_{A, A, B}$", midpoint of a2);
          label.lrt("$\lambda$", midpoint of a3);
          label.llft("$\rho$", midpoint of a4);
          label.lft("$j_B \otimes \Id_{C(A, B)}$", midpoint of a5);
          label.rt("$\Id_{C(A, B)} \otimes j_A$", midpoint of a6);
        endfig;
      \end{mplibcode}
    \end{equation*}
  \end{defenum}
...
\begin{proof}
  ...
  \begin{equation*}
    \begin{mplibcode}
        ...
        label.llft("$\Id_{X_i}$", midpoint of a1);
        label.lrt("$\pi_i$", midpoint of a2);
        label.top("$\iota_i$", midpoint of d1);
      endfig;
    \end{mplibcode}
    \hspace{1cm}
    \begin{mplibcode}
        ...
        label.llft("$0_{X_i, X_j}$", midpoint of a1);
        label.lrt("$\pi_i$", midpoint of a2);
        label.top("$\iota_j$", midpoint of d1);
      endfig;
    \end{mplibcode}
  \end{equation*}
  ...
  \begin{equation*}
    \begin{mplibcode}
        ...
        label.llft("$\gamma_i$", midpoint of a1);
  ...
  \begin{AlignedEquation}\label{thm:preadditive_biproducts/product_identity}
    \begin{mplibcode}
        ...
        label.llft("$g \circ \pi_i$", midpoint of a1);
        label.lrt("$\pi_i$", midpoint of a2);
      endfig;
    \end{mplibcode}
  \end{AlignedEquation}
...
\begin{definition}\label{def:exact_sequence_morphisms}\cite{MacLane1994}[198]
  ...
  \begin{equation*}
    \begin{mplibcode}
      beginfig(1);
        ...
        label.top("$i$", midpoint of a2);
        label.top("$p$", midpoint of a3);

        label.top("$i'$", midpoint of a6);
        label.top("$p'$", midpoint of a7);
      endfig;
    \end{mplibcode}
  \end{equation*}
  ...
  \begin{equation*}
    \begin{mplibcode}
        ...
        label.bot("$i'$", midpoint of a6);
        label.bot("$p'$", midpoint of a7);

        label.rt("$f_A$", midpoint of a9);
        label.rt("$f_B$", midpoint of a10);
        label.rt("$f_C$", midpoint of a11);
      endfig;
    \end{mplibcode}
  \end{equation*}
