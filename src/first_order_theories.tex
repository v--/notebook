...
\begin{proof}
  ...
  An equivalent condition for \( \varphi \) to be in \( \Phi \) is, due to \fullref{thm:minimal_logic_set_is_derivable_iff_conjunction_is_derivable},
  \begin{equation*}
  ...
  By \fullref{thm:minimal_logic_set_is_derivable_iff_conjunction_is_derivable},
  \begin{equation*}
