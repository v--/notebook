...
\begin{definition}\label{def:semiring}
  ...
  \begin{defenum}
    ...
    \DItem{def:semiring/unique_factorization_domain} \Def{Unique factorization domains} are integral domains.
...
\begin{proof}
  ...
  \begin{align*}
    ...
    &=
    [(x - n\lfloor \tfrac x n \rfloor) (y - n\lfloor \tfrac y n \rfloor)] \Mod n
    = \\ &=
    [xy - n\lfloor \tfrac x n \rfloor y - n\lfloor \tfrac y n \rfloor x + n^2 \lfloor \tfrac x n \rfloor \lfloor \tfrac y n \rfloor] \Mod n
    = \\ &=
    xy \Mod n.
  \end{align*}
  ...
  \begin{align*}
    ...
    = \\ &=
    [(x \odot z) + (y \odot z)] \Mod n
    = \\ &=
    [xz - n \lfloor \tfrac {xz} n \rfloor + yz - n \lfloor \tfrac {yz} n \rfloor] \Mod n
    = \\ &=
    [xz + yz] \Mod n
    = \\ &=
    [(x + y) z] \Mod n.
