...
\begin{example}\label{ex:semirings}
  ...
  \begin{reflist}
    ...
    \iref{def:semiring/integral_domain}\cite[388]{Knapp2016BAlg} The integral domain \( \BbbZ[\sqrt{-5}] \) is not a unique factorization domain because
    \begin{equation*}
...
\begin{definition}\label{def:opposite_ring}\mcite\cite[555]{Knapp2016BAlg}
