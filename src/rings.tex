...
\begin{proof}
  ...
  Now assume that \( R \) is nontrivial and let \( \iota: \Z^{\geq 0} \to R \) be the embedding defining \( \Char(R) \). Then it is obviously also an embedding of \( \Z^{\geq 0} \) into \( T \). Since \( 0_R = 0_T \), then \( \ker \iota = \ker \varphi = \Char(R) \Z^{\geq 0} \).
\end{proof}
