...
\begin{definition}\label{def:ring_direct_product}
  ...
  We define their \uline{direct sum} as the subring of $\prod_{i \in I} X_i$\Tinyref{def:ring_direct_product} where only finitely many components of any ring element are different from zero.
\end{definition}
...
\begin{definition}\label{def:category_of_ring}
  ...
  Furthermore, $\Bold{Ring}$ is locally small\Tinyref{def:category} and concrete\Tinyref{def:concrete_category}.
\end{definition}
