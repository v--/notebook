...
\begin{definition}\label{def:semiring_characteristic}
  Fix a nonempty unital semiring \( R \). We define its \Def{characteristic} \( \Char(R) \) via any of the equivalent definitions:
  \begin{defenum}
    ...
    \DItem{def:semiring_characteristic/homomorphism} The semiring \( \Z^{\geq 0} \) of nonnegative integers can be embedded into \( R \) via the homomorphism
    \begin{align*}
      &\iota: \Z^{\geq 0} \to R \\
