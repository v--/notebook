...
\begin{proposition}\label{thm:function_oscillation_properties}
  ...
  \begin{propenum}
    ...
    \ilabel{thm:function_oscillation_properties/cauchy_inequality}\mcite[28]{Николов2020}For all \( \lambda, \delta > 0 \), we have the following analog of \fullref{thm:cauchy_bunyakovsky_schwarz_inequality}
    ...
    \ilabel{thm:function_oscillation_properties/single_inequality}\mcite[28]{Николов2020}For all \( \lambda, \delta > 0 \),
