...
\begin{proposition}\label{thm:function_oscillation_properties}
  ...
  \begin{thmenum}
    ...
    \labitem{thm:function_oscillation_properties/cauchy_inequality}\mcite[28]{Николов2020Лекции}For all \( \lambda, \delta > 0 \), we have the following analog of \fullref{thm:cauchy_bunyakovsky_schwarz_inequality}
    ...
    \labitem{thm:function_oscillation_properties/single_inequality}\mcite[28]{Николов2020Лекции}For all \( \lambda, \delta > 0 \),
