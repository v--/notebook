...
\begin{proposition}[Cauchy's series convergence criterion]\label{thm:cauchy_series_convergence_criterion}\mcite\cite[3.22]{Rudin1976}
...
\begin{corollary}\label{thm:derivative_limit_exchange}\mcite\cite[thm. 7.17]{Rudin1976}
