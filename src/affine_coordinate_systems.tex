...
\begin{definition}\label{def:euclidean_plane_coordinate_system}
  ...
  \begin{itemize}
    ...
    \item An ordered\Tinyref{def:poset} basis\Tinyref{def:left_module_hamel_basis} \( (x, y) \) of \( F_2 \), called the \Def{basis} of \( Oxy \).
  \end{itemize}
