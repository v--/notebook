...
\begin{definition}\label{def:euclidean_plane_coordinate_system}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:euclidean_plane_coordinate_system/basis} An \hyperref[def:partially_ordered_set]{ordered} \hyperref[def:module_hamel_basis]{basis} \( (x, y) \) of \( F_2 \), called the \term{basis} of \( Oxy \).
  \end{thmenum}
