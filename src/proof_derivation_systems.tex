...
\begin{proposition}
  ...
  We can prove that \eqref{eq:thm:natural_deduction/or/elim} implies \eqref{eq:def:minimal_propositional_derivation_system/or/elim} is analogously to \eqref{eq:thm:natural_deduction/and_intro_axiom_derivation}.
...
\begin{definition}\label{def:intuitionistic_propositional_derivation_system}\mcite[def. 55.10]{OpenLogicFull}
  ...
  \mcite[sec. 10.2]{OpenLogicFull} The following \hyperref[thm:natural_dediction]{natural deduction} rule schema can be used interchangeably with \eqref{eq:thm:minimal_propositional_negation_laws/efq}:
...
\begin{definition}\label{def:propositional_derivation_system}
  ...
  \mcite[sec. 10.2]{OpenLogicFull} The following \hyperref[thm:natural_dediction]{natural deduction} rule schema can be used interchangeably with \eqref{eq:thm:minimal_propositional_negation_laws/dne}:
