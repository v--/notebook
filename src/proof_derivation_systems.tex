...
\begin{definition}\label{def:first_order_derivation_system}\mcite{LeanNaturalDeduction}
  ...
  \begin{thmenum}
    ...
    where \( \xi \) must not be free in the set \( \Gamma \) of assumptions. The word \enquote{assumption} here is used in the sense of \fullref{def:proof_derivation_system}.
