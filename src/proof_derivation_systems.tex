...
\begin{example}\label{ex:def:brouwer_heyting_kolmogorov_interpretation/well_ordering_principle_zfc}
  \Fullref{thm:well_ordering_principle} in \hyperref[def:set]{ZFC} does not provide a way to well-order an arbitrary set. The theorem relies on the axiom of choice, which by \fullref{diaconescu_goodman_myhill_theorem} implies the law of the excluded middle (LEM) assuming the nonlogical axioms of ZFC.
