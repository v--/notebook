...
\begin{definition}\label{def:darboux_integral}
  Fix a real-valued function \( f: [a, b] \to \BbbR \). The \Def{upper Darboux sum} corresponding to the partition \eqref{eq:def:riemann_partition/partition} is defined as
  \begin{equation*}
