...
\begin{definition}\label{def:riemann_partition}\mcite\cite[def. 1]{Gordon1991}
  ...
  \begin{defenum}
    \ilabel{def:riemann_partition/partition} A \term{Riemann partition} of \( [a, b] \) is a set
    \begin{equation*}
    ...
    \ilabel{def:riemann_partition/diameter} Finally, the \term{diameter} of the partition \eqref{eq:def:riemann_partition/partition} is defined as
