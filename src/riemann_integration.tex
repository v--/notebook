...
\begin{definition}\label{def:riemann_partition}\mcite[def. 1]{Gordon1991}
  The concept of a partition of a nonempty \hyperref[def:real_numbers]{real} \hyperref[def:partially_ordered_set_interval/closed]{closed interval} \( [a, b] \) is the base for defining Riemann-style integrals.
