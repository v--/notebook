...
\end{definition}
\begin{proof}
  \SubProofImplies{def:global_continuity/limits}{def:global_continuity/open} Follows from \fullref{def:local_convergence/neighborhoods}.
  \SubProofImplies{def:global_continuity/open}{def:global_continuity/closed} If \( F \in \CF_{\CT_Y} \) is a closed set, \( Y \setminus F \) is open, therefore \( f^{-1}(Y \setminus F) = X \setminus f^{-1}(F) \) is also open. Hence \( f^{-1}(F) \) is closed.
  \SubProofImplies{def:global_continuity/open}{def:global_continuity/base} \( \CT \) is a base of itself.
  \SubProofImplies{def:global_continuity/base}{def:global_continuity/subbase} Every base is also a subbase.
  \SubProofImplies{def:global_continuity/subbase}{def:global_continuity/limits} Follows from the equivalences in \fullref{def:local_convergence}.
  \SubProofImplies{def:global_continuity/closed}{def:global_continuity/closure} Note that
  \begin{equation*}
    A
  ...
  \SubProofImplies{def:global_continuity/closure}{def:global_continuity/closed} Fix a closed set \( F \subseteq Y \). Then
