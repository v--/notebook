...
\begin{definition}\label{def:double_index_maps}
  Let \( n, m \) be positive integers\Tinyref{def:integers}. We want to map single indices to double indices and vice versa. Define the mutually inverse operations
  \begin{align*}
