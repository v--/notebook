...
\begin{definition}\label{def:domain_divisibility}\mimprovised
  ...
  \begin{thmenum}
    ...
    \begin{thmenum}
      ...
      \thmitem{def:domain_divisibility/associates/unit} There exists a \hyperref[def:divisibility/zero]{unit} \( u \) such that \( x = uy \).
    ...
    \thmitem{def:domain_divisibility/irreducible} We say that \( x \) is \term{irreducible} if any of the following conditions hold:
    \begin{thmenum}
      \thmitem{def:domain_divisibility/irreducible/direct} \( x \) is not a unit and, if \( x = yz \), then \( y \) or \( z \) is a unit.
      \thmitem{def:domain_divisibility/irreducible/ideal} \( \braket{ x } \) is a nonzero proper ideal and is maximal among all nonzero proper principal ideals. Maximality means that, if \( \braket{ x } \subseteq \braket{ y } \) for some nonzero nonunit \( y \), then \( \braket{ x } = \braket{ y } \).
    \end{thmenum}

    \thmitem{def:domain_divisibility/prime} We say that \( x \) is \term{prime} if any of the following equivalent conditions hold:
    \begin{thmenum}
      \thmitem{def:domain_divisibility/prime/direct} \( x \mid yz \) implies \( x \mid y \) or \( x \mid z \).
    ...
    \thmitem{def:domain_divisibility/coprime} We say that \( x \) and \( y \) are \term{coprime} if any of the following equivalent conditions hold:
    \begin{thmenum}
...
\begin{defproof}
  ...
  \ImplicationSubProof{def:domain_divisibility/irreducible/direct}{def:domain_divisibility/irreducible/ideal} Suppose that \( x \) is not a unit and that \( x = yz \) implies that \( y \) or \( z \) is a unit. Since we are working in an integral domain, \( x \) is necessarily nonzero.
  ...
  \ImplicationSubProof{def:domain_divisibility/irreducible/ideal}{def:domain_divisibility/irreducible/direct} Suppose that \( \braket{ x } \) is maximal among nonzero proper principal ideals.
...
\begin{definition}\label{def:irreducible_factorization}\mimprovised
  An \term{irreducible factorization} or simply \term{factorization} of a nonzero element \( x \) in an \hyperref[def:integral_domain]{integral domain} is a finite \hyperref[def:weighted_set/multiset]{multiset} \( \set{ p_1, \ldots, p_n } \) of \hyperref[def:domain_divisibility/irreducible]{irreducible elements} such that, for some \hyperref[def:divisibility/zero]{unit} \( u \),
  \begin{equation*}
    x = u p_1 \cdots p_n.
  \end{equation*}
...
\begin{definition}\label{def:unique_factorization_domain}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:unique_factorization_domain/prime} An element is \hyperref[def:domain_divisibility/prime]{prime} if and only if it is \hyperref[def:domain_divisibility/irreducible]{irreducible}.
  \end{thmenum}
\end{definition}
\begin{defproof}
  \ImplicationSubProof{def:unique_factorization_domain/factorization}{def:unique_factorization_domain/prime} Suppose that every element has a unique factorization.

  \Fullref{thm:def:domain_divisibility/properties/prime_is_irreducible} holds, hence we only need to prove that an irreducible element is prime.
  ...
  \ImplicationSubProof{def:unique_factorization_domain/prime}{def:unique_factorization_domain/factorization} Suppose that every irreducible element is prime.
