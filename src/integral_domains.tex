...
\begin{proposition}\label{thm:def:greatest_common_divisor_domain/properties}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:def:greatest_common_divisor_domain/polynomial_ring} If the \hyperref[def:polynomial_semiring]{polynomial ring} \( R[X] \) over a commutative ring \( R \) is a greatest common divisor domain, then \( R \) also is.
...
\begin{proof}
  ...
  \SubProofOf{thm:def:greatest_common_divisor_domain/polynomial_ring} By \fullref{thm:def:integral_domain/subring}, \( R \) is an integral domain.
