...
\begin{remark}\label{rem:mathematical_logic_conventions}
  ...
  \begin{thmenum}
    ...
    \thmitem{rem:mathematical_logic_conventions/formula_term_symbols} Formulas, which we only consider in the object language, are also denoted by small Greek letters --- \( \varphi, \psi, \chi, \theta \) --- and so are terms --- \( \tau, \sigma, \rho, \kappa, \mu, \nu \).
