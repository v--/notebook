...
\begin{remark}\label{rem:mathematical_logic_conventions}
  ...
  \begin{thmenum}
    ...
    \thmitem{rem:mathematical_logic_conventions/structure_pairs} Structures in the metalogic (i.e. sets with functions and/or relations defined on them) are usually denoted by calligraphic letters (e.g. \( X \), \( R \)) --- see \fullref{rem:first_order_model_notation} for a discussion.
