...
\begin{remark}\label{rem:mathematical_logic_conventions}
  ...
  \begin{thmenum}
    ...
    \thmitem{rem:mathematical_logic_conventions/quantification} We avoid excessive universal quantification and instead rely on \fullref{thm:implicit_universal_quantification}.
  \end{thmenum}
