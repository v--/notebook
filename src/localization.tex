...
\begin{example}\label{ex:ring_localization}\MarginCite[430]{Knapp2016BAlg}
  Let \( p \) be a prime \hyperref[def:prime_number]{number} and \( P = \Gen p \) be the corresponding \hyperref[def:prime_ring_ideal]{prime ideal}. Denote its complement by \( S \).
