...
\begin{definition}\label{def:representable_functor}\mcite[def. 4.1.3 \\ def. 4.1.16]{Leinster2016Basic}
...
\begin{example}\label{def:top_representable_functor}\mcite[exmpl. 4.1.4]{Leinster2016Basic}
...
\begin{definition}\label{def:yoneda_embedding}\mcite[def. 4.1.15 \\ def. 4.1.21]{Leinster2016Basic}
...
\begin{proposition}\label{thm:yoneda_embedding_is_injective}\mcite[exer. 4.1.27]{Leinster2016Basic}
...
\begin{theorem}(Yoneda's lemma)\label{def:yoneda_lemma}\mcite[thm. 4.2.1]{Leinster2016Basic}
