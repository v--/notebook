...
\begin{proposition}\label{thm:finite_unions_and_products_are_finite}
  All finite \hyperref[def:basic_set_operations/union]{unions} and \hyperref[def:tuple_and_cartesian_product]{Cartesian products} of finite sets are finite.
\end{proposition}
...
\begin{definition}\label{def:successor_and_limit_cardinal}
  \begin{thmenum}
    ...
    Strong limit cardinals are further motivated by the usage of \hyperref[rem:strongly_inaccessible_cardinal]{regular strong limit cardinals} in \fullref{thm:strongly_inaccessible_cardinal_stages}.
  \end{thmenum}
...
\begin{proof}
  ...
  \begin{figure}
    \hfill
    \includegraphics[page=1]{figures/thm__omega_equinumerous_with_omega_squared.pdf}
    \hfill
    \includegraphics[page=2]{figures/thm__omega_equinumerous_with_omega_squared.pdf}
    \hfill\hfill
...
\begin{corollary}\label{thm:countable_product_of_countable_sets}
  A finite \hyperref[def:tuple_and_cartesian_product]{Cartesian product} of at most countable sets is at most countable.
\end{corollary}
\begin{proof}
