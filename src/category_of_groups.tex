...
\begin{definition}\label{def:group_direct_sum}
  ...
  \begin{thmenum}
    \ilabel{def:group_direct_sum/internal}\mcite\cite[126]{Knapp2016BasicAlgebra}If all \( \{ \mscrX_k \}_{k \in \mscrK} \) are subgroups of a group \( \mscrX \), we say that \( \mscrX \) is their \term{internal direct sum} if the homomorphism
    \begin{align*}
