...
\begin{definition}\label{def:first_order_syntax}
  ...
  \begin{thmenum}
    ...
    \labitem{def:first_order_syntax/term}\mcite\cite[189]{OpenLogic20201202}The set \( \mscrT \) of \term{terms} is the language \hyperref[def:grammar_derivation/grammar_language]{generated} by this grammar schema with \( \bnfpn{term} \) as a starting rule.
