...
\begin{proof}
  ...
  \begin{description}
    ...
    \RItem{thm:first_order_equality_is_equivalence_relation/transitivity} Analogously to \ref{def:order/equivalence/symmetry}, let \( a, b, c \in A \). From \fullref{remark:first_order_equality/equality} we obtain
    \begin{align*}
      T &=
