...
\begin{definition}\label{def:first_order_valuation}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:first_order_valuation/term_valuation}\mcite[def. 16.8]{OpenLogicFull} The \term{valuation} of a term \( \tau \) is a value in the universum \( \mscrX \) given by
...
\begin{definition}\label{def:first_order_semantics}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:first_order_semantics/theory_of_model}\mcite[def. 25.11]{OpenLogicFull} Similarly to \fullref{def:propositional_semantics/theory_of_model}, we define the \term{theory of the model} \( (\mscrX, I) \) to be the set
    \begin{equation*}
    ...
    \thmitem{def:first_order_semantics/theory} Closures and theories are defined as in \fullref{def:propositional_semantics/theory}.
