...
\begin{proof}
  ...
  \begin{description}
    ...
    \begin{align*}
      ...
      = \\ &=
      H_{\implies}(H_\land((x \doteq x)[v_{x,y}^{a,b}], (x \doteq y)[v_{x,y}^{a,b}]), H_{\iff}((x \doteq x)[v_{x,y}^{a,b}], (y \doteq x)[v_{x,y}^{a,b}]))
      = \\ &=
      H_{\implies}(H_\land(T, (x \doteq y)[v_{x,y}^{a,b}]), H_{\iff}(T, (y \doteq x)[v_{x,y}^{a,b}]))
      = \\ &=
      H_{\iff}((x \doteq y)[v_{x,y}^{a,b}], (y \doteq x)[v_{x,y}^{a,b}])
      = \\ &=
    ...
    \begin{align*}
      ...
      = \\ &=
      H_{\implies}(H_\land((x \doteq y)[v_{x,y,z}^{a,b,c}], (z \doteq y)[v_{x,y,z}^{a,b,c}]), H_{\iff}((x \doteq z)[v_{x,y,z}^{a,b,c}], (y \doteq y)[v_{x,y,z}^{a,b,c}]))
      = \\ &=
      H_{\implies}(H_\land((x \doteq y)[v_{x,y,z}^{a,b,c}], (z \doteq y)[v_{x,y,z}^{a,b,c}]), H_{\iff}((x \doteq z)[v_{x,y,z}^{a,b,c}], T))
      = \\ &=
      H_{\implies}(H_\land((x \doteq y)[v_{x,y,z}^{a,b,c}], (z \doteq y)[v_{x,y,z}^{a,b,c}]), (x \doteq z)[v_{x,y,z}^{a,b,c}]))
      = \\ &=
