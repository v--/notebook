...
\begin{definition}\label{def:first_order_formula}\cite[189]{OpenLogic20201202}
  ...
  \begin{itemize}
    ...
    \item If \( \varphi \) and \( \psi \) are formulas, then \( (\varphi \circ \psi), \circ \in \Sigma \) (see \fullref{def:propositional_logic_language}), are also formulas
...
\begin{definition}\label{def:first_order_structure}\cite[definition 14.27]{OpenLogic20201202}
  ...
  \begin{defenum}
    ...
    \begin{defenum}
      \DItem{def:first_order_structure/interpretation/equality} The interpretation \( I(\doteq) \) of the equality is a binary \hyperref[def:binary_relation]{relation} on \( A \).
...
\begin{definition}\label{def:first_order_homomorphism}\cite[definition 23.8]{OpenLogic20201202}
  ...
  \begin{defenum}
    \DItem{def:first_order_homomorphism/embedding} an \Def{embedding} or \Def{monomorphism} if \( \varphi \) is an injective \hyperref[def:function_invertibility/injection]{function}.

    \DItem{def:first_order_homomorphism/projection} a \Def{projection} or \Def{epimorphism} if \( \varphi \) is a surjective \hyperref[def:function_invertibility/surjection]{function}.

    \DItem{def:first_order_homomorphism/isomorphism} an \Def{isomorphism} if \( \varphi \) is a bijective \hyperref[def:function_invertibility/bijection]{function}.
