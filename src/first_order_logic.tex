...
\begin{definition}\label{def:first_order_language}\mbox{}
  \begin{DefEnum}
    ...
    \begin{bnf*}
      ...
      \bnfmore                  {\bnfpn{n-ary function} \underbrace{\bnfts{(} \bnfpn{term} \bnfts{,} \bnfsk \bnfts{,} \bnfpn{term} \bnfts{)}}_{n \text{ terms}} \bnfor} \\
      \bnfmore                  {\hspace{3cm} \vdots} \\
      ...
      \bnfmore                  {\hspace{3cm} \vdots} \\
      \bnfmore                  {\bnfpn{n-ary predicate} \underbrace{\bnfts{(} \bnfpn{term} \bnfts{,} \bnfsk \bnfts{,} \bnfpn{term} \bnfts{)}}_{n \text{ terms}} \bnfor} \\
      \bnfmore                  {\hspace{3cm} \vdots} \\
