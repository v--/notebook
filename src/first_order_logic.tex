...
\begin{definition}\label{def:first_order_formula}\cite[189]{OpenLogic20201202}
  ...
  This highlights that formulas with free variables can act as predicates, however their semantics\Tinyref{def:first_order_variable_assignment} are completely determined by the actual predicates.
\end{definition}
...
\begin{remark}\label{remark:equations}
  ...
  \begin{itemize}
    \item Linear algebra (see \cref{sec:linear_algebra}) can be regarded as the study of linear equations.
    \item Linear functional analysis (see \cref{sec:functional_analysis}) can be regarded as the study of equations relating linear operators.
