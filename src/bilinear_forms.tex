...
\begin{definition}\label{def:inner_product_space}
  ...
  In the special case where \( F = \C \), we require \( V \) to be equipped with a positive definite Hermitian\Tinyref{def:sesquilinear_form/hermitian} sesquilinear form instead.
\end{definition}
