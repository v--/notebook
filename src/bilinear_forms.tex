...
\begin{remark}\label{rem:matrices_as_bilinear_forms}
  ...
  Let \( e_1, \ldots, e_n \) be the \hyperref[def:standard_basis]{standard basis} of \( \BbbK^n \). This basis allows us to identify vectors of \( \BbbK^n \) with column vectors. To every \( n \times n \) matrix \( A \), there corresponds a bilinear form
  \begin{equation*}
...
\begin{remark}\label{rem:finite_basis_induces_inner_product}
  Let \( V \) be a vector space over \( \BbbC \) and let \( e_1, \ldots, e_n \) be a basis of \( V \). By \fullref{thm:basis_projection_orthonormal},
  \begin{equation*}
  ...
  We can thus define the \hyperref[def:inner_product_space]{inner product}
  \begin{equation*}
  ...
  This procedure reduces in an obvious way to real vector spaces.
\end{remark}
