...
\begin{proof}
  ...
  \SubProofImplication{def:compact_space/convergent_nets}{def:compact_space/centered_family}\mcite[thm. 3.1.23]{Engelking1989} Assume that every net has a cluster point. Let \( \{ F_k \}_{k \in \mscrK} \) be a central family of closed sets.
