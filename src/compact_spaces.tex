...
\begin{definition}\label{def:sequentially_compact_space}
  We say that \( X \) is a \Def{sequentially compact space} if every net\Tinyref{def:topological_net} has a cluster point or, equivalently\Tinyref{thm:net_convergence_properties/cluster_point_iff_subnet_limit_point}, a convergent\Tinyref{def:net_convergence} subnet.
\end{definition}
