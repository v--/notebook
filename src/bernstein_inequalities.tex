...
\begin{Proposition}\label{thm:modulus_of_continuity_properties}
  ...
  \begin{PropEnum}
    ...
    \ILabel{thm:modulus_of_continuity_properties/cauchy_inequality}\cite[28]{Николов2020} For all \( \lambda, \delta > 0 \), we have the following analog of \fullref{thm:cauchy_bunyakovsky_schwarz_inequality}
    ...
    \ILabel{thm:modulus_of_continuity_properties/single_inequality}\cite[28]{Николов2020} For all \( \lambda, \delta > 0 \),
...
\end{Proposition}
\begin{RefListProof}
    \IRef{thm:modulus_of_continuity_properties/continuity_condition} Follows directly from \fullref{def:uniform_continuity}.

    \IRef{thm:modulus_of_continuity_properties/monotone} A supremum on a larger set is larger.

    \IRef{thm:modulus_of_continuity_properties/cauchy_inequality} If \( \lambda \leq \delta \), clearly \( \lambda \delta \leq \delta^2 \). Otherwise, \( \lambda \delta < \lambda^2 \).
    ...
    \IRef{thm:modulus_of_continuity_properties/single_inequality} Note that
    \begin{equation*}
...
\begin{Definition}\label{def:approximation_error}\cite[44]{Николов2020}
  ...
  \begin{DefEnum}
    \ILabel{def:approximation_error/algebraic}
    \begin{align*}
      E_n: C([a, b]) \to [0, \infty] \\
      E_n(f) \coloneqq \inf_{p \in \pi_n} \Norm{f - p}.
    \end{align*}

    \ILabel{def:approximation_error/trigonometric}
    \begin{align*}
...
\begin{Theorem}[Bernstein's trigonometric inequality]\label{thm:bernsteins_trigonometric_inequality}\cite[53]{Николов2020}
...
\begin{Theorem}[Bernstein's trigonometric theorem]\label{thm:bernsteins_trigonometric_theorem}\cite[55]{Николов2020}
...
\begin{Theorem}[Bernstein's algebraic inequality]\label{thm:bernsteins_algebraic_inequality}\cite[59]{Николов2020}
...
\begin{Theorem}[Bernstein's algebraic theorem]\label{thm:bernsteins_algebraic_theorem}\cite[60]{Николов2020}
  Let \( f \in C[a, b] \) and
  \begin{equation*}
