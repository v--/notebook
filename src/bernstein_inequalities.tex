...
\begin{definition}\label{def:real_function_space_operators}
  ...
  \begin{thmenum}
    \ilabel{def:real_function_space_operators/positive} If \( f([a, b]) \subseteq [0, \infty) \) implies \( T(f)([a, b]) \subseteq [0, \infty) \), we say that \( T \) is \term{positive}.

    \ilabel{def:real_function_space_operators/monotone} If \( f(x) \leq g(x) \) for all \( x \in [a, b] \) implies \( T(f)(x) \leq T(g)(x) \) for all \( x \in [a, b] \), we say that \( T \) is \term{monotone}.
  \end{thmenum}
\end{definition}

\begin{definition}\label{def:periodic_function_space}\mcite\cite[44]{Николов2020Лекции}
...
\begin{definition}\label{def:approximation_error}\mcite\cite[44]{Николов2020Лекции}
  We introduce two operators.

  \begin{thmenum}
    \ilabel{def:approximation_error/algebraic} The \term{algebraic approximation error}
    \begin{balign*}
      E_n: C([a, b]) \to [0, \infty] \\
      E_n(f) \coloneqq \inf_{p \in \pi_n} \norm{f - p}.
    \end{balign*}

    \ilabel{def:approximation_error/trigonometric} The \term{trigonometric approximation error}
    \begin{balign*}
...
\begin{theorem}[Jackson's trigonometric theorem]\label{thm:jacksons_trigonometric_theorem}\mcite\cite[47]{Николов2020Лекции}
...
\begin{theorem}[Szego’s inequality]\label{thm:szegos_trigonometric_inequality}\mcite\cite[55]{Николов2020Лекции}
...
\begin{corollary}[Bernstein's trigonometric inequality]\label{thm:bernsteins_trigonometric_inequality}\mcite\cite[53]{Николов2020Лекции}
...
\begin{theorem}[Bernstein's trigonometric theorem]\label{thm:bernsteins_trigonometric_theorem}\mcite\cite[55]{Николов2020Лекции}
...
\begin{theorem}[Bernstein's algebraic inequality]\label{thm:bernsteins_algebraic_inequality}\mcite\cite[59]{Николов2020Лекции}
...
\begin{theorem}[Bernstein's algebraic theorem]\label{thm:bernsteins_algebraic_theorem}\mcite\cite[60]{Николов2020Лекции}
  Let \( f \in C[a, b] \) and
  \begin{equation*}
