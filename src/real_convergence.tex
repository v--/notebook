...
\begin{proof}\mbox{}
  \begin{description}
    ...
    \RItem{thm:squeeze_lemma/functions} The proof is analogous to that of \fullref{thm:squeeze_lemma/sequences}, but the machinery is different. Fix \( \varepsilon > 0 \). Then by \fullref{def:convergence_of_function_at_point/balls}, there exist radii \( \delta^- \) and \( \delta^+ \) such that
    \begin{align*}
