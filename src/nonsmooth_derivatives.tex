...
\begin{definition}\label{def:nonsmooth_derivatives}
  ...
  \begin{defenum}
    \DItem{def:nonsmooth_derivatives/directional}\Cref{def:differentiability} already introduced directional derivatives. Here we introduce a special notation for them:
    \begin{equation*}
