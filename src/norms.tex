...
\begin{definition}\label{def:absolute_value}\cite{nLab:absolute_value}
  Let \( R \) be a semiring\Tinyref{def:ring}. We say that the function \( \Abs{\cdot}: V \to \R^{>0} \) is an \Def{absolute value} if
  \begin{description}
...
\begin{definition}\label{def:norm}\cref[3]{Rudin1991}
