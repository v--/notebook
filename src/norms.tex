...
\begin{proof}
  ...
  \begin{description}
    \RItem{def:metric_space/identity} Follows from \fullref{def:norm/identity}.
...
\begin{proof}
  \begin{description}
    ...
    \Implies[def:rotund_norm/linearly_dependent][def:rotund_norm/no_sphere_segments] Let \fullref{def:rotund_norm/linearly_dependent/equation} hold and fix \( x, y \in S_E, t \in (0, 1) \). Define \( z \coloneqq tx + (1-t)y \).
