...
\begin{definition}\cite[Example 2.26]{Phelps1993}
  We define the \underLine{duality mapping}
  \begin{align*}
...
\begin{definition}\label{def:smooth_norm}\cite[Definition 2.36]{Phelps1993}
  The norm $\Norm \cdot$ on $X$ is called \underLine{smooth} if any of  if for each $x \in S_X$ the duality mapping is single-valued.
\end{definition}

\begin{definition}\label{def:rotund_norm}\cite[Definition 2.36]{Phelps1993}
  The norm $\Norm \cdot$ on $X$ is called \underLine{rotund} or \underLine{strictly convex} if any of the following equivalent conditions hold:
  \begin{defenum}
