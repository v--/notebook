...
\begin{proposition}\label{thm:krull_dimension_properties}
  ...
  \begin{propenum}
    ...
    \DItem{thm:krull_dimension_properties/field} If \( R \) is a \hyperref[def:field]{field}, \( \dim R = 0 \).
    \DItem{thm:krull_dimension_properties/polynomials_over_field}\cite[exercise 8.19]{Коцев2016} If \( R = \BK[X_1, \ldots, X_n] \) for some \hyperref[def:field]{field} \( \BK \), \( \dim R = n \).
  \end{propenum}
\end{proposition}
