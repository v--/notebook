...
\begin{proposition}\label{thm:field_maximal_ideal_representation}\cite[exercise 8.1]{Коцев2016}
  If \( r_1, \ldots, r_n \) are elements of the field \( \K \), then \( \Gen{X_1 - r_1, \ldots, X_n - r_n} \) is a maximal ideal of \( \K[X_1, \ldots, X_n] \).
\end{proposition}
...
\begin{proposition}\label{thm:krull_dimension_properties}
  ...
  \begin{thmenum}
    ...
    \DItem{thm:krull_dimension_properties/polynomials_over_field}\cite[exercise 8.19]{Коцев2016} If \( R = \K[X_1, \ldots, X_n] \) for some field\Tinyref{def:field} \( \K \), \( \dim R = n \).
  \end{thmenum}
\end{proposition}
