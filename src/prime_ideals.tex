...
\begin{definition}\label{def:prime_ring_ideal}\MarginCite[384]{Knapp2016BAlg}
  ...
  An element \( r \in R \) is called \Def{prime} if the ideal \( \Braket r \) is prime.
\end{definition}
\begin{proof}
...
\begin{proposition}\label{thm:field_maximal_ideal_representation}\MarginCite[exer. 8.1]{Коцев2016}
  If \( r_1, \ldots, r_n \) are elements of the field \( \BK \), then \( \Braket{X_1 - r_1, \ldots, X_n - r_n} \) is a maximal ideal of \( \BK[X_1, \ldots, X_n] \).
\end{proposition}
