...
\begin{definition}\label{def:hyperplane_separation}
  ...
  \begin{thmenum}
    \thmitem{def:hyperplane_separation/nonstrict}\mcite[def. 3.3]{Gallier2011} We say that two sets of points are \term{separated} by a \hyperref[def:hyperplane]{hyperplane} if the sets belongs to different closed half-spaces with respect to the hyperplane.
    ...
    \begin{figure}[!ht]
      \centering
      \includegraphics[page=1]{output/def__hyperplane_separation__nonstrict.pdf}
    ...
    \begin{figure}[!ht]
      \centering
      \includegraphics[page=1]{output/def__hyperplane_separation__strong.pdf}
      \caption{Parallel \hyperref[def:hyperplane_separation/strict]{strongly separating lines} between \hyperref[def:circle]{circles}.}\label{fig:def:hyperplane_separation/strong}
    \end{figure}
    ...
    \begin{figure}[!ht]
      \centering
      \includegraphics[page=1]{output/def__hyperplane_separation__supporting.pdf}
