...
\begin{example}\label{ex:def:quiver_geometric_realization}
  ...
  \begin{thmenum}
    ...
    \begin{equation}\label{eq:ex:def:quiver_geometric_realization/k3/relization}
      \begin{aligned}
        \includegraphics[page=1]{figures/ex__def__graph_geometric_realization.pdf}
      \end{aligned}
    \end{equation}
    ...
    \begin{equation}\label{eq:ex:def:quiver_geometric_realization/k3/embedding}
      \begin{aligned}
        \includegraphics[page=2]{figures/ex__def__graph_geometric_realization.pdf}
      \end{aligned}
    \end{equation}
    ...
    \begin{equation}\label{eq:ex:def:quiver_geometric_realization/k4/realization}
      \begin{aligned}
        \includegraphics[page=3]{figures/ex__def__graph_geometric_realization.pdf}
      \end{aligned}
    \end{equation}
