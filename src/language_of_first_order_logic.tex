...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \begin{balign*}
      \paren[\Big]{ \tau[\xi \mapsto \eta] }\eval{v}
      &=
      \paren[\Big]{ f(\tau_1[\xi \mapsto \eta], \ldots, \tau_n[\xi \mapsto \eta]) }\eval{v}
      = \\ &=
      I(f) \paren[\Bigg]{ \paren[\Big]{ \tau_1[\xi \mapsto \eta] }\eval{v}, \ldots, \paren[\Big]{ \tau_1[\xi \mapsto \eta] }\eval{v} }
      \overset {\IndHyp} = \\ &=
      I(f) \paren[\Big]{ \tau_1\eval{v_{\xi \mapsto \eta}}, \ldots, \tau_n\eval{v_{\xi \mapsto \eta}} }
      = \\ &=
      \paren[\Big]{ f(\tau_1, \ldots, \tau_n) }\eval{v_{\xi \mapsto \eta}}
      = \\ &=
      \tau\eval{v_{\xi \mapsto \eta}}.
    \end{balign*}
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \begin{balign*}
      \paren[\Big]{ \varphi[\xi \mapsto \eta] }\eval{v}
      &=
      \paren[\Big]{ p(\tau_1[\xi \mapsto \eta], \ldots, \tau_n[\xi \mapsto \eta]) }\eval{v}
      = \\ &=
      \paren[\Big]{ p(\tau_1, \ldots, \tau_n) }\eval{v_{\xi \mapsto \eta}}
      = \\ &=
      \tau\eval{v_{\xi \mapsto \eta}}.
    \end{balign*}
