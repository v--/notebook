...
\begin{definition}\label{def:lipschitz_continuity}
  ...
  \begin{defenum}
    ...
    \ilabel{def:lipschitz_continuity/calm}\cite[53]{Dontchev2014} We say that \( f \) is \term{calm} at \( x \) if it satisfies the Lipschitz condition with one of the points fixed:
    \begin{equation*}
