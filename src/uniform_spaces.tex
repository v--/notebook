...
\begin{proof}
  \begin{description}
    \RItem{def:uniform_limit_of_continuous_functions/uniform} Let \( \{ f_i \}_{i \in I} \) be a net\Tinyref{def:topological_net} of continuous on \( S \subseteq X \) functions between the uniform spaces \( (X, \U) \) to \( (Y, \V) \) that converges uniformly\Tinyref{def:function_net_convergence/uniform} to \( f: X \to Y \).

    From uniform continuity\Tinyref{def:uniform_continuity},
    \begin{equation*}
      \forall V \in \V \ \forall i \in I \ \exists U \in \U \ \forall x_1, x_2 \in S : \Abs{x_1 - x_2} < U \implies \Abs{f_i(x_1) - f_i(x_2)} < V.
    \end{equation*}

    From uniform convergence\Tinyref{def:function_net_convergence}, there exists an index \( i_0 \in I \) such that
    \begin{equation*}
      \forall V \in \V \ \forall i > i_0 \ \forall x \in S : \Abs{f_i(x) - f(x)} < V.
    \end{equation*}

    Fix an entourage \( V \in \V \), an index \( i > i_0 \). Let \( U \in \U \) be such that
    ...
    \RItem{def:uniform_limit_of_continuous_functions/continuous} The proof is analogous to \cref{def:uniform_limit_of_continuous_functions/uniform} except that the entourage \( U \in \U \) depends on the points \( x_1 \) and \( x_2 \).
  \end{description}
\end{proof}
