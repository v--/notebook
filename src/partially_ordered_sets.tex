...
\begin{definition}\label{def:inflationary_function}\mcite{MathOF:closure_operator_on_poset}
  An \hyperref[def:multi_valued_function/endofunction]{endofunction} \( f \) on a \hyperref[def:partially_ordered_set]{partially ordered set} \( (P, \leq) \) is said to be \term{inflationary} if \( x \leq f(x) \) for every \( x \in P \).
\end{definition}
