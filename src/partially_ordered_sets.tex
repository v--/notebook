...
\begin{example}\label{ex:def:lexicographic_order}
  ...
  A slightly more relevant example for mathematics is the ordering \( AB < AC < BC \) of the names of the sides of a \hyperref[def:triangle]{triangle}. The reverse lexicographic ordering would be \( AB < BC < AC \).
