...
\begin{lemma}[Zorn's lemma]\label{thm:zorns_lemma}\mcite[63]{Gratzer1978}
  If any \hyperref[def:partially_ordered_set_chain_and_antichain]{chain} in a \hyperref[def:partially_ordered_set]{partially ordered set} has an upper \hyperref[def:partially_ordered_set_extremal_points/upper_and_lower_bounds]{bound}, there exists a \hyperref[def:partially_ordered_set_extremal_points/maximal_and_minimal_element]{maximal} set in \( X \).
