...
\begin{example}\label{ex:def:hasse_diagram}
  ...
  \begin{figure}
    \centering
    \includegraphics[page=1]{figures/ex__def__hasse_diagram.pdf}
...
\begin{example}\label{ex:preorder_nonuniqueness}
  ...
  \begin{figure}
    \hfill
    \includegraphics[page=1]{figures/ex__preorder_nonuniqueness.pdf}
    \hfill
    \includegraphics[page=2]{figures/ex__preorder_nonuniqueness.pdf}
    \hfill\hfill
...
\begin{example}\label{ex:def:lexicographic_order}
  ...
  The edges of the graph in \fullref{ex:def:quiver/simple} are numbered in lexicographic order, which also happens to be the reverse lexicographic order.
