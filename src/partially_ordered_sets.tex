...
\hyperref[def:preordered_set]{Preordered sets} are simple to define and arise naturally (e.g. \fullref{def:lindenbaum_tarski_algebra}), but they require uniqueness considerations, as discussed in \fullref{ex:preorder_nonuniqueness}, and we want to avoid to factor them out. \Fullref{thm:preorder_to_partial_order} shows that the result obtained from this factorization is a partially ordered set, which this section is dedicated to.
