...
\begin{example}\label{ex:zero_morphisms_in_grp}
  ...
  \begin{thmenum}
    ...
    \thmitem{ex:zero_morphisms_in_grp/kernel} Let \( \varphi: G \to H \) be a \hyperref[thm:group_homomorphism_single_condition]{group homomorphism}. As per \fullref{def:pointed_set_kernel}, its kernel is the set
    \begin{equation*}
