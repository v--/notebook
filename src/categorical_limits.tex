...
\begin{remark}\label{note:small_categorical_product}
...
\begin{remark}\label{note:empty_categorical_product}
...
\begin{remark}\label{note:empty_categorical_coproduct}
...
\begin{remark}\label{note:categorical_colimit_preservation}
