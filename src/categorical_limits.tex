...
\begin{example}\label{ex:categorical_coproduct/set}
  Let $\{ X_i \}_{i \in I}$ be an indexed family in the category $\Bold{Set}$. Their coproduct $\coprod_{i \in I} X_i$ is the disjoint union\Tinyref{def:disjoint_union} of the underlying sets.
\end{example}
