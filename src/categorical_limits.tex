...
\begin{proof}\mbox{}
  \begin{description}
    \Iff[def:categorical_cone/explicit][def:categorical_cone/natural] Let \( i, j \in \Bold I \) and \( u: i \to j \). Then a natural transformation \( f \) in  satisfies the following commutative diagram:
    \begin{equation*}
      \begin{mplibcode}
        beginfig(1);
          input metapost/graphs;
