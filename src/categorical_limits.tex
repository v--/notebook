...
\begin{definition}\label{def:diagonal_functor}\mcite[143]{Leinster2014}
...
\begin{definition}\label{def:categorical_cone}\mcite[def. 5.1.19(a)]{Leinster2014}
  ...
  \begin{defenum}
    \ilabel{def:categorical_cone/explicit} A family of \term{projection} morphisms \( \{ \pi_k: A \to D(k) \}_{k \in \cat{I}} \) from the \term{vertex} \( A \) such that for all morphisms \( u: k \to \beta \) in \( \cat{I} \), the following diagram commutes:
...
\begin{definition}\label{def:categorical_limit}\mcite[def. 5.1.19(b), 6.3.6]{Leinster2014}
...
\begin{definition}\label{def:categorical_product}\mcite[def. 5.1.1, 5.1.7]{Leinster2014}
...
\begin{definition}\label{def:categorical_fork}\mcite[112]{Leinster2014}
...
\begin{definition}\label{def:categorical_equalizer}\mcite[def. 5.1.11]{Leinster2014}
...
\begin{definition}\label{def:categorical_pullback}\mcite[def. 5.1.16]{Leinster2014}
...
\begin{definition}\label{def:categorical_cocone}\mcite[def. 5.2.1]{Leinster2014}
...
\begin{definition}\label{def:categorical_colimit}\mcite[def. 5.1.19(b)]{Leinster2014}
...
\begin{definition}\label{def:categorical_coproduct}\mcite[def. 5.2.2]{Leinster2014}
...
\begin{definition}\label{def:categorical_coequalizer}\mcite[def. 5.2.7]{Leinster2014}
...
\begin{definition}\label{def:categorical_pushout}\mcite[def. 5.2.11]{Leinster2014}
...
\begin{definition}\label{def:categorical_limit_preservation}\mcite[def. 5.3.1, 5.3.5]{Leinster2014}
  Let \( F: \cat{A} \to \bop B \) be a functor. We say that
  \begin{defenum}
    \ilabel{def:categorical_limit_preservation/preserve} \( F \) \term{preserves} limits of shape \( \cat{I} \) for some index category \( \cat{I} \) if, given a \( \cat{I} \)-shaped limit cone
    \begin{equation*}
      \{ L \overset {\pi_k} \to D(k) \}_{k \in \cat{I}},
    \end{equation*}
    its image
    ...
    \ilabel{def:categorical_limit_preservation/reflect} \( F \) \term{reflects} limits of shape \( \cat{I} \) if, given any \( \cat{I} \)-shaped cone, if its image is a limit cone, then is it itself a limit cone.

    \ilabel{def:categorical_limit_preservation/create} \( F \) \term{creates} limits of shape \( \cat{I} \) if it both preserves and reflects limits.

    \ilabel{def:categorical_limit_preservation/lift} \( F \) \term{lifts} limits of shape \( \cat{I} \) if, given a diagram \( D: \cat{I} \to \bop B \), any limit cone \( \varprojlim D \) is the image of some limit cone in \( A \).
  \end{defenum}
\end{definition}
