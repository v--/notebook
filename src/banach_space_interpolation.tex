...
\begin{definition}\label{def:interpolated_topological_vector_space}\mcite\cite[24]{Bergh1976}
...
\begin{proposition}\label{def:banach_space_sum_and_intersection_norms}\mcite\cite[24]{Bergh1976}
...
\begin{theorem}[The Riesz-Thorin interpolation theorem]\label{thm:riesz_thorin}\mcite\cite[24]{Bergh1976}
...
\begin{definition}\label{def:k_functional}\mcite\cite[38]{Bergh1976}
...
\begin{proposition}\label{def:k_functional_properties}\mcite\cite[38]{Bergh1976}
...
\begin{definition}\label{def:k_functional_interpolation_space}\mcite\cite[40]{Bergh1976}
...
\begin{theorem}\label{thm:k_functional_interpolation}\mcite\cite[thm. 3.1.2]{Bergh1976}
...
\begin{proposition}\label{thm:e_functional_properties}\mcite\cite[lemma 7.1.3]{Bergh1976}
  ...
  \begin{propenum}
    ...
    \ilabel{def:k_functional_properties/k_functional_connection}\mcite\cite[thm. 7.1.4]{Bergh1976}
    \begin{equation*}
...
\begin{theorem}\label{thm:interpolation_space_and_approximation_space_reiteration}\mcite\cite[thm. 7.1.8]{Bergh1976}
