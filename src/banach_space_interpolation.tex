...
\begin{definition}\label{def:interpolated_topological_vector_space}\mcite[24]{Bergh1976}
...
\begin{proposition}\label{def:banach_space_sum_and_intersection_norms}\mcite[24]{Bergh1976}
...
\begin{theorem}[The Riesz-Thorin interpolation theorem]\label{thm:riesz_thorin}\mcite[24]{Bergh1976}
...
\begin{definition}\label{def:banach_interpolation_space_exponent}\mcite[27]{Bergh1976}
...
\begin{definition}\label{def:k_functional}\mcite[38]{Bergh1976}
...
\begin{proposition}\label{def:k_functional_properties}\mcite[38]{Bergh1976}
...
\begin{definition}\label{def:k_functional_interpolation_space}\mcite[40]{Bergh1976}
...
\begin{theorem}\label{thm:k_functional_interpolation}\mcite[thm. 3.1.2]{Bergh1976}
...
\begin{theorem}\label{thm:discrete_k_interpolation}\mcite[lemma 3.1.3]{Bergh1976}
...
\begin{definition}\label{def:e_functional}\mcite[174]{Bergh1976}
...
\begin{proposition}\label{thm:e_functional_properties}\mcite[lemma 7.1.3]{Bergh1976}
  ...
  \begin{propenum}
    ...
    \ilabel{def:k_functional_properties/k_functional_connection}\mcite[thm. 7.1.4]{Bergh1976}
    \begin{equation*}
...
\begin{definition}\label{def:approximation_space}\mcite[def. 7.1.5]{Bergh1976}
...
\begin{theorem}\label{thm:interpolation_space_and_approximation_space}\mcite[thm. 7.1.6]{Bergh1976}
...
\begin{theorem}\label{thm:interpolation_space_and_approximation_space_reiteration}\mcite[thm. 7.1.8]{Bergh1976}
