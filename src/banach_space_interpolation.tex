...
\begin{proof}
  ...
  Denote the limit of \( \{ x_k \}_{k=1}^\infty \) by \( x \). Let \( \varepsilon > 0 \) and let \( k_0 \) be an index such that both \( \Norm_{\CX_0}{x_k - \xi_0} < \varepsilon \) and \( \Norm{x_k - \xi_1}_{\CX_1} < \varepsilon \) whenever \( k \geq k_0 \). Then, for any \( k \geq k_0 \),
  \begin{equation*}
