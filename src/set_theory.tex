...
\begin{remark}\label{rem:set_definition_recursion}
  ...
  \begin{itemize}
    \item Using the metatheory where we assume the availability of first-order logic, we build in the object logic certain special sets within set theory that can be used as models of \logic{ZFC} --- see \fullref{remark:cumulative_hierarchy_model_of_zfc}.
