...
\begin{definition}\label{def:trigonometric_functions}
  ...
  \Fullref{def:geometric_trigonometric_functions} justifies the term \enquote{angle} for the \hyperref[def:multi_valued_function/argument]{parameter} of the trigonometric functions.
\end{definition}
...
\begin{definition}\label{def:periodic_function}
  ...
  The \term{base period} of a function is the \hyperref[def:poset_extremal_points/maximum_and_minimum]{least} of all periods, if a minimum exists. When referring to \enquote{the period}, we mean the base period.
