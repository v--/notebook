...
\begin{proposition}\label{thm:def:trigonometric_function}
  ...
  \begin{thmenum}
    \thmitem{thm:def:trigonometric_function/sin_of_arctan} For any real number \( x \),
    \begin{equation}\label{eq:thm:def:trigonometric_function/sin_of_arctan}
      \sin(\arctan(x)) = \frac x {\sqrt{1 + x^2}}.
    \end{equation}

    \thmitem{thm:def:trigonometric_function/cos_of_arctan} For any real number \( x \),
    \begin{equation}\label{eq:thm:def:trigonometric_function/cos_of_arctan}
      \cos(\arctan(x)) = \frac 1 {\sqrt{1 + x^2}}.
    \end{equation}

    \thmitem{thm:def:trigonometric_function/sum_of_arccos}\mcite{MathSE:sum_of_angles} For any pair of real numbers \( x \) and \( y \) in \( [-1, 1] \),
    \begin{equation}\label{eq:thm:def:trigonometric_function/sum_of_arccos}
      \arccos(x) + \arccos(y) = \arccos\parens*{ xy - \sqrt{ (1 - x)^2 (1 - y)^2 } }.
    \end{equation}
  \end{thmenum}
\end{proposition}
\begin{proof}
  \SubProofOf{thm:def:trigonometric_function/sin_of_arctan} If \( x = 0 \), then \( \arctan x = 0 \) and \( \sin(\arctan x) = 0 \).
  ...
  \SubProofOf{thm:def:trigonometric_function/cos_of_arctan} If \( x = 0 \), then \( \arctan x = 0 \) and \( \cos(\arctan x) = 1 \).
  ...
  \SubProofOf{thm:def:trigonometric_function/sum_of_arccos} Let \( \alpha \coloneqq \arccos(x) \) and \( \beta \coloneqq \arccos(y) \). Then
  \begin{balign*}
    \arccos(x) + \arccos(y)
    &=
