...
\begin{proposition}\label{thm:trigonometric_identities}
  ...
  \begin{PropEnum}
    \ILabel{thm:trigonometric_function_properties/pythagorean_identity} (Pythagorean identity) For any \( z \in \BC \),
...
\end{proposition}
\begin{proof}
  \SubProofOf{thm:trigonometric_function_properties/pythagorean_identity} We use Cauchy multiplication for
  \begin{align*}
    \sin(z)^2
     & =
    \sin(z) \cdot \sin(z)
  ...
  \SubProofOf{thm:trigonometric_identities/products} We will only prove \ref{eq:thm:trigonometric_identities/products/ss} because the other identities are proved analogously. From \fullref{thm:trigonometric_identities/eulers_formula},
  \begin{align*}
    2 \sin(x) \sin(y)
     & =
  ...
  The identity \fullref{thm:trigonometric_identities/sums/sin_sum} the follows from \fullref{eq:thm:trigonometric_identities/products/sc} applied to \( t \) and \( s \). The other identities are proved analogously.

  \SubProofOf{thm:trigonometric_identities/sum_of_angles} We will only prove \fullref{eq:thm:trigonometric_identities/sum_of_angles/sin} because \fullref{eq:thm:trigonometric_identities/products/cos} is proved analogously. From \fullref{eq:thm:trigonometric_identities/products/cs},
  \begin{align*}
    \sin(x + y)
     & =
  ...
  After dividing by \( 2 \), we obtain \fullref{eq:thm:trigonometric_identities/sum_of_angles/sin}.
\end{proof}

\begin{lemma}\label{thm:trigonometric_function_roots}
...
\end{lemma}
\begin{proof}
\ref{eq:thm:trigonometric_function_basic_roots/zero} follows directly from \fullref{def:trigonometric_functions}.
  ...
  Hence \( \cos(\pi) = -1 \). From \fullref{thm:trigonometric_function_properties/pythagorean_identity},
  \begin{equation*}
...
\begin{proof}
  ...
  Since, by \fullref{thm:trigonometric_function_basic_roots}, \( \cos(0) = 1 \), it follows that \( \cos(x) > 0, x \in (-\gamma, \gamma) \). Therefore its primitive function \( \sin(x) \) increases on the same interval. It is also continuous, hence by \fullref{thm:trigonometric_function_properties/pythagorean_identity}, \( \sin(\gamma) = 1 \) because \( \cos(\gamma) = 0 \).
