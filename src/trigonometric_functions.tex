...
\begin{definition}\label{def:trigonometric_functions}
  ...
  \Fullref{def:geometric_trigonometric_functions} justifies the term \enquote{angle} for the \hyperref[def:function_arguments]{parameter} of the trigonometric functions.
\end{definition}
