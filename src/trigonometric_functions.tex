...
\begin{definition}\label{def:derived_trigonometric_functions}
  ...
  \begin{defenum}
    \DItem{def:derived_trigonometric_functions/tan} The partial\Tinyref{def:function/partial} \Def{tangent} function, also called \Def{tangens}, is
    \begin{equation*}
    ...
    \DItem{def:derived_trigonometric_functions/cot} The partial\Tinyref{def:function/partial} \Def{cotangent function}, also called \Def{cotangens}, is
    \begin{equation*}
...
\begin{definition}\label{def:inverse_trigonometric_functions}
  ...
  \begin{defenum}
    \DItem{def:inverse_trigonometric_functions/arcsin} The \Def{arcus sinus} function \( \arcsin(x) \) is defined as the inverse function\Tinyref{def:function/inverse} of \( \sin(x) \)\Tinyref{def:trigonometric_functions/sine} from \( [-1, 1] \) to \( [0, 2\pi) \).

    \DItem{def:inverse_trigonometric_functions/arccos} The \Def{arcus cosinus} function \( \arccos(x) \) is defined as the inverse of \( \cos(x) \)\Tinyref{def:trigonometric_functions/cosine} from \( [-1, 1] \) to \( [0, 2\pi) \).

    \DItem{def:inverse_trigonometric_functions/arctan} The \Def{arcus tangens} function \( \arctan(x) \) is defined as the inverse of \( \tan(x) \)\Tinyref{def:derived_trigonometric_functions/tan} from \( \BR \) to \( (0, 2\pi) \).

    \DItem{def:inverse_trigonometric_functions/arccot} The \Def{arcus cotangens} function \( \arccot(x) \) is defined as the inverse of \( \cot(x) \)\Tinyref{def:derived_trigonometric_functions/cot} from \( \BR \) to \( (0, 2\pi) \).
  \end{defenum}
\end{definition}
