...
\begin{proposition}\label{thm:trigonometric_identities}
  ...
  \begin{PropEnum}
    \ILabel{thm:trigonometric_identities/pythagorean_identity} (Pythagorean identity) For any \( z \in \BC \),
...
\end{proposition}
\begin{proof}
  \SubProofOf{thm:trigonometric_identities/pythagorean_identity} We use Cauchy multiplication for
  \begin{align*}
    \sin(z)^2
     & =
    \sin(z) \cdot \sin(z)
