...
\begin{definition}\label{def:inverse_trigonometric_functions}
  ...
  \begin{defenum}
    \DItem{def:inverse_trigonometric_functions/arcsin} The \Def{arcus sinus} function \( \arcsin(x) \) is defined as the inverse \hyperref[def:function/inverse]{function} of \( \sin(x) \)\Tinyref{def:trigonometric_functions/sine} from \( [-1, 1] \) to \( [0, 2\pi) \).
