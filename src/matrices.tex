...
\begin{definition}\label{def:matrix_determinant}\mcite[215]{Knapp2016BAlg}
...
\begin{proposition}\label{thm:matrix_determinant_properties}\mcite[prop. 5.1]{Knapp2016BAlg}
...
\begin{proposition}\label{thm:matrix_invertible_iff_nonsingular}\mcite[cor. 5.5]{Knapp2016BAlg}
