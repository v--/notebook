...
\begin{definition}\label{def:array}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:array/vector} one-dimensional arrays are called simply \term{vectors} or \hyperref[def:tuple_and_cartesian_product]{tuples} and are usually written as either column vectors or row vectors.
  \end{thmenum}
\end{definition}
