...
\begin{definition}\label{def:connected_space}\MarginCite[thm. 6.1.1]{Engelking1989}
...
\begin{definition}\label{def:locally_connected}\MarginCite[exer. 6.3.3]{Engelking1989}
...
\begin{definition}\label{def:path_connected}\MarginCite[exer. 6.3.9]{Engelking1989}
...
\begin{definition}\label{def:locally_path_connected}\MarginCite[exer. 6.3.10]{Engelking1989}
