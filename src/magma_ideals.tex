...
\begin{example}\label{ex:subgroup_is_not_ideal}
  We explicitly give a counterexample to the converse of \fullref{thm:magma_ideal_is_submagma}. Define \( G \coloneqq \BZ \times \BZ \) to be the \hyperref[def:abelian_group]{abelian group} given by pointwise addition. Define
  \begin{equation*}
...
\begin{proof}
  ...
  \Sufficiency Let \( e \in I \). Then \( ex = x \) for any \( x \in M \), thus \( IM = M \). But \( I \) is an ideal, hence we have that \( IM = I \), thus \( I = IM = M \).
  \Necessity If \( I = M \), then obviously \( e \in M = R \).
