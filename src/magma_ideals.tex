...
\begin{definition}\label{def:magma_ideal}
  Let \( \CM \) be a \hyperref[def:magma]{magma} and \( I \) be a subset of \( \CM \). We say that \( I \) is a \Def{left ideal} of \( \CM \) if the inclusion \( I\CM \subseteq I \) holds, where we use the convention in \fullref{remark:magma_set_operations}, that is,
  \begin{equation*}
