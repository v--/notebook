...
In this section, \( \BK \) will refer to either \( \BR \) or \( \BC \). See \cref{remark:real_field_extensions} for a justification.
...
\begin{definition}\label{def:topological_group}
  ...
  See \cref{remark:hausdorff_topological_groups} and \cref{def:category_of_topological_groups} for more nuances.
\end{definition}
