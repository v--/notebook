...
\begin{proof}
  ...
  \begin{refenum}
    ...
    \refitem{def:left_monoid_action/operation/compatibility} \( (x^n)^m = x^{nm} \) is the literal statement of \eqref{eq:thm:def:magma_exponentiation/properties/repeated}.
  \end{refenum}
\end{proof}
