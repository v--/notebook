...
\begin{conjecture}[Continuum conjecture]\label{hyp:continuum_conjecture}\mcite\cite[165]{Enderton1977Sets}
...
\begin{remark}\label{rem:continuum_conjecture}\mcite\cite[165]{Enderton1977Sets}
  \Fullref{hyp:continuum_conjecture} has been shown by G\"odel to not be disprovable in \hyperref[def:set_zfc]{ZFC} and by Cohen to not be provable in ZFC.
\end{remark}
