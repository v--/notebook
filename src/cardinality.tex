...
\begin{definition}\label{def:finite_set}\MarginCite[133]{Enderton1977}
  A set \( A \) is \Def{finite} if it is equinumerous to a natural number as defined in \fullref{ex:natural_numbers} (using the convention that \( \varnothing \) corresponds to zero).
