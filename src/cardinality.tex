...
\begin{conjecture}[Continuum conjecture]\label{hyp:continuum_conjecture}\mcite\cite[165]{Enderton1977}
  There exists no cardinal \( \xi \) such that \( \aleph_0 < \xi < c \).
\end{conjecture}

\begin{remark}\label{rem:continuum_conjecture}\mcite\cite[165]{Enderton1977}
