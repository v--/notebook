...
\begin{definition}\label{def:finite_set}\cite[133]{Enderton1977}
  A set \( A \) is \Def{finite} if it is isomorphic to a natural number as defined in \cref{def:natural_numbers_zfc} (using the convention that \( \varnothing \) corresponds to zero).
