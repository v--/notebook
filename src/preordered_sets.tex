...
\begin{definition}\label{def:preordered_set}\mcite{nLab:preorder}
  ...
  \begin{thmenum}[series=def:preordered_set]
    ...
    \thmitem{def:preordered_set/trivial} The \hyperref[thm:substructures_form_complete_lattice/bottom]{trivial preordered set} is the empty set (see \fullref{rem:empty_models}).
