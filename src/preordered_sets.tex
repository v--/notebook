...
\begin{definition}\label{def:preordered_set}\mcite[def. 2.14]{OpenLogicFull}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:preordered_set/category} We give no special name for the \hyperref[def:category_of_small_first_order_models]{category of models} for the theory of preordered sets.
