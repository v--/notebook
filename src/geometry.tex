...
A modern interpretation if the ideas behind analytic geometry leads to \hyperref[def:affine_spaces]{affine spaces}, which we will discuss in \fullref{subsec:affine_spaces} and \fullref{subsec:euclidean_spaces} and \fullref{subsec:euclidean_plane}. As part of our discussion of the \hyperref[def:euclidean_space]{Euclidean plane}, we will briefly introduce modern concepts related to differential geometry in \fullref{subsec:manifolds} and algebraic geometry in \fullref{subsec:quadratic_plane_curves}.
