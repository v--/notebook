...
Finally, we will very briefly touch contemporary topics in geometry --- differential geometry in \fullref{subsec:manifolds} and algebraic geometry in \fullref{subsec:quadratic_curves}.
