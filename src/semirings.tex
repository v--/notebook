...
\begin{definition}\label{def:semiring}\mcite[1]{Golan2010}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:semiring/duality}\mcite[555]{Knapp2016BasicAlgebra} The \term{dual} or \term{opposite} semiring of \( (R, +, \cdot) \) is the semiring \( (R, +, \star) \), with multiplication defined as \( x \star y = y \cdot x \).
  \end{thmenum}
\end{definition}
...
\begin{proposition}\label{thm:natural_number_divisibility_order}
  ...
  \begin{figure}
    ...
    \caption{A spacial \hyperref[def:hasse_diagram]{Hasse diagram} for a fragment of the \hyperref[thm:natural_number_divisibility_order]{natural number divisibility lattice}.}
