...
\begin{definition}\label{def:ordered_semiring}
  A \term{preordered semiring} is a semiring \( R \) with a \hyperref[def:preordered_set]{preorder} \( \leq \) such that \( (R, +) \) is a \hyperref[def:ordered_magma]{ordered magma} and, additionally, \( 0 \leq x \) and \( 0 \leq y \) implies \( 0 \leq xy \).
\end{definition}
