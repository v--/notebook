...
\begin{definition}\label{def:minimal_hypergraph_transversal}
  ...
  \begin{defenum}
    \DItem{def:minimal_hypergraph_transversal/order} \( T \) is a minimal element\Tinyref{def:preordered_set/maximal_minimal_element} under set inclusion\Tinyref{remark:subset_and_membership_relations} in the set of all transversals of \( H \).
