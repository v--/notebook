...
\begin{definition}\label{def:minimal_hypergraph_transversal}
  ...
  \begin{defenum}
    \DItem{def:minimal_hypergraph_transversal/order} \( T \) is a minimal \hyperref[def:preordered_set/maximal_minimal_element]{element} under \hyperref[set remark:subset_and_membership_relations]{inclusion} in the set of all transversals of \( H \).
