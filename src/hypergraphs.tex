...
\begin{definition}\label{def:minimal_hypergraph_transversal}
  ...
  \begin{thmenum}
    \thmitem{def:minimal_hypergraph_transversal/order} \( T \) is a minimal \hyperref[def:poset_extremal_points/maximal_and_minimal_element]{element} under \hyperref[def:subset]{set inclusion} in the set of all transversals of \( H \).
