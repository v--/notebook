...
\begin{definition}\label{def:banach_space}
  A \Def{Banach space} is a \hyperref[def:norm]{normed} \hyperref[def:vector_space]{vector space} which is also a complete metric \hyperref[def:complete_metric_space]{spaces} with the metric induced by the \hyperref[def:norm_induced_metric]{norm}.
\end{definition}
