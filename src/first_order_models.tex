...
\begin{theorem}[Semantic deduction theorem]\label{thm:semantic_deduction_theorem}\MarginCite[thm. 14.53]{OpenLogic20201202}
  The entailment \( \Gamma, \psi \vDash \varphi \) holds if and only if \( \Gamma \vDash \psi \rightarrow \varphi \) holds. Compare this result to \fullref{thm:deduction_theorem}.
\end{theorem}
