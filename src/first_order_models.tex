...
\begin{example}\label{ex:thm:functions_over_model_of_positive_formulas_form_model}
  ...
  \begin{itemize}
    ...
    Then by \fullref{thm:functions_over_model_form_model}, the set \( \mscrB = \fun(\mscrS, \set{ T, F }) \) of all Boolean functions of arbitrary arities is again a Boolean algebra. See \fullref{thm:lindenmaum_tarski_algebra_of_full_propositional_logic/boolean_algebra} for further discussion.
