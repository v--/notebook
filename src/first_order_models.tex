...
\begin{remark}\label{rem:induction}
  ...
  \end{equation*}
  where \( S \) is the \hyperref[def:basic_set_operations/successor]{ordinal successor operator}.
...
\begin{proof}
  ...
  At least one such assignment exists due to \fullref{def:zfc/A8}. If \( h \) is injective, this assignment is unique.
