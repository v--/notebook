...
\begin{definition}\label{def:extended_real_numbers}
  ...
  \end{itemize}
  where \( -\infty \) and \( +\infty \) are both sentinel values that act as the \hyperref[def:poset_extremal_points/maximum_and_minimum]{greatest} and/or least real number.
