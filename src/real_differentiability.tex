...
\begin{example}[Weierstrass' nowhere differentiable function]\label{ex:weierstrass_nowhere_differentiable_function}\mcite\cite[\textnumero 271]{Фихтенгольц1968Том2}
  ...
  \begin{figure}
    \centering
    \includegraphics{figures/ex__weierstrass_nowhere_differentiable_function__plot.pdf}
    \Caption{ex:weierstrass_nowhere_differentiable_function/plot}{Plot of the third partial sum of the Weierstrass function with \( a = 0.9 \) and \( b = 7 \) from \( -\sfrac \pi 8 \) to \( \sfrac \pi 8 \).}
  \end{figure}
