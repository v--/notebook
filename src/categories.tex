...
\begin{definition}\label{def:standard_categories}
  \begin{defenum}
    ...
    \item\label{def:standard_categories/ord} Given a partially ordered set $(X, \leq)$\Tinyref{def:orders}, we can form the category $\Bold{C}$ by defining
    \begin{itemize}
...
\begin{definition}\label{def:categorical_subject}\cite{MacLane1994}[122]
