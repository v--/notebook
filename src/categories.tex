...
\begin{proposition}\label{thm:def:morphism_invertibility/properties}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:def:morphism_invertibility/properties/monomorphism_and_epimorphism} A left inverse of any morphism is right-cancellative and a right inverse is left-cancellative.
...
\begin{proof}
  ...
  \SubProofOf{thm:def:morphism_invertibility/properties/monomorphism_and_epimorphism} Suppose that \( g: Y \to X \) is a left inverse of \( f: X \to Y \) and let
  \begin{equation*}
  ...
  From \fullref{thm:def:morphism_invertibility/properties/monomorphism_and_epimorphism} it follows that \( f \) is left-cancellative. Since we have
  \begin{equation*}
    \id_Y \bincirc f
    =
    (f \bincirc g) \bincirc f,
