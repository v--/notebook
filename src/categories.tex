...
\begin{remark}\label{remark:category_obj_hom}
  ...
  Some authors, e.g. \cite{MacLane1994} or \cite{Aluffi2009}, use notations such as \( \operatorname{hom}_{\Bold C}(A, B) \) to denote the class of morphisms between the objects \( A, B \in \Bold C \). We use this notation when dealing with algebraic structures, e.g. vector spaces (see \fullref{thm:linear_map_iff_function_on_basis}).
