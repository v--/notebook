...
\begin{proposition}\label{thm:category_of_small_sets_properites}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:category_of_small_sets_properites/limits} The \hyperref[def:discrete_category_limits]{products} and \hyperref[def:discrete_category_limits]{coproducts} are the \hyperref[def:tuple_and_cartesian_product/product]{Cartesian products} and the \hyperref[def:disjoint_union]{disjoint unions}, respectively.
...
\begin{proposition}\label{thm:categorical_principle_of_duality}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:categorical_principle_of_duality/universal_objects} \Fullref{thm:universal_object_duality}: An object is \hyperref[def:universal_object/initial]{initial} if and only if it is a \hyperref[def:universal_object/terminal]{terminal object} the \hyperref[def:dual_category]{dual category}.
