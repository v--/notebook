...
\begin{definition}\label{def:category}\MarginCite[def. 1.1.1]{Leinster2014}
  A category is a generalization of the class of a preordered \hyperref[def:preordered_set]{set} (see \fullref{thm:preorder_category_correspondence}). In particular, the \hyperref[def:subset]{subset} relation in the class of all \hyperref[def:set_zfc]{sets} is a preorder (see \fullref{def:category_of_sets}).
...
\begin{definition}\label{def:discrete_category}\MarginCite[ex. 1.1.18(b]{Leinster2014})
