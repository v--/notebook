...
\begin{proposition}\label{thm:aleph_zero_is_strong_limit}
...
\end{proposition}
\begin{proof}
  Since ordinal exponentiation extends natural number exponentiation, we can conclude that \( 2^n < \aleph_0 \) for any \( n < \aleph_0 \).
\end{proof}
