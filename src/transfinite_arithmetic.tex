...
\begin{corollary}\label{thm:cantor_power_set_theorem_exponentiation}
  For any cardinal \( \kappa \) we have \( \kappa < 2^\kappa \).
\end{corollary}
\begin{proof}
  Follows from \fullref{thm:cantor_power_set_theorem} and \fullref{thm:cardinal_exponentiation_power_set}.
\end{proof}
...
\begin{conjecture}[Generalized continuum hypothesis]\label{hyp:generalized_continuum_hypothesis}
  ...
  For the definition and the properties of the \( \aleph \) hierarchy, see \fullref{def:aleph_hierarchy}.
