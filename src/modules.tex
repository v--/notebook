...
\begin{proof}
  ...
  \SubProofOf{thm:def:hamel_basis/expansion} Let \( a_1, \ldots, a_n \) be a basis of \( N \) and let \( b_1, \ldots, b_m \) be a basis of \( M \). Then \( \set{ a_1, \ldots, a_n, b_1, \ldots, b_m } \) is necessarily a linearly dependent set. Hence, \( b_m \) is a linear combination of the others, and
  \begin{equation*}
