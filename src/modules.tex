...
\begin{definition}\label{def:left_module}
  ...
  \begin{DefEnum}
    ...
    \ILabel{def:left_module/multiplication}\cite[374]{Knapp2016BAlg} an \hyperref[def:magma/associative]{associative} and \hyperref[def:unital_magma]{unital} \hyperref[rem:left_monoid_actions_as_algebraic_structures]{operation} \( \cdot: R \times M \to M \), written using juxtaposition.
