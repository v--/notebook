...
\begin{definition}\label{def:linear_dependence}\mimprovised
  ...
  \begin{thmenum}
    \thmitem{def:linear_dependence/direct} A \hyperref[rem:linear_combinations]{linear combination} in \( B \) sums to zero if and only if it is \hyperref[def:free_semimodule]{trivial}.
