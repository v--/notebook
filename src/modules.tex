...
\begin{definition}\label{def:abelian_group_z_module}\mcite[375]{Knapp2016BAlg}
...
\begin{proposition}\label{thm:abelian_group_iff_z_module}\mcite[375]{Knapp2016BAlg}
...
\begin{definition}\label{def:free_left_module}\mcite[377]{Knapp2016BAlg}
...
\begin{definition}\label{def:left_module_tensor_product}\mcite[574]{Knapp2016BAlg}
...
\begin{theorem}\label{thm:tensor_product_universal_property}\mcite[thm. 10.18]{Knapp2016BAlg}
...
\begin{proposition}\label{thm:tensor_product_with_underlying_ring}\mcite[677]{Knapp2016BAlg}
...
\begin{definition}\label{def:algebra_over_ring}\mcite[408]{Knapp2016BAlg}
...
\begin{definition}\label{def:left_module_annihilator}\mcite[30]{Коцев2016}
