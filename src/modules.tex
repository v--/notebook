...
\begin{definition}\label{def:left_module}
  ...
  \begin{DefEnum}
    ...
    \ILabel{def:left_module/multiplication}\cite[374]{Knapp2016BAlg} an \hyperref[def:magma/associative]{associative} and \hyperref[def:unital_magma]{unital} \hyperref[def:left_monoid_action/operation]{operation} \( \cdot: R \times M \to M \), written using juxtaposition.
...
\begin{proposition}\label{thm:left_module_properties}
  ...
  \begin{PropEnum}
    \ILabel{thm:left_module_properties/ring_zero_is_absorbing} Multiplication by \( 0_R \) is \Def{absorbing}, that is, \( 0_R x = 0_M \) for any \( x \in M \).
