...
\begin{proposition}\label{def:module_properties}
  ...
  \begin{defenum}
    \item\label{def:module_properties/zero_absorbing} Multiplication by $0_R$ is \uline{absorbing}\Tinyref{def:group/absorbing_element}, that is, $0_R \cdot u = 0_M$ for any $u \in M$.
  \end{defenum}
\end{proposition}
\begin{proof}\mbox{}
  \begin{itemize}
