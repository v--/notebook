...
\end{definition}
\begin{proof}
  \SubProofImplies{def:left_module/homomorphism}{def:left_module/multiplication} Let \( \tau: R \to \End(M) \) be a ring homomorphism. Define the operation
  \begin{align*}
     & \cdot: R \times M \to M           \\
  ...
  \SubProofImplies{def:left_module/multiplication}{def:left_module/homomorphism} Let \( \cdot: R \times M \to M \) be a left scalar multiplication operation. We define
  \begin{align*}
     & \tau: R \to \End(M)                      \\
