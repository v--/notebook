...
\begin{definition}\label{def:free_left_module}[32]\cite[377]{Knapp2016BAlg}
  ...
  The cardinality of the basis of a free left module \( M \) is called the \Def{rank} \( \Rank M \) of \( M \). \Cref{thm:left_module_basis_cardinality} tells us that this rank is unique for commutative unital rings.
\end{definition}
