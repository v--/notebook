...
\begin{proposition}\label{thm:nowhere_dense_properties}
  ...
  \begin{propenum}
    ...
    \DItem{thm:nowhere_dense_properties/closure_contains_open_set} The set is nowhere dense if and only if its closure does not contain a nonempty open set.
