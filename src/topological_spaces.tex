...
\begin{definition}\label{def:topological_space}\MarginCite[11]{Engelking1989}
  Let \( X \) be any set and \( \mscrT \subseteq \Pow(X) \) be a family of subsets of \( X \). \( \mscrT \) is called a \Def{topology} on \( X \) and the tuple \( (X, \mscrT) \) is said to be a \Def{topological space} if the following axioms are satisfied:
  \begin{DefEnum}
  ...
  Elements of the set \( X \) are called \Def{points} of the topological space, elements of \( \mscrT \) are called \Def{open sets} and set-theoretic complements of open sets are called \Def{closed sets}.

  If \( x \in U \in \mscrT \), we say that \( U \) is a \Def{neighborhood} of \( x \). Note that some authors (e.g. \cite[38]{Kelley1955}) alternatively define neighborhoods as arbitrary sets that contain an open set that contains \( x \). For simplicity, we define the subfamily
  \begin{equation*}
...
\begin{definition}\label{def:standard_topologies}
  ...
  \begin{DefEnum}
    \ILabel{def:standard_topologies/discrete} The \Def{discrete topology} \( \mscrT \coloneqq \Pow(X) \).
    \ILabel{def:standard_topologies/indiscrete} The \Def{indiscrete topology} \( \mscrT \coloneqq \{ \varnothing, X \} \).
    \ILabel{def:standard_topologies/co_cardinal} For any \hyperref[def:cardinal]{cardinal} \( \xi \), the \Def{co-\( \xi \) topology} \( \mscrT \coloneqq \{ A \subseteq X \colon \Card A < \xi \} \) and, in particular, \Def{cofinite} (\( \xi = \aleph_0 \)) and \Def{cocountable} (\( \xi = c \)) topologies.
  \end{DefEnum}
...
\begin{definition}\label{def:topological_base}\MarginCite[12]{Engelking1989}
  Fix a topological space \( (X, \mscrT) \). We say that the family \( \mscrB \subseteq \mscrT \) is a \Def{base} for the topology \( \mscrT \) if \( \mscrB \) satisfies any of the equivalent conditions:
  \begin{DefEnum}
...
\begin{definition}\label{def:topological_space_weight}
  We define the \Def{weight} of \( (X, \mscrT) \) as the cardinal
  \begin{equation*}
...
\begin{definition}\label{def:topological_subbase}\MarginCite[12]{Engelking1989}
  Fix a topological space \( (X, \mscrT) \). We say that the family \( \mscrP \subseteq \mscrT \) is a \Def{subbase} for the topology \( \mscrT \) if the family
  \begin{equation*}
...
\begin{definition}\label{def:topological_local_base}\MarginCite[12]{Engelking1989}
  Fix a topological space \( (X, \mscrT) \) and a point \( x \in X \). We say that the family \( \mscrB(x) \subseteq \mscrT \) is a \Def{local base} for \( \mscrT \) at \( x \) if every neighborhood of \( x \) contains a set from \( \mscrB(x) \).

  Given a base \( \mscrB \), unless explicitly noted, we consider the subfamily \( \mscrB(x) \) of all members of \( \mscrB \) containing \( x \).

  The indexed family of local bases \( \{ \mscrB(x) \colon x \in X \} \) is called a \Def{neighborhood system} of \( \mscrT \).
\end{definition}
...
\begin{definition}\label{def:topological_space_character}
  ...
  We define the \Def{character} of of \( (X, \mscrT) \) as
  \begin{equation*}
...
\begin{definition}\label{def:topological_local_subbase}
  Combining \fullref{def:topological_subbase} and \fullref{def:topological_local_base}, we define a \Def{local subbase} for \( \mscrT \) at \( x \) to be a family \( \mscrP(x) \subseteq \mscrT \) such that every neighborhood \( U \) of \( x \) contains a finite intersection of sets from \( \mscrP(x) \).
...
\begin{definition}\label{def:closure_operator}\MarginCite[33]{Engelking1989}
  Let \( (X, \mscrT) \) be a topological space. Define the \Def{closure operator}
...
\begin{definition}\label{def:interior_operator}\MarginCite[15]{Engelking1989}
  Let \( (X, \mscrT) \) be a topological space. Define the \Def{interior operator}
  \begin{BreakableAlign*}
     & \Int: \Pow(X) \to \Pow(X)                                     \\
...
\begin{definition}\label{def:topological_boundary}
  For a subset \( A \) of a topological space we define its \Def{boundary} \( \Fr(A) \) equivalently as
  \begin{DefEnum}
    \ILabel{def:topological_boundary/closure} \( \Fr(A) \coloneqq \Cl(A) \setminus \Int(A) \)
...
\begin{definition}\label{def:topological_derived_set}\MarginCite[24]{Engelking1989}
  ...
  \begin{DefEnum}
    ...
    \ILabel{def:topological_derived_set/derived_set} The set of all cluster points of \( A \) is called the \Def{derived set} of \( A \) and is denoted by \( \Derived(A) \).

    \ILabel{def:topological_derived_set/perfect_set} If a set equals its derived set, we call it a \Def{perfect set}.

    \ILabel{def:topological_derived_set/isolated_point} Points in \( A \setminus \Derived(A) \) are said to be \Def{isolated points} of \( A \).

    \ILabel{def:topological_derived_set/discrete_set} If \( \Derived(A) = \varnothing \), that is, if \( A \) consists of only discrete points, we say that \( A \) is a \Def{discrete set}.
  \end{DefEnum}
\end{definition}
...
\begin{definition}\label{def:topologically_dense_set}\MarginCite[25]{Engelking1989}
  ...
  \begin{DefEnum}
    ...
    \ILabel{def:topologically_dense_set/dense_in_itself} \Def{dense in itself} if \( A \subseteq \Derived(A) \), i.e. if \( A \) has no isolated points.
  \end{DefEnum}
