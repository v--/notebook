...
\begin{definition}\label{def:topologically_dense_set}\cite[25]{Engelking1989}
  ...
  We define the \ul{density $d(X)$ of $X$} to be the minimum cardinality\Tinyref{def:cardinal} of all dense sets. If $d(X) \leq \aleph_0$, we say that the space is separable.
\end{definition}
