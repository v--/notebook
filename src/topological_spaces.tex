...
\begin{definition}\label{def:topological_space}\cite[11]{Engelking1989}
  ...
  If \( x \in U \in \Cal{T} \), we say that \( U \) is a \Def{neighborhood of \( x \)}. Note that some authors (e.g.~\cite[38]{Kelley1955}) alternatively define neighborhoods as arbitrary sets that contain an open set that contains \( x \).
