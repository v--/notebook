...
\begin{proposition}\label{thm:interior_operator_properties}
  ...
  \begin{thmenum}
    ...
    \DItem{thm:interior_operator_properties/neighborhoods} A set \( A \) is a topological space is open if and only if every point \( x \in A \) has a neighborhood \( U \) such that \( U \subseteq A \).
  \end{thmenum}
\end{proposition}
...
\begin{definition}\label{def:topological_boundary}\cite[24]{Engelking1989}
  For a subset \( A \) of a topological space we define the \Def{boundary}
  \begin{equation*}
...
\begin{proposition}\label{thm:topological_boundary_properties}
  ...
  \begin{thmenum}
    ...
    \DItem{thm:topological_boundary_properties/neighborhoods} If \( x \in \partial A \), every neighborhood of \( x \) contains points from both \( A \) and \( X \setminus A \).
  \end{thmenum}
\end{proposition}
