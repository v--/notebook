...
draw_edge((2, 0), (3, 0), is_arc=true);

draw_vertex((3, 0), L=Label('$3$', align=2S));
draw_edge((3, 0), (3.9, 0), is_arc=true);

label((4, 0), '$\ldots$');
draw_edge((4.1, 0), (5, 0), is_arc=true);

draw_vertex((5, 0), L=Label('$n - 1$', align=2S));
draw_edge((5, 0), (6, 0), is_arc=true);

draw_vertex((6, 0), L=Label('$\phantom{1} n \phantom{1}$', align=2S));
draw_edge((6, 0), (7, 0), is_arc=true);

draw_vertex((7, 0), L=Label('$n + 1$', align=2S));
draw_edge((7, 0), (7.9, 0), is_arc=true);
