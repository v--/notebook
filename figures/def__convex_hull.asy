...
pen affine_hull = yellow + opacity(0.4);
pen conic_hull = blue + opacity(0.3);
pen conic_hull_border = darkblue + opacity(0.3);
pen convex_hull = green + opacity(0.2);
pen convex_hull_border = darkgreen + opacity(0.2);
...
draw(surface(O -- 1.5A -- 1.5B -- cycle), conic_hull);
draw(surface(O -- 1.5A -- 1.5C -- cycle), conic_hull);
draw(surface(O -- 1.5B -- 1.5C -- cycle), conic_hull);
