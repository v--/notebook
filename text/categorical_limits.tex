...
\begin{definition}\label{def:comma_category}\mcite[46]{MacLane1998Categories}
...
\begin{definition}\label{def:direct_and_inverse_limits}
  ...
  \begin{thmenum}
    \thmitem{def:direct_and_inverse_limits/direct}\mcite[example 5.2.15]{Leinster2014BasicCategories} Consider the category \hyperref[thm:order_category_isomorphism]{induced} by the positive integers
    ...
    \thmitem{def:direct_and_inverse_limits/inverse}\mcite[example 5.1.21(d)]{Leinster2014BasicCategories} Now consider the opposite category
...
\begin{definition}\label{def:equalizers}\mcite[def. 5.1.11]{Leinster2014BasicCategories}
...
\begin{definition}\label{def:compete_category}\mcite[109]{MacLane1998Categories}
