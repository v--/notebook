...
\begin{comments}
  ...
  \item In connection with \cref{thm:equalizer_invertibility}, we have interchanged the notation for the projections and inclusions compared to \cref{def:discrete_category_limits} --- \( (L, \iota) \) is a \hi{limit}, while \( (L, \pi) \) is a \hi{colimit}.
\end{comments}
