...
\begin{definition}\label{def:group_action}
  ...
  A \term{left group action} or simply \term[bg=действие (на група) (\cite[def. IV.18]{ГеновМиховскиМоллов1991Алгебра}), ru=действие (группы) (\cite[def. 10.3.1]{Винберг2014КурсАлгебры})]{group action} of \( G \) on \( X \) can be defined equivalently as:
  \begin{thmenum}
