...
\begin{definition}\label{def:endomorphism_monoid}\mimprovised
  ...
  Outside of \hyperref[ch:category_theory]{category theory}, whenever the category \( \cat{C} \) is clear from the context, we call \( \cat{C}(X) \) the \term[ru=полугруппа эндоморфизмов (\cite[127]{Курош1973ОбщаяАлгебра}), en=endomorphism monoid (\cite[60]{Jacobson1985BasicAlgebraI})]{endomorphism monoid} over \( X \) and denote it by \( \End_{\cat{C}}(X) \).
\end{definition}
\begin{comments}
  \item \Textcite[127]{Курош1973ОбщаяАлгебра} and \textcite[41]{Ляпин1960Полугруппы} define endomorphism monoids for homomorphisms of models of \hyperref[def:fol_equational_theory]{equational theories}, \textcite[60]{Jacobson1985BasicAlgebraI} defines endomorphism monoids for \hyperref[def:monoid/morphism]{monoid homomorphisms} and \textcite[515]{Grätzer2011LatticeTheory} defines them for \hyperref[def:lattice/homomorphism]{lattice homomorphisms}. We generalize all.
\end{comments}
