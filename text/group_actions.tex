...
\begin{example}\label{ex:def:group_action_orbit}
  ...
  \begin{thmenum}
    ...
    \thmitem{ex:def:group_action_orbit/collatz} The study of the \cref{hyp:collatz_conjecture} can be rephrased in terms of orbits --- see \cref{hyp:collatz_conjecture_equivalences/orbit}.
  \end{thmenum}
\end{example}
