...
\end{definition}
\begin{comments}
  \item Some authors, for example Saunders Mac Lane in \cite[253]{MacLane1998} and Anthony Knapp in \cite[121]{Knapp2016BasicAlgebra}, call \( S_n \) the \enquote{symmetric group on \( n \) letters}.
...
\end{proposition}
\begin{comments}
  \item Some authors like Anthony Knapp in \cite[15]{Knapp2016BasicAlgebra} and Evgeny Tyrtyshnikov in \cite[sec. 4.3]{Тыртышников2007} define cycles as permutations satisfying \cref{eq:thm:def:cyclic_permutation/cycle}.
\end{comments}
\begin{proof}
