...
\end{definition}
\begin{comments}
  \item \incite[515]{Gratzer2011} defines endomorphism monoids for \hyperref[def:lattice]{lattices}. We simply generalize his definition.
\end{comments}
...
\begin{definition}\label{def:automorphism_group}\mcite[example 4.6]{Aluffi2009}
...
\begin{definition}\label{def:group_action}
  ...
  \begin{thmenum}
    \thmitem{def:group_action/homomorphism}\mcite[subsec. II.9.1]{Aluffi2009} A \hyperref[def:group/homomorphism]{group homomorphism} from \( G \) to the \hyperref[def:automorphism_group]{automorphism group} \( \aut(X) \).
