...
\end{definition}
\begin{comments}
  \item \incite[127]{Курош1973ОбщаяАлгебра} and \incite[41]{Ляпин1960Полугруппы} define endomorphism monoids for homomorphisms of models of \hyperref[def:fol_equational_theory]{equational theories}, \incite[60]{Jacobson1985BasicAlgebraI} defines endomorphism monoids for \hyperref[def:monoid/morphism]{monoid homomorphisms} and \incite[515]{Grätzer2011LatticeTheory} defines them for \hyperref[def:lattice/homomorphism]{lattice homomorphisms}. We generalize all.
\end{comments}
