...
\begin{definition}\label{def:cayley_table}\mcite[150]{Rotman2015AlgebraVol1}
  The \term[ru=таблица умножения (\cite[135]{Шафаревич1999Алгебра})]{multiplication table} or \term[ru=таблица Кэли (\cite[135]{Шафаревич1999Алгебра}), en=Cayley table (\cite[5]{Gratzer2008UniversalAlgebra})]{Cayley table} for a finite \hyperref[def:semigroup]{(semi)group} \( G = \set{ a_1, \ldots, a_n } \), is an \( n \times n \) matrix whose \( (i, j) \)-th entry is \( a_i a_j \).
