...
\end{definition}
\begin{comments}
  \item The term \enquote{Euclidean space} arose as a generalization of the three-dimensional space discussed in \cite{Euclids2008Elements}; thus, its definition varies in the literature --- see \fullref{rem:euclidean_space_etymology}.
\end{comments}
