...
\begin{definition}\label{def:locally_connected_space}\mcite[exer. 6.3.3]{Engelking1989}
...
\begin{definition}\label{def:path_connected_space}\mcite[exer. 6.3.9]{Engelking1989}
...
\begin{definition}\label{def:locally_path_connected_space}\mcite[exer. 6.3.10]{Engelking1989}
