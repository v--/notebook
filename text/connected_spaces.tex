...
\begin{definition}\label{def:connected_space}\mcite[thm. 6.1.1]{Engelking1989GeneralTopology}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:connected_space/boundary} The \hyperref[def:topological_boundary_operator]{boundary} of any nonempty proper subset is nonempty.
  \end{thmenum}
\end{definition}
\begin{comments}
  \item Connected spaces are the basis of Aristotelian continuous variables; see \fullref{con:discrete_and_continuous_variables}.
\end{comments}

\begin{definition}\label{def:locally_connected_space}\mcite[exerc. 6.3.3]{Engelking1989GeneralTopology}
...
\begin{definition}\label{def:path_connected_space}\mcite[exerc. 6.3.9]{Engelking1989GeneralTopology}
...
\begin{definition}\label{def:locally_path_connected_space}\mcite[exerc. 6.3.10]{Engelking1989GeneralTopology}
