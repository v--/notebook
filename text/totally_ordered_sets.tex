...
\end{comments}
\begin{proof}
  We have already shown in \fullref{thm:total_lexicographic_order_is_total_order} and these total orders. It only remains to check the \hyperref[def:chain_conditions]{descending chain condition}.
