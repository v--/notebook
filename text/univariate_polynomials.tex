...
\begin{comments}
  ...
  \item The equivalence between \( (X - u) \) dividing \( p(X) \) and \( p(u) \) being zero is called the \enquote{factor theorem} by \incite[corr. 1.13]{Knapp2016BasicAlgebra}.
\end{comments}
\begin{defproof}
  ...
  Let \( \Phi_u: R[X] \to R \) be the \hyperref[con:evaluation_homomorphism]{evaluation homomorphism} at \( u \). Then
  \begin{equation*}
