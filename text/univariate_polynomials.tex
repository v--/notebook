...
Polynomials are not functions in general, and the exact relationship between polynomials and polynomial functions is discussed in \fullref{thm:polynomial_algebra_universal_property} and \cref{thm:functions_over_finite_fields}.
...
\end{algorithm}
\begin{comments}
  \item This algorithm can be found as \identifier{math.polynomials.univariate.euclidean_divmod} in \cite{notebook:code}.
\end{comments}
\begin{defproof}
