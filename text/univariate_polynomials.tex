...
\begin{definition}\label{def:monic_polynomial}
  We say that the nonzero univariate polynomial \( p(X) \) is \term[bg=унитарен (\cite[page 1 in \textparagraph 14]{НеновБожилов2007}), ru=унитарный (\cite[def. 9.10]{ГлуховЕлизаровНечаев2015})]{monic} if its leading coefficient is \( 1 \).
\end{definition}
...
\begin{definition}\label{def:polynomial_root}
  ...
  We say that the value \( u \in R \) is a \term[bg=корен (\cite[page 2 in \textparagraph 20]{НеновБожилов2007}), ru=корень (\cite[def. 9.3]{ГлуховЕлизаровНечаев2015})]{root} of multiplicity \( m \) for the univariate polynomial \( p(X) \in R[X] \) of degree \( n \geq m \) if any of the following equivalent conditions hold:
  \begin{thmenum}
    \thmitem{def:polynomial_root/division}\mcite[def. 9.6]{ГлуховЕлизаровНечаев2015} The polynomial \( (X - u)^m \) divides \( p(X) \).
