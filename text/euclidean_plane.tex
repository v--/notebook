...
\begin{definition}\label{def:angle}\mimprovised
  ...
  \begin{thmenum}
    ...
    \begin{thmenum}
      ...
      \thmitem{def:angle/measure/acute}\mcite[\textnumero 16]{Saul2008Hadamard} \term[bg=остър (\cite[9]{Гюзелев1873}), ru=острый (\cite[\textnumero 22]{Киселёв2009})]{acute} if \( 0 < \varphi < \pi / 2 \),
      ...
      \thmitem{def:angle/measure/obtuse}\mcite[\textnumero 16]{Saul2008Hadamard} \term[bg=тъп (\cite[9]{Гюзелев1873}), ru=тупой (\cite[\textnumero 22]{Киселёв2009})]{obtuse} if \( \pi / 2 < \varphi < \pi \),
