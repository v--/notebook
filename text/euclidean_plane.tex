...
\begin{definition}\label{def:plane_line_equations}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:plane_line_equations/general}\mcite[example 2.4]{ВеселовТроицкий2002Лекции} The image of the scalar equations \eqref{eq:def:plane_line_equations/scalar_parametric} consists of all pairs \( (x, y) \) such that
...
\begin{proposition}\label{thm:adjacent_angles}
  ...
  \begin{figure}[!ht]
    \centering
    \includegraphics[align=c]{output/thm__adjacent_angles}
...
\begin{proposition}\label{thm:angles_of_crossing}
  ...
  \begin{figure}[!ht]
    \centering
    \includegraphics[align=c]{output/thm__angles_of_crossing}
...
\begin{proposition}\label{thm:angles_of_transversal}
  ...
  \begin{figure}[!ht]
    \centering
    \includegraphics[align=c]{output/thm__angles_of_transversal}
