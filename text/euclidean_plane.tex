...
\begin{proof}
  ...
  \begin{equation*}
    \begin{pNiceMatrix} x \\ y \end{pNiceMatrix} = A \begin{pNiceMatrix} 1 \\ 0 \end{pNiceMatrix} = B \begin{pNiceMatrix} 1 \\ 0 \end{pNiceMatrix}.
  \end{equation*}

  Rotation matrices have the form \eqref{eq:thm:plane_rotation_matrix}, and in this case
  \begin{equation*}
    A = B = \begin{pNiceMatrix}
      x & -y \\
      y & x
    \end{pNiceMatrix}.
  \end{equation*}
...
\begin{proof}
  ...
  \begin{equation*}
    S^{-1} e
    =
    S^{-1} S \begin{pNiceMatrix} 1 \\ 0 \end{pNiceMatrix}
    =
    R^{-1} R \begin{pNiceMatrix} 1 \\ 0 \end{pNiceMatrix}
    =
    R^{-1} d.
  \end{equation*}
...
\begin{definition}\label{def:angle}\mimprovised
  ...
  \begin{thmenum}
    ...
    \begin{thmenum}
      ...
      \thmitem{def:angle/measure/acute}\mcite[\S 16]{Saul2008Hadamard} \term[bg=остър (\cite[9]{Гюзелев1873}), ru=острый (\cite[\S 22]{Киселёв2009})]{acute} if \( 0 < \varphi < \pi / 2 \),

      \medspace

      \thmitem{def:angle/measure/right} \term[bg=прав (\cite[9]{Гюзелев1873}), ru=прямой (\cite[\S 22]{Киселёв2009})]{right} if \( \varphi = \tfrac \pi 2 \),

      \medspace

      \thmitem{def:angle/measure/obtuse}\mcite[\S 16]{Saul2008Hadamard} \term[bg=тъп (\cite[9]{Гюзелев1873}), ru=тупой (\cite[\S 22]{Киселёв2009})]{obtuse} if \( \pi / 2 < \varphi < \pi \),

      \medspace

      \thmitem{def:angle/measure/straight}\mcite[\S 15]{Saul2008Hadamard} \term{straight} if \( \varphi = \pi \), in which case the angle is actually a line,
...
\begin{definition}\label{def:adjacent_angles}\mcite[\S 10]{Saul2008Hadamard}
  We say that two \hyperref[def:angle]{undirected angles} with a common vertex are \term[bg=съседен (\cite[\S 5]{Гюзелев1873}), ru=смежный (\cite[\S 22]{Киселёв2009})]{adjacent} if they have a common side and if their other sides lie on different \hyperref[def:half_space]{half-planes} with respect to (the line containing) their common side.
...
\begin{definition}\label{def:sum_of_angles}
  Fix three rays \( p \), \( r \) and \( s \) with a common vertex \( O \). We call the (directed) angle \( \angle(r, s) \) the \term[bg=сума (\cite[8]{Гюзелев1873}), ru=сумма (\cite[\S 15]{Киселёв2009})]{sum} of \( \angle(r, p) \) and \( \angle(p, s) \).
...
\begin{definition}\label{def:vertical_angles}\mcite[\S 12]{Saul2008Hadamard}
  ...
  We say that \( \angle(\vect{OP}, \vect{OQ}) \) and \( \angle(\vect{OP'}, \vect{OQ'}) \) are a pair of \term[bg=вертикални/срещуположни ъгли (\cite[\S 7]{Гюзелев1873}), ru=вертикальные углы (\cite[\S 26]{Киселёв2009})]{vertical angles}, and similarly for \( \angle(\vect{OP}, \vect{OQ'}) \) and \( \angle(\vect{OP'}, \vect{OQ}) \).
\end{definition}
...
\begin{definition}\label{def:angles_of_transversal}\mcite[\S 37]{Saul2008Hadamard}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:angles_of_transversal/alternate} We say that two \hi{non-\hyperref[def:adjacent_angles]{adjacent}} angles are \term[bg={кръстни, кръстосани (\cite[\S 28]{Гюзелев1873})}, ru=накрестлежащие (\cite[\S 72]{Киселёв2009})]{alternate} if they lie in different half-planes with respect to \( l \) and are both either interior or exterior.
    ...
    \thmitem{def:angles_of_transversal/corresponding} We say that two \hi{non-\hyperref[def:adjacent_angles]{adjacent}} angles are \term[bg=съответни (\cite[\S 28]{Гюзелев1873}), ru=соответственные (\cite[\S 72]{Киселёв2009})]{corresponding} if they lie in different in the same half-plane with respect to \( l \) and one of them is internal, while the other is external.
