...
\begin{concept}\label{con:functional}
  ...
  \begin{itemize}
    ...
    This terminology can be found, for example, in \cite[50]{Knapp2016BasicAlgebra} and \cite[sec. 26.1]{Тыртышников2007ЛинАлгебра}.
    ...
    The former terminology can be found, for example, in \cite[def. 3.1]{Rudin1991Functional} and \cite[sec. 1.3]{Clarke2013OptimalControl}.
