...
\begin{theorem}[Downward L\"owenheim-Skolem theorem]\label{thm:downward_lowenheim_skolem}\mcite[thm. 2.3.34]{Hinman2005Logic}
...
\end{theorem}
\begin{comments}
  \item This theorem is closely related to \fullref{thm:upward_lowenheim_skolem}.
\end{comments}
\begin{proof}
...
\begin{theorem}[Upward L\"owenheim-Skolem theorem]\label{thm:upward_lowenheim_skolem}\mcite[thm. 2.4.22]{Hinman2005Logic}
  The following dual of \fullref{thm:downward_lowenheim_skolem} holds: whenever \( \mu > \kappa \geq \aleph_0 \) and \( \Sigma \) has at most \( \kappa \) symbols, every structure over \( \Sigma \) of cardinality \( \kappa \) has an \hyperref[def:elementary_embedding]{elementary extension} of cardinality \( \mu \).
\end{theorem}
\begin{proof}
