...
\begin{example}\label{ex:def:category_adjunction}
  ...
  \begin{thmenum}
    ...
    \thmitem{ex:def:category_adjunction/dm_cat} The left adjoint of the forgetful functor \( U \) from \( \cat{Cat} \) to the \hyperref[def:directed_multigraph/category]{category of directed multigraphs}, which we will denote by \( \cat{DMGph} \) is the free category functor defined in \cref{def:directed_multigraph_free_category}. We denote this functor by \( F \).
