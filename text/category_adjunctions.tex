...
\begin{concept}\label{con:univalence_principle}
  ...
  \incite[266]{Bourbaki2004TheoryOfSets}, when trying to formalize a general notion of mathematical structure, classify structures into \enquote{species} and call a species \enquote{univalent} if any two of its structures are isomorphic.
  ...
  \begin{displayquote}
    \textellipsis which provides a natural way to assert that \enquote{two homotopy equivalent types are equal}.
  \end{displayquote}
