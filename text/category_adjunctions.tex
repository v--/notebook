...
\begin{remark}\label{rem:category_adjunctions_category_order}
  \hyperref[def:category_adjunction]{Adjunctions} (and also \hyperref[def:category_equivalence]{equivalences}) of categories involve a pair of opposite functors.
