...
\begin{example}\label{ex:def:category_adjunction}
  ...
  \begin{thmenum}
    ...
    Indeed, fix a small category \( \cat{C} \) and a set \( A \). From our discussion in \cref{ex:set_discr_cat_isomorphism} it is obvious that the restriction
    \begin{equation*}
