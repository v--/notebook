...
\begin{proof}
  ...
  \SubProofOf{thm:simple_algebraic_type_arithmetic/addition_associative} Associativity is a little more complicated but analogous to \fullref{thm:simple_algebraic_type_arithmetic/addition_commutative}.
