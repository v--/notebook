...
\begin{proposition}\label{thm:simple_algebraic_type_arithmetic}
  ...
  \begin{thmenum}[resume=thm:simple_algebraic_type_arithmetic]
    ...
    \thmitem{thm:simple_algebraic_type_arithmetic/addition_neutral} \( \syn\Bbbzero \) acts as a \hyperref[def:semiring_neutral_element]{neutral element} of addition (and thus satisfies the bounded lattice axiom \eqref{eq:def:bounded_lattice/theory/top}):
