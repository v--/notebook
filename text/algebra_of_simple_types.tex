...
\begin{proposition}\label{thm:simple_algebraic_type_arithmetic}
  ...
  In the corresponding \hyperref[def:lattice_as_semiring]{join-meet semiring} they act as addition and multiplication, with zero element \( {\syn\Bbbzero} \) and unity element \( {\syn\Bbbone} \).
  ...
  \begin{thmenum}[resume=thm:simple_algebraic_type_arithmetic]
    ...
    \thmitem{thm:simple_algebraic_type_arithmetic/addition_neutral} \( \syn\Bbbzero \) acts as a \hyperref[def:semigroup_neutral_element]{neutral element} of addition (and thus satisfies the bounded lattice axiom \eqref{eq:def:bounded_lattice/theory/top}):
  ...
  \begin{thmenum}[resume=thm:simple_algebraic_type_arithmetic]
    ...
    \thmitem{thm:simple_algebraic_type_arithmetic/multiplication_absorbs} The operations satisfy the absorption law \eqref{eq:def:lattice/theory/absorption/meet}:
    \begin{equation}\label{eq:thm:simple_algebraic_type_arithmetic/multiplication_absorbs}
      \tau \syntimes (\tau \synplus \sigma) \sim \tau
    \end{equation}

    \thmitem{thm:simple_algebraic_type_arithmetic/addition_absorbs} The operations satisfy the absorption law \eqref{eq:def:lattice/theory/absorption/join}:
