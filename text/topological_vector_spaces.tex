...
\begin{definition}\label{def:category_of_topological_vector_spaces}
  The category \( \cat{TopVect}_{\BbbK} \) of topological vector spaces over \( \BbbK \) is a subcategory of both \( \cat{Top} \) and \( \cat{Vect}_K \). Its morphisms are the \hyperref[def:global_continuity]{continuous} linear \hyperref[def:semimodule/morphism]{maps}.
\end{definition}
...
\begin{definition}\label{def:sublinear_functional}
  ...
  Compare this definition to \cref{def:semimodule/morphism}.
\end{definition}
