...
\begin{comments}
  ...
  \item If \eqref{eq:thm:minimal_propositional_negation_laws/efq} does not hold, we say that a derivation system is \term{paraconsistent} instead --- see \cite{StanfordPlato:paraconsistent_logic}.
\end{comments}
