...
\end{theorem}
\begin{comments}
  \item Within \hyperref[def:zfc]{\logic{ZF}}, this theorem is equivalent to the \hyperref[def:zfc/choice]{axiom of choice} --- see \cref{thm:axiom_of_choice_equivalences/selection}.
\end{comments}
\begin{proof}
...
\end{theorem}
\begin{comments}
  \item Within \hyperref[def:zfc]{\logic{ZF}}, this theorem is equivalent to the \hyperref[def:zfc/choice]{axiom of choice} --- see \cref{thm:axiom_of_choice_equivalences/surjective}.
\end{comments}
\begin{proof}
...
\begin{proposition}\label{thm:function_invertibility_categorical}
  ...
  \begin{thmenum}
    \thmitem{thm:function_invertibility_categorical/empty} An \hyperref[def:set_valued_map/empty]{empty function} is always \hyperref[def:function_invertibility/injective]{injective} and \hyperref[def:morphism_invertibility/left_cancellative]{left-cancellative}, however only if its codomain is empty is it \hyperref[def:morphism_invertibility/left_invertible]{left-invertible}, \hyperref[def:function_invertibility/surjective]{surjective}, \hyperref[def:morphism_invertibility/right_cancellative]{right-cancellative} and \hyperref[def:morphism_invertibility/right_invertible]{right-invertible}.
...
\begin{proof}
  ...
  \begin{itemize}
    ...
    This makes \( g \) left-cancellative irrespective of \( C \).
  ...
  \SubProofOf{thm:function_invertibility_categorical/left_cancellative} Empty functions are handled in \cref{thm:function_invertibility_categorical/empty}, so here we will only discuss the nonempty case.

  \SufficiencySubProof* Fix a nonempty left-cancellative function \( g: B \to C \).
  ...
  Since \( g \) is left-cancellative, it follows that \( f = \id_B \). In particular, \( y_1 = y_2 \), which demonstrates that \( g \) is injective.
  ...
  \SubProofOf{thm:function_invertibility_categorical/right_cancellative} Empty functions are handled in \cref{thm:function_invertibility_categorical/empty}, so here we will only discuss the nonempty case.

  \SufficiencySubProof* Fix a nonempty right-cancellative function \( g: B \to C \).
  ...
  Clearly \( f_1 \bincirc g = f_2 \bincirc g \). Since \( g \) is right-cancellative, this implies that \( f_1 = f_2 \), and in particular \( z_1 = z_2 \). But we have picked \( z_1 \) and \( z_2 \) from disjoint sets.
