...
\begin{definition}\label{def:zfc}\mcite[def. 6.1.6]{Hinman2005Logic}
  ...
  \begin{thmenum}
    ...
    As is the case with the \hyperref[def:zfc/specification]{axiom schema of specification}, the formula \( \varphi \) may depend on parameters, in which case we use its \hyperref[def:fol_universal_closure]{universal closure}.
