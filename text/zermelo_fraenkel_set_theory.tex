...
\begin{theorem}[Axiom of choice equivalences]\label{thm:axiom_of_choice_equivalences}
  ...
  \begin{thmenum}[resume=thm:axiom_of_choice_equivalences]
    ...
    \thmitem{thm:axiom_of_choice_equivalences/fully_faithful_essentially_surjective} \Fullref{thm:categorical_equivalence_characterization}: Every \hyperref[def:functor_invertibility/fully_faithful]{fully faithful} and \hyperref[def:functor_invertibility/essentially_surjective]{essentially surjective} functor induces an \hyperref[def:category_equivalence]{equivalence of categories}.
