    ...
    \begin{itemize}
      ...
      \begin{itemize}
        ...
        \begin{itemize}
          ...
          Since \( x \) is not free in \( E = \qabs y R \), it is not free in \( R \), and, by \cref{thm:def:lambda_term_alpha_equivalence/free}, also not free in \( S \). Then \cref{thm:substitution_chain_contraction/precomposition} implies that
          \begin{equation*}
