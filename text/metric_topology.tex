...
\begin{definition}\label{def:metric_space}\mcite[248]{Engelking1989Topology}
...
\begin{definition}\label{def:metric_topology}\mcite[249]{Engelking1989Topology}
...
\begin{theorem}\label{thm:countable_uniform_base_implies_metrizable}\mcite[thm. 8.1.21]{Engelking1989Topology}
  A uniform space \( X \) is metrizable if and only \( w(X) \leq \aleph_0 \).
\end{theorem}

\medskip

\begin{definition}\label{def:isometry}\mcite[253]{Engelking1989Topology}
