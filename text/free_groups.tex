...
\begin{proof}
  ...
  \Cref{thm:fundamental_theorem_of_homomorphisms} implies that the quotient of \( F(G) / \ker \varphi \) is isomorphic to \( G \). \Cref{thm:normal_subgroups_and_congruences} implies that the relation \( {\cong} \) defined as
  \begin{equation*}
