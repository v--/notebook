...
\begin{definition}\label{def:cyclic_group}\mcite[43]{Jacobson1985BasicAlgebraI}
  We say that a \hyperref[def:group]{group} is \term[ru=циклична группа (\cite[379]{Обрешков1962ВисшаАлгебра}), ru=циклическая группа (\cite[97]{Тыртышников2017ОсновыАлгебры})]{cyclic} if it can be \hyperref[def:object_presentation]{generated} by a single element.
