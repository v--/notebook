...
\begin{example}\label{ex:def:klein_four_group}
  ...
  \begin{thmenum}
    ...
    \thmitem{ex:def:klein_four_group/formula_quaterniality} We show in \fullref{ex:def:group_action/formula_duality} how \( V_4 \) \hyperref[def:group_action]{acts} on formulas in the \hyperref[def:lattice/language]{first-order language of lattices}.
