...
\begin{definition}\label{def:free_group}\mimprovised
  ...
  Let \( + \) and \( - \) be some \hyperref[def:alphabet/symbol]{symbols} not in \( A \). Define the \hyperref[def:disjoint_union]{disjoint union} \( U \coloneqq A \times \set{ +, - } \), whose members we will denote by \( a^+ \) and \( a^- \).
