...
\end{definition}
\begin{itemize}
  \item It is tempting to require the subsets of the partition to be nonempty, however many authors choose not to do so. This includes \incite[17]{Diestel2005Graphs}, \incite[27]{Harary1969Graphs}, \incite[21]{Bollobas1998Graphs}, \incite[def. 1.3.1]{Knauer2011AlgGraphTheory}, \incite[26]{GondranMinoux1984Graphs}, \incite[530]{Rosen1999DiscreteHandbook} and \incite[11]{ЕмеличевИПр1990Графы}. We follow their lead.
\end{itemize}
...
\end{definition}
\begin{comments}
  \item The term \enquote{clique} is used as a synonym for complete subgraph by \incite[def. 1.4.11]{Knauer2011AlgGraphTheory}, \incite[5]{GondranMinoux1984Graphs}, \incite[394]{Erickson2019Algorithms}, \incite[111]{ЕмеличевИПр1990Графы} (as \enquote{клика}) and \incite[\S 7.3.1]{Новиков2013ДискретнаяМатематика} (as \enquote{клика}). Other authors use it to mean a maximal complete subgraph, for example \incite[20]{Harary1969Graphs}, \incite[112]{Bollobas1998Graphs}, Arthur White in \cite[596]{Rosen1999DiscreteHandbook} and \incite[103]{Мирчев2001Графи} (as \enquote{клика}).
...
\begin{definition}\label{def:star_graph}\mcite[18]{Diestel2005Graphs}
