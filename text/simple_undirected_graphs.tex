...
\begin{definition}\label{def:complete_subgraph}\mimprovised
  ...
  \begin{thmenum}
    ...
    \thmitem{def:complete_subgraph/isomorphic} \( H \) is isomorphic to the \hyperref[def:complete_graph]{complete graph} \( K_\kappa \), where \( \kappa \) is the (cardinal) \hyperref[def:graph_cardinality/order]{order} of \( H \).
  \end{thmenum}
\end{definition}
\begin{proof}
