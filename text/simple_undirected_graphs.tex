...
\begin{proof}
  ...
  \begin{equation*}
    \frac {n^2 - r^2} 4 + \binom r 2,
  \end{equation*}
  where \( r = \rem(n, 2) \) is \( 0 \) if \( n \) is even and \( 1 \) if \( n \) is odd. We have the following weaker bound:
  \begin{equation*}
    \frac {n^2} 4 + \frac {-r^2 + 2r^2 - 2r} 4
    =
    \frac {n^2} 4 + \underbrace{\frac {r(r - 2)} 4}_{\leq 0}
    \leq
    \frac {n^2} 4.
  \end{equation*}
