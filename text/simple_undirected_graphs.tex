...
\end{theorem}
\begin{comments}
  \item \Cref{thm:hom_adjunction_from_universal_morphism/counit} implies that \( V \mapsto K_V \) is \hyperref[def:adjoint_functor]{right adjoint} to the \hyperref[con:forgetful_functor]{forgetful functor} from simple undirected graphs to sets.
