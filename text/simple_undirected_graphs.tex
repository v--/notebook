...
\begin{comments}
  ...
  \item An \hyperref[def:multigraph_orientation]{orientation} of a complete graph is sometimes called a \enquote{tournament} --- for example by \incite[289]{Diestel2005}, \incite[30]{Bollobas1998}, Stephen Maurer in \cite[570]{Rosen1999} and \incite[\S 7.3.3]{Новиков2013} (as \enquote{турнир}).
\end{comments}
...
\begin{comments}
  ...
  The term \enquote{join} is used by \incite[21]{Harary1969}, \incite[def. 4.2.1]{Knauer2011} and \incite[\S 265]{Новиков2013} (as \enquote{соединение}). The aforementioned authors denote this operation by \enquote{\( + \)}. Lowell Beineke in \cite[547]{Rosen1999} also calls this operation \enquote{join}, however he denotes it by \enquote{\( \Ast \)}. \incite[15]{Diestel2005} also uses \enquote{\( \Ast \)}, however avoids introducing a special term.
\end{comments}
...
\end{definition}
\begin{comments}
  \item The term \enquote{clique} is used as a synonym for complete subgraph by \incite[def. 1.4.11]{Knauer2011}, \incite[5]{GondranMinoux1984Graphs}, \incite[394]{Erickson2019}, \incite[111]{Емеличев1990} (as \enquote{клика}) and \incite[\S 7.3.1]{Новиков2013} (as \enquote{клика}). Other authors use it to mean a maximal complete subgraph, for example \incite[20]{Harary1969}, \incite[112]{Bollobas1998}, Arthur White in \cite[596]{Rosen1999} and \incite[103]{Мирчев2001} (as \enquote{клика}).
...
\begin{theorem}[Turan's theorem]\label{thm:turans_theorem}\mcite[thm. 7.1.1]{Diestel2005}
...
\begin{theorem}[Mantel's theorem]\label{thm:mantel_theorem}\mcite[thm. I.2]{Bollobas1998}
