...
\begin{proof}
  ...
  Let \( V_1, \ldots, V_r \) be \hi{any} partition of the vertices of \( G \). By \cref{thm:pigeonhole_principle/simple}, there exists an index \( k \) such that \( V_k \) contains at least two vertices of \( H \). But then \( V_k \) is not an independent set.
