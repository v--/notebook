...
\begin{definition}\label{def:graph_box_product}\mcite[def. 4.3.1]{Knauer2019AlgGraphTheory}
  We define the \term{box product} \( G \boxprod H \) of two \hyperref[def:undirected_graph]{simple undirected graphs} \( G \) and \( H \) as the graph whose vertex set is the \hyperref[def:cartesian_product/product]{Cartesian product} \( V_G \times V_H \) and whose edge set is
