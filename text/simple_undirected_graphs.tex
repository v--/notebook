...
\begin{comments}
  ...
  \item An \hyperref[def:multigraph_orientation]{orientation} of a complete graph is sometimes called a \enquote{tournament} --- for example by \textcite[319]{Diestel2017GraphTheory}, \textcite[30]{Bollobás1998ModernGraphTheory} and \textcite[\S 7.3.3]{Новиков2013ДискретнаяМатематика} (as \enquote{\textru{турнир}}).
\end{comments}
...
\end{definition}
\begin{comments}
  \item The term \enquote{clique} is used as a synonym for complete subgraph by \textcite[def. 1.4.11]{Knauer2019AlgebraicGraphTheory}, \textcite[5]{GondranMinoux1984GraphsAndAlgorithms}, \textcite[394]{Erickson2019Algorithms}, \textcite[111]{ЕмеличевИПр1990ТеорияГрафов} (as \enquote{\textru{клика}}) and \textcite[\S 7.3.1]{Новиков2013ДискретнаяМатематика} (as \enquote{\textru{клика}}). Other authors use it to mean a maximal complete subgraph, for example \textcite[20]{Harary1969GraphTheory}, \textcite[112]{Bollobás1998ModernGraphTheory} and \textcite[103]{Мирчев2001Графи} (as \enquote{\textbg{клика}}).
...
\end{definition}
\begin{itemize}
  \item It is tempting to require the subsets of the partition to be nonempty, however many authors choose not to do so. This includes \textcite[17]{Diestel2017GraphTheory}, \textcite[27]{Harary1969GraphTheory}, \textcite[6]{Bollobás1998ModernGraphTheory}, \textcite[def. 1.3.1]{Knauer2019AlgebraicGraphTheory}, \textcite[26]{GondranMinoux1984GraphsAndAlgorithms} and \textcite[11]{ЕмеличевИПр1990ТеорияГрафов}. We follow their lead.
\end{itemize}
