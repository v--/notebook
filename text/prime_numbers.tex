...
\begin{remark}\label{rem:prime_numbers_and_prime_elements}
  ...
  \begin{thmenum}
    ...
    \Fullref{thm:euclids_lemma} demonstrates that every prime \hi{number} is also a prime \hi{element} of \( \BbbZ \). Thus, a prime element \( p \) of \( \BbbZ \) is a prime number if and only if \( p \) is positive.
  \end{thmenum}
\end{remark}
\begin{comments}
