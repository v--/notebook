...
\begin{definition}\label{def:prime_number}\mcite[2]{Apostol1976AnalyticNumberTheory}
  A \term[ru=простое (число) (\cite[256]{Хинчин1951ЭлементыТеорииЧисел})]{prime number} is an integer greater than \( 1 \) whose only proper \emph{positive} \hyperref[def:divisibility]{divisor} is \( 1 \). Non-prime integers greater than \( 1 \) are called \term[ru=составное (число) (\cite[256]{Хинчин1951ЭлементыТеорииЧисел})]{composite numbers}.
\end{definition}
\begin{comments}
