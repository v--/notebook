...
\begin{proposition}\label{thm:parallel_subspace_through_point}
  ...
  The case of an \hyperref[def:affine_line]{affine line} is a restatement of Euclid's \enquote{Proposition \( \beta. \)} (see \cite[8]{Fitzpatrick2007EuclidsElements}):
  \begin{quote}
...
\begin{proposition}\label{thm:pair_of_points_is_collinear}
  ...
  The case of exactly two points is a restatement of Euclid's first postulate (see \cite[7]{Fitzpatrick2007EuclidsElements}):
  \begin{quote}
