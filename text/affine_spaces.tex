...
\begin{defproof}
  ...
  \SubProofOf[eq:def:additive_function]{additivity} \Fullref{thm:def:affine_combinations/vectors_to_points} implies
  \begin{equation*}
    \tau_{u + v}(O)
    =
    \tau_{u + v - 0}(O)
...
\begin{defproof}
  ...
  \begin{itemize}
    ...
    \item Otherwise, we utilize \fullref{thm:inverse_of_2x2_matrix} to solve the \hyperref[def:system_of_linear_equations]{system of equations}
    \begin{equation*}
      \begin{pmatrix}
        t_y & t_z \\
        r_y & r_z
