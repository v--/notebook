...
\begin{remark}\label{rem:geometric_shape}
  ...
  When two geometric shapes intersect, we say that they are \term{incident}. This relates to \hyperref[def:hypergraph/incidence]{(hyper)graph incidence} via \hyperref[def:directed_multigraph_geometric_realization]{geometric realizations}.
\end{remark}
