...
\begin{proposition}\label{thm:subgroups_of_integers}
  If \( H \) is a \hi{nontrivial} \hyperref[def:group/subobject]{subgroup} of \( \BbbZ \), then \( H = n\BbbZ \), where \( n \) is the smallest positive number in \( H \).
\end{proposition}
\begin{comments}
