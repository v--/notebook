...
\begin{remark}\label{rem:integer_division_uniqueness}
  ...
  \begin{thmenum}
    ...
    \thmitem{rem:integer_division_uniqueness/floor} Python uses \enquote{floor division}, where the quotient of \( n \) and \( m \) is defined as the \hyperref[def:real_floor_ceiling]{floor} of the \hyperref[def:rational_numbers]{rational number} \( n / m \). This is discussed in \cite{PEP:238}.
