...
\begin{remark}\label{rem:integer_division_uniqueness}
  ...
  \begin{thmenum}
    \thmitem{rem:integer_division_uniqueness/max} \incite[23]{Jacobson1985AlgebraPart1}, \incite[thm. A-2.2]{Rotman2015AlgebraVol1}, \incite[prop. 1.1]{Knapp2016BasicAlgebra}, \incite[83]{Aluffi2009Algebra} and \incite[sec. 2.12]{Тыртышников2007ЛинейнаяАлгебра} assume that
    \begin{equation*}
