...
\begin{remark}\label{rem:lattice_categorical_product}
  The existence of finite joins and meets is equivalent to the existence of finite products and coproducts in the respective \hyperref[def:preorder_category]{preorder category} defined in \fullref{thm:order_category_isomorphism}.
\end{remark}
