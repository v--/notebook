...
\begin{remark}\label{rem:lattice_polynomials}
  ...
  \end{equation*}
  corresponds to the product (meet) of the polynomials \( X \) and \( Y \vee Z \). Polynomials over two-element lattice \( \set{ \top, \bot } \) correspond to \hyperref[def:propositional_grammar_schema/formula]{propositional formulas} in \hyperref[def:cnf_and_dnf]{disjunctive normal forms}.
