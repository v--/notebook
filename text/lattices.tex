...
\begin{definition}\label{def:lattice}\mcite[3]{Birkhoff1967LatticeTheory}
  ...
  \begin{thmenum}[resume=def:lattice]
    ...
    \thmitem{def:lattice/category}\mcite[\S I.3.2]{Johnstone1982StoneSpaces} We denote the \hyperref[def:category_of_first_order_models]{category of \( \mscrU \)-small models} for lattices via \( \ucat{Lat} \). It is clearly concrete over \hyperref[def:partially_ordered_set]{\( \ucat{Pos} \)}.
