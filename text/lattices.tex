...
\begin{theorem}[Principle of duality for lattices]\label{thm:lattice_duality}\mcite[14]{Gratzer2011Lattices}
...
\begin{definition}\label{def:complete_lattice}\mcite[6]{Birkhoff1967Lattices}
  ...
  \begin{thmenum}
    \thmitem{def:complete_lattice/submodel}\mcite[250]{Gratzer2011Lattices} We call a subset of a complete lattice a \term{complete sublattice} if it is closed under arbitrary suprema and infima.
...
\begin{proposition}\label{thm:complete_semilattice}\mcite[lemma 34]{Gratzer2011Lattices}
...
\begin{example}\label{ex:def:modular_lattice}
  ...
  \begin{thmenum}
    ...
    \thmitem{ex:def:modular_lattice/pentagon}\mcite[109]{Gratzer2011Lattices} An example of a non-modular lattice is the \term{pentagon}
...
\begin{proposition}\label{thm:modular_lattice_characterization}\mcite[thm. 102(i)]{Gratzer2011Lattices}
...
\begin{remark}\label{rem:lattice_polynomials}
  ...
  \incite[sec. II.5]{Birkhoff1967Lattices} discusses only lattice polynomials \enquote{with no coefficients}, that is, whose coefficients are \( \top \). \incite[sec. I.4]{Gratzer2011Lattices} allows polynomials to have non-identity coefficients, for example
  \begin{equation*}
...
\begin{example}\label{ex:def:distributive_lattice}
  ...
  \begin{thmenum}
    ...
    \thmitem{ex:def:distributive_lattice/diamond}\mcite[109]{Gratzer2011Lattices} An example of a \hyperref[def:modular_lattice]{modular} but non-distributive lattice is the \term{diamond}\fnote{\incite{Birkhoff1967Lattices} uses the notation \enquote{\( M_5 \)} and \incite[327]{PicadoPultr2012Frames} use \enquote{\( D_3 \)}, but \incite{Gratzer2011Lattices} and \incite{DaveyPriestley2002Lattices} prefer \enquote{\( M_3 \)}}
...
\begin{proposition}\label{thm:distributive_modular_lattice_characterization}\mcite[thm. 102(ii)]{Gratzer2011Lattices}
...
\begin{corollary}\label{thm:distributive_lattice_characterization}\mcite[thm. 101]{Gratzer2011Lattices}
...
\begin{definition}\label{def:lattice_ideal}\mcite[25]{Birkhoff1967Lattices}
  ...
  \begin{thmenum}
    ...
    \begin{paracol}{2}
      \begin{leftcolumn}\mcite[32]{Gratzer2011Lattices}
...
\begin{definition}\label{def:directed_set}\mcite[54]{Gratzer2011Lattices}
  We say that a subset \( A \) of a \hyperref[def:preordered_set]{preordered set} is \term[bg=насочено надясно (множество) (\cite[10]{Проданов1982ФункАнализТом1})]{directed from above} (resp. \term{directed from below}) if every two elements of \( A \) have an \hyperref[def:extremal_points/bounds]{upper bound} (resp. lower bound).
