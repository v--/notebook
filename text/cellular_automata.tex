...
\begin{definition}\label{def:game_of_life}\mimprovised
  ...
  Given the local state \( u: D_{i, j} \to \set{ \semtop, \sembot } \) at the cell \( (i, j) \), the local evolution function simply counts the number of \hi{other} live cells in the \hyperref[def:cayley_graph_neighborhood/moore]{Moore neighborhood} \( D_{i, j} \) as follows:
