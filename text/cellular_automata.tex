...
\begin{comments}
  ...
  \item Since the phase space consists of global configurations, \hyperref[def:dynamical_system_trajectory]{trajectories} are sequences of global configurations. As mentioned in \fullref{rem:dynamical_system_trajectory_terminology}, we thus avoid speaking of trajectories of cellular automata.
\end{comments}
