...
\begin{remark}\label{rem:object_language_disambiguation_conventions}
  ...
  \begin{itemize}
    ...
    \item \incite[8]{Shoenfield1967MathematicalLogic} and \incite*[\S 51]{Andrews2002Logic} rely on another convention --- to use bold letters for metalingual variables and normal-weight letters for variables in the object language.
