...
\begin{remark}\label{rem:object_language_dots}
  ...
  \begin{thmenum}
    ...
    Another convention used in \incite[\S 51]{Andrews2002STT} is to use bold letters for metalingual variables and normal-weight letters for variables in the object language. We find Andrews' convention more confusing.
