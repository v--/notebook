...
\begin{remark}\label{rem:object_language_dots}
  ...
  \begin{thmenum}
    ...
    For the sake of readability, we avoid this convention in \fullref{subsec:untyped_lambda_calculus}, instead preferring the capitalization convention from \fullref{rem:lambda_object_language}.
  ...
  \incite[rem. 2.1.3]{Hinman2005} follows similar conventions, but uses the dots over function and predicate symbols mostly and avoids placing them over variables and connectives. We chose different conventions because most of the monograph is not concerned with syntax.
\end{remark}
