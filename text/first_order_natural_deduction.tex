...
\begin{definition}\label{def:fol_natural_deduction_proof_tree}
  ...
  \begin{thmenum}[series=def:fol_natural_deduction_proof_tree]
    ...
    These obey some specific restrictions listed below. We show in \cref{ex:dependent_types_and_hol_quantifier_rules} how these restrictions appear naturally when discharging type assertions in \hyperref[def:martin_lof_type_theory]{Martin-L\"of type theory}.
