...
\begin{definition}\label{def:resultant}\mcite[136]{Тыртышников2017Алгебра}
  We define the \term[bg=резултанта (\cite[198]{Обрешков1962ВисшаАлгебра}), ru=результанта, en=resultant (\cite[def. 3.6.2]{CoxLittleOShea2015AlgGeometry})]{resultant} of the non-constant univariate polynomials \( p(X) \) and \( q(X) \) as the \hyperref[def:determinant]{determinant}
  \begin{equation*}
