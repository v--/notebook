...
\end{definition}
\begin{comments}
  \item Relations are the semantical counterpart to \hyperref[def:fol_structure/interpretation/predicate]{first-order predicates} and are equivalent to Boolean-valued functions, as discussed in \cref{rem:boolean_valued_functions_and_relations}.
\end{comments}
