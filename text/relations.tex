...
\begin{definition}\label{def:binary_relation}\mcite[40]{Enderton1977Sets}
  ...
  \begin{thmenum}[resume=def:binary_relation]
    ...
    \thmitem{def:binary_relation/connected}\mcite[example 2.2.1(ii)(d)]{Hinman2005} We call \( R \) \term[ru=полное (отношение) (\cite[def. 2.7]{Гуров2013})]{connected} if any two member of \( A \) are related.
...
\end{definition}
\begin{comments}
  \item This definition is based on transitive reductions of simple directed graphs discussed in \cite{AhoGareyUllman1972}.
\end{comments}
