...
\begin{remark}\label{rem:cartesian_products_and_functions}
  ...
  \begin{itemize}
    ...
    \incite[def. I.4.11]{Kunen2013Sets},
    \incite[235]{Mendelson2015Logic},
    \incite[36]{Enderton1977Sets},
    \incite[23]{Halmos1960Sets},
    \incite[1]{Engelking1989Topology},
    \incite[139]{КолмогоровДрагалин2006Логика},
    \incite[127]{Герасимов2011Вычислимость},
    \incite[thm. 9]{ШеньВерещагин2020Множества},
    \incite[\S 1.2.3]{КусраевКутателадзе2005БулевозначныйАнализ}.

    \incite[72]{Bourbaki2004Sets} instead introduce an axiom that guarantees the existence of an ordered pair satisfying \fullref{thm:kuratowski_pair_extensionality}.

    \incite{Архангельский1988Множества} defines the other concepts leading to general Cartesian products without a formal definition of ordered pairs.
    ...
    \incite[def. I.6.5]{Kunen2013Sets},
    \incite[240]{Mendelson2015Logic},
    \incite[37]{Enderton1977Sets},
    \incite[24]{Halmos1960Sets},
    \incite[1]{Engelking1989Topology},
    \incite[def. I.5.2.1]{Bourbaki2004Sets},
    \incite[141]{КолмогоровДрагалин2006Логика},
    \incite[132]{Герасимов2011Вычислимость},
    \incite[9]{Архангельский1988Множества} and
    \incite[\S 1.2.3]{КусраевКутателадзе2005БулевозначныйАнализ}.

    \incite[32]{ШеньВерещагин2020Множества}, when defining Cartesian products, defer the definition of Kuratowski pairs for a few pages, instead relying on an intuitive definition of ordered pairs.
    ...
    Out of the aforementioned authors, \incite[def. I.3.1]{Bourbaki2004Sets} and \incite[9]{Архангельский1988Множества} define function graphs as subsets of the Cartesian product after discussing functions. Arhangelskii does not define functions formally.

    Most other authors define functions as subsets of Cartesian products ---
    \incite[def. 6.2.8]{Hinman2005Logic},
    \incite[42]{Enderton1977Sets},
    \incite[30]{Halmos1960Sets},
    \incite[1]{Engelking1989Topology},
    \incite[143]{КолмогоровДрагалин2006Логика},
    \incite[133]{Герасимов2011Вычислимость} and
    \incite[32]{ШеньВерещагин2020Множества}.

    \incite[def. I.6.3]{Kunen2013Sets}, \incite[240]{Mendelson2015Logic} and \incite[\S 1.2.4]{КусраевКутателадзе2005БулевозначныйАнализ} define functions as sets of tuples, without referencing Cartesian products.
    ...
    Both choice functions and general products are explicitly discussed by \incite[60]{Halmos1960Sets}. \incite[prop. 4.42(a)]{Mendelson2015Logic} and \incite[thm. 6M(3)]{Enderton1977Sets} only briefly mention choice functions, but discuss general products.

    \incite[def. 6.4.1]{Hinman2005Logic}, \incite[def. I.12.2]{Kunen2013Sets} and \incite[136]{Герасимов2011Вычислимость} discuss choice functions, but not general Cartesian products.
    ...
    \incite[131]{Mendelson2015Logic} and \incite[54]{Enderton1977Sets} define general Cartesian products and later mention choice functions without even stating a connection.

    \incite[def. I.5.3.1]{Bourbaki2004Sets},
    \incite[2]{Engelking1989Topology},
    \incite[146]{КолмогоровДрагалин2006Логика} and
    \incite[41]{ШеньВерещагин2020Множества}
    ...
    \incite[36]{Halmos1960Sets}, prior to discussing choice functions, defines the Cartesian product of the family \( \seq{ A_k }_{k \in \mscrK} \)  as the set of all indexed families \( \seq{ a_k }_{k \in \mscrK} \) such that \( a_k \) belongs to \( A_k \) for every \( k \) in \( \mscrK \). \incite[11]{Архангельский1988Множества} proceeds similarly.
  \end{itemize}
\end{remark}

\paragraph{Kuratowski pairs}

\begin{definition}\label{def:kuratowski_pair}\mcite[thm. 9]{ШеньВерещагин2020Множества}
...
\end{proposition}
\begin{comments}
  \item \incite[72]{Bourbaki2004Sets} introduce an axiom for the existence of ordered pairs satisfying \eqref{eq:thm:kuratowski_pair_extensionality}. See \fullref{rem:cartesian_products_and_functions} for a broader discussion.
\end{comments}
\begin{proof}
...
\begin{definition}\label{def:sequence}\mcite[45]{Halmos1960Sets}
  An \term{infinite sequence} or simply \term[ru=последовательность (\cite[10]{Архангельский1988Множества})]{sequence} is a \hyperref[def:indexed_family]{families} indexed by the \hyperref[thm:smallest_inductive_set_existence]{smallest inductive set} \( \omega \).
...
\end{definition}
\begin{comments}
  \item We base this definition on \cite[36]{Halmos1960Sets} and \cite[11]{Архангельский1988Множества}, but we avoid defining binary Cartesian products and functions beforehand. See \fullref{rem:cartesian_products_and_functions} for a discussion of how Cartesian products are defined across the literature and why we chose this particular definition.
...
\begin{definition}\label{def:binary_relation}\mcite[40]{Enderton1977Sets}
  ...
  \begin{thmenum}[series=def:binary_relation]
    ...
    \thmitem{def:binary_relation/diagonal}\mcite[8]{Kelley1975Topology} For every set \( A \), we define a special relation,
    \begin{equation*}
      \increment_A \coloneqq \set{ (x, x) \given x \in A },
    \end{equation*}
    which we call the \term[ru=диагональное (отношение) (\cite[def. 2.7]{Гуров2013Решётки})]{diagonal relation} or \term{identity relation}.
  ...
  \begin{thmenum}[resume=def:binary_relation]
    \thmitem{def:binary_relation/reflexive}\mcite[def. 6.2.14(i)]{Hinman2005Logic} We call \( R \) \term[bg=рефлексивна (релация) (\cite[369]{ГеновМиховскиМоллов1991Алгебра}), ru=рефлексивное (отношение) (\cite[def. 2.7]{Гуров2013Решётки})]{reflexive} if \( \Delta_A \subseteq R \), i.e. if every element of \( A \) is related with itself.
    ...
    \thmitem{def:binary_relation/irreflexive}\mcite[def. 6.2.14(ii)]{Hinman2005Logic} We call \( R \) \term[ru=антирефлексивное (отношение) (\cite[def. 2.7]{Гуров2013Решётки})]{irreflexive} if \( \Delta_A \cap R = \varnothing \), i.e. if no element of \( A \) is related with itself.
    ...
    \thmitem{def:binary_relation/symmetric}\mcite[def. 6.2.14(ix)]{Hinman2005Logic} We call \( R \) \term[bg=симетрична (релация) (\cite[369]{ГеновМиховскиМоллов1991Алгебра}), ru=симметрическое (отношение) (\cite[def. 2.7]{Гуров2013Решётки})]{symmetric} if \( R = R^{-1} \).
    ...
    \thmitem{def:binary_relation/antisymmetric}\mcite[example 2.2.1(ii)(c)]{Hinman2005Logic} We call \( R \) \term[bg=антисиметрична (релация) (\cite[369]{ГеновМиховскиМоллов1991Алгебра}), ru=антисимметрическое (отношение) (\cite[def. 2.7]{Гуров2013Решётки})]{antisymmetric} if \( R \cap R^{-1} = \Delta_X \).
    ...
    \thmitem{def:binary_relation/transitive}\mcite[def. 6.2.14(iii)]{Hinman2005Logic} We call \( R \) \term[bg=транзитивна (релация) (\cite[369]{ГеновМиховскиМоллов1991Алгебра}), ru=транзитивное (отношение) (\cite[def. 2.7]{Гуров2013Решётки})]{transitive} if \( R = R \bincirc R \).
    ...
    \thmitem{def:binary_relation/connected}\mcite[63]{Enderton1977Sets} We call \( R \) \term[ru=полное (отношение) (\cite[def. 2.7]{Гуров2013Решётки})]{connected} if any two member of \( A \) are related.
    ...
    \thmitem{def:binary_relation/trichotomy}\mcite[62]{Enderton1977Sets} We say that \( R \) satisfies \term[bg=трихотомия (\cite[11]{Тагамлицки1971ДиференциалноСмятане})]{trichotomy} if every two elements of \( A \) are either related or equal.
...
\begin{definition}\label{def:set_cover}\mcite[44]{Engelking1989Topology}
