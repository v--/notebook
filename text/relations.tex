...
\end{definition}
\begin{comments}
  \item \Cref{thm:moore_family_closure_operator} implies that the equivalence closure is a \hyperref[def:moore_closure_operator]{Moore closure operator} on \( A^2 \).
