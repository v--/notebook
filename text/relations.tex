...
\begin{definition}\label{def:relation}\mcite[41]{Enderton1977Sets}
  ...
  \end{equation*}
  of their \hyperref[def:cartesian_product/product]{Cartesian product} an \( n \)-ary \term[bg=релация (\cite[def. 2B1]{Сариев2022}), ru=отношение (\cite[25]{КолмогоровДрагалин2006})]{relation}.
