...
\begin{definition}\label{def:algebraic_equation}\mimprovised
  ...
  We use the prefixes from the polynomial degree terminology described in \cref{def:polynomial_degree_terminology}, e.g. we call \eqref{eq:def:algebraic_equation/canonical} a \enquote{quadratic equation} if \( f(X_1, \ldots, X_n) \) is a quadratic polynomial.
\end{definition}
