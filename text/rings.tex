...
\begin{definition}\label{def:ring}\mcite[def. 2.1]{Jacobson1985AlgebraPart1}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:ring/homomorphism}\mcite[def. 2.3]{Jacobson1985AlgebraPart1} A \hyperref[def:first_order_homomorphism]{first-order homomorphism} between the rings \( R \) and \( T \) is a \hyperref[def:semiring/homomorphism]{semiring homomorphism} \( \varphi: R \to T \) that additionally preserves additive inverses.
    ...
    \thmitem{def:ring/submodel}\mcite[105]{Jacobson1985AlgebraPart1} The set \( A \subseteq R \) is a \hyperref[def:first_order_submodel]{submodel} of \( R \) if it is a \hyperref[def:semiring]{sub-semiring} of \( R \).
    ...
    \thmitem{def:ring/commutative}\mcite[108]{Jacobson1985AlgebraPart1} If multiplication is commutative, we call the ring itself \term{commutative}. Unless multiplication corresponds to function composition, most rings we will encounter will be commutative.
...
\begin{definition}\label{def:division_ring}\mcite[91]{Jacobson1985AlgebraPart1}
...
\begin{definition}\label{def:field}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:field/division_ring}\mcite[91]{Jacobson1985AlgebraPart1} \( \BbbK \) is a \hyperref[def:ring/commutative]{commutative} \hyperref[def:division_ring]{division ring}.
  \end{thmenum}
