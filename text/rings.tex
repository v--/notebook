...
\end{comments}
\begin{proof}
  \SubProofOf{thm:ordered_ringe/additive_inversion} Follows from \fullref{thm:ordered_group/inversion}.
  ...
  \SubProofOf{thm:def:ordered_semiring/strict_prod} Fix \( x < y \) and \( z > 0 \).
