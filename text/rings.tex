...
\begin{proposition}\label{thm:def:signum}
  \hyperref[def:signum]{The signum function} on the totally ordered \hi{\hyperref[def:entire_semiring]{entire}} ring \( R \) is a \hyperref[def:group/morphism]{group homomorphism} from the multiplicative group of \( R \) to the group \( \set{ -1, 0, 1 } \) under integer multiplication.
