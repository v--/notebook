...
\begin{remark}\label{rem:fol_free_term_model_with_terms}
  In \cref{def:fol_tree_term_model}, we defined free term models using \hyperref[def:labeled_tree]{labeled trees} instead of \hyperref[def:fol_term]{logical terms}. These trees generalize the syntax trees of the terms by allowing possibly uncountably many indeterminates.
