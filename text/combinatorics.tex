...
\begin{example}\label{ex:fibonacci_rabbits}
  Leonardo Pisano, known as Fibonacci, published a book on arithmetic named \enquote{Liber Abaci} in 1202. In \cite[54]{ЭнциклопедияЕлементарнойМатематикиТом1}, Bashmakova and Yushkevich claim that books is among the first books featuring decimal numerals. Despite being influential, the book lacks the clarity of exposition that we can afford now after centuries of polishing existing concepts.

  The solution to one of the problems stated there later generalized to what is now known as the Fibonacci sequence. In an English translation of the book, \cite{Fibonacci2002Sigler}, the problem is formulated as follows:
  \begin{displayquote}
