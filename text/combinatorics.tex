...
\begin{example}\label{ex:fibonacci_rabbits}
  ...
  It should also be noted that the Fibonacci sequence named after this problem is defined to start with \( F_0 = 0 \) and \( F_1 = 1 \) --- see \fullref{def:fibonacci_number}.
\end{example}
