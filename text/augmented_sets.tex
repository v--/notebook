...
\begin{remark}\label{rem:set_labeling_terminology}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item \incite[395]{Erickson2019}, \incite[\textnumero 5.4]{Harzheim2005}, \incite[111]{Diestel2005}, \incite[590]{Rosen1999} and \incite[\textnumero 10.7.1]{Новиков2013} (as \enquote{раскраска}) as an explicit function labeling graph vertices with positive integers.

      \item \incite[28]{Зыков2004} (as \enquote{раскраска}) as a \hyperref[def:set_partition]{partition} of the vertices of a graph into nonempty sets.
    ...
    \begin{itemize}
      ...
      \item \incite[309]{Новиков2013} (as \enquote{нагрузка}) for labeling vertices with nonnegative real values.

      \item \incite[2]{Knauer2011}, \incite[62]{Зыков2004} for general labels of either vertices or edges of graphs.
      ...
      \item \incite[387]{Knuth1997Vol1} for the number of nodes in a subtree, but later in \incite[417]{Knuth1997Vol1} as number-valued labels of nodes.

      \item \incite[37]{Blizard1988} as an example of an obsolete synonym for \enquote{multiset}.
    \end{itemize}
