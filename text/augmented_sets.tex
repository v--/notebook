...
\begin{remark}\label{rem:set_labeling_terminology}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item \incite[395]{Erickson2019Algorithms}, \incite[\S 5.4]{Harzheim2005OrderedSets}, \incite[111]{Diestel2005Graphs}, \incite[590]{Rosen1999DiscreteHandbook}, \incite[235]{Емеличев1990Графы} (as \enquote{раскраска}) and \incite[\S 10.7.1]{Новиков2013ДискретнаяМатематика} (as \enquote{раскраска}) as an explicit function labeling graph vertices with positive integers.
    ...
    \begin{itemize}
      ...
      \item \incite[exer. 8.4]{Новиков2013ДискретнаяМатематика} (as \enquote{нагрузка}) and \incite[59]{Емеличев1990Графы} (as \enquote{вес}) for labeling vertices with nonnegative real values.
