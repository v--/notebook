...
\begin{remark}\label{rem:set_labeling_terminology}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item \incite[595]{ButlerEtAl2016Progressions} as an explicit function labeling the elements of initial segments of an \hyperref[def:arithmetic_progression]{arithmetic progression}.

      \item \incite[21]{Rotman2015AlgebraPart1} as an \hyperref[def:group_action_orbit]{orbit} of a \hyperref[def:group_action]{group action} on a finite set.
    \end{itemize}
    ...
    \begin{itemize}
      ...
      \item \incite[37]{Blizard1988MultisetTheory}, \incite[18]{Stanley2012EnumCombinatoricsVol1}, \incite[309]{Barendregt1984LambdaCalculus}, \incite[20]{Golan1999Semirings} and \incite[A.3.5]{Mimram2020Types} for explicit labeling with positive integers.
...
\begin{remark}\label{rem:ast_labeling}
  ...
  \Fullref{rem:tree_grafting_nodes} describes how we use \hyperref[def:ordered_tree_grafting_product]{grafting products} to build abstract syntax trees.
...
\begin{example}\label{ex:def:convex_fuzzy_set}
  ...
  \begin{thmenum}
    ...
    \thmitem{ex:def:convex_fuzzy_set/convex_function_convex_set_not_convex_function_set} Dually, consider the membership function
    \begin{equation*}
