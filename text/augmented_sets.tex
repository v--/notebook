...
\begin{remark}\label{rem:set_labeling_terminology}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item \incite[3]{Bollobas1998Graphs}, \incite{Salomaa1987Languages} \incite{Mimram2020Types}, \incite{CitkinMuravitsky2021ConsequenceRelations} and \incite{Erickson2019Algorithms} without explicit definitions for labels of graph vertices and edges.
      ...
      \item \incite[238]{Diestel2005Graphs} for natural number labels of graph vertices.
    \end{itemize}
    ...
    \begin{itemize}
      ...
      \item \incite[7]{Knauer2011AlgGraphTheory} for general labels of tree nodes.
    ...
    \begin{itemize}
      \item \incite[7]{Birkhoff1967Lattices}, \incite[145]{Bollobas1998Graphs}, \incite[152]{Knauer2011AlgGraphTheory}, \incite[500]{Jacobson1985AlgebraPart1} and \incite[141]{Мирчев2001Графи} (as \enquote{оцветяване}) without an explicit definition as way of classifying objects.

      \item \incite[395]{Erickson2019Algorithms}, \incite[\S 5.4]{Harzheim2005OrderedSets}, \incite[111]{Diestel2005Graphs}, \incite[590]{Rosen1999DiscreteHandbook}, \incite[235]{ЕмеличевИПр1990Графы} (as \enquote{раскраска}) and \incite[\S 10.7.1]{Новиков2013ДискретнаяМатематика} (as \enquote{раскраска}) as an explicit function labeling graph vertices with positive integers.
      ...
      \item \incite[78]{Rotman2010Algebra} as an \hyperref[def:group_action_orbit]{orbit} of a \hyperref[def:group_action]{group action} on a finite set.
    \end{itemize}
    ...
    \begin{itemize}
      ...
      \item \incite[2]{Knauer2011AlgGraphTheory} for general labels of either vertices or edges of graphs.
      ...
      \item \incite[542]{Rosen1999DiscreteHandbook}, \incite[9]{GondranMinoux1984Graphs} and \incite[12]{Мирчев2001Графи} for number-valued labels (without specifying which kind of numbers) of edges of graphs, although Mirchev also allows vertices to be labeled.

      \item \incite[298]{Diestel2005Graphs} for coefficients of \hyperref[def:convex_hull]{convex combinations}.
    ...
    \begin{itemize}
      \item \incite[473]{Knuth1997ArtVol2}, \incite[2]{Aluffi2009Algebra}, \incite[41]{Rosen1999DiscreteHandbook} and \incite[28]{Новиков2013ДискретнаяМатематика} as an informal notion of \enquote{generalized sets} allowing each element to be repeated finitely many times.
...
\begin{definition}\label{def:set_coloring}\mimprovised
  Fix a nonempty set \( Q \) whose elements we will call \term[bg=цветове (\cite[141]{Мирчев2001Графи}), ru=цвета (\cite[\S 10.7.1]{Новиков2013ДискретнаяМатематика}), en=coloring (\cite[111]{Diestel2005Graphs})]{colors}. A \( Q \)-\term[bg=оцветяване (\cite[141]{Мирчев2001Графи}), ru=раскраска (\cite[\S 10.7.1]{Новиков2013ДискретнаяМатематика}), en=coloring (\cite[111]{Diestel2005Graphs})]{coloring} of the \hyperref[def:set]{plain set} is simply a \hyperref[def:labeled_set]{labeling} of \( S \) with elements of \( Q \).

  \begin{thmenum}
    \thmitem{def:set_coloring/monochromatic}\mcite[253]{Diestel2005Graphs} We say that a subset of \( S \) is \term[ru=одноцветный (класс) (\cite[\S 10.7.1]{Новиков2013ДискретнаяМатематика})]{monochromatic} if all its elements have the same color.
