...
\begin{definition}\label{def:meager_set}\mcite[def. 2.1]{Rudin1991FuncAnalysis}
...
\begin{proposition}\label{thm:def:meager_set}\mcite[43]{Rudin1991FuncAnalysis}
...
\begin{theorem}[Baire category theorem]\label{thm:baire_category_theorem}\mcite{Rudin1991FuncAnalysis}
  \begin{thmenum}
