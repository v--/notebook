...
\begin{remark}\label{rem:periodic_functions_and_periods}
  ...
  \begin{itemize}
    ...
    \item In the context of \hyperref[def:dynamical_system_periodicity]{periodicity of orbits} of \hyperref[def:dynamical_system]{dynamical systems}, \textcite[88]{Müller2022HandbookOfDynamicsAndProbability} calls a \hi{nonconstant} real-valued function \( f \) periodic if \( f(x + p) = f(x + q) \) for some \( p \neq q \).
