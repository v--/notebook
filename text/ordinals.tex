...
\begin{proof}
  ...
  By transitivity of \( \alpha \), we have \( \beta \subseteq \alpha \), and thus \( (\beta, \in) \) is a (strictly) totally ordered set as a \hyperref[def:fol_substructure/model]{submodel} of \( (\alpha, \in) \).
