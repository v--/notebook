...
\begin{remark}\label{rem:ordinal_definition}
  ...
  It just, so happens that each natural number \( n \) is the set of natural numbers that are smaller with respect to the strict order relation \( < \) defined in \eqref{eq:def:peano_arithmetic_ordering/strict_predicate}.
