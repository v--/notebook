...
\begin{concept}\label{con:induction}
  ...
  \begin{thmenum}
    ...
    \thmitem{con:induction/grammars} Within this monograph, we use \fullref{thm:induction_on_syntax_trees}, for example \hyperref[def:propositional_grammar_schema/formula]{propositional} and \hyperref[def:first_order_syntax/formula]{first-order formulas}. It is not an established principle like the others.
