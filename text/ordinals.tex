...
\begin{remark}\label{rem:induction}
  ...
  \begin{thmenum}
    ...
    A special case that is useful in logic and computer science is \fullref{thm:tree_recursion}.

    Within this document, we use \fullref{thm:induction_on_syntax_trees} in certain special cases, for example \hyperref[def:propositional_syntax/formula]{propositional} and \hyperref[def:first_order_syntax/formula]{first-order formulas}.
  \end{thmenum}
\end{remark}
