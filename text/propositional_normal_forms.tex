...
\begin{remark}\label{rem:substitution_symbol}
  Using \( \Bbbs \) and adjacent letters to denote a substitution function is inspired by Hindley's \enquote{type-substitutions} defined in \cite[def. 3A1]{Hindley1997STT}. An alternative used by \incite[\S 5.4]{Mimram2020Types} and \incite[def. 3.1.3]{CitkinMuravitsky2022ConsequenceRelations} is \( \sigma \).
...
\begin{remark}\label{rem:substitution_notation}
  ...
  It is used for logical formulas by \incite[\S 3.1.4]{Mimram2020Types}, \incite[23]{Герасимов2011Вычислимость} and \incite[161]{ШеньВерещагин2017Логика}, and for \( \synlambda \)-terms by \incite[def. 1A7]{Hindley1997STT}.

  Moreover, some authors like \incite[4]{TroelstraSchwichtenberg2000Proofs} exchange the variables and formulas in this notation.
  ...
  \incite[44]{Smullyan1995FOL} and \incite[16]{Andrews2002STT} instead uses the very concise notation
  \begin{equation*}
