...
\end{definition}
\begin{comments}
  \item These grammar rules give us the ability to formalize the syntax used for the \hyperref[def:inference_rule]{inference rules} in \fullref{sec:first_order_logic}.
\end{comments}
