...
\end{definition}
\begin{comments}
  \item Our definition is based on \incite[def. 3.1.3]{CitkinMuravitsky2021}, with three notable differences:
  \begin{itemize}
    ...
    \item The requirement of only finitely many variables is inspired by \incite[222]{Mimram2020}.
  \end{itemize}
...
\begin{remark}\label{rem:substitution_notation}
  ...
  It is used, among others, by \incite[1A7]{Hindley1997}, \incite[55]{Mimram2020}, \incite[23]{Герасимов2011} and \incite[161]{ШеньВерещагин2017Языки}.

  Other authors use more esoteric notations --- \incite[47]{КолмогоровДрагалин2006} use
  \begin{equation*}
    \varphi(p_1, \ldots, p_n \Vert \omega_1, \cdots, \omega_n),
  \end{equation*}
  while \incite[131]{Эдельман1975} uses
  \begin{equation*}
