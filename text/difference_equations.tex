...
\begin{remark}\label{rem:system_of_first_order_difference_equations}
  ...
  First note that difference equations over the \hyperref[def:first_order_direct_product]{direct product} \( G = H^n \) are equivalent to \hyperref[def:system_of_equations]{systems} of \( n \) difference equations over \( H \).
