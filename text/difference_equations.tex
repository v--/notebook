...
\begin{proposition}\label{thm:discrete_logistic_model_dynamics}
  ...
  \begin{thmenum}
    \thmitem{thm:discrete_logistic_model_dynamics/boundary} The trajectories starting at \( 0 \) or \( (1 + \alpha) / \beta \) converge to \( 0 \).
  \end{thmenum}
\end{proposition}
\begin{proof}
  \SubProofOf{thm:discrete_logistic_model_dynamics/boundary} The boundary points \( 0 \) and \( (1 + \alpha) / \beta \) are the roots of the equation
  \begin{equation*}
    (1 + \alpha - \beta X) X,
  \end{equation*}
