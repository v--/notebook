...
\begin{definition}\label{def:semiring}\mcite[1]{Golan2010}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:semiring/initial} The \hyperref[thm:substructures_form_complete_lattice/bottom]{initial substructure} of a nontrivial semiring is instead the set of nonnegative integers --- see \fullref{thm:semiring_characteristic_homomorphism}.
