...
\begin{definition}\label{def:semiring}\mcite[1]{Golan1999Semirings}
  ...
  \begin{thmenum}
    ...
    First, we add another \hyperref[def:function_application_syntax]{infix} binary functional symbol \( \cdot \) and a constant \( 1 \). The notation for the constant is justified by \cref{thm:semiring_characteristic_homomorphism}.
