...
\begin{concept}\label{con:syntax_fragment}\mimprovised
  ...
  For example, the formulas in conjunctive and disjunctive normal forms from \cref{def:cnf_and_dnf} are a subset of all propositional formulas, as defined in \cref{def:propositional_formula}. This constitutes a fragment.
