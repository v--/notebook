...
\end{definition}
\begin{comments}
  \item We can retain the logical constants, but then we would face the dilemma of how to interpret \( \synbot \) when minimal semantics is involved; see \cref{rem:minimal_semantics_and_bottom}.
\end{comments}
