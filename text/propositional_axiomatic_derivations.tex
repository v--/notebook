...
\begin{definition}\label{def:propositional_axiomatic_derivation}\mcite[51]{TroelstraSchwichtenberg2000BasicProofTheory}
  ...
  \begin{thmenum}
    \thmitem{def:propositional_axiomatic_derivation/axiom} \( \psi_k \) is a logical axiom, i.e. there exists an axiom schema \( \syn\psi_k \) and an \hyperref[def:propositional_schema_instantiation]{instantiation} \( \BbbI \) such that \( \psi_k = \syn\psi_k[\BbbI] \).
