...
\begin{definition}\label{def:atomic_propositional_schema_instantiation}\mimprovised
  An \hyperref[con:schemas_and_instances]{atomic instantiation} for \hyperref[def:propositional_formula]{propositional formulas} is a \hyperref[def:set_valued_map/partial]{partial map} \( \BbbI \) from \hyperref[def:propositional_formula_schema]{propositional formula placeholders} to \hyperref[def:propositional_formula]{propositional formulas}.
\end{definition}
\begin{comments}
