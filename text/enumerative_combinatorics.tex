...
\begin{example}\label{ex:thm:pigeonhole_principle}
  ...
  \begin{thmenum}
    \thmitem{ex:thm:pigeonhole_principle/lagrange} Given a \hyperref[def:group/morphism]{group homomorphism} \( \varphi: G \to H \), by \cref{thm:homomorphism_theorem_for_groups},
    \begin{equation*}
