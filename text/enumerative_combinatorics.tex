...
\begin{concept}\label{con:pigeonhole_principle}
  ...
  \begin{itemize}
    \item The \enquote{pigeonhole principle} is used, among others, by \textcite[289]{Knuth1997ArtVol2}, \textcite[sec. 6.2]{Rosen2019DiscreteMathematics}, \textcite[66]{HopcroftEtAl2001Computability}, \textcite[exerc. A-4.1]{Rotman2015AdvancedModernAlgebraPart1}, \textcite[134]{Enderton1977SetTheory} and \textcite[16]{Savage2008ModelsOfComputation}.
    \item The \enquote{drawer principle} is used by \textcite[222]{Арнольд2014ОДУ} (as \enquote{\textru{принцип ящиков Дирихле}}), Goncharov in \cite[156]{Гончаров1952ФункцииДействительногоПеременного} (as \enquote{\textru{принцип Дирихле}}), \textcite[224]{Проданов1982ФункционаленАнализЧаст1} (as \enquote{\textbg{принцип за чекмеджетата}}).
    \item \enquote{Dirichlet's principle} is used by \textcite[64]{Гуров2013ТеорияРешёток} (as \enquote{\textru{принцип Дирихле}}), \textcite[9]{Мирчев2001Графи} (as \enquote{\textbg{принцип на Дирихле}}).
  \end{itemize}
\end{concept}
...
\begin{remark}\label{rem:combinatorial_permutation_terminology}
  ...
  \begin{itemize}
    ...
    \textcite[31]{Jacobson1985BasicAlgebraI},
    \textcite[78]{Винберг2014КурсАлгебры} (as \enquote{\textru{перестановка}}) and
    \textcite[82]{Тыртышников2017ОсновыАлгебры} (as \enquote{\textru{подстановка}})

    \item In the same sense, but without explicit discussion of symmetric groups, it is used by
    \textcite[28]{Knuth1997ArtVol1},
    \textcite[20]{Stanley2012EnumerativeCombinatoricsVol1} and
    \textcite[def. 2.11.1]{Savage2008ModelsOfComputation}.

    \item For elements of a general symmetric group \( S_A \), it is used by
    \textcite[8]{Lang2002Algebra},
    \textcite[116]{Rotman2015AdvancedModernAlgebraPart1},
    \textcite[def. II.2.1]{Aluffi2009Algebra} and
    \textcite[\S 2.2.5]{Новиков2013ДискретнаяМатематика} (as \enquote{\textru{перестановка}}).
  \end{itemize}
\end{remark}
