...
\begin{example}\label{ex:thm:pigeonhole_principle}
  ...
  \begin{thmenum}
    \thmitem{ex:thm:pigeonhole_principle/lagrange} Given a \hyperref[def:group/morphism]{group homomorphism} \( \varphi: G \to H \), by \cref{thm:homomorphisms_theorem_for_groups},
    \begin{equation*}
...
\begin{proof}
  ...
  \Cref{thm:homomorphisms_theorem_for_groups} implies that the quotient \( S_n / A_n \) is isomorphic to \( C_2 \).
