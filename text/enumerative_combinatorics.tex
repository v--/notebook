...
\begin{remark}\label{rem:combinatorial_permutation_terminology}
  ...
  In Russophone literature, \enquote{размещение} (\enquote{arrangement}) is used instead. This usage can be found in \cite[171]{Яблонский2003ДискретнаяМатематика} and \textcite[100]{БелоусовТкачёв2004ДискретнаяМатематика}.
