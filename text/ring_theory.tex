...
As discussed in \cref{def:additive_semigroup}, commutative and non-commutative groups are quite different. Rings are extensions of \hyperref[def:abelian_group]{abelian groups}, which allow multiplication with more than members of \( \BbbZ \).

For commutative rings, this second operation is often truly an extension of \cref{def:semigroup/exponentiation} to arbitrary ring elements. For noncommutative ring, this second operation is usually given by function composition.
...
\begin{figure}
  \caption{Some important types of (semi)rings}\label{fig:ring_hierarchy}
  \smallskip
  \hfill
  \begin{forest}
    for tree={s sep=0cm}
