...
As discussed in \cref{con:additive_semigroup}, commutative and non-commutative groups are quite different. Rings are extensions of \hyperref[def:abelian_group]{abelian groups}, which allow multiplication with more than members of \( \BbbZ \).
