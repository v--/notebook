...
\begin{remark}\label{rem:simple_graphs}
  ...
  \begin{itemize}
    ...
    \item Other aforementioned authors, namely \incite[def. 1.1.2]{Knauer2019AlgGraphTheory}, \incite[571]{Stanley2012EnumCombinatoricsVol1}, \incite[def. 10.1.1]{Rosen2019DiscreteMathematics} \incite[190]{Erickson2019Algorithms}, and \incite[7]{Мирчев2001Графи} define undirected graphs as pairs \( (V, E) \), where \( E \) consists of one-element or two-element subsets of \( V \). This definition again allows loops.
