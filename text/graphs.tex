...
\begin{comments}
  ...
  \incite[1]{König1986Graphentheorie}, which, as explained in \fullref{rem:graph_definition}, is considered the first book on graph theory, gives a vague definition of a graph that roughly coincides with our notion of directed multigraph, with infinite graphs explicitly considered.
\end{comments}
