...
\begin{example}\label{ex:konigsberg_bridges}
  ...
  \begin{figure}[ht!]\continuedfloat
    \begin{subcaptionblock}{0.55\textwidth}
      \centering
      \includegraphics[width=\textwidth]{images/ex__konigsberg_bridges__figure_1}
      \caption{A schematic drawing of the \hyperref[ex:konigsberg_bridges]{K\"onigsberg bridges} problem --- the first figure from Euler's paper \cite{Euler1741}.}
      \label{fig:ex:konigsberg_bridges/figure_1}
    \end{subcaptionblock}
    \hfill
    \begin{subcaptionblock}{0.4\textwidth}
      \centering
      \begin{equation}\label{eq:fig:ex:konigsberg_bridges/graph}
        \includegraphics{output/ex__konigsberg_bridges}
      \end{equation}
      \caption{The \hyperref[def:undirected_multigraph]{undirected multigraph} corresponding to Euler's formulation of the \hyperref[ex:konigsberg_bridges]{K\"onigsberg bridges} problem.}
