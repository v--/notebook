...
\begin{definition}\label{def:equinumerosity}\mcite[129, 145]{Enderton1977Sets}
  We say that two sets are \term[bg=равномощни (\cite[90]{ГеновМиховскиМоллов1991Алгебра}), ru=равномощные (\cite[144]{КолмогоровДрагалин2006Логика})]{equinumerous} if there exists a \hyperref[def:function_invertibility/bijective]{bijective function} between them.
