...
\begin{remark}\label{rem:order_function_countability_terminology}
  We mentioned in \cref{def:set_countability} that the terms based on the word \enquote{countable} and \enquote{enumerable} are inconsistently used across the literature. We list in \cref{tab:rem:order_function_countability_terminology} how this is handled in some of the books we cite.
  ...
  \begin{table}[!ht]
    ...
    \begin{tabular}{l l l}
      ...
      \bottomrule
    \end{tabular}
    \caption{The table for \cref{rem:order_function_countability_terminology} discussing terminology related to \hyperref[def:set_countability]{countability}.}\label{tab:rem:order_function_countability_terminology}
  \end{table}
\end{remark}
...
\begin{remark}\label{rem:cardinality_auxiliary_terminology}
  ...
  As another example, a \hyperref[rem:arbitrary_kind_graph]{graph or hypergraph} can be \enquote{locally finite}, \enquote{locally countable}, etc., in accordance with \cref{def:graph_cardinality/local}.
