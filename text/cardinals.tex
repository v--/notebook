...
\begin{remark}\label{rem:countability_etymology}
  Some authors, for example \incite[159]{Enderton1977Sets}, Peter Hinman in \incite[def. 6.2.32(v)]{Hinman2005Logic} and \incite[4]{Engelking1989Topology}, use the shortened term \enquote{countable} to mean \enquote{at most countable}, while other authors like \incite[def. 2.4(c)]{Rudin1976AnalysisPrinciples} use \enquote{countable} to mean \enquote{countably infinite}. The term \enquote{denumerable} is also used for \enquote{countably infinite}, for example by Peter Hinman in \incite[def. 6.2.32(iv)]{Hinman2005Logic}, \incite[123]{MacLane1998Categories} and \incite[def. 2.4]{Rudin1976AnalysisPrinciples}.
\end{remark}
