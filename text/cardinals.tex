...
\begin{definition}\label{def:equinumerosity}\mcite[129, 145]{Enderton1977Sets}
  We say that two sets are \term[bg=равномощни (\cite[90]{ГеновМиховскиМоллов1991}), ru=равномощные (\cite[144]{КолмогоровДрагалин2006})]{equinumerous} if there exists a \hyperref[def:function_invertibility/bijective]{bijective function} between them.
...
\begin{proof}
  ...
  \begin{itemize}
    \item The condition \( \alpha < \beta \) is vacuously false for the base case \( \beta = 0 \), hence by \eqref{inf:def:propositional_natural_deduction_systems/bot/efq} the statement vacuously holds.
