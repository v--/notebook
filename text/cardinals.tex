...
\begin{definition}\label{def:set_finiteness}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:set_finiteness/dedekind}\mcite[def. II.64]{Dedekind1901Essays} The set \( A \) is not \hyperref[def:equinumerosity]{equinumerous} all of its proper subsets. That is, if \( B \) is a proper subset of \( A \), then no function from \( A \) to \( B \) is injective.
  \end{thmenum}
