...
\begin{remark}\label{rem:countability_terminology_review}
  ...
  \begin{table}[!ht]
    ...
    \begin{tabular}{l l l}
      ...
      \bottomrule
    \end{tabular}
    \caption{The table for \cref{rem:countability_terminology_review} discussing terminology related to \hyperref[def:set_countability]{countability}.}\label{tab:rem:countability_terminology_review}
  \end{table}
\end{remark}
