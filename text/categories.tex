...
\begin{example}\label{ex:def:category}
  ...
  \begin{itemize}
    ...
    \item All the \hyperref[def:category_of_small_first_order_models]{categories of small first-order models} listed in \cref{ex:def:category_of_small_first_order_models}
...
\begin{definition}\label{def:morphism_invertibility}
  In connection with \cref{def:function_invertibility} and \cref{def:first_order_embedding}, we introduce the following terminology:
  \begin{thmenum}
