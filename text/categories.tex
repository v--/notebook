...
\begin{proposition}\label{thm:def:morphism_invertibility}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:def:morphism_invertibility/at_most_one_inverse}\mcite[exer. 1.1.13]{Leinster2014BasicCategories} Any morphism has at most one two-sided inverse.
