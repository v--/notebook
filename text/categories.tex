...
\begin{definition}\label{def:morphism_invertibility}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:morphism_invertibility/involution} If an automorphism is its own inverse, we call it an \term[ru=инволюция (\cite[97]{АлександровМаркушевичХинчин1963ЭнциклопедияТом4}), en=involution (\cite[3]{Birkhoff1967Lattices})]{involution}.
  \end{thmenum}
\end{definition}
