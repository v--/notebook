...
\begin{example}\label{ex:def:lambda_term}
  ...
  \begin{thmenum}
    ...
    \incite[def. 1A10.1]{Hindley1997} avoids the combinator \ref{eq:ex:def:lambda_term/combinator/omega}; it is discussed in \incite[3.2.6]{Mimram2020} and \incite[2.1.34]{Barendregt1984}.
  \end{thmenum}
\end{example}
