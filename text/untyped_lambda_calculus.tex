...
\begin{definition}\label{def:lambda_term_length}
  ...
  \begin{thmenum}
    \thmitem{def:lambda_term_length/string}\mcite[2.1.3]{Barendregt1984} We define \( \len(M) \) to be the \hyperref[def:formal_language/string_length]{string length} of \( M \).
