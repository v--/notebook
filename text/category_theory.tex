...
Beyond that, \fullref{sec:category_adjunctions} and \fullref{sec:categorical_limits} contain some topics important for us, and \fullref{sec:category_similarity} fills some gaps.
