...
\end{definition}
\begin{comments}
  \item We use the definition of tiling by \incite[611]{Arenas1999Tilings}, but split it in two parts -- we define packing in \cref{def:topological_space_packing} and them, based on the more concrete case in \incite[16]{GrünbaumShephard1987TilingsAndPatterns}, we define a tiling as a packing that covers the entire space.
...
\begin{remark}\label{rem:tiling_definition}
  ...
  \begin{thmenum}
    ...
    \thmitem{rem:tiling_definition/berger} \incite[\S 1.7.3]{Berger1987GeometryI} restricts himself to tilings generated from a single connected tile by an \hyperref[def:isometry_group]{isometry group}.
  \end{thmenum}
\end{remark}
