...
\end{definition}
\begin{comments}
  \item Our definitions extends that from \cite[74]{Rogers1964PackingAndCovering}, where Rogers additionally requires \( \mscrP \) to be countable, and additionally assumes the existence of a radius \( r \) such that the balls \( B(p, r) \) with \( p \in \mscrP \) cover \( \BbbR^n \).
\end{comments}
