...
\begin{example}\label{ex:noncompactness_measures}\mcite[exer. 7.3]{Deimling1985NonlinearFA}
...
\begin{theorem}[Kuratowski's noncompactness lemma]\label{thm:noncompact_kuratowskis_lemma}\mcite[exer. 7.4]{Deimling1985NonlinearFA}
