...
\begin{definition}\label{def:planar_graph}\mcite[102]{Harary1969GraphTheory}
  If a \hyperref[rem:graph_of_unspecified_type]{graph of unspecified type} can be embedded into \( \BbbR^2 \), we say that it is \term[bg=планарен (граф) (\cite[129]{Мирчев2001Графи}), ru=планарный (граф) (\cite[150]{ЕмеличевИПр1990ТеорияГрафов}), en=planar (graph) (\cite[89]{Diestel2017GraphTheory})]{planar}.
\end{definition}
