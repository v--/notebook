...
\begin{definition}\label{def:planar_graph}\mcite[102]{Harary1969}
  If an \hyperref[rem:arbitrary_kind_graph]{arbitrary-kind graph} can be embedded into \( \BbbR^2 \), we say that it is \term[bg=планарен (граф) (\cite[129]{Мирчев}), ru=планарный (граф) (\cite[150]{Емеличев1990}), en=planar (graph) (\cite[93]{Diestel2005})]{planar}.
\end{definition}
