...
\begin{proposition}\label{thm:moment_curve}\mcite[exerc. 4.59]{Stanley2012EnumCombinatoricsVol1}
...
\end{theorem}
\begin{comments}
  \item The first proof of this theorem has been published in \cite{AppelHaken1977FourColoringPartI} and \cite{AppelHaken1977FourColoringPartII}. It relies on computer verification of hundreds on cases. \cite{AppelHaken1977FourColoringPartII} lists 63 figures, each containing 35 graphs with some blank spaces left.
\end{comments}
