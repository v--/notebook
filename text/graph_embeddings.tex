...
\begin{example}\label{ex:def:graph_geometric_realization}
  ...
  \begin{thmenum}
    ...
    The corresponding undirected graph is the \hyperref[def:complete_graph]{complete graph} \( K_3 \). We may have different orientations of \( K_3 \). Consider the following two:
    ...
    \thmitem{ex:def:graph_geometric_realization/k4} \Cref{fig:def:complete_graph} shows that the complete graph \( K_4 \) is planar.
