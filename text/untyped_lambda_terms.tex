...
\begin{comments}
  ...
  \item Variables and constants are \hyperref[con:assumed_knowledge]{assumed knowledge}, so definitions across the literature are scarce. \Textcite[9]{Church1956LogicVol1} writes
  \begin{displayquote}
