...
\begin{remark}\label{rem:variable_binding_properties}
  ...
  \begin{itemize}
    ...
    \item Capture-avoiding substitution as defined in \cref{alg:lambda_term_substitution}, with properties like \cref{thm:lambda_substitution_free_variables}, \cref{thm:lambda_substitution_single_rule}, \cref{thm:lambda_substitutions_agree} and \cref{thm:lambda_substitutions_agree}.
