...
\end{theorem}
\begin{comments}
  \item \Cref{thm:adjunction_from_universal_morphism/unit} implies thatthis functor becomes \hyperref[def:adjoint_functor]{left adjoint} to the \hyperref[con:forgetful_functor]{forgetful functor} from complete lattices to partially ordered sets.
\end{comments}
\begin{proof}
