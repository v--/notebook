...
\begin{comments}
  ...
  \item This algorithm can be found as \identifier{math.lambda_.type_derivation.instantiation.instantiate_type_schema} in \cite{notebook:code}.
\end{comments}
...
\end{defproof}
\begin{comments}
  \item This algorithm can be found as \identifier{math.lambda_.type_derivation.instantiation.infer_instantiation_from_type} in \cite{notebook:code}.
\end{comments}
...
\end{algorithm}
\begin{comments}
  \item This algorithm can be found as \identifier{math.lambda_.type_derivation.instantiation.instantiate_term_schema} in \cite{notebook:code}.
\end{comments}
...
\end{defproof}
\begin{comments}
  \item This algorithm can be found as \identifier{math.lambda_.type_derivation.instantiation.infer_instantiation_from_term} in \cite{notebook:code}.
\end{comments}
...
\end{algorithm}
\begin{comments}
  \item This algorithm can be found as \identifier{math.lambda_.type_derivation.instantiation.instantiate_assertion_schema} in \cite{notebook:code}.
\end{comments}
...
\end{algorithm}
\begin{comments}
  \item This algorithm can be found as \identifier{math.lambda_.type_derivation.instantiation.infer_assertion_schema} in \cite{notebook:code}.
\end{comments}
