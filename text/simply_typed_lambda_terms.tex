...
\begin{definition}\label{def:type_derivation_tree}\mimprovised
  ...
  \begin{thmenum}[resume=def:type_derivation_tree]
    ...
    \thmitem{def:type_derivation_tree/application} We define \term{rule application} trees based on a straightforward adaptation of \cref{def:propositional_natural_deduction_proof_tree/application} for natural deduction rule applications, with schema instantiation based on \fullref{alg:lambda_schema_instantiation}.
