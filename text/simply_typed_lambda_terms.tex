...
\begin{comments}
  ...
  \item Both typed and untyped \( \muplambda \)-terms are implemented in \cite{notebook:code}, in the module
    \WriteCodeRefText{math.lambda_.terms}

  A parser is implemented in
    \WriteCodeRefText{math.lambda_.parsing}
\end{comments}
...
\begin{comments}
  ...
  \item This algorithm is implemented in \cite{notebook:code} as
    \WriteCodeRef{alg:simple_type_schema_instantiation}
\end{comments}
...
\begin{comments}
  \item This algorithm is implemented in \cite{notebook:code} as
    \WriteCodeRef{alg:simple_type_schema_inference}
\end{comments}
...
\begin{comments}
  \item This algorithm is implemented in \cite{notebook:code} as
    \WriteCodeRef{alg:lambda_term_schema_instantiation}
\end{comments}
...
\begin{comments}
  \item This algorithm is implemented in \cite{notebook:code} as
    \WriteCodeRef{alg:lambda_term_schema_inference}
\end{comments}
...
\begin{comments}
  \item This algorithm is implemented in \cite{notebook:code} as
    \WriteCodeRef{alg:type_assertion_schema_instantiation}
\end{comments}
...
\begin{comments}
  \item This algorithm is implemented in \cite{notebook:code} as
    \WriteCodeRef{alg:type_assertion_schema_inference}
\end{comments}
...
\begin{comments}
  \item Rule application is implemented programmatically in \cite{notebook:code}, in the function
    \WriteCodeRef{def:type_derivation_tree}
\end{comments}
...
\begin{comments}
  \item Many of these examples are verified programmatically in \cite{notebook:code}, in the modules
    \WriteCodeRefText{math.lambda_.type_derivation.test_tree}
  and
    \WriteCodeRefText{math.lambda_.type_derivation.test_inference}
\end{comments}
...
\begin{comments}
  ...
  \item This algorithm is implemented in \cite{notebook:code} as
    \WriteCodeRef{alg:simply_typed_combinator_type_derivation}
\end{comments}
