...
\begin{comments}
  ...
  \incite[note 2A5.2]{Hindley1997BasicSTT} considers contexts to be unordered, but does not go beyond simple types.
\end{comments}
...
\begin{concept}\label{con:simple_type_theory}
  ...
  \begin{thmenum}
    \thmitem{con:simple_type_theory/hol} The original usage, due to \bycite[56]{Church1940STT}, allows two base types, arrow types and no type variables, with the specific typing rules listed in \cref{def:hol_typing_rules}. This system is intended to serve as a foundation for \hyperref[def:higher_order_logic]{higher-order logic}.
