...
\begin{comments}
  ...
  \item Both typed and untyped \( \muplambda \)-terms are implemented in \cite{notebook:code}, in the module
    \WriteCodeRefText{lambda_.terms}

  A parser is implemented in
    \WriteCodeRefText{lambda_.parsing}
\end{comments}
...
\begin{comments}
  \item Many of these examples are verified programmatically in \cite{notebook:code}, in the modules
    \WriteCodeRefText{lambda_.type_derivation.test_tree}
  and
    \WriteCodeRefText{lambda_.type_derivation.test_inference}
\end{comments}
