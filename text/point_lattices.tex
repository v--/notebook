...
\begin{remark}\label{rem:lattice_terminology}
  ...
  \begin{itemize}
    ...
    \item Explicit definitions of point lattices are given in
    \cite[\S I.2]{Cassels1997NumberGeometry},
    \cite[\S 9.14.29]{Berger1987GeometryI},
    \cite[28]{GrünbaumShephard1987TilingsAndPatterns},
    \cite[1]{Rogers1964PackingAndCovering},
    \cite[356]{Gruber2007ConvexAndDiscreteGeometry},
    \cite[376]{Винберг2014КурсАлгебры} (as \enquote{\textru{решётка}}) and
    \cite[155]{Шафаревич2019ОсновныеПонятияАлгебры} (as \enquote{\textru{решётка}}).

    \item Explicit definitions for order-theoretic lattices are given in
    \cite[6]{Birkhoff1967LatticeTheory},
    \cite[9]{Grätzer2011LatticeTheory},
    \cite[def. 1.6.14]{Harzheim2005OrderedSets},
    \cite[def. 2.4]{DaveyPriestley2002LatticeTheory},
    \cite[40]{HalmosGivant2009BooleanAlgebras},
    \cite[3]{Johnstone1982StoneSpaces},
    \cite[80]{Kelley1975GeneralTopology},
    \cite[145]{Bourbaki2004TheoryOfSets},
    \cite[exerc. VI.2.1]{MacLane1998CategoryTheory},
    \cite[248]{Stanley2012EnumerativeCombinatoricsVol1},
    \cite[192]{Carothers2000RealAnalysis},
    \cite[3]{HillePhillips1996FunctionalAnalysis},
    \cite[2]{Yoshida1980FunctionalAnalysis},
    \cite[210]{Rotman2015AdvancedModernAlgebraPart1},
    \cite[def. 8.2]{Jacobson1985BasicAlgebraI},
    \cite[227]{Cohn2013MeasureTheory} (only for lattices of vectors),
    \cite[def. 6.5.1]{Bobrowski2005FunctionalAnalysis} (only for lattices of continuous functions),
    \cite[174]{GelbaumOlmsted2003CounterexamplesInAnalysis} (also only for lattices of continuous functions),
    \cite[46]{CitkinMuravitsky2022ConsequenceRelations} (only for distributive lattices),
    \cite[10]{Barendregt1984LambdaCalculus} (only for complete lattices).

    In Russian, \enquote{решётка} (\enquote{lattice}) is mostly used, for example by
    \cite[127]{Гуров2013ТеорияРешёток},
    \cite[129]{Мальцев1970АлгебраическиеСистемы},
    \cite[\S 2.1.2]{КусраевКутателадзе2005БулевозначныйАнализ},
    \cite[212]{БелоусовТкачёв2004ДискретнаяМатематика} and
    \cite[360]{КанторовичАкилов1984ФункциональныйАнализ},
    however \enquote{структура} (\enquote{structure}) is sometimes used in older literature, for example by
    \cite[16]{Владимиров1969БулевыАлгебры}
    \cite[58]{Ляпин1960Полугруппы} and
    \cite[178]{Курош1973ОбщаяАлгебра} (who doesn't even mention \enquote{решётка}).
  \end{itemize}
\end{remark}
