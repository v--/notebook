...
\begin{comments}
  ...
  \item \Textcite[405]{BoydVandenberghe2004ConvexOptimization} define a \enquote{configuration} as finite subset of an Euclidean space, in the context of convex optimization.
\end{comments}
...
\begin{remark}\label{rem:lattice_terminology}
  ...
  \begin{itemize}
    ...
    \textcite[155]{Шафаревич1999ОсновныеПонятияАлгебры} (as \enquote{\textru{решётка}}).
    ...
    \textcite[def. 6.14]{Harzheim2005OrderedSets},
