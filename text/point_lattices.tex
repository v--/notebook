...
\begin{proof}
  ...
  The intersection of subgroups is a subgroup by \cref{thm:intersection_of_fol_submodels}, so \( L_m \) is indeed a discrete subgroup of \( L \). Furthermore, since \( L \) spans \( \BbbR^n \), \( L_m \) spans \( V_m \). Thus, the problem is well-posed, and we can begin.
