...
\begin{remark}\label{rem:lattice_terminology}
  ...
  \begin{itemize}
    ...
    \incite[376]{Винберг2014КурсАлгебры} (as \enquote{\textru{решётка}}) and
    \incite[155]{Шафаревич1999ОсновныеПонятияАлгебры} (as \enquote{\textru{решётка}}).
...
\begin{comments}
  ...
  \begin{itemize}
    ...
    \item \incite[92]{ГашковЧубариков2005СложностьВычисления} (as \enquote{\textru{целочисленная решётка}}) in the context of number geometry (which applies Euclidean geometry to number theory).
    \item \incite[256]{БолтянскийЯглом1966Равносоставленость} (as \enquote{\textru{целочисленная решётка}}) in the context of \hyperref[def:euclidean_plane]{plane geometry}.
    \item \incite[348]{Зыков2004ТеорияГрафов} (as \enquote{\textru{целочисленная решётка}}) in the context of \hyperref[def:graph_geometric_realization/embedding]{graph embeddings}.
  \end{itemize}
