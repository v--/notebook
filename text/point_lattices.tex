...
\begin{remark}\label{rem:lattice_terminology}
  ...
  \begin{itemize}
    ...
    \incite[\S 9.14.29]{Berger1987GeometryVol1},
    ...
    \incite[2]{Yoshida1980FuncAnalysis},
    \incite[210]{Rotman2015AlgebraVol1},
    \incite[def. 8.2]{Jacobson1985AlgebraPart1},
    \incite[171]{Bennett1995Geometry},
    \incite[227]{Cohn2013Measures} (only for lattices of vectors),
    \incite[def. 6.5.1]{Bobrowski2005FuncAnalysis} (only for lattices of continuous functions),
