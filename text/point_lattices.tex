...
\begin{remark}\label{rem:lattice_terminology}
  ...
  \begin{itemize}
    ...
    \incite[53]{Roman2008LatticeTheory},
    ...
    \incite[171]{Bennett1995AffineAndProjectiveGeometry},
    ...
    \incite[79]{БогомоловСалий1997ДискретныеСистемы},
...
\begin{comments}
  ...
  \begin{itemize}
    ...
    \item \incite[77]{Hatcher2002AlgebraicTopology} in the context of \hyperref[def:group_action]{group actions}.
    ...
    \item \incite[348]{Зыков2004ТеорияГрафов} (as \enquote{целочисленная решётка}) in the context of \hyperref[def:graph_embeddings]{graph embeddings}.
  \end{itemize}
