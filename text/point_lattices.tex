...
\begin{comments}
  ...
  \item Primitive vectors as standalone objects are discussed in \incite[24]{Cassels1997NumberGeometry} and \incite[358]{Gruber2007Geometry}, however we wanted to highlight the construction of primitive vectors from existing ones.
\end{comments}
