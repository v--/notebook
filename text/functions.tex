...
\begin{definition}\label{def:set_valued_map}\mcite[def. 1.3.1]{AubinFrankowska1990SetValued}
  ...
  \begin{thmenum}[series=def:set_valued_map]
    ...
    \thmitem{def:set_valued_map/partial}\mcite[41]{Rosen1999DiscreteHandbook} We say that \( F \) is \term{partial} if \( F(x) = \varnothing \) for some \( x \in A \) and \term{total} otherwise.
