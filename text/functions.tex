...
\begin{remark}\label{rem:undefined_and_primitive_terms}
  Both \incite[57]{Church1956LogicVol1} and \incite[28]{Kleene1971Metamathematics} use the adjective \enquote{undefined} for the symbols that are considered primitive rather than defined via others. As discussed in \fullref{con:primitive_notion}, we call such symbols \enquote{primitive} to prevent confusion with the notion of undefinedness which we present in \fullref{con:undefinedness}.
