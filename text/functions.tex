...
\begin{comments}
  ...
  \incite[\S 3.2]{Farmer2008STTVirtues} suggests a dedicated constant \( \bot_\tau \) as an undefined value of type \( \tau \) in his presentation of \hyperref[rem:simply_typed_hol]{simply typed higher-order logic}. This is done specifically to provide well-behaved semantics for the \hyperref[con:description_operator/iota]{definite description operator}.

  \item \incite[475]{Farmer2004Undefinedness} describes undefinedness as follows:
  \begin{displayquote}
...
\begin{comments}
  ...
  \incite[prop. 4.42(a)]{Mendelson2015Logic},
