...
\begin{remark}\label{rem:function_superposition}
  Although the terms \enquote{composition} and \enquote{superposition} are used interchangeably, for example by \incite[\textnumero 25]{ФихтенгольцОсновыТом1}, the term \enquote{superposition} often refers to a certain generalization of \hyperref[def:set_valued_map/composition]{function composition}. The latter is used by Sergey Yablonsky in \cite[16]{Яблонский1986}.
