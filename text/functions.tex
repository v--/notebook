...
\begin{comments}
  ...
  \incite[\S 3.2]{Farmer2008STTVirtues} suggests a dedicated constant \( \bot_\tau \) as an undefined value of type \( \tau \) in his presentation of \hyperref[def:simply_typed_hol]{higher-order logic}. This is done specifically to provide well-behaved semantics for the \hyperref[con:denotation/iota]{definite description operator}.
