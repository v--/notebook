...
\begin{remark}\label{rem:disjoint_unions}
  ...
  We do not usually care about the particular construction. In accordance with \cref{rem:definition_via_characterization}, we will provide a \enquote{canonical} disjoint union definition in \cref{def:disjoint_union}, and, after proving \fullref{thm:disjoint_union_universal_property}, only rely on the canonical inclusion maps.
\end{remark}
