...
\begin{remark}\label{rem:undefined_and_primitive_terms}
  ...
  Their notion of undefinedness is distinct from the one we present in \fullref{con:undefinedness} --- they delegate the semantics of an undefined expression to the \hyperref[con:metalogic]{metatheory}, while the notion presented here signifies that the expression has no intended semantics.
\end{remark}
