...
\begin{comments}
  ...
  \begin{itemize}
    ...
    \item \( B^A \), which is consistent with \hyperref[def:cardinal_arithmetic/exponentiation]{cardinal exponentiation} (used by Paolo Aluffi in \cite[example 3.2]{Aluffi2009}).
...
\begin{remark}\label{rem:implicit_function_notation}
  ...
  \begin{itemize}
    \item Quotient maps such as \( H \mapsto H / N \) from \fullref{thm:quotient_structure_lattice_theorem}.
