...
\end{definition}
\begin{comments}
  \item In logic, it makes sense to regard \( 1 \) and \( 0 \) as general \hyperref[def:truth_value_algebra]{Boolean values}. Generally, however, characteristic functions are used in measure theory, where their numerical values are important.
