    ...
    \begin{forest}
      [
        {\hyperref[def:topological_space]{Topological} \\ \hyperref[def:topological_space]{space}}, align=center, name=topological
          [
            {\hyperref[def:topological_lattice]{Topological} \\ \hyperref[def:topological_lattice]{lattice}}, align=center, tier=group, name=lattice
              [
                {\hyperref[def:topological_vector_lattice]{Topological} \\ \hyperref[def:topological_vector_lattice]{vector lattice}}, align=center, tier=normed, name=vector_lattice
                  [
                    {\hyperref[def:normed_vector_lattice]{Normed} \\ \hyperref[def:normed_vector_lattice]{vector lattice}}, align=center, tier=riemannian, name=normed_lattice
                      [{\hyperref[def:normed_vector_lattice]{Banach} \\ \hyperref[def:normed_vector_lattice]{lattice}}, align=center, name=banach_lattice]
                  ]
              ]
          ]
          [
