...
\begin{figure}
  \caption{Some important types of topological spaces}\label{fig:topological_space_kind_hierarchy}
  \smallskip
  \hfill
  \begin{forest}
    for tree={s sep=0cm}
