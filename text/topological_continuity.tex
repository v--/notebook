\section{Topological continuity}\label{sec:topological_continuity}
...
\begin{definition}\label{def:global_continuity}
  ...
  \begin{thmenum}
    \thmitem{def:global_continuity/limits} \( f \) is continuous at every point of \( X \) in the sense of \cref{def:local_continuity}.
...
\end{definition}
\begin{proof}
  \ImplicationSubProof{def:global_continuity/limits}{def:global_continuity/open} Follows from \cref{def:local_convergence/neighborhoods}.
  ...
  \ImplicationSubProof{def:global_continuity/subbase}{def:global_continuity/limits} Follows from the equivalences in \cref{def:local_convergence}.
...
\end{definition}
\begin{comments}
  \item For the etymology of the word \enquote{homeomorphism}, see \cref{rem:morphism_etymology}.
\end{comments}
