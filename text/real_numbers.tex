...
\begin{proposition}\label{thm:nth_root_polynomial}
  The \( n \)-th \hyperref[def:nth_root]{root} \( \sqrt[n]{ P } \) of a nonnegative \hyperref[def:real_numbers]{real number} \( P \) is a \hyperref[def:polynomial_root]{polynomial root} of the \hyperref[def:polynomial_algebra/polynomials]{polynomial} \( X^n - P \).
