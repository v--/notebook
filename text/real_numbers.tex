...
\begin{proposition}\label{thm:field_of_real_numbers}
  ...
  \begin{thmenum}[resume=thm:field_of_real_numbers]
    ...
    \thmitem{thm:field_of_real_numbers/field_embedding} The \hyperref[def:preordered_set/homomorphism]{order embedding} \( \iota(a) = \BbbQ_{<a} \) from \cref{def:lower_cut_completion} is a \hyperref[def:field/morphism]{field embedding} of \( \BbbQ \) into \( \BbbR \).
  \end{thmenum}
\end{proposition}
\begin{proof}
