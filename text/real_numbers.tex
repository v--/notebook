...
\begin{proposition}\label{thm:def:real_nth_root}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:def:real_nth_root/polynomial} \( \sqrt[n]{ A } \) is a \hyperref[def:multiple_root]{polynomial root} of the \hyperref[def:polynomial_algebra/polynomials]{polynomial} \( X^n - A \) over the real numbers.
