...
\begin{definition}\label{def:algebra_over_ring}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:algebra_over_ring/trivial} The \hyperref[def:trivial_structure]{trivial} \( R \)-algebra is the \hyperref[rem:pointed_set/trivial]{trivial pointed set} \( \set{ 0_R } \). It is isomorphic to \hyperref[thm:substructures_form_complete_lattice/bottom]{initial substructure} of any \( R \)-algebra.
