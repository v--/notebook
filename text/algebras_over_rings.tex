...
\begin{comments}
  ...
  \item The letter \( \BbbH \) is chosen in honor of William Hamilton, who introduced them in a \enquote{multi-part paper over the course of several years, from 1846 to 1850. The compiled paper can be found in \cite{Hamilton2000Quaternions}.
\end{comments}
