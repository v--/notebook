...
\begin{proof}
  ...
  Denote by \( L \) the set of all leading coefficients of polynomials in \( I \). \Cref{thm:univariate_polynomial_product/leading} implies that the leading coefficient of the product of univariate polynomials is the product of their leading coefficients, hence \( L \) is an ideal as a consequence of \( I \) being an ideal.
