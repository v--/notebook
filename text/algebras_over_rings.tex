...
\begin{definition}\label{def:algebra_over_ring}\mcite[15]{Kaplansky1974CommutativeRings}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:algebra_over_ring/kernel}\mimprovised \Cref{thm:ring_zero_morphisms/kernel} implies that the \hyperref[def:categorical_kernels/kernel]{categorical kernel} of a homomorphism \( \varphi: M \to N \) between \emph{nonunital} \( R \)-algebras is the additive group kernel
    \begin{equation*}
