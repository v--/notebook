...
\begin{definition}\label{def:algebra_over_ring}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:algebra_over_ring/bottom} The \hyperref[thm:substructures_form_complete_lattice/bottom]{bottom substructure} of any \( R \)-algebra is isomorphic to the trivial \( R \)-algebra.
...
\begin{theorem}[Quotient ideal lattice theorem]\label{thm:lattice_theorem_for_rings}
  ...
  Compare this result to \fullref{thm:quotient_structure_lattice_theorem} and \fullref{thm:lattice_theorem_for_submodules}.
\end{theorem}
\begin{proof}
  \SubProof{Proof for general ideals} Simple refinement of \fullref{thm:quotient_structure_lattice_theorem}.
