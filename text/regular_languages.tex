...
\end{algorithm}
\begin{comments}
  \item This algorithm can be found as \identifier{math.grammars.regular.to_finite_automaton} in \cite{notebook:code}.
\end{comments}
...
\end{algorithm}
\begin{comments}
  \item This algorithm can be found as \identifier{math.grammars.regular.from_finite_automaton} in \cite{notebook:code}.
\end{comments}
