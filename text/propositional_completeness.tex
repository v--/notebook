...
\begin{proposition}\label{thm:lindenbaum_tarski_theories}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:lindenbaum_tarski_theories/consistent} The theory \( \Delta \) is \hyperref[def:propositional_theory/consistent]{inconsistent} if and only if \( \pi[\Delta] = \BbbL \).
