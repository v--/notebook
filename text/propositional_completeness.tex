...
\end{corollary}
\begin{comments}
  \item This statement has an analog for \hyperref[def:first_order_logic]{first-order logic} --- see \cref{thm:fol_consistent_implies_satisfiable}.
\end{comments}
\begin{proof}
...
\begin{comments}
  ...
  \item This is the classical counterpart of \fullref{thm:intuitionistic_propositional_completeness} and the propositional counterpart of \fullref{thm:fol_completeness}.
\end{comments}
\begin{proof}
  ...
  The set \( \Gamma \cup \set{ \neg \varphi } \) must be \hyperref[def:propositional_theory/consistent]{inconsistent} since otherwise \cref{thm:propositional_consistent_implies_satisfiable} would imply that it is satisfiable.
