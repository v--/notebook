...
\begin{definition}\label{def:propositional_theory}\mimprovised
  ...
  \begin{thmenum}
    ...
    \thmitem{def:propositoinal_theory/conservative} As in \cref{def:entailment_system_theory/conservative}, we say that a theory extension \( \Delta \) of \( \Gamma \) is \term{conservative} when \( \Gamma \nvdash \varphi \) implies \( \Delta \nvdash \varphi \).
