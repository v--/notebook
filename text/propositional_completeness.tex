...
\begin{lemma}[Lindenbaum's lemma for propositional logic]\label{thm:propositional_lindenbaums_lemma}
  For the \hyperref[def:propositional_natural_deduction_system]{classical propositional natural deduction system}, every \hyperref[def:propositional_theory/consistent]{consistent} set of sentences can be extended to a \hyperref[def:propositional_theory/complete]{complete} consistent \hi{theory}.
\end{lemma}
\begin{comments}
