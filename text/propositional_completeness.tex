...
\begin{corollary}\label{thm:propositional_consistent_implies_satisfiable}
  If a set of sentences is \hyperref[def:propositional_theory/consistent]{consistent} with respect to \hyperref[def:propositional_natural_deduction_system]{classical propositional natural deduction}, it is \hyperref[def:propositional_semantics/satisfaction]{satisfiable} with respect to \hyperref[def:truth_value_algebra/classical]{classical semantics}.
\end{corollary}
\begin{comments}
...
\end{comments}
\begin{proof}
  Let \( \Gamma \) be a consistent set of formulas. Denote by \( T \) the \hyperref[def:propositional_theory/complete]{complete} consistent theory extending \( \Gamma \), which we obtain from \cref{thm:propositional_lindenbaums_lemma}.
