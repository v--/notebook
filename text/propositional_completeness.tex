...
\begin{proof}
  ...
  Clearly \( \Gamma, \varphi \vdash \varphi \). Aiming at a contradiction, suppose that \( \Gamma \not\vdash \varphi \). Then, by assumption, we have \( \Gamma \vdash \synneg \varphi \), and, after adding \( \varphi \) as a hypothesis, we have \( \Gamma, \varphi \vdash \synneg \varphi \). Then \( \Gamma \cup \set{ \varphi } \) satisfies \cref{thm:propositional_syntactic_inconsistency/bot} and is thus inconsistent, contradicting our assumption.
