...
We denote orders using symbols rather than letters because it is customary to write orders using \hyperref[def:function_application_notation]{infix notation}, e.g. \( a \leq b \) rather than \( (a, b) \in {\leq} \).
