...
\begin{proposition}\label{thm:hypergraph_representation}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:hypergraph_representation/equivalence} The category of hypergraphs and hypergraph homomorphisms is \hyperref[def:isomorphism_of_categories]{isomorphic} to the category of small \( 2 \)-colored simple undirected graphs and color-preserving graph homomorphisms.
  \end{thmenum}
\end{proposition}
\begin{comments}
