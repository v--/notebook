...
\begin{comments}
  ...
  \item Some authors like \incite[119]{Diestel2017Graphs}, \incite[126]{Harary1969Graphs}, \incite[145]{Bollobas1998Graphs} and \incite[374]{Новиков2013ДискретнаяМатематика} do not distinguish between proper and improper colorings by requiring all colorings to be proper.
...
\end{definition}
\begin{comments}
  \item Different authors use a different notation for chromatic numbers. We use \enquote{\( \chi \)} similarly to \incite[119]{Diestel2017Graphs}, \incite[145]{Bollobas1998Graphs}, \incite[152]{Knauer2019AlgGraphTheory}, \incite[235]{ЕмеличевИПр1990Графы} and \incite[374]{Новиков2013ДискретнаяМатематика}. \incite[28]{GondranMinoux1984Graphs} use \enquote{\( \gamma \)}, while \incite[142]{Мирчев2001Графи} uses \enquote{\( \varkappa \)}.
\end{comments}
