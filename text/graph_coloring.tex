...
\begin{comments}
  ...
  \item Some authors like \incite[119]{Diestel2017Graphs}, \incite[126]{Harary1969Graphs}, \incite[145]{Bollobás1998Graphs}, \incite[def. 10.8.1]{Rosen2019DiscreteMathematics} and \incite[374]{Новиков2013ДискретнаяМатематика} do not distinguish between proper and improper colorings by requiring all colorings to be proper.
...
\end{definition}
\begin{comments}
  \item Different authors use a different notation for chromatic numbers. We use \enquote{\( \chi \)} similarly to \incite[119]{Diestel2017Graphs}, \incite[145]{Bollobás1998Graphs}, \incite[152]{Knauer2019AlgGraphTheory}, \incite[def. 10.8.2]{Rosen2019DiscreteMathematics}, \incite[235]{ЕмеличевИПр1990Графы} and \incite[374]{Новиков2013ДискретнаяМатематика}. \incite[28]{GondranMinoux1984Graphs} use \enquote{\( \gamma \)}, while \incite[142]{Мирчев2001Графи} uses \enquote{\( \varkappa \)}.
\end{comments}
...
\begin{comments}
  ...
  The theorem has later been restated and re-proved multiple times. We generalized the statement and proof from \incite[thm. VI.1]{Bollobás1998Graphs} to \( r \) colors rather than only \( 2 \).
\end{comments}
\begin{proof}
...
\begin{definition}\label{def:ramsey_number}\mcite[183]{Bollobás1998Graphs}
...
\end{definition}
\begin{comments}
  \item We avoid defining Ramsey numbers for \( r = 1 \) due to possible ambiguity. \incite[183]{Bollobás1998Graphs} defines \( R(s) \) to be \( R(s, s) \), while our general definition would suggest that \( R(s) \) should instead be the degenerate case of monochromatic coloring.
\end{comments}
