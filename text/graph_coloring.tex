...
\begin{comments}
  ...
  \item Some authors like \textcite[119]{Diestel2017GraphTheory}, \textcite[126]{Harary1969GraphTheory}, \textcite[145]{Bollobás1998ModernGraphTheory}, \textcite[def. 10.8.1]{Rosen2019DiscreteMathematics} and \textcite[374]{Новиков2013ДискретнаяМатематика} do not distinguish between proper and improper colorings by requiring all colorings to be proper.

  We prefer the more explicit terminology of \mcite[395]{Erickson2019Algorithms}, \textcite[\S 53]{ЕмеличевИПр1990ТеорияГрафов} and \textcite[141]{Мирчев2001Графи}.
\end{comments}
...
\end{definition}
\begin{comments}
  \item Different authors use a different notation for chromatic numbers. We use \enquote{\( \chi \)} similarly to \textcite[119]{Diestel2017GraphTheory}, \textcite[145]{Bollobás1998ModernGraphTheory}, \textcite[152]{Knauer2019AlgebraicGraphTheory}, \textcite[def. 10.8.2]{Rosen2019DiscreteMathematics}, \textcite[235]{ЕмеличевИПр1990ТеорияГрафов} and \textcite[374]{Новиков2013ДискретнаяМатематика}. \Textcite[28]{GondranMinoux1984GraphsAndAlgorithms} use \enquote{\( \gamma \)}, while \textcite[142]{Мирчев2001Графи} uses \enquote{\( \varkappa \)}.
\end{comments}
