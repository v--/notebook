...
\begin{example}\label{ex:ramsey_party_problem}
  ...
  Compare this to the considerably easier problem from \cref{ex:thm:pigeonhole_principle/party}, in which we are interested in how many people know \hi{everybody else}.
