...
\begin{remark}\label{rem:estimating_ramsey_numbers}
  ...
  If we are lucky, exhaustive search can yield a result early. In \cite{notebook:code}, the function \identifier{math.combinatorics.ramsey.compute_ramsey_number_exhaustively} needs to only check \( \numprint{221} \) colorings and a total of \( \numprint{729} \) triangles to conclude that \( R(3, 3) = 6 \).
