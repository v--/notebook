...
\begin{proof}
  ...
  \begin{equation*}
    \begin{prooftree}
      ...
      \infer1[\eqref{eq:def:propositional_natural_deduction_systems/or/intro_left}]{ \theta[\xi \mapsto 0] }
      ...
      \infer1[\eqref{eq:def:propositional_natural_deduction_systems/or/intro_right}]{ \theta[\xi \mapsto s(\eta)] }
      \infer1[\eqref{eq:def:propositional_natural_deduction_systems/imp/intro}]{ \theta[\xi \mapsto \eta] \synimplies \theta[\xi \mapsto s(\eta)] }
      ...
      \infer2[\eqref{eq:def:propositional_natural_deduction_systems/and/intro}]{ \theta[\xi \mapsto 0] \synwedge \qforall \eta \parens[\Big] { \theta[\xi \mapsto \eta] \synimplies \theta[\xi \mapsto s(\eta)] } }
    \end{prooftree}
  \end{equation*}
