...
\begin{definition}\label{def:graph_cycle}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:graph_cycle/degree}\mcite[13]{GondranMinoux1984GraphsAndAlgorithms} In the \hyperref[def:graph_walk/subgraph]{induced subgraph} of the walk, every vertex has \hyperref[def:graph_cardinality/directed_degree]{degree} \( 2 \).
  \end{thmenum}
\end{definition}
\begin{defproof}
