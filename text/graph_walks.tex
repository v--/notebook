...
\begin{definition}\label{def:graph_bridge}
  ...
  \begin{thmenum}
    \thmitem{def:graph_bridge/components}\mcite[6]{Bollobas1998} After removing it from its \hyperref[def:graph_connected_component]{connected component}, it is no longer connected.
