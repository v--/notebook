...
\begin{remark}\label{rem:graph_walk_terminology}
  ...
  \begin{thmenum}
    ...
    \begin{itemize}
      \item \incite[6]{König1990GraphTheory} (originally \enquote{Kantenfolge}, literally \enquote{edge sequence}) for a finite graph whose arcs or edges can be \hyperref[def:enumeration]{enumerated}, with repetition allowed, so that consecutive arcs/edges in the sequence have a common vertex.
