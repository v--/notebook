...
\begin{remark}\label{rem:graph_walk_terminology}
  ...
  \begin{thmenum}
    ...
    \begin{itemize}
      \item \incite[13]{Harary1969Graphs} and \incite[5]{Bollobas1998Graphs} for walks with no repeated arcs.
    \end{itemize}
