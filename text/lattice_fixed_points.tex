...
\begin{comments}
  ...
  \item This theorem is called \enquote{constructive} by \incite{Echenique2005TarskiFixedPointTheorem}, but it utilizes \fullref{thm:propositional_semantic_dne}, so it can be argued that it is not, in fact, constructive, at least not in the sense of the \hyperref[con:brouwer_heyting_kolmogorov_interpretation]{Brouwer-Heyting-Komogorov interpretation}.
