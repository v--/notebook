...
\begin{definition}\label{def:lipschitz_continuity}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:lipschitz_continuity/calm}\mcite[53]{DontchevRockafellar2014} We say that \( f \) is \term{calm} at \( x \) if it satisfies the Lipschitz condition with one of the points fixed:
    \begin{equation*}
