...
\begin{definition}\label{def:separation_axioms}
  ...
  \begin{thmenum}
    ...
    \thmitem[def:separation_axioms/T6]{T6} If every closed set in a \( T_4 \) space \( X \) is \( G_\delta \) (see \cref{def:borel_hierarchy}), we say that \( X \) is a \( T_6 \) space or a \term{perfectly normal space}.
  \end{thmenum}
\end{definition}
