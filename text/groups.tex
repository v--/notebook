...
\begin{definition}\label{def:group}\mcite[29]{Ляпин1960Полугруппы}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:group/category}\mcite[12]{MacLane1998CategoryTheory} We denote the \hyperref[def:category_of_first_order_models]{category of \( \mscrU \)-small models} of groups by \( \ucat{Grp} \).
