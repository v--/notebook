...
\begin{definition}\label{def:group}\mcite[29]{Ляпин1960Полугруппы}
  ...
  \begin{thmenum}
    \thmitem{def:group/theory}\mimprovised To obtain a \hyperref[def:fol_theory]{first-order theory} for groups, we can extend the \hyperref[def:monoid/theory]{theory of monoids} by adding a unary \hyperref[def:fol_signature/functions]{functional symbol} \( (\anon)^{-1} \) to the language and then adding the axiom
    ...
    As a consequence of \cref{thm:positive_formulas_preserved_under_homomorphism}, the image of a group homomorphism is a subgroup of its codomain.
