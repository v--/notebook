...
\begin{definition}\label{def:zero_morphisms}
  ...
  \begin{thmenum}
    \thmitem{def:zero_morphisms/morphism}\mcite[20]{MacLane1994} For every pair of objects \( A \) and \( B \) in \( \cat{C} \), there exists unique morphism, called the \term{zero morphism}, that \hyperref[def:factors_through]{uniquely factors through} \( Z \):
