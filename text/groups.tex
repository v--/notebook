...
\end{definition}
\begin{comments}
  \item If the order is infinite, it can only be countably infinite. Following \cref{rem:lemniscate_symbol}, we will use the symbol \( \infty \) rather than \( \omega \) for infinite order.
