...
\begin{definition}\label{def:group}\mcite[29]{Ляпин1960Полугруппы}
  A \term[bg=група (\cite[def. IV.2]{ГеновИПр1991Алгебра}), ru=группа (\cite[def. 4.1.2]{Винберг2014Алгебра})]{group} is a \hyperref[def:monoid]{monoid} in which every element has a \hyperref[def:monoid_inverse]{two-sided inverse}. They are the most well-studied and most well-behaved semigroups.
