...
\end{proposition}
\begin{comments}
  \item This allows to define a group homomorphism without requiring it to preserve neutral elements and inverses like \cref{def:first_order_homomorphism} suggests.
\end{comments}
\begin{proof}
