...
\begin{proposition}\label{thm:def:group}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:def:group/zero_kernel} The \hyperref[def:group/kernel]{kernel} of a group homomorphism \( \varphi: G \to H \) is trivial if and only if \( \varphi \) is an \hyperref[def:first_order_isomorphism]{embedding} (injective homomorphism).
