...
\begin{definition}\label{def:group}\mcite[29]{Ляпин1960Полугруппы}
  A \term[bg=група (\cite[372]{Обрешков1962ВисшаАлгебра}), ru=группа, en=group (\cite[49]{Jacobson1985AlgebraI})]{group} is a \hyperref[def:monoid]{monoid} in which every element has a \hyperref[def:monoid_inverse]{two-sided inverse}. They are the most well-studied and most well-behaved semigroups.
...
\begin{definition}\label{def:normal_closure}\mcite[506]{Jacobson1989AlgebraII}
...
\begin{definition}\label{def:group_order}\mcite[30]{Jacobson1985AlgebraI}
