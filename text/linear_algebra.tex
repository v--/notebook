...
\begin{itemize}
  ...
  \item Linear spans, defined in \cref{def:semimodule/subobject} and characterized via \cref{thm:span_via_linear_combinations}.
  \item Linear maps, defined in \cref{def:semimodule/morphism}, and multilinear maps, defined in \cref{def:multilinear_function}.
