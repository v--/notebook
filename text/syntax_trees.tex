...
\begin{comments}
  ...
  \item This algorithm can be found as \identifier{math.grammars.brute_force_parse.parse} in \cite{notebook:code}.
...
\end{algorithm}
\begin{comments}
  \item This algorithm can be found as \identifier{math.grammars.parse_tree.parse_tree_to_derivation} in \cite{notebook:code}.
\end{comments}
