...
\begin{definition}\label{def:parse_tree}\mcite[\S 2.2.3]{Aho2006}
...
\begin{comments}
  ...
  \item Although we generally follow the definition from \cite[\S 2.2.3]{Aho2006}, we disallow parse trees for strings containing nonterminals, and thus we do not need to specially handle \( \bnfes \)-labeled nodes.
\end{comments}
...
\begin{definition}\label{def:parse_tree_string}\mcite[\S 2.2.3]{Aho2006}
