...
\begin{remark}\label{rem:primitive_element_terminology}
  ...
  \begin{itemize}
    ...
    \item \incite[A.V.40]{Bourbaki2003Algebra4to7}, \incite[214]{Jacobson1985BasicAlgebraI} and \incite[244]{Lang2002Algebra} use \enquote{primitive element} for what we call a \enquote{generator of a \hyperref[def:simple_extension]{simple field extension}}.
  \end{itemize}
\end{remark}
