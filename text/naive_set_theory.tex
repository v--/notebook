...
\begin{proof}
  ...
  Thus, \( \psi \) and \( \synneg\psi \) are both derivable in the same theory, and we can use \ref{eq:def:propositional_natural_deduction_systems/neg/elim} to also derive \( \synbot \), which shows that na\"ive set theory is inconsistent.
\end{proof}
