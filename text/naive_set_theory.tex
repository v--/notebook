...
\end{definition}
\begin{comments}
  \item The term \enquote{subsingleton} is used in \cite[112]{UnivalentFoundationsProgram2024OctoberHoTT} in the context of \hyperref[con:n_type]{\( n \)-types}, but not in axiomatic set theory.
