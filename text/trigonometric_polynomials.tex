...
\begin{definition}\label{def:trigonometric_polynomial}
  ...
  \end{equation}
  or, using \hyperref[thm:exponential_trigonometric_identities/eulers_formula]{Euler's formula}, rewritten in the more conventional notation (see \cite[1]{Боянов2008ЧислениМетоди} or \cite[88]{Rudin1987RealAndComplex}):
