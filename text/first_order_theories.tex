...
\end{definition}
\begin{comments}
  \item We adapt this definition to groups in \cref{def:group/simple}, to rings in \cref{def:ring/simple} and to \( R \)-modules in \cref{def:module/simple}.
...
\begin{proposition}\label{thm:fol_categorical_theories}
  \hyperref[def:fol_theory/theory]{Categorical theories} have the following basic properties:
  \begin{thmenum}
