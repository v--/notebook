...
\begin{example}\label{ex:def:fol_definitional_extension}
  ...
  \begin{thmenum}
    ...
    \thmitem{ex:def:fol_definitional_extension/lattices} The \hyperref[def:lattice/theory]{theory of lattices} is only formulated using function symbols, and is adapted to the \hyperref[def:partially_ordered_set/theory]{theory of preordered sets} via definitional extensions.
  \end{thmenum}
\end{example}
