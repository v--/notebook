...
\begin{remark}\label{rem:root_terminology}
  ...
  \begin{thmenum}
    ...
    \thmitem{rem:root_terminology/equation} The \hyperref[def:equation_solution]{solutions} of an \hyperref[def:polynomial_equation]{algebraic equation} are also called \enquote{roots}. An explicit definition with this usage can be found in \cite[2]{Обрешков1962ВисшаАлгебра}.
