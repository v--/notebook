...
\end{theorem}
\begin{comments}
  \item \Cref{thm:adjunction_from_universal_morphism/unit} implies that \( G \mapsto R[G] \) is \hyperref[def:adjoint_functor]{left adjoint} to the \hyperref[con:forgetful_functor]{forgetful functor} which sends associative \( R \)-algebras to their multiplicative semigroup.
\end{comments}
\begin{proof}
