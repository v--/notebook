...
\end{theorem}
\begin{comments}
  \item Via \fullref{rem:universal_mapping_property}, \( G \mapsto R[G] \) becomes \hyperref[def:categorb_adjunction]{left adjoint} to the \hyperref[def:concrete_category]{forgetful functor} which sends \( R \)-algebras to their multiplicative group.
\end{comments}
\begin{proof}
