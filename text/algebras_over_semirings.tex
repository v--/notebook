...
\begin{example}\label{ex:def:root_of_polynomial}
  ...
  \begin{thmenum}
    ...
    \Cref{thm:boolean_algebra_as_ring} allows us to regard it as a \hyperref[def:boolean_ring]{Boolean ring}, with \hyperref[def:symmetric_difference]{symmetric difference} as addition and intersection as multiplication.
