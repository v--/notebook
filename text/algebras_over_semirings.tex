...
\begin{proposition}\label{thm:semiring_is_natural_number_algebra}
  The \hyperref[def:category]{categories} \hyperref[def:semiring/category]{of semirings} and \hyperref[def:semimodule/category]{of associative \( \BbbN \)-algebras} are \hyperref[rem:category_similarity/isomorphism]{isomorphic}.
\end{proposition}
\begin{comments}
