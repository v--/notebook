...
\begin{definition}\label{def:algebra_over_semiring}\mimprovised
  ...
  \begin{thmenum}[resume=def:algebra_over_semiring]
    ...
    \thmitem{def:algebra_over_semiring/morphism}\mcite[def. III.1.2]{Bourbaki1998Algebra1to3} We say that the function \( \varphi: M \to N \) between \( R \)-algebras is \( R \)-\term{algebra homomorphism} if it is a \hyperref[def:linear_function]{linear map} that also preserves vector multiplication.
