...
\begin{definition}\label{def:polynomial_algebra}\mimprovised
  ...
  \begin{thmenum}
    ...
    We call elements of \( R[\mscrX] \) \term[bg=полиноми (\cite[22]{ГеновИПр1991Алгебра}), ru=многочлены (\cite[92]{Винберг2014Алгебра}; многочлены/полиномы (\cite[sec. 11.3]{Тыртышников2007ЛинАлгебра})]{polynomials}. A polynomial is thus a linear combination of monomials with the \hyperref[def:semigroup_algebra]{convolution product}.
...
\end{definition}
\begin{comments}
  \item \incite[898]{Rotman2010Algebra} and \incite[127]{Aluffi2009Algebra} discuss the ring of Laurent polynomials, but restrict themselves to one variable.
\end{comments}
