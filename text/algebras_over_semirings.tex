...
\begin{definition}\label{def:semigroup_algebra}
  ...
  \begin{equation}\label{eq:def:semigroup_algebra/multiplication}
    \parens[\Big]{ \Bbbsum_{x \in G} a_x \cdot y } \ast \parens[\Big]{ \Bbbsum_{y \in G} b_y \cdot y }
    \coloneqq
    \Bbbsum_{g \in G} \parens[\Big]{ \sum_{g = xy} a_x b_y } \cdot g.
  \end{equation}
...
\begin{defproof}
  ...
  \begin{align*}
    &\phantom{{}={}}
    \parens[\Bigg]{ \parens[\Big]{ \Bbbsum_{x \in G} a_x \cdot x } \ast \parens[\Big]{ \Bbbsum_{y \in G} b_y \cdot y } } \ast \parens[\Big]{ \Bbbsum_{z \in G} c_z \cdot z }
    \reloset {\eqref{eq:def:semigroup_algebra/multiplication}} = \\ &=
    \parens[\Big]{ \Bbbsum_{g \in G} \parens[\Big]{ \sum_{g = xy} a_x b_y } \cdot g } \ast \parens[\Big]{ \Bbbsum_{z \in G} c_z \cdot z }
    \reloset {\eqref{eq:def:semigroup_algebra/multiplication}} = \\ &=
    \Bbbsum_{h \in G} \parens[\Big]{ \sum_{h = kz} \parens[\Big]{ \sum_{g = xy} a_x b_y } c_z } \cdot h
    \reloset {\eqref{eq:def:semiring/theory/axioms/distributivity/right}} = \\ &=
    \Bbbsum_{h \in G} \parens[\Big]{ \sum_{h = (xy)z} (a_x b_y) c_z } \cdot h.
  \end{align*}

  Since both \( G \) and \( R \) have associative multiplication, the above can be rewritten as
  \begin{equation*}
    \Bbbsum_{h \in G} \parens[\Big]{ \sum_{h = g(hz)} a_x (b_y c_z) } \cdot h,
  \end{equation*}
  and so the above derivation can be backtracked to show that this product equals
  \begin{equation*}
    \parens[\Big]{ \Bbbsum_{x \in G} a_x \cdot g } \ast \parens[\Bigg]{ \parens[\Big]{ \Bbbsum_{y \in G} b_y \cdot h } \ast \parens[\Big]{ \Bbbsum_{z \in G} c_z \cdot z } }.
  \end{equation*}

  \SubProof{Proof that \( 1 \) is a multiplicative unit} We have
  \begin{equation*}
    1 \ast \parens[\Big]{ \Bbbsum_{x \in G} a_x \cdot x }
    =
    \Bbbsum_{g \in G} \parens[\Big]{ \sum_{g = 1_R \cdot_G x} 1_G \cdot a_x } \cdot g
    =
...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \begin{equation*}
      ...
      =
      \Bbbsum_{g \in G} \underbrace{\parens[\Big]{ \sum_{x y = g} a_x b_y }}_{\T{zero}} \cdot_M e(g).
    \end{equation*}
    ...
    \begin{equation}\label{eq:thm:semigroup_algebra_universal_property/second}
      \Bbbsum_{g \in G} \parens[\Big]{ \sum_{xy_{m+1} = g} a_x b_{y_{m+1}} } \cdot_M e(g).
    \end{equation}
    ...
    \begin{align*}
      ...
      = \\ &=
      \Bbbsum_{g \in G} \parens[\Big]{ \sum_{\substack{a y_i = g \\ 1 \leq y \leq m}} a_x b_{y_i} } \cdot_M e(g) + \Bbbsum_{g \in G} \parens[\Big]{ \sum_{xy_{m+1} = g} a_x b_{y_{m+1}} } \cdot_M e(g)
      = \\ &=
      \Bbbsum_{g \in G} \parens[\Big]{ \sum_{\substack{a y_i = g \\ 1 \leq y \leq m}} a_x b_{y_i} + \sum_{xy_{m+1} = g} a_x b_{y_{m+1}} } \cdot_M e(g)
      = \\ &=
      \Bbbsum_{g \in G} \parens[\Big]{ \sum_{\substack{a y_i = g \\ 1 \leq y \leq m + 1}} a_x b_{y_i} } \cdot_M e(g)
      = \\ &=
      \Bbbsum_{g \in G} \parens[\Big]{ \sum_{x y = g} a_x b_y } \cdot_M e(g).
    \end{align*}
  \end{itemize}
...
\begin{definition}\label{def:monic_polynomial}\mcite[131]{Jacobson1985BasicAlgebraI}
  We say that a \hyperref[def:univariate_polynomial]{univariate polynomial} is \term[bg=нормированный (многочлен) (\cite[409]{Обрешков1962ВисшаАлгебра}), ru=нормированный (многочлен) (\cite[102]{Винберг2014КурсАлгебры})]{monic} if its leading coefficient is the multiplicative unit \( 1 \).
\end{definition}
...
\begin{example}\label{ex:adjoining_root}
  ...
  It has no natural number root as a consequence of \eqref{eq:def:peano_arithmetic/theory/PA2}.
