...
\begin{definition}\label{def:semiring_adjunction}\mcite[119]{Jacobson1985Vol1}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:semiring_adjunction/evaluation} \( R[A] \) is the image of the \hyperref[rem:substitution_homomorphism]{evaluation homomorphism} \( \Phi_e: R[\mscrX] \to S \), where \( e: \mscrX \to S \) is a bijective function assigning the elements of \( A \) to indeterminates.
  \end{thmenum}
