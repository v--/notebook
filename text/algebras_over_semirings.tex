...
\begin{definition}\label{def:polynomial_root}\mimprovised
  A \term{root} in the \( R \)-module \( M \) of the polynomial \( p \) from \( R[\mscrX] \) is an evaluation \( e: \mscrX \to M \) such that \( \Phi_e(p) = 0_M \).
\end{definition}
\begin{comments}
...
\begin{definition}\label{def:polynomial_degree_terminology}\mimprovised
  We introduce the following names for polynomials of certain total degrees:
  \begin{itemize}
