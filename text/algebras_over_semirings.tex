...
\begin{proposition}\label{thm:semiring_is_natural_number_algebra}
  The \hyperref[def:category]{categories} \hyperref[def:semiring/category]{of semirings} and \hyperref[def:semimodule/category]{of unital associative \( \BbbN \)-algebras} are \hyperref[rem:category_similarity/isomorphism]{isomorphic}.
\end{proposition}
\begin{comments}
...
\begin{theorem}[Semigroup algebra universal property]\label{thm:semigroup_algebra_universal_property}\mcite[381]{Knapp2016BasicAlgebra}
  ...
  \begin{displayquote}
    For every \( R \)-algebra \( M \) and every \hyperref[def:semigroup/morphism]{semigroup homomorphism} \( e: G \to M \) into the multiplicative group of \( M \), there exists a unique homomorphism of \( R \)-algebras \( \Phi_e: R[G] \to M \) such that the following diagram commutes:
