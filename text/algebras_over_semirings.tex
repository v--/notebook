...
\begin{remark}\label{rem:univariate_polynomial_coefficient_order}
  ...
  \begin{itemize}
    ...
    \incite[exer. 9.4.6]{Tao2022AnalysisPart1}
...
\end{definition}
\begin{comments}
  \item \incite[exer. B-1.7]{Rotman2015AlgebraVol1} and \incite[127]{Aluffi2009Algebra} discuss the ring of Laurent polynomials, but restrict themselves to one variable.
\end{comments}
