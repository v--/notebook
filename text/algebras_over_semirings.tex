...
\begin{proposition}\label{thm:def:polynomial_algebra}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:def:polynomial_algebra/union}\mcite[119]{Jacobson1985Vol1} The algebras \( R[\mscrX \cup \mscrY] \) and \( R[\mscrX][\mscrY] \) are isomorphic.
...
\begin{definition}\label{def:formal_power_series}\mcite[127]{Jacobson1985Vol1}
...
\begin{definition}\label{def:laurent_polynomial}\mimprovised
...
\begin{definition}\label{def:semiring_adjunction}\mcite[119]{Jacobson1985Vol1}
...
\begin{proposition}\label{thm:semiring_adjunction_tower}\mcite[119]{Jacobson1985Vol1}
