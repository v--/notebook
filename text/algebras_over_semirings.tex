...
\begin{definition}\label{def:algebra_over_semiring}\mimprovised
  ...
  \begin{thmenum}
    ...
    \thmitem{def:algebra_over_semiring/category} As with semirings, for a fixed \hyperref[def:grothendieck_universe]{Grothendieck universe} \( \mscrU \) and a fixed semiring \( R \), the first-order theories of \( R \)-algebras gives rise to several \hyperref[def:fol_theory_model_functor/obj]{categories of \( \mscrU \)-small models}.
    ...
    The approaches of several authors towards algebra ideals are reviewed in \Cref{rem:ring_unitality/algebras}.
