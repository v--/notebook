...
\end{definition}
\begin{comments}
  \item We generalize terminology traditionally used for \hyperref[def:linear_function]{linear maps} --- for example by \incite[66]{Knapp2016BasicAlgebra}, \incite[522]{Aluffi2009Algebra} or \incite[239]{Treil2017LinearAlgebraDoneWrong}.
\end{comments}
...
\begin{definition}\label{def:polynomial_algebra}\mimprovised
  ...
  \begin{thmenum}
    ...
    We call elements of \( R[\mscrX] \) \term[bg=полиноми (\cite[1]{Обрешков1962ВисшаАлгебра}), ru=многочлены/полиномы (\cite[sec. 11.3]{Тыртышников2007ЛинейнаяАлгебра})]{polynomials}.
...
\begin{remark}\label{rem:univariate_polynomial_coefficient_order}
  ...
  \begin{itemize}
    ...
    \incite[44]{Rotman2015AdvancedModernAlgebraPart1}
    \incite[9]{Knapp2016BasicAlgebra}
    \incite[def. III.1.19]{Aluffi2009Algebra}
    \incite[120]{Jacobson1985BasicAlgebraI}
    ...
    \incite[92]{Винберг2014КурсАлгебры}
    \incite[180]{Кострикин2000АлгебраЧасть1}
    \incite[118]{Тыртышников2017ОсновыАлгебры}
    ...
    \incite[131]{Курош1968КурсВысшейАлгебры}
