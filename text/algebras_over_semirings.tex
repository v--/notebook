...
\begin{definition}\label{def:polynomial_degree_terminology}
  ...
  \begin{itemize}
    \item \term[ru=константа (\cite[118]{Тыртышников2007ЛинейнаяАлгебра})]{constant} when \( \deg(f) = 0 \) or \( f \) is the zero polynomial,
    \item \term[bg=линеен (полином) (\cite[1]{Обрешков1962ВисшаАлгебра}), ru=линейная (форма) (\cite[315]{Курош1968ВысшаяАлгебра})]{linear} when \( \deg(f) = 1 \),
    \item \term[bg=квадратен (полином) (\cite[1]{Обрешков1962ВисшаАлгебра}), ru=квадратичная (форма) (\cite[315]{Курош1968ВысшаяАлгебра}), en=quadratic (equation) (\cite[360]{Rosen2018DiscreteHandbook})]{quadratic} when \( \deg(f) = 2 \),
    \item \term[bg=кубична (форма) (\cite[1]{Обрешков1962ВисшаАлгебра}), ru=кубичная (форма) (\cite[315]{Курош1968ВысшаяАлгебра}), en=cubic (equation) (\cite[360]{Rosen2018DiscreteHandbook})]{cubic} when \( \deg(f) = 3 \),
    \item \term[en=quartic (equation) (\cite[360]{Rosen2018DiscreteHandbook})]{quartic} when \( \deg(f) = 4 \),
    \item \term[en=quintic (equation) (\cite[360]{Rosen2018DiscreteHandbook})]{quintic} when \( \deg(f) = 5 \)
  \end{itemize}
\end{definition}
\begin{comments}
