...
\begin{remark}\label{rem:logical_compactness_theorems}
  ...
  \begin{itemize}
    \item \Cref{thm:propositional_axiomatic_derivation_entailment_compact} for \hyperref[def:propositional_axiomatic_derivation_system]{propositional axiomatic derivation systems}.
    \item \Cref{thm:propositional_natural_deduction_derivation_compact} for \hyperref[def:propositional_natural_deduction_systems]{propositional natural deduction systems}.
