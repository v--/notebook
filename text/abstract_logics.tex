...
\begin{concept}\label{con:intuitionistic_logic}\mimprovised
  ...
  We will only discuss one abstract logic --- that of \hyperref[def:propositional_formula]{propositional formulas}, \hyperref[def:truth_value_algebra/intuitionistic]{Heyting algebra semantics} and the \hyperref[def:propositional_natural_deduction_systems]{intuitionistic propositional natural deduction system}.
\end{concept}
\begin{comments}
...
\begin{concept}\label{con:minimal_logic}\mimprovised
  ...
  As in the case of intuitionistic logic, we will only discuss one abstract logic --- that of \hyperref[def:propositional_formula]{propositional formulas}, \hyperref[def:minimal_propositional_semantics]{minimal Heyting algebra semantics} and the \hyperref[def:propositional_natural_deduction_systems]{minimal propositional natural deduction system}.
\end{concept}
