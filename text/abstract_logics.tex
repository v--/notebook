...
\begin{remark}\label{rem:named_logical_systems}
  ...
  \begin{itemize}
    ...
    \thmitem{rem:named_logical_systems/f} Girard is attributed with introducing \hyperref[def:polymorphic_typed_lambda_calculus]{second-order polymorphic \( \muplambda \)-calculus} in a variant called \enquote{System \( F \)}. See \fullref{rem:polymorphic_type_origin}.
  \end{itemize}
\end{remark}
