...
\begin{comments}
  \item This algorithm is implemented in \cite{notebook:code} as
    \WriteCodeRef{alg:euclidean_division_of_polynomials}
\end{comments}
\begin{defproof}
...
\begin{remark}\label{rem:alg:horners_rule}
  ...
  \incite{Horner1819SolvingNumericalEquations} describes a method for solving \hyperref[def:polynomial_equation]{algebraic equations}. Variations of his method are described in \cite[144]{Курош1968КурсВысшейАлгебры}, \cite[97]{Винберг2014КурсАлгебры} and \cite[209]{Кострикин2000АлгебраЧасть1} as \enquote{схема Горнера} (\enquote{Horner's scheme}) and in \cite[\S III.V.2]{Обрешков1962ВисшаАлгебра} as \enquote{правилото на Хорнер} (\enquote{Horner's rule}). We roughly follow their discussion in \fullref{alg:horners_rule}.
