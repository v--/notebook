...
\begin{definition}\label{def:interpolated_topological_vector_space}\mcite[24]{BerghLofstrom1976Interpolation}
...
\begin{proposition}\label{def:banach_space_sum_and_intersection_norms}\mcite[24]{BerghLofstrom1976Interpolation}
...
\begin{definition}\label{def:lebesgue_space}\mcite[6]{BerghLofstrom1976Interpolation}
...
\begin{theorem}[The Riesz-Thorin interpolation theorem]\label{thm:riesz_thorin}\mcite[24]{BerghLofstrom1976Interpolation}
...
\begin{definition}\label{def:distribution_function}\mcite[6]{BerghLofstrom1976Interpolation}
...
\begin{definition}\label{def:banach_interpolation_space_exponent}\mcite[27]{BerghLofstrom1976Interpolation}
...
\begin{definition}\label{def:k_functional}\mcite[38]{BerghLofstrom1976Interpolation}
...
\begin{proposition}\label{def:k_functional_properties}\mcite[38]{BerghLofstrom1976Interpolation}
  The \hyperref[def:k_functional]{\( K \)-functional} has the following basic properties:

  \begin{thmenum}
    \thmitem{def:k_functional_properties/basic} For any fixed \( x \in \Sigma \oline{X} \), the function \( t \mapsto K(t, x) \) is positive, \hyperref[def:order_function]{monotone} and \hyperref[def:convex_functions]{concave}.
...
\begin{definition}\label{def:k_functional_interpolation_space}\mcite[40]{BerghLofstrom1976Interpolation}
...
\begin{theorem}\label{thm:k_functional_interpolation}\mcite[thm. 3.1.2]{BerghLofstrom1976Interpolation}
...
\begin{theorem}\label{thm:discrete_k_interpolation}\mcite[lemma 3.1.3]{BerghLofstrom1976Interpolation}
...
\begin{definition}\label{def:e_functional}\mcite[174]{BerghLofstrom1976Interpolation}
...
\begin{proposition}\label{thm:def:e_functional}\mcite[lemma 7.1.3]{BerghLofstrom1976Interpolation}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:k_functional_properties/k_functional_connection}\mcite[thm. 7.1.4]{BerghLofstrom1976Interpolation}
    \begin{equation*}
...
\begin{definition}\label{def:approximation_space}\mcite[def. 7.1.5]{BerghLofstrom1976Interpolation}
...
\begin{theorem}\label{thm:interpolation_space_and_approximation_space}\mcite[thm. 7.1.6]{BerghLofstrom1976Interpolation}
...
\begin{theorem}\label{thm:interpolation_space_and_approximation_space_reiteration}\mcite[thm. 7.1.8]{BerghLofstrom1976Interpolation}
