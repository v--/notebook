...
\begin{definition}\label{def:vector_space}\mcite[78]{Мальцев2009ОсновыЛинейнойАлгебры}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:vector_space/category}\mcite[25]{MacLane1998CategoryTheory} We denote the category of vector spaces over \( \BbbK \) by \( \ucat[\BbbK]{Vect} \) rather than \( \ucat[\BbbK]{Mod} \).
