...
This section is a natural continuation of \fullref{sec:modules} and the choice of topics is more suitable for \fullref{ch:linear_algebra}, however we place it here because studying fields is meaningless without vector spaces.
...
\begin{definition}\label{def:vector_space}\mcite[78]{Мальцев2009ОсновыЛинейнойАлгебры}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:vector_space/category}\mcite[25]{MacLane1998CategoryTheory} We denote the category of vector spaces over \( \BbbK \) by \( \cat[\BbbK]{Vect} \) rather than \( \cat[\BbbK]{Mod} \).
