...
\end{definition}
\begin{comments}
  \item For every nonnegative rational number, we can choose a concrete representation as a quotient of coprime nonnegative integers via \fullref{thm:def:coprime_elements/lowest_terms}. For every negative rational number, it suffices to consider its additive inverse.
...
\begin{proposition}\label{thm:def:rational_number_ordering}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:def:rational_number_ordering/archimedean_exponentiation} For every pair \( a / b > 1 \) and \( c / d > 0 \), there exists some integer \( n \) such that \( (a / b)^n > c / d \).

    \thmitem{thm:def:rational_number_ordering/power_monotone} If \( a / b < c / d \), then, for any positive integer \( n \), we have \( (a / b)^n < (c / d)^n \).

    \thmitem{thm:def:rational_number_ordering/reciprocal} For positive rational numbers \( a / b \) and \( c / d \), we have
...
\end{proposition}
\begin{proof}
  \SubProofOf{thm:def:rational_number_ordering/inverse} Let \( a / b \leq c / d \). Then \( ad \leq_\BbbZ bc \). \Fullref{thm:def:integer_ordering/inverse} implies that \( -bc \leq_\BbbZ -ad \), and hence \( -c / d \leq - a / b \).
  ...
  \SubProofOf{thm:def:rational_number_ordering/archimedean} If both \( a / b \) and \( c / d \) are positive, all \( a \), \( b \), \( c \) and \( d \) are positive integers. We are looking for a positive integer \( n \) such that
  \begin{equation*}
  ...
  \SubProofOf{thm:def:rational_number_ordering/power_monotone} Suppose that \( a / b < c / d \). We will show by induction on positive integers \( n \) that \( (a / b)^n < (c / d)^n \).
  ...
  \SubProofOf{thm:def:rational_number_ordering/reciprocal} Both directions have identical proofs, so we will only prove that \( a / b < c / d \) implies \( b / a > d / c \).
