...
\end{definition}
\begin{comments}
  \item We will prefer representations of rational numbers \hyperref[def:lowest_terms]{in lowest terms} with positive denominators. \Fullref{thm:rational_number_lowest_terms} implies that such a representation is unique.
