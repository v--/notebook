...
\begin{definition}\label{def:invariant_subset}\mcite[23]{Зорич2019Том1}
  We say that the subset \( B \) of any \hyperref[def:set]{plain set} \( A \) is \term[bg=инвариантно подпространство (\cite[def. X.1]{ГеновМиховскиМоллов1991}), ru=инвариантное (множество), en=invariant (\cite[108]{DaveyPriestley2002})]{invariant} under the endofunction \( f: A \to A \) if \( f[B] \subseteq B \).
\end{definition}
\begin{comments}
