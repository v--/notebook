...
\begin{definition}\label{def:invariant_subset}\mcite[23]{Зорич2019АнализТом1}
  We say that the subset \( B \) of any \hyperref[def:set]{plain set} \( A \) is \term[bg=инвариантно подпространство (\cite[def. X.1]{ГеновИПр1991Алгебра}), ru=инвариантное (множество), en=invariant (\cite[108]{DaveyPriestley2002Lattices})]{invariant} under the endofunction \( f: A \to A \) if \( f[B] \subseteq B \).
\end{definition}
\begin{comments}
