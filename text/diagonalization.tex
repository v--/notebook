...
\begin{definition}\label{def:eigenpair}\mcite[def. VI.6.13]{Aluffi2009Algebra}
  ...
  An \term[ru=собственная пара (\cite[\S 29.2]{Тыртышников2007ЛинейнаяАлгебра}), en=(right) eigenpair (\cite[def. 1.1]{Stewart2001MatrixAlgorithms})]{eigenpair} \( (\lambda, e) \) of \( T \) consists of an \term[bg=собствена стойност (\cite[256]{ГеновМиховскиМоллов1991Алгебра}), ru=собственное значение (\cite[\S 29.2]{Тыртышников2007ЛинейнаяАлгебра})]{eigenvalue} \( \lambda \in \BbbK \) and a \hi{nonzero} \term[bg=собствен вектор (\cite[256]{ГеновМиховскиМоллов1991Алгебра}), ru=собственный вектор (\cite[\S 29.2]{Тыртышников2007ЛинейнаяАлгебра})]{eigenvector} \( e \in V \) such that
...
\begin{comments}
  ...
  \item In Russian, the phrase \enquote{собственное подпространство} (\enquote{proper space}) is used for eigenspaces, for example by \incite[\S 30.2]{Тыртышников2007ЛинейнаяАлгебра} and \incite[def. II.3]{Курош1968ВысшаяАлгебра}. The phrase is however ambiguous because \enquote{собственный} (\enquote{proper}) is generally used for proper substructures the sense of \fullref{thm:substructures_form_complete_lattice/top}.
...
\begin{remark}\label{rem:linear_operator_characteristic_polynomial_convensions}
  ...
  \begin{itemize}
    ...
    \incite[196]{Jacobson1985AlgebraI}
    \incite[561]{Lang2002Algebra}
    \incite[390]{Rotman2015AlgebraPart1}
    \incite[148]{Bourbaki1972CommAlgebra}
    \incite[154]{Roman2005LinearAlgebra}
    \incite[499]{Knuth1997ArtVol1}
    \incite[def. 6.2.2]{Винберг2014Алгебра}
    \incite[77]{Обрешков1962ВисшаАлгебра}

    \item \( \det(T - \Lambda \id) \) is used by
    \incite[101]{Halmos1974FinDimVectorSpaces}
    \incite[\S 1.2]{Treil2017LinearAlgebra}
    \incite[248]{FriedbergInselSpence2018LinearAlgebra}
    \incite[\S 29.4]{Тыртышников2007ЛинейнаяАлгебра}
    \incite[207]{Курош1968ВысшаяАлгебра}
    \incite[78]{Кострикин2000АлгебраЧасть2}
    \incite[255]{ГеновМиховскиМоллов1991Алгебра}
  \end{itemize}
\end{remark}

\begin{definition}\label{def:eigenvalue_multiplicity}\mcite[\S 29.5; \S 30.2]{Тыртышников2007ЛинейнаяАлгебра}
  We define the \term[ru=алгебраическая кратность, en=algebraic multiplicity (\cite[def. VI.6.17]{Aluffi2009Algebra})]{algebraic multiplicity} of an \hyperref[def:eigenvalue]{eigenvalue} as its \hyperref[def:multiple_root]{root multiplicity} in the \hyperref[def:linear_operator_characteristic_polynomial]{characteristic polynomial}.
...
\begin{proposition}\label{thm:geometric_vs_algebraic_multiplicity}\mcite{MathSE:geometric_multiplicity_is_bounded_by_algebraic}
  The \hyperref[def:eigenvalue_multiplicity]{geometric multiplicity} of an eigenvalue does not exceed its \hyperref[def:eigenvalue_multiplicity]{algebraic multiplicity}.
\end{proposition}
\begin{proof}
