...
\begin{remark}\label{rem:linear_operator_characteristic_polynomial_convensions}
  ...
  \begin{itemize}
    ...
    \textcite[74]{Knapp2016BasicAlgebra}
    \textcite[def. VI.6.8]{Aluffi2009Algebra}
    \textcite[196]{Jacobson1985BasicAlgebraI}
    \textcite[561]{Lang2002Algebra}
    \textcite[390]{Rotman2015AdvancedModernAlgebraPart1}
    \textcite[499]{Knuth1997ArtVol1}
    \textcite[def. 6.2.2]{Винберг2014КурсАлгебры}
    \textcite[77]{Обрешков1962ВисшаАлгебра}

    \item \( \det(T - \Lambda \id) \) is used by
    \textcite[101]{Halmos1974VectorSpaces}
    \textcite[\S 1.2]{Treil2017LinearAlgebraDoneWrong}
    \textcite[248]{FriedbergInselSpence2018LinearAlgebra}
    \textcite[\S 29.4]{Тыртышников2007ЛинейнаяАлгебра}
    \textcite[207]{Курош1968КурсВысшейАлгебры}
    \textcite[78]{Кострикин2000АлгебраЧасть2}
    \textcite[255]{ГеновМиховскиМоллов1991Алгебра}
  \end{itemize}
\end{remark}
