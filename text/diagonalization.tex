...
\begin{definition}\label{def:eigenpair}\mcite[def. 4.17]{Rudin1991FunctionalAnalysis}
...
\begin{definition}\label{def:eigenspace}\mcite[sec. 31.2]{Тыртышников2007ЛинейнаяАлгебра}
...
\begin{definition}\label{def:characteristic_polynomial}\mimprovised
  ...
  The \term{algebraic multiplicity} of \( \lambda \in \BbbK \) is the \hyperref[def:multiple_root]{root multiplicity} of \( \lambda \) in \( p_A \).
\end{definition}
...
\begin{definition}\label{def:point_spectrum}\mcite[10.32]{Rudin1991FunctionalAnalysis}
