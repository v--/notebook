...
\end{proposition}
\begin{proof}
  By \fullref{thm:quotient_module_universal_property}, \( T \) \hyperref[def:factors_through]{factors through}
  \begin{equation*}
    U / \ker T \cong \img T.
  \end{equation*}
...
\begin{comments}
  ...
  \item \enquote{Invariant} in this sense often refers to linear subspaces invariant under a linear map. Examples of such usage include Anthony Knapp in \cite[218]{Knapp2016BasicAlgebra} and Evgeny Tyrtyshnikov in \cite[sec. 28.5]{Тыртышников2007}.
\end{comments}
