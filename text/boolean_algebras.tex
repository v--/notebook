...
\begin{example}\label{ex:boolean_algebras}
  ...
  \begin{itemize}
    ...
    \thmitem{ex:boolean_algebras/f2} The isomorphic (as per \fullref{thm:two_element_lattice}) Boolean algebras \hyperref[def:boolean_value]{\( \set{ T, F } \)} and \hyperref[thm:finite_fields]{\( \BbbF_2 \)} are used extensively in \fullref{sec:mathematical_logic}.
