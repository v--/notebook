...
\begin{definition}\label{def:ultrafilter}
  We say that a proper \hyperref[def:lattice_ideal]{filter} \( F \) in a \hyperref[def:boolean_algebra]{Boolean algebra} is an \term[bg=ултрафилтер (\cite[18]{Проданов1982ФункцАнализ}), ru=ультрафильтр (\cite[182]{Гуров2013Решётки})]{ultrafilter} if any of the following equivalent conditions hold:
  \begin{thmenum}
