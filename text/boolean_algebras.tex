...
\begin{definition}\label{def:heyting_algebra}\mcite[147]{Birkhoff1948}
  ...
  \begin{thmenum}[resume=def:heyting_algebra]
    ...
    \thmitem{def:heyting_algebra/bottom} The \hyperref[thm:substructures_form_complete_lattice/bottom]{bottom substructure} of a Heyting algebra is the \hyperref[def:semilattice/trivial]{two-element bounded lattice} (whose elements are equal only of the lattice is trivial).
...
\begin{proof}
  ...
  \begin{balign*}
    y
    &\reloset {\eqref{eq:thm:binary_lattice_operations/neutral/meet}} =
    y \wedge \top
...
\begin{definition}\label{def:boolean_algebra}\mcite[def. 1.7.1]{Hinman2005}
  ...
  \begin{thmenum}[resume=def:boolean_algebra]
    ...
    \thmitem{def:boolean_algebra/bottom} The \hyperref[thm:substructures_form_complete_lattice/bottom]{bottom substructure} of a Boolean algebra is the \hyperref[def:semilattice/trivial]{two-element bounded lattice} (whose elements are equal only of the lattice is trivial).
