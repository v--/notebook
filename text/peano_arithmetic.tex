...
\begin{definition}\label{def:peano_arithmetic}\mcite[def. 2.7.7; 150]{VanDalen2004LogicAndStructure}
  ...
  \begin{thmenum}
    ...
    \begin{thmenum}
      ...
      \thmitem{def:peano_arithmetic/signature/succ} A unary \hyperref[def:fol_signature/functions]{functional symbol} \( \synS \) using \hyperref[def:fol_signature/notation]{condensed notation}, called the \term[en=successor (\cite[87]{VanDalen2004LogicAndStructure})]{successor operation}.
    ...
    \begin{thmenum}
      ...
      The schema is stated as an \hyperref[def:inference_rule]{inference rule} in \cref{inf:thm:peano_arithmetic_admissible_rules/induction}. A metatheoretic restatement of is given in \fullref{thm:induction_on_natural_numbers}, while a variation of the principle is given in \fullref{thm:strong_induction_on_natural_numbers}.
...
\end{theorem}
\begin{comments}
  \item A useful varition of this theorem is \fullref{thm:strong_induction_on_natural_numbers}. It can also be regarded as a special case of \fullref{thm:bounded_transfinite_induction}.
...
\begin{example}\label{ex:peano_arithmetic_predecessor_existence}
  We will also demonstrate induction in \hyperref[def:peano_arithmetic]{Peano arithmetic} using \hyperref[def:fol_natural_deduction_proof_tree]{natural deduction proof trees} by way of a simple proposition --- that every number is either zero or has a predecessor:
  \begin{equation}\label{eq:ex:peano_arithmetic_predecessor_existence}
    \qforall \synn ((\synn \syneq \syn0) \synvee (\qexists \synm \synn \syneq \synS \synm)).
  \end{equation}

  An interesting feature of this proof is that it uses induction, but only as a way to traverse the natural numbers --- the inductive hypothesis is never used.
  ...
  \begin{equation*}
    \begin{prooftree}
      ...
      \infer2[\ref{inf:def:propositional_natural_deduction/and/intro}]{ \varphi[\synx \mapsto \syn0] \synwedge \qforall \synn \parens[\big]{ \varphi[\synx \mapsto \synn] \synimplies \varphi[\synx \mapsto \synS \synn] } }

      \infer2[\ref{inf:def:propositional_natural_deduction/imp/elim}]{ \qforall \synn \varphi[\synx \mapsto \synn] }
    \end{prooftree}
  \end{equation*}

  Later on, we will find it more convenient to use the inference rule \ref{inf:thm:peano_arithmetic_admissible_rules/induction} instead.
\end{example}
...
\begin{proposition}\label{thm:peano_arithmetic_admissible_rules}
  ...
  \begin{thmenum}
    \thmitem{thm:peano_arithmetic_admissible_rules/induction} The induction axiom \eqref{eq:def:peano_arithmetic/theory/PA3} can be restated as an inference rule
    \begin{equation*}\taglabel[\logic{PA3}]{inf:thm:peano_arithmetic_admissible_rules/induction}
      \begin{prooftree}
        ...
        \infer2[\ref{inf:thm:peano_arithmetic_admissible_rules/induction}]{ \qforall \synn \syn\varphi[\synx \synsubst \synn] }
      \end{prooftree}
    \end{equation*}

    \thmitem{thm:peano_arithmetic_admissible_rules/refl} The nonstrict inequality is reflexive:
    \begin{equation*}\taglabel[\ensuremath{ \logic{PA}_{\logic{R}} }]{inf:thm:peano_arithmetic_admissible_rules/refl}
      \begin{prooftree}
        \infer0[\ref{inf:thm:peano_arithmetic_admissible_rules/refl}]{ \synn \synleq \synn }
      \end{prooftree}
    \end{equation*}

    \thmitem{thm:peano_arithmetic_admissible_rules/less_than_zero} No number is less than zero:
    \begin{equation*}\taglabel[\ensuremath{ \logic{PA}_{<0} }]{inf:thm:peano_arithmetic_admissible_rules/less_than_zero}
      \begin{prooftree}
        \hypo{ \synn \synless \syn0 }
        \infer1[\ref{inf:thm:peano_arithmetic_admissible_rules/less_than_zero}]{ \synbot }
      \end{prooftree}
    \end{equation*}

    \thmitem{thm:peano_arithmetic_admissible_rules/less_than_successor} Every number is smaller than its successor:
    \begin{equation*}\taglabel[\ensuremath{ \logic{PA}_{n<Sn} }]{inf:thm:peano_arithmetic_admissible_rules/less_than_successor}
      \begin{prooftree}
        \infer0[\ref{inf:thm:peano_arithmetic_admissible_rules/less_than_successor}]{ \synn \synless \synS \synn }
      \end{prooftree}
    \end{equation*}

    \thmitem{thm:peano_arithmetic_admissible_rules/nonstrict_successor} Successors of the upper bound are compatible with nonstrict inequalities:
    \begin{equation*}\taglabel[\ensuremath{ \logic{PA}_{m<Sn} }]{inf:thm:peano_arithmetic_admissible_rules/nonstrict_successor}
      \begin{prooftree}
        \hypo{ \synn \synleq \synm }
        \infer1[\ref{inf:thm:peano_arithmetic_admissible_rules/nonstrict_successor}]{ \synn \synleq \synS \synm }
      \end{prooftree}
    \end{equation*}

    \thmitem{thm:peano_arithmetic_admissible_rules/less_successor_to_leq} Strict inequality with a successor can be expressed via strict inequality:
    \begin{equation*}\taglabel[\ensuremath{ \logic{PA}_{< \to \leq} }]{inf:thm:peano_arithmetic_admissible_rules/less_successor_to_leq}
      \begin{prooftree}
        \hypo{ \synn \synless \synS \synm }
        \infer1[\ref{inf:thm:peano_arithmetic_admissible_rules/less_successor_to_leq}]{ \synn \synleq \synm }
      \end{prooftree}
    \end{equation*}

    \thmitem{thm:peano_arithmetic_admissible_rules/leq_to_less} Nonstrict inequality can be expressed via strict inequality:
    \begin{equation*}\taglabel[\ensuremath{ \logic{PA}_{\leq \to <} }]{inf:thm:peano_arithmetic_admissible_rules/leq_to_less}
      \begin{prooftree}
        \hypo{ \synn \synleq \synm }
        \infer1[\ref{inf:thm:peano_arithmetic_admissible_rules/leq_to_less}]{ \synn \synless \synm \synvee \synn \syneq \synm }
      \end{prooftree}
    \end{equation*}
  \end{thmenum}
\end{proposition}
\begin{proof}
  \SubProofOf{thm:peano_arithmetic_admissible_rules/induction}
  \begin{equation*}
    \begin{prooftree}
      \hypo{ [\eqref{eq:def:peano_arithmetic/theory/PA3}]^{a_1} }
  ...
  \SubProofOf{thm:peano_arithmetic_admissible_rules/refl}
  \begin{equation*}
    \begin{prooftree}
  ...
  \SubProofOf{thm:peano_arithmetic_admissible_rules/less_than_zero}
  \footnotesize
  \begin{equation*}
  ...
  \SubProofOf{thm:peano_arithmetic_admissible_rules/less_than_successor}
  \begin{equation*}
    \begin{prooftree}
  ...
  \SubProofOf{thm:peano_arithmetic_admissible_rules/nonstrict_successor}
  \footnotesize
  \begin{equation*}
    \begin{prooftree}[separation=1.2em]
      \hypo{ [\eqref{eq:def:peano_arithmetic_ordering/strict}]^{a_1} }
  ...
  \SubProofOf{thm:peano_arithmetic_admissible_rules/less_successor_to_leq}
  \footnotesize
  \begin{equation*}
    \begin{prooftree}[separation=1.2em]
  ...
  \SubProofOf{thm:peano_arithmetic_admissible_rules/leq_to_less}
  \begin{equation*}
    \begin{prooftree}
      \hypo{ [m \synleq n]^u }
      ...
      \hypo{ [\eqref{eq:ex:peano_arithmetic_predecessor_existence}]^{a_2} }
      \infer1[\ref{inf:def:fol_natural_deduction/forall/elim}]{ \synanon }
...
\begin{proof}
  ...
  \begin{equation*}
    \begin{prooftree}
      ...
      \infer2[\ref{inf:thm:peano_arithmetic_admissible_rules/induction}]{ \qforall \synm \syn\varphi[\synx \mapsto \synm] }
    \end{prooftree}
  \end{equation*}
  where the subtree \( L \) is
  \begin{equation*}
  ...
  \begin{equation*}
    \begin{prooftree}
      ...
      \infer1[\ref{inf:thm:peano_arithmetic_admissible_rules/less_successor_to_leq}]{ \synn \synleq \synm }
      \infer1[\ref{thm:peano_arithmetic_admissible_rules/nonstrict_successor}]{ \synn \synleq \synS \synm }
...
\begin{theorem}[Strong induction on natural numbers]\label{thm:strong_induction_on_natural_numbers}
  ...
  We will use multiple instances of \eqref{eq:def:peano_arithmetic/theory/PA3} to derive one instance of \eqref{eq:thm:strong_induction_on_natural_numbers}; thus, they are equivalent only as schemas.
...
\end{theorem}
\begin{comments}
  \item This theorem can be regarded as special case of \fullref{thm:epsilon_induction}. See \cref{con:induction} for a general discussion of induction and recursion.

  \item This theorem is stated for \( \omega \) in \cite[87]{Enderton1977SetTheory}.
\end{comments}
\begin{proof}
  \ImplicationSubProof{eq:def:peano_arithmetic/theory/PA3}{eq:thm:strong_induction_on_natural_numbers} Fix a formula \( \varphi \). Without loss of generality, suppose that \( \synx \) is the only free variable of \( \varphi \); otherwise we will have to apply \ref{inf:def:fol_natural_deduction/forall/intro} and \ref{inf:def:fol_natural_deduction/forall/elim} the appropriate number of times.
  ...
  \begin{equation*}
    \begin{prooftree}
      ...
      \hypo{ [\qforall n (\psi_n \synimplies \varphi_n)]^v \quad [\psi_n]^w }
      ...
      \infer2[\ref{inf:thm:peano_arithmetic_admissible_rules/induction}]{ \qforall n \psi_n }
  ...
  \begin{equation*}
    \begin{prooftree}[separation=1.5em]
      ...
      \infer1[\ref{inf:thm:peano_arithmetic_admissible_rules/less_successor_to_leq}]{ m \synleq n }
      \infer1[\ref{inf:thm:peano_arithmetic_admissible_rules/leq_to_less}]{ m \synless n \synvee m \syneq n }
  ...
  \begin{equation*}
    \begin{prooftree}
      ...
      \infer0[\ref{inf:thm:peano_arithmetic_admissible_rules/less_than_successor}]{ n \synless \synS n }
      \infer2[\ref{inf:def:propositional_natural_deduction/imp/elim}]{ \varphi_n }
