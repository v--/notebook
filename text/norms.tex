...
\begin{proposition}\label{thm:triangle_inequality_to_subadditivity}
  As in \cref{thm:subadditivity_to_triangle_inequality}, fix two \hyperref[con:additive_semigroup]{additive (semi)groups} \( G \) and \( H \), and suppose that \( H \) is \hyperref[def:ordered_semigroup]{ordered}.
