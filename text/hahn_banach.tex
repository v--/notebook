...
\begin{theorem}[Geometric Hahn-Banach theorem/Mazur's theorem]\label{thm:geometric_hahn_banach}\mcite[24]{ИоффеТихомиров1974ЭкстремальныеЗадачи}
...
\begin{corollary}\label{thm:hahn_banach_implies_functionals_vanish_nowhere}\mcite[24]{ИоффеТихомиров1974ЭкстремальныеЗадачи}
...
\begin{corollary}\label{thm:hahn_banach_implies_annihilator_nontrivial}\mcite[25]{ИоффеТихомиров1974ЭкстремальныеЗадачи}
...
\begin{corollary}\label{thm:hahn_banach_implies_duality_mapping_nonempty}\mcite[25]{ИоффеТихомиров1974ЭкстремальныеЗадачи}
...
\begin{definition}\label{def:hyperplane_separation}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:hyperplane_separation/strong}\mcite[def. 3.3]{Gallier2011Geometry} If the sets belong to different \emph{open} half-spaces, we say that they are \term{strongly separated}. The inequalities then become
...
\begin{theorem}[Hahn-Banach hyperplane separation theorem]\label{thm:hahn_banach_hyperplane_separation}\mcite[25]{ИоффеТихомиров1974ЭкстремальныеЗадачи}
