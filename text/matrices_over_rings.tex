...
\begin{example}\label{ex:def:array}
  ...
  \begin{thmenum}
    ...
    We will call the unique \( 0 \times 0 \) matrix the \term[en=zero-dimensional matrix (\cite[example 1.5.19]{Perrone2021Categories})]{zero-dimensional matrix}.
  \end{thmenum}
\end{example}
...
\begin{definition}\label{def:matrix_determinant}\mcite[215]{Knapp2016BasicAlgebra}
  ...
  Following \incite[493]{Eisenbud1995CommAlgebra}, we will define the determinant for the \hyperref[ex:def:array/zero_dimensional]{zero-dimensional matrix} as \( 1 \).
