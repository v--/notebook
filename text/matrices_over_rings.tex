...
\begin{remark}\label{rem:vector_etymology}
  ...
  \begin{itemize}
    ...
    \item Ordered tuples are defined and discussed in \cref{def:ordered_tuple}. Tuples are technically \hyperref[def:indexed_family]{indexed families} and the latter are defined without reference to functions, which we use to define both arrays and sequences.
  \end{itemize}
\end{remark}
