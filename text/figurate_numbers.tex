...
\begin{concept}\label{con:figurate_number}
  ...
  The philosophical development leading to figurate numbers is described briefly by \incite{Розенфельд1963ОсновныеПонятиеГеометрии}. Rosenfeld, Zhmud and the Deza spouses, as well as \incite[1; 2]{Apostol1976AnalyticNumberTheory}, attribute the concept to the \hyperref[rem:pythagoreanism]{Pythagorean school}.
