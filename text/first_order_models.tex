...
\end{proposition}
\begin{comments}
  \item The initial substructure may or may not be isomorphic to the \hyperref[def:trivial_structure]{trivial structure}.
...
\begin{proof}
  ...
  \SubProofOf{thm:def:first_order_homomorphism/preserves_substructures} To prove that \( (f(X), I_Y) \) is a substructure of \( \mscrY \), we will show that \fullref{def:first_order_substructure/universe/deductive} holds.
