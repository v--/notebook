...
\begin{definition}\label{def:first_order_generated_substructure}\mcite[prop. 3.1.16]{Hinman2005}
...
\begin{proposition}\label{thm:first_order_generated_substructures_exist}
  Let \( \mscrX = (X, I) \) be a structure for the language \( \mscrL \) and let \( A \) be an arbitrary subset of \( X \). Then there exists a unique substructure \( \mscrY \) \hyperref[def:first_order_generated_substructure]{generated} by \( A \).
