...
\end{definition}
\begin{comments}
  \item \incite[46]{Мальцев1970Системы} gives an analogous definition, but calls structures \enquote{algebraic systems} and studies them independently of first-order logic.
\end{comments}
\begin{defproof}
