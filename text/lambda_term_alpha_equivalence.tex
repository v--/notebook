...
\begin{definition}\label{def:lambda_renaming}
  We say that the \hyperref[def:atomic_lambda_term_substitution]{atomic substitution} \( \Bbbs \) is a \term{renaming substitution} if \( \Bbbs(x) \) is a variable for every \( x \).
\end{definition}
\begin{comments}
