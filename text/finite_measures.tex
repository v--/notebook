...
\begin{definition}\label{def:finite_measure}\mcite[31]{Halmos1976Measures}
  Fix a \hyperref[def:measure/positive]{positive measure space} \( (\Omega, \mscrA, \mu) \). We say that \( \mu \) is a \term[bg=крайна мярка (\cite[def. 3.11]{Драганов2022Мерки})]{finite measure} if \( \mu(\Omega) \) is finite.
...
\begin{definition}\label{def:sigma_finite_measure}\mcite[31]{Halmos1976Measures}
  Fix a \hyperref[def:measure/positive]{positive measure space} \( (\Omega, \mscrA, \mu) \). We say that \( \mu \) is \term[bg=\( \sigma \)-крайна мярка (\cite[def. 3.11]{Драганов2022Мерки}), ru=\( \sigma \)-крайний (\cite[def. 1.6.1]{Богачёв2003МерыТом1})]{\( \sigma \)-finite} if \( \Omega \) can be \hyperref[def:exhausting_sequence]{exhausted} by a sequence of sets of finite measure.
\end{definition}
