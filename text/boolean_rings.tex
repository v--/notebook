...
\end{proposition}
\begin{proof}
  Denote the category of \( \mscrU \)-small Boolean rings by \( \ucat{BRing} \). \Cref{thm:boolean_algebra_as_ring} provides a functor \( F: \ucat{Bool} \to \ucat{BRing} \), while \cref{thm:boolean_ring_as_algebra} provides a functor \( G: \ucat{BRing} \to \ucat{Bool} \).
