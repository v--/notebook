...
\end{proposition}
\begin{proof}
  Denote the category of Boolean rings by \( \cat{BRing} \). \Fullref{thm:boolean_algebra_as_ring} provides a functor \( F: \cat{Bool} \to \cat{BRing} \), while \fullref{thm:boolean_ring_as_algebra} provides a functor \( G: \cat{BRing} \to \cat{Bool} \).
