...
\begin{definition}\label{def:first_order_language}\mcite[def. 2.1.2]{Hinman2005}
  ...
  \begin{description}
    ...
    \begin{thmenum}[series=def:first_order_language]
      ...
      \thmitem{def:first_order_language/universal_quantifier_quantifier} The \term{universal quantifier} \enquote{\( \synforall \)}.

      \thmitem{def:first_order_language/existential_quantifier} The \term{existential quantifier} \enquote{\( \synexists \)}.
  ...
  \begin{equation*}
    \begin{aligned}
      \id(\varphi) \coloneqq \begin{cases}
        ...
        \quantifier Q \xi \id(\psi),    &\varphi = \quantifier Q \xi \psi, Q \in \set{ \synforall, \synexists }. \\
      \end{cases}
    \end{aligned}
  \end{equation*}
  ...
  \begin{equation*}
    \begin{aligned}
      R(\varphi) \coloneqq \begin{cases}
        ...
        \quantifier Q \xi R(\psi),    &\varphi = \quantifier Q \xi \psi, Q \in \set{ \synforall, \synexists }. \\
      \end{cases}
    \end{aligned}
  \end{equation*}
