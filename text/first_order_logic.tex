...
\begin{proof}
  ...
  \begin{equation*}
    \begin{prooftree}
      ...
      \infer[left label=\( 1 \)]1[\eqref{eq:def:classical_propositional_deduction_systems/rules/dne}]{ \qforall \synx \varphi }
