...
\begin{remark}\label{rem:first_order_formula_conventions}
  ...
  \begin{thmenum}
    \thmitem{rem:first_order_formula_conventions/parentheses} We use the parentheses conventions from \cref{rem:propositional_formula_notation_conventions}.

    \thmitem{def:function_application_syntax} Binary functional symbols are often written using \term{infix notation}, i.e.
    \begin{equation*}
