...
\begin{algorithm}[Signature translation of first-order terms]\label{alg:fol_term_signature_translation}
  Given a \hyperref[def:fol_signature_category/morphisms]{signature morphism} \( t: \Sigma \to \Sigma' \), we can easily translate any \hyperref[def:fol_term]{first-order term} from \( \op*{Term}_\Sigma \) to \( \op*{Term}_{\Sigma'} \):
  \begin{equation*}
...
\begin{algorithm}[Signature translation of first-order formulas]\label{alg:fol_formula_signature_translation}
  Given a \hyperref[def:fol_signature_category/morphisms]{signature morphism} \( t: \Sigma \to \Sigma' \), we can translate any \hyperref[def:fol_formula]{first-order formula} from \( \op*{Form}_\Sigma \) to \( \op*{Form}_{\Sigma'} \) with the aid of \fullref{alg:fol_term_signature_translation}:
  \begin{equation*}
...
\end{remark}
\begin{comments}
  \item This is the approach we have used to implement propositional logic in the module \identifier{math.logic.propositional} in \cite{notebook:code}.
\end{comments}
