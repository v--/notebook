...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \item The cases \( \varphi = \synneg \psi \) and \( \varphi = \psi_1 \bincirc \psi_2 \) are proved in an straightforward manner.
...
\begin{proposition}\label{thm:pulling_quantifiers_out}
  For \( Q \in \set{ \synforall, \synexists } \) and \( \bincirc \in \set{ \synvee, \synwedge } \), if \( \eta \) is not free in \( \varphi \) nor \( \psi \), then
    ...
    \begin{equation*}
      P_3(\varphi) \coloneqq \begin{cases}
        ...
        \quantifier Q \eta P_3 \parens[\Big]{ \varphi[\xi \mapsto \eta] \bincirc \theta }, &\varphi = \parens[\Big]{ \quantifier Q \xi \psi } \bincirc \theta, \\
                                                                                           &Q \in \set{ \synforall, \synexists }, \quad \bincirc \in \set{ \synvee, \synwedge }, \\
