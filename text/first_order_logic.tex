...
\begin{example}\label{ex:equations}
  ...
  \begin{itemize}
    ...
    \item Affine varieties, which are sets of roots of polynomials, are studied in algebraic geometry. See \fullref{sec:quadratic_plane_curves}.
  \end{itemize}
\end{example}
...
\begin{comments}
  ...
  \item These algorithms can be found as \identifier{fol.substitution.substitute_in_term} and \identifier{fol.substitution.substitute_in_formula} in \cite{notebook:code}.
\end{comments}
...
\begin{comments}
  ...
  \item This algorithm can be found as \identifier{fol.pnf.to_pnf} in \cite{notebook:code}.
\end{comments}
