...
\begin{remark}\label{rem:fol_application_notation}
  ...
  Examples of condensed notation are mostly restricted to unary operators, where writing parentheses adds little benefit. This includes nearly all unary operators from \fullref{ch:set_theory}, as well as various kinds of \hyperref[def:morphism_invertibility/involution]{involutions}, \hyperref[def:abstract_closure_operator]{closure operators}, and the \hyperref[sec:trigonometric_functions]{trigonometric functions}.
...
\begin{definition}\label{def:fol_institution}\mimprovised
  ...
  \begin{thmenum}
    ...
    \begin{thmenum}
      \thmitem{def:fol_institution/models/obj} Let \( \cat{Mod}(\Sigma) \) be the category of small \hyperref[def:fol_structure]{first-order structures} and \hyperref[def:fol_homomorphism]{their homomorphisms}.
