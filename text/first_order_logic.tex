...
\begin{definition}\label{def:first_order_syntax}
  ...
  \begin{thmenum}
    ...
    We implicitly associate with each first-order term a syntax tree. The grammar of terms is unambiguous as shown via \cref{thm:propositional_formula_grammar/unambiguous}, which makes it possible to perform proofs via \fullref{thm:induction_on_rooted_trees}.
...
\begin{comments}
  ...
  \item These algorithms can be found as \identifier{math.logic.substitution.substitute_in_term} and \identifier{math.logic.substitution.substitute_in_formula} in \cite{notebook:code}.
\end{comments}
...
\begin{comments}
  ...
  \item This algorithm can be found as \identifier{math.logic.pnf.to_pnf} in \cite{notebook:code}.
\end{comments}
