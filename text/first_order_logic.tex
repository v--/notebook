...
\begin{remark}\label{rem:empty_first_order_structures}
   If we allow the domain of a structure to be empty, we would have to reformulate a lot of important theorems (e.g. our proof of \fullref{thm:renaming_assignment_compatibility/formulas}), which would complicate compatibility between semantics and \hyperref[def:deductive_system]{deduction systems}.
...
\begin{comments}
  ...
  \item \Fullref{thm:propositional_semantic_deduction_consequences} hold for first-order entailment as well.
\end{comments}
