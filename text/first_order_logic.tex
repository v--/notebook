...
\begin{remark}\label{rem:first_order_formula_conventions}
  ...
  \begin{thmenum}
    ...
    as a shorthand for
    \begin{equation*}
      \mathbf{\qforall \xi (p(\xi, \cdots) \synimplies \varphi)}
    \end{equation*}
    \begin{equation*}
...
\begin{proof}
  ...
  \begin{equation*}
    \begin{prooftree}
      ...
      \hypo{ [\synneg \varphi]^2 }
      \infer2[\ref{eq:def:propositional_natural_deduction_systems/neg/elim}]{ \synbot }
      \infer[left label=\( 1 \)]1[\ref{eq:def:propositional_natural_deduction_systems/neg/intro}]{ \synneg \qforall \xi \varphi }
