...
\begin{definition}\label{def:trivial_structure}\mimprovised
  A \term{trivial structure} for the language \( \mscrL \) is one with minimal \hyperref[def:cardinality_existence]{cardinality}, assuming different structures with this cardinality are isomorphic.
