...
\begin{proof}
  ...
  \begin{equation*}
    \begin{prooftree}
      ...
      \infer[left label=\( 2 \)]1[\eqref{eq:def:propositional_natural_deduction_systems/neg/intro}]{ \synneg \varphi }
  ...
  \begin{equation*}
    \begin{prooftree}
      ...
      \hypo{ [\synneg \varphi]^2 }
      \infer2[\eqref{eq:def:propositional_natural_deduction_systems/neg/elim}]{ \synbot }
      \infer[left label=\( 1 \)]1[\eqref{eq:def:propositional_natural_deduction_systems/neg/intro}]{ \synneg \qforall \xi \varphi }
