...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \item If \( b \) has order \( 4 \), \fullref{thm:def:cyclic_group/generators} implies that \( b \) generates \( G \). Hence, by \fullref{thm:cyclic_monoid_classification/finite_group}, \( G \) is isomorphic to \( C_4 \).
  \end{itemize}
  ...
  \begin{itemize}
    ...
    It remains for the order of \( c \) to be \( 6 \). \Fullref{thm:def:cyclic_group/generators} implies that \( c \) generates \( G \), and \fullref{thm:cyclic_monoid_classification/finite_group} implies that \( G \) is isomorphic to \( C_6 \).
    ...
    \begin{itemize}
      ...
      Clearly \( (ab)^6 = e \). Then \( 6 \) is the smallest power of \( ab \) that gives \( e \), i.e. the order of \( ab \). \Fullref{thm:def:cyclic_group/generators} implies that \( ab \) generates \( G \), and \fullref{thm:cyclic_monoid_classification/finite_group} implies that \( G \) is isomorphic to \( C_6 \).
