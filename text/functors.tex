...
\end{definition}
\begin{comments}
  \item Such a category is based the \hyperref[def:discrete_topology]{discrete topology} and is unrelated to Aristotelian discrete variables in the sense of \fullref{con:discrete_and_continuous_variables}.
\end{comments}
