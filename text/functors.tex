...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \begin{equation*}
      (\gph F_{\mor}, \mor(\cat{C}), \mor(\cat{D})),
    \end{equation*}
    ...
    \item Under the interpretation from \cref{rem:small_functions/graph}, where \( F_{\mor} \) is its graph \( \gph F_{\mor} \), since \( F_{\mor} \) is assumed to be small, so are \( \mor(\cat{C}) \) and the image \( \img F_{\mor} \).
