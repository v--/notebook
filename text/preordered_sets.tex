...
\begin{definition}\label{def:preordered_set}\mcite[13]{Harzheim2005}
  ...
  \begin{thmenum}[resume=def:preordered_set]
    ...
    \thmitem{def:preordered_set/opposite}\mcite[3]{Birkhoff1967} We define the \term{dual} or \term{opposite} preordered set of \( (P, \leq) \) as \( (P, \geq) \).
...
\begin{remark}\label{rem:order_homomorphism_terminology}
  ...
  \begin{itemize}
    ...
    \incite[lemma 6.3.1]{Bergman2015} uses \enquote{increasing} for what we call an \enquote{\hyperref[def:extensive_function]{extensional function}}.
