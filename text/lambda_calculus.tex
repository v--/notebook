...
This \enquote{simple theory of types} is attributed as a development by different logicians of the \enquote{ramified theory of types} by Bertrand Russell. Russell himself was concerned with \hyperref[con:impredicative_definition]{impredicativity}, as explained in \fullref{sec:ramified_types}. Type theory has since been studied separately from logic; we will briefly discuss some different type theories.
...
Further connections with logic will be investigated in \fullref{sec:higher_order_logic} and \fullref{sec:henkin_semantics}.
