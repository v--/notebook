...
Two connections to logic will be investigated --- one in \fullref{sec:curry_howard_correspondence} and, within \fullref{ch:mathematical_logic}, another one in \fullref{sec:predicate_logic}.
