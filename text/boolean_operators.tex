...
\begin{definition}\label{def:boolean_closure}\mcite[30]{Яблонский1986}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:boolean_closure/closure}\mcite[33]{Яблонский1986} We define the \hyperref[def:moore_closure_operator]{Moore closure operator} \( \cl \) on \( \pow(\mscrB) \) by assigning to every set \( B \) the smallest closed set containing \( B \).
