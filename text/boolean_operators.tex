...
\begin{proposition}\label{thm:two_element_lattice}
  Any two-element \hyperref[def:semilattice/lattice]{lattice} is \hyperref[def:semilattice/homomorphism]{isomorphic} to the \hyperref[def:finite_field]{finite field} \( \BbbF_2 = \set{ 0, 1 } \) regarded as a \hyperref[def:boolean_algebra]{Boolean algebra}.
\end{proposition}
\begin{proof}
