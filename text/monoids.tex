...
\begin{definition}\label{rem:pointed_set}\mcite[26]{MacLane1998}
  ...
  \begin{thmenum}
    ...
    \thmitem{rem:pointed_set/trivial} The \hyperref[def:trivial_structure]{trivial} pointed set is, up to an isomorphism, the set \( \set{ e } \). It is isomorphic to \hyperref[thm:substructures_form_complete_lattice/bottom]{initial substructure} of any pointed set.
...
\begin{definition}\label{def:set_with_involution}\mimprovised
  ...
  \begin{thmenum}
    ...
    \thmitem{def:set_with_involution/trivial} The \hyperref[def:trivial_structure]{trivial} set with involution is the empty set. It is also the \hyperref[thm:substructures_form_complete_lattice/bottom]{initial substructure} of any set with involution.
...
\begin{definition}\label{def:magma}
  ...
  \begin{thmenum}[series=def:magma]
    ...
    \thmitem{def:magma/trivial} The \hyperref[thm:substructures_form_complete_lattice/bottom]{trivial magma} is the empty set with an empty operation. It is the unique \hyperref[def:universal_objects/initial]{zero object} in \( \cat{Mag} \) and is isomorphic to \hyperref[thm:substructures_form_complete_lattice/bottom]{initial substructure} of any magma.
...
\begin{definition}\label{def:monoid}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:monoid/trivial} The \hyperref[def:trivial_structure]{trivial} monoid is the \hyperref[rem:pointed_set/trivial]{trivial pointed set} \( \set{ e } \). It is isomorphic to \hyperref[thm:substructures_form_complete_lattice/bottom]{initial substructure} of any monoid.
