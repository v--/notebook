...
\begin{definition}\label{rem:pointed_set}\mcite[26]{MacLane1994}
  ...
  \begin{thmenum}
    ...
    \thmitem{rem:pointed_set/homomorphism} A \hyperref[def:first_order_homomorphism]{homomorphism} between the pointed sets \( (X, e_{X}) \) and \( (Y, e_{Y}) \) is, explicitly, a function \( \varphi: X \to Y \) that satisfies
...
\begin{definition}\label{def:monoid}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:monoid/homomorphism} A \hyperref[def:first_order_homomorphism]{homomorphism} between monoids is a function that satisfies both \eqref{eq:rem:pointed_set/homomorphism} and \eqref{eq:def:magma/homomorphism}.
