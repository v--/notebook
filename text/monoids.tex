...
\begin{definition}\label{def:operation_on_set}\mcite[65]{Rosen1999DiscreteHandbook}
  An \term[bg=операция (\cite[def. IV.1]{ГеновИПр1991Алгебра}), ru=операция (\cite[12]{ЦаленкоШульгейфер1974Категории})]{operation} of arity \( n \) or \( n \)-ary operation on a \hyperref[def:set]{plain set} \( A \) is a \hyperref[def:function]{function} from \( A^n \) to \( A \).
\end{definition}
\begin{comments}
...
\begin{definition}\label{def:operation_arity}\mcite[132]{Birkhoff1967Lattices}
  ...
  \begin{itemize}
    ...
    \item \term[bg=унарна (операция) (\cite[75]{ГеновИПр1991Алгебра}), ru=унарная (операция) (\cite[11]{Эдельман1975Логика})]{Unary} for \( n = 1 \).
    \item \term[bg=бинарна (операция) (\cite[def. IV.1]{ГеновИПр1991Алгебра}), ru=бинарная (операция) (\cite[11]{Эдельман1975Логика})]{Binary} for \( n = 2 \).
    \item \term[bg=тернарна (операция) (\cite[75]{ГеновИПр1991Алгебра}), ru=тернарная (операция) (\cite[11]{Эдельман1975Логика})]{Ternary} for \( n = 3 \).
  \end{itemize}
\end{definition}
...
\begin{definition}\label{def:binary_operation}
  ...
  \begin{thmenum}
    \thmitem{def:binary_operation/associative}\mcite[\S 1.18(\( \alpha \))]{Ляпин1960Полугруппы} \term[bg=асоциативност (\cite[11]{ГеновИПр1991Алгебра}), ru=ассоциативность, en=associativity (\cite[41]{Savage1998Computability})]{Associativity}:
    \begin{equation}\label{eq:def:binary_operation/associative}
      (\synx \cdot \syny) \cdot \synz = \synx \cdot (\syny \cdot \synz).
    \end{equation}

    \thmitem{def:binary_operation/commutative}\mcite[\S 1.18(\( \beta \))]{Ляпин1960Полугруппы} \term[bg=комутативност (\cite[11]{ГеновИПр1991Алгебра}), ru=коммутативность, en=commutativity (\cite[3]{Golan1999Semirings})]{Commutativity}:
    ...
    \thmitem{def:binary_operation/cancellative}\mcite[19]{MacLane1998Categories} Left and right \term[bg=съкращаване (\cite[77]{ГеновИПр1991Алгебра}), ru=сокращение (\cite[\( 1.18(\varepsilon) \)]{Ляпин1960Полугруппы})]{cancellation}:
    \begin{subequations}
      \begin{align}
