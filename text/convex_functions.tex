...
\begin{proposition}\label{thm:convex_subdifferential_is_convex_and_weak*_closed}\mcite[exerc. 1.10]{Phelps1993Convex}
...
\begin{theorem}\label{thm:rn_continuous_convex_partial_derivatives_imply_gateaux}\mcite[exerc. 1.15(b]{Phelps1993Convex})
...
\begin{theorem}\label{thm:rn_continuous_convex_gateaux_implies_frechet}\mcite[exerc. 1.15(a]{Phelps1993Convex})
...
\begin{theorem}\label{thm:rn_continuous_convex_frechet_almost_everywhere}\mcite[exerc. 1.17]{Phelps1993Convex}
