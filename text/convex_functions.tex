...
\begin{comments}
  ...
  \item What we call a \enquote{sublevel set} is also referred to as a \enquote{level set}, for example by \textcite[28]{Rockafellar1997ConvexAnalysis} and \textcite[281]{AubinFrankowska1990SetValuedAnalysis}.
\end{comments}
