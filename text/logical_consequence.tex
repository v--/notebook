...
\begin{remark}\label{rem:named_logical_systems}
  ...
  \begin{itemize}
    ...
    In the same paper he also introduces \hyperref[def:sequent_calculus_system]{sequent calculus}, whose variants he called \logic{LJ} (\enquote{Intuitionistische Pr\"adikatenlogik}) and \logic{LK} (\enquote{Klassik Pr\"adikatenlogik}). We formulate them in \cref{def:classical_propositional_sequent_calculus}.
