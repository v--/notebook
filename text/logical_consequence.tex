...
\begin{concept}\label{con:intuitionistic_logic}\mimprovised
  ...
  We will also discuss two \hyperref[def:general_logic]{general logics} --- the one defined in \cref{def:propositional_logic} for \hyperref[def:propositional_formula]{propositional formulas}, with the \hyperref[def:truth_value_algebra/intuitionistic]{intuitionistic} \hyperref[def:propositional_institution]{propositional institution} and the corresponding \hyperref[def:propositional_natural_deduction_systems]{natural deduction system}, and the one defined in \cref{def:first_order_logic} for \hyperref[def:fol_formula]{first-order formulas}, with the corresponding \hyperref[def:fol_natural_deduction_systems]{natural deduction system}.
\end{concept}
\begin{comments}
...
\begin{concept}\label{con:minimal_logic}\mimprovised
  ...
  We will only sketch semantics for \hyperref[def:propositional_formula]{propositional formulas} in \cref{rem:minimal_logic_semantics}, but will present a full-fledged natural deduction system in \cref{def:propositional_natural_deduction_systems}, and extend it to \hyperref[def:fol_formula]{first-order formulas} in \cref{def:fol_natural_deduction_systems}.
\end{concept}
