...
\begin{definition}\label{def:category_of_theories}\mcite[def. 2]{Meseguer1989GeneralLogics}
  ...
  \begin{thmenum}
    \thmitem{def:category_of_theories/objects} The objects are pairs \( (\Sigma, T) \), where \( T \) is a \( \mscrU \)-small \hyperref[def:entailment_system_theory]{theory} over the \( \mscrU \)-small signature \( \Sigma \).
