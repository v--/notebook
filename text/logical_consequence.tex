...
\begin{remark}\label{rem:logical_theory_closed}
  ...
  On the other hand, the requirement that a theory is closed is sometimes lifted, for example by \textcite[7]{TroelstraSchwichtenberg2000BasicProofTheory}, \textcite[def. 3.1.1]{Герасимов2014Вычислимость} and \textcite[146]{ШеньВерещагин2017ЯзыкиИИсчисления}.
