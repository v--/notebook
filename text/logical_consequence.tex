...
\begin{comments}
  ...
  This definition technically makes unsatisfiable theories categorical. Unlike the aforementioned authors, \incite[def. 3.3.15]{VanDalen2004LogicAndStructure} explicitly requires the theory to be satisfiable.
\end{comments}
