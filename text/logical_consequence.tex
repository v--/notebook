...
\begin{remark}\label{rem:logical_compactness_theorems}
  ...
  \begin{thmenum}
    ...
    \thmitem{rem:logical_compactness_theorems/sequent_calculus} \Cref{thm:sequent_calculus_consequence_compact}.
    \thmitem{rem:logical_compactness_theorems/fol_syntactic} \Cref{thm:fol_natural_deduction_derivation_compact}.
    \thmitem{rem:logical_compactness_theorems/fol_semantic} \Cref{thm:fol_semantic_compactness}.
    \thmitem{rem:logical_compactness_theorems/hol_syntactic} \Cref{thm:hol_natural_deduction_derivation_compact}.
    \thmitem{rem:logical_compactness_theorems/hol_semantic} \Cref{thm:hol_weak_semantic_compactness}.
  \end{thmenum}
\end{remark}
\begin{comments}
...
\end{definition}
\begin{comments}
  \item We generalize the definitions given for \hyperref[def:fol_theory]{first-order theories} given in \cite[def. 2.5.2]{Hinman2005Logic} and \cite[88]{Shoenfield1967MathematicalLogic} and for \hyperref[def:hol_theory]{higher-order theories} given in \cite[exerc. X5502]{Andrews2002Logic}.
