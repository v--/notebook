...
\begin{concept}\label{con:logical_model}
  ...
  The models themselves are not isolated, and the connections between them are described by \term[en=structure-preserving map (\cite[25]{DaveyPriestley2002LatticeTheory})]{structure preserving maps}, also called \term[en=morphism (\cite[25]{DaveyPriestley2002LatticeTheory})]{morphisms} and \term{homomorphisms}.

  The precise connection between a theory, its models and their morphisms gives rise to a particular \hyperref[def:institution]{institution}.
\end{concept}
\begin{comments}
