...
\begin{proposition}\label{thm:complex_numbers_as_matrices}
  ...
  \begin{equation}\label{eq:thm:complex_numbers_as_matrices}
    ...
    \end{pmatrix}
  \end{equation}
  is a \hyperref[def:algebra_over_ring/submodel]{unital subalgebra} and is isomorphic to the \( \BbbR \)-algebra \( \BbbC \) of \hyperref[def:complex_numbers]{complex numbers}.
\end{proposition}
\begin{proof}
