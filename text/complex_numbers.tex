...
\begin{definition}\label{def:complex_numbers}
  ...
  \begin{thmenum}
    \thmitem{def:complex_numbers/polynomials} The most \enquote{algebraic} way to define complex numbers is as the \hyperref[def:polynomial_algebra/polynomial]{polynomial} quotient ring
    \begin{equation*}
