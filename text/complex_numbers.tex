...
\begin{proposition}\label{thm:real_quadratic_polynomial_roots}
  The \hyperref[def:polynomial_root]{roots} of the \hyperref[def:real_numbers]{real} \hyperref[def:polynomial_degree_terminology]{quadratic} \hyperref[def:polynomial_algebra]{polynomial} \( f(X) = a X^2 + b X + c \) are
