...
\begin{proof}
  ...
  \SufficiencySubProof* If \( D(f) > 0 \), \fullref{thm:principal_real_square_root_sign/nonnegative} implies that \( \sqrt{D(f)} \) is positive, and hence \( x_+ \) and \( x_- \) are distinct real numbers.
  ...
  \SubProofOf{thm:real_quadratic_discriminant/eq}
