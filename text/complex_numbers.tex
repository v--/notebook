...
\begin{definition}\label{def:complex_numbers}
  ...
  \begin{thmenum}
    \thmitem{def:complex_numbers/polynomials} The most \enquote{algebraic} way to define complex numbers is as the \hyperref[def:polynomial_algebra/polynomials]{polynomial} quotient ring
    \begin{equation*}
  ...
  We define the unary \term{complex conjugation} operation as \( \oline{a + bi} \coloneqq a - bi \) and the \term{absolute value} as
  \begin{equation*}
