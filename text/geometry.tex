...
Our goal is to introduce formalisms for these mental visualizations. An axiomatic approach for a theory of figures in the place and space was developed by Euclid in the third century BC and can be found in \cite{Euclids2008Elements}. A few millennia later, several mathematicians proposed systems of axioms that fit the requirements of \hyperref[ch:mathematical_logic]{modern logical systems}. Tarski's system can be found in \cite{Tarski1959ElementaryGeometry}. This is known today as \term{synthetic Euclidean geometry} and is mostly of theoretical interest.
...
A modern interpretation if the ideas behind analytic geometry leads to \hyperref[def:affine_space]{affine spaces}, which we will discuss in \fullref{sec:affine_spaces} and \fullref{sec:convex_sets}, to Euclidean spaces discussed in \fullref{sec:euclidean_spaces} and to the Euclidean plane discussed in \fullref{sec:euclidean_plane}, \fullref{sec:triangles} and \fullref{sec:quadratic_plane_curves}. As part of our discussion of the \hyperref[def:euclidean_plane]{Euclidean plane}, we will briefly introduce modern concepts related to differential geometry in \fullref{sec:parametric_curves} and algebraic geometry in \fullref{sec:quadratic_plane_curves}.
