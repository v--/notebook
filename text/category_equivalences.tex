...
\begin{example}\label{ex:set_discr_cat_isomorphism}
  ...
  These were discussed in \cref{ex:discrete_category_adjunction}, although with \( \cat{Cat} \) rather than \( \ucat{DiscrCat} \).
...
\begin{proof}
  ...
  \SubProofOf[def:binary_relation/transitive]{transitivity} By \cref{thm:def:morphism_invertibility/invertible_composition}, the composition of invertible natural isomorphisms is again a natural isomorphism, hence equivalence in \( \obj(\ucat{Cat}) \) is a transitive relation.
\end{proof}
