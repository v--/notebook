...
\end{definition}
\begin{comments}
  \item Across our cited literature, \enquote{delooping} is used only in \cite[10]{Perrone2024StartingCategoryTheory}. The same construction with the same notation but with no explicit name can be found in \cite[exerc. 1.3.9]{Riehl2016CategoryTheory}.
\end{comments}
