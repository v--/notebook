...
\begin{example}\label{ex:set_discr_cat_isomorphism}
  ...
  These were discussed in \cref{ex:discrete_category_adjunction}, although with \( \cat{Cat} \) rather than \( \cat{DiscrCat} \).
...
\begin{proof}
  ...
  \SubProofOf[def:binary_relation/transitive]{transitivity} By \cref{thm:def:morphism_invertibility/invertible_composition}, the composition of invertible natural isomorphisms is again a natural isomorphism, hence equivalence in \( \obj(\cat{Cat}) \) is a transitive relation.
\end{proof}
...
\begin{theorem}[Fully faithful and essentially surjective functor induces equivalence]\label{thm:fully_faithful_and_essentially_surjective_functor_induces_equivalence}
  ...
  In \hyperref[def:zfc]{\logic{ZF}}, this theorem is equivalent to the \hyperref[def:zfc/choice]{axiom of choice} --- see \cref{thm:axiom_of_choice_equivalences/fully_faithful_essentially_surjective}.
...
\begin{proof}
  ...
  We have implicitly used \cref{rem:inverting_isomorphisms_may_preserve_commutativity} above.
...
\end{theorem}
\begin{comments}
  \item In \hyperref[def:zfc]{\logic{ZF}}, this theorem is equivalent to the \hyperref[def:zfc/choice]{axiom of choice} --- see \cref{thm:axiom_of_choice_equivalences/skeletons}.
\end{comments}
\begin{proof}
