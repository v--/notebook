...
\begin{definition}\label{def:connected_category}\mcite[88]{MacLane1998}
  We say that a \hyperref[def:category]{category} is \term{connected} if there exists an \hyperref[def:directed_multigraph_path/undirected]{undirected path} between any two points of the \hyperref[def:category]{underlying multigraph}.
\end{definition}
