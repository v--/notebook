...
\begin{definition}\label{def:banach_space_support_function}\mcite[example 3.2(a)]{Phelps1993Convex})
...
\begin{definition}\label{def:banach_space_slice}\mcite[def. 2.17]{Phelps1993Convex}
