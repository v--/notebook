...
\begin{remark}\label{rem:real_function_definiteness_terminology}
  ...
  \begin{itemize}
    ...
    \item \incite[def. 1.4.7]{Кострикин2000АлгебраЧасть2}, \incite[152]{Фаддеев1984ЛекцииПоАлгебре} and \incite[208]{Treil2017LinearAlgebraDoneWrong} gives an explicit definition for positive and negative (semi)definite finite dimensional \hyperref[thm:quadratic_forms]{quadratic forms}. Kostrikin require the forms to be nondegenerate.
    ...
    \item \incite[230]{Roman2005AdvancedLinearAlgebra} give an explicit definition for \enquote{positive} (what we call positive semidefinite) positive definite self-adjoint linear operators.
