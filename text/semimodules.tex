...
\begin{remark}\label{rem:free_commutative_monoid_as_quotient}
  ...
  By \cref{thm:homomorphism_induces_congruence}, \( \varphi \) induces a \hyperref[def:fol_congruence]{monoid congruence} \( \cong \) on \( A^* \) where two strings are congruent if they have the same amount of each symbol from \( A \).
