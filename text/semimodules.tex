...
\begin{definition}\label{def:semimodule}
  ...
  \begin{thmenum}[resume=def:semimodule]
    ...
    \thmitem{def:semimodule/trivial} The \hyperref[def:trivial_structure]{trivial} \( R \)-semimodule is the \hyperref[rem:pointed_set/trivial]{trivial pointed set} \( \set{ 0 } \). It is isomorphic to \hyperref[thm:substructures_form_complete_lattice/bottom]{initial substructure} of any \( R \)-semimodule.
