...
\begin{definition}\label{def:semimodule}
  ...
  \begin{thmenum}[resume=def:semimodule]
    ...
    \thmitem{def:module/initial} The \hyperref[thm:substructures_form_complete_lattice/bottom]{initial substructure} of any \( R \)-semimodule is isomorphic to the trivial \( R \)-semimodule \( \set{ \vect 0 } \).
