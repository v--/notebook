...
\begin{lemma}[K\"onig's lemma]\label{thm:konigs_lemma}
  Every \hyperref[def:hypergraph/degree]{locally finite} \hyperref[def:arborescence]{arborescence} of \hyperref[def:graph_cardinality/order]{infinite} \hyperref[def:graph_cardinality/order]{order} contains a \hyperref[def:undirected_multigraph_path/simple]{simple path} of infinite length.
\end{lemma}
\begin{proof}
