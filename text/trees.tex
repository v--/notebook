...
\begin{definition}\label{def:rooted_tree}\mcite[15]{Diestel2005Graphs}
  A \term[ru=ориентированное дерево (\cite[323]{ЕмеличевИПр1990Графы}); корневое дерево (\cite[\S 9.2.1]{Новиков2013ДискретнаяМатематика})]{rooted tree} is a triple \( T = (V, E, r) \), where \( (V, E) \) is a \hyperref[def:tree]{tree} and \( r \) is a distinguished node, called the \term{root}.
