...
\begin{remark}\label{rem:tree_grafting_nodes}
  When building \hyperref[def:ordered_tree]{ordered trees} recursively, for example in \cref{def:propositional_formula_ast}, \cref{def:lambda_term_ast} or \cref{def:natural_deduction_proof_tree}, we start with singleton trees and then graft existing trees onto new roots.
