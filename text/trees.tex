...
\begin{definition}\label{def:tree}\mcite[thm. 1.5.1]{Diestel2017GraphTheory}
  ...
  \begin{thmenum}[resume=def:tree]
    ...
    \thmitem{def:tree/category}\mimprovised Correspondingly, for a fixed Grothendieck universe \( \mscrU \), we can define a \hyperref[def:category]{category} of \( \mscrU \)-small trees and their homomorphisms.
...
\begin{definition}\label{def:rooted_tree}\mcite[783]{Rosen2019DiscreteMathematics}
  ...
  \begin{thmenum}[resume=def:rooted_tree]
    ...
    \thmitem{def:rooted_tree/category}\mimprovised For a fixed Grothendieck universe \( \mscrU \), we can define a \hyperref[def:category]{category} of \( \mscrU \)-small rooted trees and their homomorphisms.
...
\begin{definition}\label{def:ordered_tree}\mimprovised
  ...
  \begin{thmenum}
    ...
    \thmitem{def:ordered_tree/category} For a fixed Grothendieck universe \( \mscrU \), we can define a \hyperref[def:category]{category} of \( \mscrU \)-small ordered trees and their homomorphisms.
  \end{thmenum}
\end{definition}
\begin{comments}
...
\begin{definition}\label{def:labeled_tree}\mimprovised
  ...
  \begin{thmenum}
    ...
    \thmitem{def:labeled_tree/category} For a fixed Grothendieck universe \( \mscrU \), we can define a \hyperref[def:category]{category} of \( \mscrU \)-small labeled trees and their homomorphisms.
  \end{thmenum}
\end{definition}
\begin{comments}
