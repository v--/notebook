...
\begin{comments}
  ...
  We have chosen the term \enquote{labeled tree} for brevity; \incite[471]{Mimram2020} and Paul Stockmeyer in \cite[655]{Rosen1999} use the same term for generic trees with labeled nodes, while \incite[\S 2.8]{Holtkamp2011} uses it for rooted trees with labeled nodes.
\end{comments}
