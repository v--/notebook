...
\begin{comments}
  ...
  \item Representations can be used to describe \hyperref[con:universal_property]{universal properties} --- see \cref{rem:representable_functor_universal_morphism}.
\end{comments}
