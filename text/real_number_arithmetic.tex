...
\begin{example}\label{ex:def:extended_real_numbers}
  ...
  \begin{thmenum}
    ...
    We treat the order as either a nonnegative integer or \( \infty \), which allows us to easily handle the sums and maxima in \eqref{eq:def:hol_formula_ramification_order/direct} and \eqref{eq:def:quantifiable_type_ramification_order/direct}.
  \end{thmenum}
\end{example}
