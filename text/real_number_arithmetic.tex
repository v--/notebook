...
\begin{example}\label{ex:def:extended_real_numbers}
  ...
  \begin{thmenum}
    ...
    \thmitem{ex:def:extended_real_numbers/formula_order} When defining the minimal order of a \hyperref[def:hol_term/formula]{formula of higher-order logic} in \cref{def:hol_formula_ramification_order}, we are faced with the possibility of it being unramifiable. Then the order is undefined.
