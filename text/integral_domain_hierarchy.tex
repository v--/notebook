...
\begin{comments}
  ...
  \begin{itemize}
    ...
    \item \Textcite[36]{Шафаревич1999ОсновныеПонятияАлгебры} and \textcite[def. VI.2]{ГеновМиховскиМоллов1991Алгебра} also use \enquote{Euclidean ring}, however neither state \cref{def:euclidean_domain/multiplication}, and the latter even require degrees to be defined for zero elements.
