...
\begin{remark}\label{rem:locus_terminology}
  ...
  \begin{itemize}
    \item \incite[17]{Розенфельд1963ОсновныеПонятиеГеометрии} explains this with Aristotle's idea that a line is not a set of points, but merely a position where points can be placed. This view was shared by Euclid, and through his \enquote{Elements} book series later the Latin translation of \enquote{place}, \enquote{locus}, became standard terminology. In \cite{Euclid2008Elements}, Fitzpatrick translates several distinct Ancient Greek words as \enquote{place} or \enquote{position}, both as nouns and as verbs.
