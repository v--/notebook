...
\end{definition}
\begin{comments}
  \item It is the in the \hyperref[def:topological_space_ordering]{finest} topology in the \hyperref[thm:lattice_of_topologies]{lattice of topologies} on \( X \), and is \hyperref[def:adjoint_functor]{left adjoint} to the \hyperref[con:forgetful_functor]{forgetful functor} \( U: \cat{Top} \to \cat{Set} \).
