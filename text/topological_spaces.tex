...
\end{definition}
\begin{comments}
  \item Some authors --- for example \incite[12]{Engelking1989Topology}, \incite[7]{Rudin1991Functional} and \incite[def. 4.1]{Александров1977Топология} --- stick to this definition, while others define neighborhoods to be an arbitrary superset of what we call a neighborhood --- for example \incite[8]{Kelley1975Topology}.
\end{comments}
