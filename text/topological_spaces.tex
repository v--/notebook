...
\end{definition}
\begin{comments}
  \item Some authors --- for example \incite[12]{Engelking1989}, \incite[7]{Rudin1991Functional} and \incite[def. 4.1]{Александров1977Введение} --- stick to this definition, while others define neighborhoods to be an arbitrary superset of what we call a neighborhood --- for example \incite[8]{Kelley1975}.
\end{comments}
...
\end{theorem}
\begin{comments}
  \item \incite{Александров1977Введение} calls this theory \enquote{the} Alexandrov-Urysohn theorem. The infinite case of the theorem can be found as \enquote{theorem 2} in his earlier paper \cite{АлександровУрысон1950} with Pavel Urysohn, although this theorem is not the focus of their paper.
\end{comments}
\begin{proof}
...
\end{definition}
\begin{comments}
  \item This is a twist around the usual definition requiring that the family of all finite intersections of members of \( \mscrS \) is a \hyperref[def:topological_base]{basis}. This is the definition given by \incite[4]{Engelking1989}, by \incite[48]{Kelley1975} and \incite[def. 4.7]{Александров1977Введение}).
\end{comments}
