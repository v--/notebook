...
\begin{definition}\label{def:extremal_points}
  ...
  \begin{thmenum}
    \thmitem{def:extremal_points/upper_and_lower_bounds}\cite[16]{Birkhoff1948}
    ...
    \thmitem{def:extremal_points/maximal_and_minimal_element}\cite[7]{Birkhoff1948}
    \begin{minipage}[t]{0.45\textwidth}
    ...
    \thmitem{def:extremal_points/supremum_and_infimum}\cite[16]{Birkhoff1948}
    \begin{minipage}[t]{0.45\textwidth}
