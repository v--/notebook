...
\begin{example}\label{ex:def:lexicographic_order}
  ...
  \begin{thmenum}
    ...
    \thmitem{ex:def:lexicographic_order/natural_numbers} Consider the language of natural numbers in decimal notation from \fullref{rem:decimal_notation_grammar}. Ordering single-digit strings is trivial, but ordering multi-digit numeric strings requires using lexicographic ordering.
