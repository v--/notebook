...
\begin{definition}\label{def:extremal_points}
  ...
  \begin{thmenum}
    \thmitem{def:extremal_points/upper_and_lower_bounds}\cite[20]{Вулих1961}
    ...
    \thmitem{def:extremal_points/maximal_and_minimal_element}\cite[def. 1.5.1]{Birkhoff1948}
    \begin{minipage}[t]{0.45\textwidth}
    ...
    \thmitem{def:extremal_points/supremum_and_infimum}\cite[def. 1.6.1]{Вулих1961}
    \begin{minipage}[t]{0.45\textwidth}
