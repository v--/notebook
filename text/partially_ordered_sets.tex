...
\begin{comments}
  ...
  \incite[157]{Gratzer2011Lattices},
...
\begin{definition}\label{def:partial_order_chain}
  ...
  \begin{thmenum}
    \thmitem{def:partial_order_chain/chain}\mcite[4]{Gratzer2011Lattices} We say that \( C \) is a \term[bg=верига (\cite[10]{Проданов1982ФункАнализТом1}), ru=цепь (\cite[def. 3.4]{Гуров2013Решётки})]{chain} if every two elements of \( C \) are comparable.
...
\begin{comments}
  ...
  \item Zorn's lemma is sometimes stated and used only in a \hyperref[thm:boolean_algebra_of_subsets]{lattice of sets} --- for example by \incite[117]{Gratzer2011Lattices}, \incite[thm. 6.4.34]{Hinman2005Logic}, \incite[151]{Enderton1977Sets} and \incite[16]{КанторовичАкилов1984ФункАнализ}. A statement similar to this one is used by \incite[50]{Harzheim2005OrderedSets}, \incite[33]{Kelley1975Topology}, \incite[8]{Engelking1989Topology}, \incite[lemma V.3.1]{Aluffi2009Algebra}, \incite[880]{Lang2002Algebra}, \incite[314]{Rotman2015AlgebraVol1}, \incite[117]{Гуров2013Решётки}, \incite[31]{Мальцев1970ОбщаяАлгебра} and \incite[13]{Проданов1982ФункАнализТом1}. \incite[2]{Jacobson1989AlgebraPart2} states both.
\end{comments}
\begin{proof}
