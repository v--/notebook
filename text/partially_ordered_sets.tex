...
\begin{comments}
  ...
  \item Some authors like \incite[168]{Enderton1977Sets} defines partial orders as what we call strict partial orders.
...
\begin{definition}\label{def:extremal_points}
  We introduce the following terminology for extremal elements of a partially ordered set \( P \). The definitions hold more generally for preordered sets, but the nonuniqueness problems outlined in \fullref{ex:preorder_nonuniqueness} highlight that the notions may act unexpectedly.
