...
\begin{definition}\label{def:extensive_function}\mcite[49]{Birkhoff1948}
  An \hyperref[def:multi_valued_function/endofunction]{endofunction} \( f \) on a \hyperref[def:partially_ordered_set]{partially ordered set} \( (P, \leq) \) is said to be \term{extensive} if \( x \leq f(x) \) for every \( x \in P \).
\end{definition}
