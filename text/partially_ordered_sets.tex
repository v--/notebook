...
\begin{definition}\label{def:partially_ordered_set}\mcite[1]{Birkhoff1967LatticeTheory}
  ...
  The metamathematical properties are inherited from \cref{def:preordered_set} with this additional axiom added. Following \textcite[\S I.3.2]{Johnstone1982StoneSpaces}, we denote the corresponding category via \( \cat{Pos} \).
\end{definition}
\begin{comments}
  \item \Textcite[72]{Гуров2013ТеорияРешёток}, \textcite[10]{Проданов1982ФункционаленАнализЧаст1}, \textcite[4]{Engelking1989GeneralTopology}, \textcite[2]{DaveyPriestley2002LatticeTheory}, \textcite[13]{Harzheim2005OrderedSets}, \textcite[1]{Grätzer2011LatticeTheory} and \textcite[1]{Birkhoff1967LatticeTheory} define partial orders like us. \Textcite[62]{Enderton1977SetTheory} defines partial orders as what we call \enquote{\hyperref[def:strict_partial_order]{strict partial orders}}, while \textcite[13]{Kelley1975GeneralTopology} defines partial orders as simply \hyperref[def:binary_relation/transitive]{transitive} relations.
...
\begin{comments}
  ...
  \textcite[147]{Bourbaki2004TheoryOfSets},
  \textcite[def. 2.3]{EkelandTemam1976ConvexAnalysis} and
  \textcite[51]{Зорич2019АнализЧасть1}.

  We prefer \enquote{\( (a, b) \)}, which is in turn used by most of our sources ---
  \textcite[9]{Lorentz1966ApproximationOfFunctions},
  \textcite[31]{Rudin1976AnalysisPrinciples},
  \textcite[10]{Engelking1989GeneralTopology},
  \textcite[269]{Jacobson1985BasicAlgebraI},
  \textcite[157]{Grätzer2011LatticeTheory},
  \textcite[31]{Harzheim2005OrderedSets},
  \textcite[\S 3.3.14]{Schechter1997AnalysisHandbook}
  \textcite[11]{Folland1999RealAnalysis}
  \textcite[25]{МагарилИльяевТихомиров2002ВыпуклыйАнализ},
  \textcite[18]{ИльинСадовничийСендов1985АнализТом1},
  \textcite[\S 22.2]{Тыртышников2007ЛинейнаяАлгебра},
  \textcite[12]{Александров1977ОбщаяТопология},
  \textcite[112]{Винберг2014КурсАлгебры},
  \textcite[10]{БелоусовТкачёв2004ДискретнаяМатематика},
  \textcite[23]{Гуров2013ТеорияРешёток},
  \textcite[7]{Боянов2008ЧислениМетоди},
  \textcite[225]{ГеновМиховскиМоллов1991Алгебра} and
  \textcite[39]{Тагамлицки1971ДиференциалноСмятане}.

  \textcite[36]{Knuth1997ArtVol1} uses \enquote{\( (a..b) \)}.
\end{comments}
...
\begin{definition}\label{def:partial_order_chain}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:partial_order_chain/length}\mimprovised We define the \term[ru=длина (\cite[83]{Гуров2013ТеорияРешёток}), en=length (\cite[4]{Grätzer2011LatticeTheory})]{length} \( \len(C) \) of a \emph{nonempty} chain \( C \) as the unique \hyperref[def:cardinal]{cardinal} satisfying \( {\len(C) + 1 = \card(A)} \), that is, \( \len(C) = \card(C) - 1 \) for finite chains and \( \len(C) = \card(C) \) otherwise.
...
\begin{comments}
  ...
  \item \Textcite[5]{Birkhoff1967LatticeTheory} and \textcite[4]{Grätzer2011LatticeTheory} use \enquote{length} for what we call \enquote{height}, while \textcite[24]{Harzheim2005OrderedSets} and \textcite[83]{Гуров2013ТеорияРешёток} prefer our terminology.
  \item \Textcite[19]{Harzheim2005OrderedSets} defines the length of a chain as the cardinality itself, while \textcite[5]{Birkhoff1967LatticeTheory}, \textcite[4]{Grätzer2011LatticeTheory}, \textcite[def. 2.37]{DaveyPriestley2002LatticeTheory} and \textcite[83]{Гуров2013ТеорияРешёток} subtract one. We prefer the latter convention.
\end{comments}
...
\end{definition}
\begin{comments}
  \item The definition is based on \cite[113]{DaveyPriestley2002LatticeTheory}, where atoms are defined in lattices. We additionally define coatoms.
\end{comments}
...
\end{definition}
\begin{comments}
  \item \Textcite[40]{Harzheim2005OrderedSets} prefers the term \enquote{extensional operator}, \textcite[186]{DaveyPriestley2002LatticeTheory} prefer \enquote{increasing map} while \textcite[def. 2.12]{Гуров2013ТеорияРешёток} uses \enquote{рефлексивный оператор} (\enquote{reflexive operator}).
\end{comments}
...
\begin{comments}
  ...
  \item Zorn's lemma is sometimes stated and used only in a \hyperref[thm:boolean_algebra_of_subsets]{lattice of sets} --- for example by \textcite[117]{Grätzer2011LatticeTheory}, \textcite[thm. 6.4.34]{Hinman2005Logic}, \textcite[151]{Enderton1977SetTheory} and \textcite[16]{КанторовичАкилов1984ФункциональныйАнализ}. A statement similar to this one is used by \textcite[50]{Harzheim2005OrderedSets}, \textcite[33]{Kelley1975GeneralTopology}, \textcite[8]{Engelking1989GeneralTopology}, \textcite[lemma V.3.1]{Aluffi2009Algebra}, \textcite[880]{Lang2002Algebra}, \textcite[314]{Rotman2015AdvancedModernAlgebraPart1}, \textcite[117]{Гуров2013ТеорияРешёток}, \textcite[31]{Мальцев1970АлгебраическиеСистемы} and \textcite[13]{Проданов1982ФункционаленАнализЧаст1}. \Textcite[2]{Jacobson1989BasicAlgebraII} states both.
\end{comments}
\begin{proof}
