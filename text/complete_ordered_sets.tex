...
\begin{proposition}\label{thm:dedekind_completeness_unbounded_characterization}
  An \hi{\hyperref[def:extremal_points/bounds]{unbounded}} totally ordered set is \hyperref[def:dedekind_completeness]{Dedekind complete} if and only if it is closed under suprema and infima of \hi{nonempty bounded} sets.
\end{proposition}
\begin{proof}
