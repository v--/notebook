...
\end{definition}
\begin{comments}
  \item Monadic second-order logic covers most of what we would possibly need beyond first-order logic, for example the \enquote{full} variants of \hyperref[def:peano_arithmetic]{Peano arithmetic} and \hyperref[def:zfc]{Zermelo-Fraenkel set theory}.
