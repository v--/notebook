...
\begin{definition}\label{def:topological_net}\mcite[65]{Kelley1975Topology}
...
\begin{definition}\label{def:net_eventually_in}\mcite[65]{Kelley1975Topology}
...
\begin{definition}\label{def:net_frequently_in}\mcite[65]{Kelley1975Topology}
...
It is unfortunately an established convention for subsequences to be defined differently compared to subnets. There are actually different definitions of subnets in the literature --- see \cite[\S 7.14]{Schechter1997AnalysisHandbook} for a discussion; We will base our exposition definition on Kelley's \cite[ch. 2]{Kelley1975Topology}.

\begin{definition}\label{def:subsequence}\mcite[63]{Kelley1975Topology}
  We say that
...
\begin{comments}
  ...
  \item While Kelley in \cite[63]{Kelley1975Topology} calls this definition \enquote{unnecessarily stringent} before introducing nets, other authors like \incite[def. 3.5]{Rudin1976AnalysisPrinciples} prefer this definition.
...
\begin{definition}\label{def:subnet}\mcite[70]{Kelley1975Topology}
...
\begin{definition}\label{def:net_cluster_point}\mcite[71]{Kelley1975Topology}
...
\begin{proposition}\label{thm:cluster_point_iff_in_closure}\mcite[prop. 1.6.3]{Engelking1989Topology}
...
\begin{definition}\label{def:net_limit_point}\mcite[66]{Kelley1975Topology}
