...
It is unfortunately an established convention for subsequences to be defined differently compared to subnets. There are actually different definitions of subnets --- see \cite{Lehuta2009Subnets} --- but we will base our exposition on that of \incite[ch. 2]{Kelley1975Topology}.
