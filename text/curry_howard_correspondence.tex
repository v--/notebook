...
\begin{algorithm}[Type derivation to proof tree]\label{alg:type_derivation_to_proof_tree}
  ...
  \begin{thmenum}
    ...
    Each derivation tree has an associated \hyperref[def:atomic_lambda_schema_instantiation]{\( \muplambda \)-schema instantiation} from which we can infer the required propositional instantiation.
