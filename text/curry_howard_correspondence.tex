...
\begin{definition}\label{def:simple_product_type}\mimprovised
  When defining the syntax of simple types in \fullref{def:simple_type}, we have described product types, which allow combining the types \( \tau \) and \( \sigma \) into the compound type \( \tau \syntimes \sigma \).
