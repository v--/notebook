...
\begin{algorithm}[Type derivation to proof tree]\label{alg:type_derivation_to_proof_tree}
  ...
  \begin{thmenum}
    ...
    \thmitem{alg:type_derivation_to_proof_tree/instantiation} As discussed in \cref{rem:natural_deduction_rule_application}, the application of some rules of natural deduction like \ref{inf:def:propositional_natural_deduction_systems/bot/efq}, \ref{inf:def:propositional_natural_deduction_systems/or/intro_left} and \ref{inf:def:propositional_natural_deduction_systems/or/intro_right} requires an explicit \hyperref[alg:propositional_schema_instantiation]{propositional schema instantiation}.
