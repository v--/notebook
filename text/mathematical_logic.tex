...
\begin{remark}\label{rem:mathematical_logic_conventions}
  ...
  \begin{thmenum}
    ...
    \thmitem{rem:mathematical_logic_conventions/models_as_sets} Unless we are working with explicit \hyperref[con:proposition]{sentences}, we will generally reason about \hyperref[def:logical_model]{models} in the ambient metatheory and treat their universes, elements, relations and operations as sets.
