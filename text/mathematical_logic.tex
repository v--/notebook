...
\begin{definition}\label{def:intuitionistic_logic}\mcite[sec. 5]{VanDalen2004}
...
\begin{definition}\label{def:minimal_logic}\mcite[1]{DienerMcKubreJordens2016}
