...
\begin{remark}\label{rem:mathematical_logic_conventions}
  ...
  \begin{thmenum}
    \thmitem{rem:mathematical_logic_conventions/models_as_sets} Unless we are working with explicit \hyperref[con:proposition]{sentences} and their \hyperref[def:logical_model]{models}, we will generally reason about them in the ambient metatheory and treat them as sets.
