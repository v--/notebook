...
\begin{remark}\label{rem:mathematical_logic_conventions}
  ...
  \begin{thmenum}
    ...
    Note that we avoid this convention for \( \synlambda \)-calculus by instead using distinct Latin letters for different purposes --- see \fullref{rem:lambda_object_language}.
