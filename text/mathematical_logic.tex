...
\begin{concept}\label{con:judgment}
  Our first fundamental notion is that of a \term{judgment}. \incite[9]{MartinLöf1996LogicalLaws} states the following:
  \begin{displayquote}
...
\begin{comments}
  ...
  \item Martin-L\"of's work in type theory requires a lucid concept of judgment as a building block for typing rules; see \fullref{rem:typing_rule} for a broader discussion.
\end{comments}
