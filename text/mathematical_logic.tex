...
\begin{concept}\label{con:hypothetical_judgment}
  \incite[30]{MartinLöf1984IntTypeTheory} calls a \hyperref[con:judgment]{judgment} \term{hypothetical} if it is, in his own words, \enquote{made under assumptions}.
\end{concept}
\begin{comments}
...
\begin{comments}
  ...
  \begin{itemize}
    ...
    \item \incite[27]{CurryFeys1958CombinatoryLogic} claim that the terms \enquote{well-formed} is introduced in \incite[352]{Church1932Untyped} and is \enquote{finding wide acceptance}.

    \item \incite[29]{Andrews2002STT} refers describes \enquote{well-formed formulas} as \enquote{meaningful expressions}.
