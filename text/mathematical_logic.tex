...
\begin{remark}\label{rem:mathematical_logic_conventions}
  ...
  \begin{thmenum}
    ...
    \thmitem{rem:mathematical_logic_conventions/structure_pairs} We often conflate structures in the metatheory (i.e. sets with functions and/or relations defined on them) with their domain --- see \cref{rem:fol_structure_notation} for a further discussion.
