...
\begin{remark}\label{rem:mathematical_logic_conventions}
  ...
  \begin{thmenum}
    ...
    \thmitem{rem:mathematical_logic_conventions/shorthands} We additionally use syntactic shorthands like \cref{rem:propositional_formula_parentheses} and \cref{rem:first_order_formula_conventions} when writing formulas.
