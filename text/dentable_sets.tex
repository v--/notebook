...
\begin{definition}\label{def:dentability}\mcite[def. 5.1]{Phelps1993ConvexDifferentiability}
...
\begin{definition}\label{def:radon-nikodym-property}\mcite[def. 5.2]{Phelps1993ConvexDifferentiability}
