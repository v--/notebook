...
\begin{comments}
  ...
  \item Only unweighted adjacency matrices are usually considered, for example by \incite[28]{Diestel2017Graphs}, \incite[151]{Harary1969Graphs}, \incite[54]{Bollobas1998Graphs}, \incite[195]{Erickson2019Algorithms}, \incite[32]{Зыков2004Графы}, \incite[27]{ЕмеличевИПр1990Графы}, \incite[\S 7.4.2]{Новиков2013ДискретнаяМатематика} and \incite[52]{Мирчев2001Графи}.
