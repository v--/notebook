...
\begin{comments}
  ...
  \item Rather than considering explicit weights, Lowell Beineke in \cite[552]{Rosen1999} and \incite[def. 2.1.1]{Knauer2011} define adjacency matrices for directed multigraphs as matrices of the underlying directed graph \hyperref[def:graph_functors/directed_forgetful]{\( U_D(G) \)}, possibly with loops, weighted by the number of parallel arcs. We provide an example in \fullref{ex:def:graph_adjacency_matrix/multi}.
\end{comments}
