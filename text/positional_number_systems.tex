...
\begin{definition}\label{def:real_number_radix_expansion}\mcite[60]{Зорич2019АнализТом1}
  Given a radix \( b \geq 2 \), an \term[en=expansion (\cite[260]{Rosen2019DiscreteMathematics})]{expansion} of the \hyperref[def:real_numbers]{real number} \( x \) is a univariate \hyperref[def:formal_laurent_series]{Laurent series} such that
