...
\begin{definition}\label{def:positional_number_system}\mimprovised
  ...
  \begin{thmenum}
    \thmitem{def:positional_number_system/binary}\mcite[227]{Rosen2018DiscreteHandbook} The \term[ru=двоичная (система) (\cite[60]{Зорич2019АнализТом1})]{binary} system with \( b = 2 \) and digits \( 0, 1 \). We also call binary digits \term{bits}.

    \thmitem{def:positional_number_system/ternary}\mcite[195]{Knuth1997ArtVol2} The \term[ru=троичная (система) (\cite[60]{Зорич2019АнализТом1})]{ternary} system with \( b = 3 \) and digits \( 0, 1, 2 \).

    \thmitem{def:positional_number_system/octal}\mcite[227]{Rosen2018DiscreteHandbook} The \term[ru=восьмичная (система) (\cite[60]{Зорич2019АнализТом1})]{octal} system with \( b = 8 \) and digits \( 0, 1, \ldots, 7 \).

    \thmitem{def:positional_number_system/decimal}\mcite[227]{Rosen2018DiscreteHandbook} The ubiquitous \term[ru=десетичная (система) (\cite[60]{Зорич2019АнализТом1})]{decimal} system with \( b = 10 \) and digits \( 0, 1, \ldots, 9 \).

    \thmitem{def:positional_number_system/hexadecimal}\mcite[228]{Rosen2018DiscreteHandbook} The \term{hexadecimal} system with \( b = 16 \) and digits \( 0, 1, \ldots, 9, A, B, C, D, E, F \).
  \end{thmenum}
\end{definition}
\begin{comments}
  ...
  \item The overline notation can be found in \cite[228]{Rosen2018DiscreteHandbook}. The corresponding parenthesized notation can be found in \cite*[96]{БелоусовТкачёв2004ДискретнаяМатематика}.
\end{comments}

\paragraph{Real number radix expansion}

\begin{definition}\label{def:real_number_radix_expansion}\mcite[60]{Зорич2019АнализТом1}
  Given a radix \( b \geq 2 \), an \term[en=expansion (\cite[228]{Rosen2018DiscreteHandbook})]{expansion} of the \hyperref[def:real_numbers]{real number} \( x \) is a univariate \hyperref[def:formal_laurent_series]{Laurent series} such that
