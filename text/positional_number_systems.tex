...
\begin{comments}
  ...
  \item This algorithm is implemented in \cite{notebook:code} as
    \WriteCodeRef{alg:real_number_radix_expansion}
\end{comments}
\begin{defproof}
...
\begin{comments}
  \item This algorithm is implemented in \cite{notebook:code} as
    \WriteCodeRef{alg:rational_number_to_positional_string}
\end{comments}
\begin{defproof}
...
\begin{comments}
  \item This algorithm is implemented in \cite{notebook:code} as
    \WriteCodeRef{alg:positional_string_to_rational_number}
\end{comments}
