...
\begin{definition}\label{def:integer_radix_expansion}
  Similarly to how we have defined real number radix expansions in \fullref{def:real_number_radix_expansion}, we define a radix \( b \) expansion for the nonnegative integer \( n \) as an univariate \hyperref[def:polynomial]{polynomials}
  \begin{equation*}
