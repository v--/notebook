...
\begin{proposition}\label{thm:integer_decimal_expansion_parity}
  An \hyperref[def:integers]{integer} is \hyperref[def:integer_parity]{even} if and only if the last digit of its \hyperref[alg:integer_radix_expansion]{decimal expansion} is even.
\end{proposition}
