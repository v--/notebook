...
\begin{definition}\label{def:positional_number_system}\mimprovised
  ...
  \begin{thmenum}
    \thmitem{def:positional_number_system/binary}\mcite[256]{Rosen1999DiscreteHandbook} The \term[ru=двоичная (система) (\cite[60]{Зорич2019АнализТом1})]{binary} system with \( b = 2 \) and digits \( 0, 1 \). We also call binary digits \term{bits}.

    \thmitem{def:positional_number_system/ternary}\mimprovised The \term[ru=троичная (система) (\cite[60]{Зорич2019АнализТом1})]{ternary} system with \( b = 3 \) and digits \( 0, 1, 2 \).

    \thmitem{def:positional_number_system/octal}\mcite[256]{Rosen1999DiscreteHandbook} The \term[ru=восьмичная (система) (\cite[60]{Зорич2019АнализТом1})]{octal} system with \( b = 8 \) and digits \( 0, 1, \ldots, 7 \).

    \thmitem{def:positional_number_system/decimal}\mcite[256]{Rosen1999DiscreteHandbook} The ubiquitous \term[ru=десетичная (система) (\cite[60]{Зорич2019АнализТом1})]{decimal} system with \( b = 10 \) and digits \( 0, 1, \ldots, 9 \).

    \thmitem{def:positional_number_system/hexadecimal}\mcite[256]{Rosen1999DiscreteHandbook} The \term{hexadecimal} system with \( b = 16 \) and digits \( 0, 1, \ldots, 9, A, B, C, D, E, F \).
  \end{thmenum}
\end{definition}
\begin{comments}
  ...
  \item Some authors like \incite[96]{БелоусовТкачёв2004ДискретнаяМатематика} actually prefer the parenthesized notation for periodic digits strings, but others like \incite[257]{Rosen1999DiscreteHandbook} prefer overlines.
\end{comments}

\paragraph{Real number radix expansion}

\begin{definition}\label{def:real_number_radix_expansion}\mcite[60]{Зорич2019АнализТом1}
  Given a radix \( b \geq 2 \), an \term[en=expansion (\cite[256]{Rosen1999DiscreteHandbook})]{expansion} of the \hyperref[def:real_numbers]{real number} \( x \) is a univariate \hyperref[def:formal_laurent_series]{Laurent series} such that
...
\end{definition}
\begin{comments}
  \item These interpretations are justified by \fullref{thm:integer_radix_expansion} and \fullref{alg:rational_number_to_positional_string}.
\end{comments}
