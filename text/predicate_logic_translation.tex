...
\end{algorithm}
\begin{comments}
  \item This algorithm can be found in \cite{notebook:code} as
\WriteCodeRef{alg:fol_signature_to_hol_signature}
\end{comments}
...
\WriteCodeRef{alg:fol_term_to_hol_expression}
\end{comments}
...
\begin{comments}
  \item This translation is justified in \cref{thm:fol_to_hol_translation}.
  \item This algorithm is implemented in \cite{notebook:code} as
\WriteCodeRef{alg:fol_formula_to_hol_expression}
\end{comments}
...
\begin{comments}
  ...
  \item This algorithm is implemented in \cite{notebook:code} as
\WriteCodeRef{alg:fol_structure_to_hol_structure}
\end{comments}
