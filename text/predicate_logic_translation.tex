...
\begin{algorithm}[First-order signature to higher-order signature]\CodeRefLabel{alg:fol_signature_to_hol_signature}
...
\end{algorithm}
\begin{comments}
  \item This algorithm can be found in \cite{notebook:code} as \WriteCodeRef
\end{comments}
