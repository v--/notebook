...
\begin{definition}\label{def:simply_typed_hol}\mimprovised
  We will define a family of \hyperref[con:explicit_and_implicit_typing]{explicitly typed} \hyperref[def:simple_type_system]{simple type systems} which we will call \term{simply typed higher-order logic}.
