...
\begin{example}\label{ex:simplified_hol_predicate_definition}
  There is an important special case of \hyperref[def:hol_definition]{higher-order logic definitions} which hints at how to introduce new predicate symbols in first-order logic.
  ...
  Indeed, then the condition \eqref{eq:def:hol_definition/sequent} becomes
  \begin{equation*}
