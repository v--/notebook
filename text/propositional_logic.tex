...
\begin{comments}
  ...
  \item According to \cite[75]{Rosen2019DiscreteMathematics}, \enquote{\foreignlanguage{latin}{modus ponens}} is Latin for \enquote{mode that affirms}.
...
\begin{comments}
  ...
  \item This principle is useful as a \hyperref[def:inference_rule]{inference rule} --- see \cref{inf:def:propositional_natural_deduction/bot/efq}.
