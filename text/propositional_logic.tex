...
\begin{comments}
  ...
  \item Propositional formulas are implemented in the module \identifier{math.logic.propositional} in \cite{notebook:code} as a special case of first-order formulas in accordance with \cref{rem:propositional_logic_as_first_order_logic}.
\end{comments}
...
\begin{comments}
  ...
  \item This algorithm can be found as \identifier{math.logic.propositional.evaluate_prop_formula} in \cite{notebook:code}.
\end{comments}
...
\end{definition}
\begin{comments}
  \item Parametrized denotations are implemented as \identifier{math.logic.propositional.formula_to_function} in \cite{notebook:code}.
\end{comments}
