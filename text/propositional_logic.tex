...
\begin{definition}\label{def:propositional_language}\mcite[14]{Hinman2005}
  ...
  \begin{thmenum}
    ...
    \begin{thmenum}
      \thmitem{def:propositional_language/connectives/disjunction} \term{Disjunction} \enquote{\( \vee \)}, also known as \hyperref[def:standard_boolean_operators]{\term{or}} and \hyperref[def:lattice/join]{\term{join}}.
      \thmitem{def:propositional_language/connectives/conjunction} \term{Conjunction} \enquote{\( \wedge \)}, also known as \hyperref[def:standard_boolean_operators]{\term{and}} and \hyperref[def:lattice/meet]{\term{meet}}.
