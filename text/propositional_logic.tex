...
\begin{definition}\label{def:propositional_alphabet}\mcite[4; 5]{Smullyan1995FOL}
  The \hyperref[def:formal_language/alphabet]{alphabet} of \hyperref[con:logical_symbol]{logical symbols} of propositional logic consists of the following:
