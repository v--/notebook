...
\begin{comments}
  ...
  \item Propositional formulas are implemented in \cite{notebook:code}, in the module
    \WriteCodeRefText{math.logic.formulas}
...
\begin{comments}
  ...
  \item This algorithm is implemented in \cite{notebook:code} as
    \WriteCodeRef{alg:propositional_denotation}
\end{comments}
...
\begin{comments}
  \item Parametrized denotations are implemented in \cite{notebook:code} as
    \WriteCodeRef{def:parametrized_propositional_denotation}
\end{comments}
...
\begin{comments}
  \item This algorithm is implemented in \cite{notebook:code} as
    \WriteCodeRef{alg:brute_force_propositional_satisfaction}
\end{comments}
