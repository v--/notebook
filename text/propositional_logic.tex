...
\begin{comments}
  ...
  \item This principle is useful as a \hyperref[def:inference_rule]{inference rule} --- see \ref{inf:def:propositional_natural_deduction_systems/bot/raa}.
  ...
  He introduces this principle in order to give a name for the inference rule \ref{inf:def:propositional_natural_deduction_systems/bot/raa}.
