...
\begin{proposition}\label{thm:propositional_denotation_characterization}
  ...
  \begin{thmenum}
    \thmitem{thm:propositional_denotation_characterization/negation} Assuming \hyperref[def:truth_value_algebra/degenerate]{non-degenerate semantics}, from \( I \vDash \varphi \) it follows that \( I \nvDash \synneg \varphi \).
