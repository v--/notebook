...
\begin{comments}
  ...
  \item It is common to call reserved symbols \enquote{logical}, but this is unfortunately ambiguous --- see \fullref{rem:logical_symbol_terminology}.
\end{comments}
...
\begin{definition}\label{def:propositional_syntax}\mimprovised
  ...
  \begin{thmenum}
    ...
    \thmitem{def:propositional_syntax/fragment} By a \term[en=fragment (\cite[49]{Mimram2020ProgramEqualsProof})]{fragment} of propositional logic we will mean a subset of \( \op*{Form} \), most easily obtained by restricting which rules from the full schema are used. See \fullref{def:implicational_propositional_fragment}.
  \end{thmenum}
\end{definition}
\begin{comments}
...
\begin{comments}
  ...
  \item Our definition for minimal semantics is based on the general principles outlined by \incite[3]{VanDerMolen2016MinimalLogic}, \incite[35]{TroelstraSchwichtenberg2000BasicProofTheory} and \incite[1]{DienerMcKubreJordens2020MaterialImplication}. None of the aforementioned discuss semantics.
\end{comments}
