...
\begin{comments}
  ...
  \item \incite{Эдельман1975Логика} states that \enquote{\textla{conjunctio}} and \enquote{\textla{disjunctio}} are Latin words for \enquote{union} and \enquote{separation}, while \enquote{\textla{implicatio}} is Latin for \enquote{entangled}.
...
\begin{comments}
  ...
  \item \enquote{Reductio ad absurdum} (\enquote{RAA} for short) is stated in both forms by different authors. For example, \tcite{#2, where #1}[31]{VanDalen2004LogicAndStructure} states the principle as follows:
  \begin{displayquote}
  ...
  \incite[thm. 2.5.1.1(ii)]{Mimram2020ProgramEqualsProof} and \incite[100]{КолмогоровДрагалин2006Логика} use \enquote{reductio ad absurdum} synonymously with double negation elimination.

  On the other hand, \incite[15]{Kleene1971Metamathematics}, \incite[187]{Gentzen1935LogischeSchließen} and \incite[90]{CitkinMuravitsky2022ConsequenceRelations} use \enquote{reductio ad absurdum} in the more general sense stated above --- in Kleene's words:
  \begin{displayquote}
