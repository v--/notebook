...
\begin{comments}
  ...
  \item \enquote{Conjunctio} and \enquote{disjunctio} are Latin strings for \enquote{union} and \enquote{separation}, respectively. \enquote{Implicatio} is Latin for \enquote{entangled}.
\end{comments}
...
\begin{definition}\label{def:propositional_grammar_schema/formula_variables}\mimprovised
