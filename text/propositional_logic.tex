...
\begin{remark}\label{rem:improper_symbols_and_parsing}
  ...
  We even disallow \hyperref[con:logical_system_signature]{signature symbols} to clash with variables or placeholders, except in the special case of \cref{def:hol_typing/equality}.
\end{remark}
...
\end{definition}
\begin{comments}
  \item We use terminology resembling that for first-order logic from \cref{def:first_order_valuation}. As it often happens, the terminology is inconsistent across authors:
  \begin{itemize}
...
\begin{definition}\label{def:propositional_derivation}\mimprovised
