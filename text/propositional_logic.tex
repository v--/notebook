...
\begin{definition}\label{def:propositional_formula}\mimprovised
  ...
  We will also call the formulas \term{sentences} in relation to \hyperref[def:general_logic]{general logics}. This contrasts with predicate logic, where only specific formulas are called sentences --- see \cref{ex:universal_validity_and_lem}.
\end{definition}
\begin{comments}
