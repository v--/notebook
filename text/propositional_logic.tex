...
\begin{theorem}[Propositional semantic deduction theorem]\label{thm:propositional_semantic_deduction_theorem}
  For arbitrary \hyperref[def:propositional_semantics]{propositional semantics}, we have
  \begin{equation*}
...
\begin{remark}\label{rem:deduction_theorem_list}
  ...
  \begin{thmenum}
    ...
    \thmitem{rem:deduction_theorem_list/fol_syntactic} \Fullref{thm:fol_natural_deduction_deduction_theorem}.
  \end{thmenum}
\end{remark}
