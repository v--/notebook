...
\begin{remark}\label{rem:measure_terminology}
  ...
  \begin{itemize}
    ...
    \item \incite[def. 2.1]{ДьяченкоУльянов1998МераИИнтеграл} define \enquote{measures} (\enquote{меры}) as finitely-additive nonnegative-valued functions on what they call \enquote{semirings of sets}. They also define \enquote{\( \sigma \)-additive measures} (\enquote{\textru{\( \sigma \)-аддитивные меры}}) as secondary notions.
