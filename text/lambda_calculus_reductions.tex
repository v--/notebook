...
\begin{example}\label{ex:def:beta_eta_reduction}
  ...
  \begin{thmenum}
    ...
    We will define truth values differently in \fullref{sec:simply_typed_lambda_calculus}, for which reason we avoid using these terms as boolean more generally.
