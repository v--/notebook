...
\begin{definition}\label{def:ordinal_arithmetic}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:ordinal_arithmetic/exponentiation}\mcite[exer. 6.3.34]{Hinman2005Logic} Exponentiation extends \fullref{def:monoid/exponentiation}:
...
\begin{definition}\label{def:cardinal_arithmetic}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:cardinal_arithmetic/exponentiation}\mcite[exer. 6.4.46]{Hinman2005Logic} We define \term{exponentiation} as
    \begin{equation*}
