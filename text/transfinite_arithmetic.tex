...
\begin{definition}\label{def:ordinal_arithmetic}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:ordinal_arithmetic/exponentiation}\mcite[lemma 66.16]{OpenLogicFull} Exponentiation extends \fullref{def:monoid/exponentiation}:
...
\begin{proof}
  ...
  \end{equation*}
  is the corresponding \hyperref[def:partially_ordered_set_interval/ray]{initial segment}.
