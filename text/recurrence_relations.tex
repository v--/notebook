...
\begin{proposition}\label{thm:linear_recurrence_finite_field_periodic}
  ...
  \begin{thmenum}
    \thmitem{thm:linear_recurrence_finite_field_periodic/general}\mcite[thm. 8.7]{LidlNiederreiter1997FiniteFields} Every sequence satisfying this recurrence is \hyperref[def:ultimately_periodic_sequence]{ultimately periodic} with least period at most \( q^k \).
...
\begin{theorem}[Linear recurrences with maximal period]\label{thm:linear_recurrences_with_maximal_period}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:linear_recurrences_with_maximal_period/impulse} The \hyperref[def:recurrence_relation_space]{impulse response sequence} is periodic with the same least period.
  \end{thmenum}
\end{theorem}
\begin{proof}
