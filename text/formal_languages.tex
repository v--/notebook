...
\begin{remark}\label{rem:language_alphabet_cardinality}
  ...
  \begin{thmenum}
    ...
    As shown in \cref{thm:small_set_closure/function}, it is important for a \hyperref[con:logical_system_signature]{logical signature} to be \hyperref[def:small_set]{small} so that it is possible to determine whether a \hyperref[def:fol_semantics/model]{model} is small.
