...
\begin{example}\label{ex:natural_number_arithmetic_grammar/schema}
  ...
  Following the convention from \fullref{rem:object_language_dots}, we have placed dots above the terminal symbols to avoid ambiguity, especially later in \fullref{ex:natural_number_arithmetic_grammar/evaluation} when we will discuss evaluation of these symbols.
