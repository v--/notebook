...
\begin{proposition}\label{thm:def:formal_language}
  ...
  \begin{thmenum}
    \thmitem{thm:def:formal_language/finite_alphabet_cardinality} For any \hi{nonempty finite} \hyperref[def:formal_language/alphabet]{alphabet} \( A \), the \hyperref[def:formal_language/kleene_star]{Kleene star} \( A^* \) is countably infinite.
...
\begin{example}\label{ex:def:chomsky_hierarchy}
  ...
  \begin{thmenum}
    ...
    \begin{itemize}
      ...
      \item \( S \Rightarrow aSBc \Rightarrow a\hi{abc}Bc \Rightarrow aab\hi{Bc}c \Rightarrow a^2 b^2 c^2 \).
      \item \( S \Rightarrow aSBc \Rightarrow a\hi{aSBc}Bc \Rightarrow aa\hi{abc}BcBc \Rightarrow \cdots \Rightarrow a^3 b B^2 c^3 \Rightarrow a^3 b^3 c^3 \).
    \end{itemize}
