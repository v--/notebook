...
\begin{comments}
  ...
  \item This algorithm can be found as \identifier{math.lang.distance.wagner_fisher} in \cite{notebook:code}.
\end{comments}
...
\end{definition}
\begin{comments}
  \item Formal grammars are implemented in \identifier{math.grammars.grammar}, with a parser in \identifier{math.grammars.parsing}.
\end{comments}
...
\end{algorithm}
\begin{comments}
  \item This algorithm can be found as \identifier{math.grammars.renaming_rules.collapse_renaming_rules} in \cite{notebook:code}.
