...
\begin{definition}\label{def:formal_language}\mcite[9]{Savage2008ModelsOfComputation}
  ...
  \begin{thmenum}
    ...
    Unless explicitly noted otherwise, like in \fullref{sec:free_groups}, we will assume that \( \mscrA \) is finite, even \hyperref[def:universe_of_hereditary_finite_sets]{hereditarily finite}. Hereditary finiteness becomes important when considering all \hyperref[con:logical_system_signature]{signatures} of a given \hyperref[con:logical_system]{logical system}; see \cref{rem:signatures_are_small}.
