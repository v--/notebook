...
\begin{definition}\label{def:formal_language}\mcite[3; 4]{Salomaa1987}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:formal_language/empty_word} We denote the empty word via \( \varepsilon \)\footnote{This notation is used, for example, by \incite[9]{Savage1998}. \incite[3]{Salomaa1987} uses \( \lambda \) instead, while \incite[19]{Гладкий1973} uses \( \Lambda \).}.
