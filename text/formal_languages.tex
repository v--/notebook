...
\begin{example}\label{ex:def:chomsky_hierarchy}
  ...
  \begin{thmenum}
    ...
    Since \( G \) is essentially length-increasing, its language is context-sensitive. In fact, \tcite{#1 shows in #2 that}[example 6.2]{Salomaa1973FormalLanguages} the language \( \mscrL \) cannot be context-free.
