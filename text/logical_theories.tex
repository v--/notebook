...
\begin{definition}\label{def:first_order_theory}\mcite[48]{VanDalen2004}
...
\begin{example}\label{ex:def:category_of_small_first_order_models}
  ...
  \begin{itemize}
    ...
    \item The categories \hyperref[def:partially_ordered_set/category]{\( \cat{Pos} \)} in order theory and the related \hyperref[def:preordered_set/category]{\( \cat{PreOrd} \)}, \hyperref[def:totally_ordered_set]{\( \cat{Tos} \)}, \hyperref[def:semilattice/category]{\( \cat{Lat} \)}, \hyperref[def:heyting_algebra/category]{\( \cat{Heyt} \)} and \hyperref[def:boolean_algebra/category]{\( \cat{Bool} \)} in lattice theory.
  \end{itemize}
...
\begin{definition}\label{def:subobject_and_quotient}\mcite[122]{MacLane1994}
...
\begin{proposition}\label{thm:first_order_categorical_invertibility}
  ...
  \begin{thmenum}
    \thmitem{thm:first_order_categorical_invertibility/injective} Every \hyperref[def:multi_valued_function/empty]{\hi{nonempty}} \hyperref[def:first_order_homomorphism_invertibility/embedding]{structure embedding} (injective homomorphism) is a \hyperref[def:morphism_invertibility/left_cancellative]{categorical monomorphism}.
    ...
    \thmitem{thm:first_order_categorical_invertibility/surjective} \hyperref[thm:categorical_principle_of_duality]{Dually}, every \hyperref[def:first_order_homomorphism_invertibility/surjective]{structure projection} (surjective homomorphism) is a \hyperref[def:morphism_invertibility/right_cancellative]{categorical epimorphism}.
    ...
    \thmitem{thm:first_order_categorical_invertibility/bijective} Every \hyperref[def:first_order_homomorphism_invertibility/isomorphism]{structure isomorphism} is a \hyperref[def:morphism_invertibility/isomorphism]{categorical isomorphism} and vice versa.
  \end{thmenum}
\end{proposition}
\begin{proof}
...
\begin{remark}\label{rem:thm:intuitionistic_lindenbaum_tarski_algebra/syntactic_proof}
  ...
  Thus, we have shown that Heyting algebras arise naturally from the intuitionistic natural deduction system and that their role as a semantic framework is justified.
\end{remark}
