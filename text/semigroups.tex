...
\begin{remark}\label{rem:bourbaki}
  ...
  \begin{itemize}
    ...
    \item On the other hand, their concept of \hyperref[rem:magma_terminology]{magmas} is not used often, as discussed in \fullref{rem:magma_terminology}.
  ...
  The treatment of logic mentioned is the use of Hilbert's \( \varepsilon \) operator, which we briefly discuss in \fullfef{con:description_operator}.
\end{remark}
...
\begin{remark}\label{rem:magma_terminology}
  ...
  We are not interested in the structural theory at such generality, for which reason we will refrain from defining magmas and instead define semigroups in \fullref{def:semigroup} as an \hyperref[def:binary_operation/associative]{associative} magma. This latter definition is almost unambiguous --- it is used in
