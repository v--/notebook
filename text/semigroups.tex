...
\begin{remark}\label{rem:magma_terminology}
  ...
  Semigroups, being a special case when the operation is \hyperref[def:binary_operation/associative]{associative}, are well-established concepts, unlike magmas. The term is defined by \incite[144]{MacLane1998CategoryTheory}, \incite[1]{Golan1999Semirings} and \incite[28]{Ляпин1960Полугруппы}, and used without definition by others, including \incite[21]{Birkhoff1967LatticeTheory} and \incite[402]{Rockafellar1997ConvexAnalysis}.
...
\begin{definition}\label{def:semigroup}\mcite[28]{Ляпин1960Полугруппы}
  ...
  \begin{thmenum}[series=def:semigroup]
    ...
    \thmitem{def:semigroup/exponentiation}\mcite[86]{Тыртышников2017ОсновыАлгебры} We define an additional \term{exponentiation} operation for positive integers \( n \) \hyperref[rem:natural_number_recursion]{recursively} as
