...
\begin{definition}\label{def:monoid}\mcite[def. 1.1]{Jacobson1985BasicAlgebraI}
  ...
  \begin{thmenum}
    ...
    \begin{itemize}
      ...
      \item For epimorphisms a similar statement does not hold, unfortunately. The embedding \( \iota: \BbbN \to \BbbZ \) is an epimorphism due to \fullref{thm:group_of_differences_universal_property}, but it is clearly not surjective.
    \end{itemize}
