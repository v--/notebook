...
\begin{definition}\label{def:binary_operation}
  ...
  The following \hyperref[def:first_order_syntax/formula]{formulas}, or rather their \hyperref[def:fol_quantifier_closure]{universal closures}, are common \hyperref[def:fol_theory]{axioms}:
  \begin{thmenum}
