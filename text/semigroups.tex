...
\begin{definition}\label{def:semigroup_neutral_element}\mcite[115]{БелоусовТкачёв2004ДискретнаяМатематика}
  ...
  \begin{align}
    \qforall \synx (\syne \synmult \synx \syneq \synx), \label{eq:def:semigroup_neutral_element/left} \\
    \qforall \synx (\synx \synmult \syne \syneq \synx). \label{eq:def:semigroup_neutral_element/right}
  \end{align}
