...
\begin{concept}\label{con:assumed_knowledge}
  ...
  \begin{itemize}
    \item We strive to ensure that the concepts we use reflect the usage in the literature, or at least do not deviate far. This also leads to literature reviews like \fullref{rem:sigma_algebra_terminology} and \fullref{rem:graph_walk_terminology}.
