...
Last but not least, more algorithmic portions of the monograph have programmatic implementations in the \identifier{src/} subdirectory within the source code. I have prioritized following the exposition of the text, so parts of the code are more naive than necessary.
