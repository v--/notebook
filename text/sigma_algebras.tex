\section[σ-algebras]{\( \sigma \)-algebras}\label{sec:sigma_algebras}
...
\begin{comments}
  ...
  \incite[def. 1.2.1]{Богачёв2003ТеорияМерыТом1},
  \incite[def. 1.2]{ДьяченкоУльянов1998ТеорияМеры} (who require closure under intersections and \hi{symmetric differences}) and
  \incite[30]{Ширяев2007ВероятностиТом1}.
  ...
  \item The simplified condition \fullref{thm:boolean_subalgebra/binary} is often stated, in the context of \hyperref[def:algebra_of_subsets]{algebras of subsets}, so that \( Y \) must contain \( \top \) (e.g. \incite[def. 1.3]{Rudin1987RealAndComplexAnalysis}, \incite[\S 5.25]{Schechter1997AnalysisHandbook}, \incite[3]{Bobrowski2005FuncAnalysis} and \incite[def. 2.1]{Боровков1999Вероятности}), or alternatively so that \( Y \) must contain \( \bot \) (e.g. \incite[def. 1.4.1]{Tao2011MeasureTheory}) or even both (e.g. \incite[def. 1.1]{ДимитровЯнев2007Статистика})
\end{comments}
\begin{proof}
...
\begin{definition}\label{def:monotone_class}\mcite[def. 1.9.1]{Богачёв2003ТеорияМерыТом1}
...
\begin{definition}\label{def:sigma_algebra}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:sigma_algebra/monotone}\mcite[thm. 1.9.3(i)]{Богачёв2003ТеорияМерыТом1} It is an \hyperref[def:algebra_of_subsets]{algebra of subsets} and is closed under unions of countable \hyperref[def:directed_set]{upward-directed families} (resp. intersections of \hyperref[def:directed_set]{downward-directed families}).
  \end{thmenum}
\end{definition}
\begin{comments}
  ...
  \incite[thm. 1.2.7]{Bobrowski2005FuncAnalysis},
  \incite[lemma 1.7.14]{Tao2011MeasureTheory},
  \incite[exer. 1.6(b)]{Cohn2013Measures},
  \incite[thm. 2.35]{Folland1999RealAnalysis},
  \incite[thm. 5.17]{Axler2020RealAnalysis} and
  \incite[thm. 1.9.3(i)]{Богачёв2003ТеорияМерыТом1}.
...
\begin{remark}\label{rem:sigma_algebra_terminology}
  ...
  \begin{table}[!ht]
    ...
    \begin{tabular}{l l l}
      ...
      \cite[15]{Yoshida1980FuncAnalysis}                         &                                                       & \( \sigma \)-ring / \( \sigma \)-additive family \\
      ...
      \cite[113; 118]{Gratzer2011Lattices}                       & Field of sets                                         &                                                  \\
      ...
      \cite[2]{Cinlar2011Probability}                            & Algebra                                               & \( \sigma \)-algebra                             \\
      \cite[3; 4]{Bobrowski2005FuncAnalysis}                     & Algebra of sets                                       & \( \sigma \)-algebra                             \\
      \cite[def. 2.23]{Axler2020RealAnalysis}                    &                                                       & \( \sigma \)-algebra                             \\
      ...
      \cite[50]{КанторовичАкилов1984ФункАнализ}                  & Алгебра                                               & \( \sigma \)-алгебра                             \\
                                                                 & \footnotesize (algebra)                               & \footnotesize (\( \sigma \)-algebra)             \\
      \cite[def. 1.2]{ДьяченкоУльянов1998ТеорияМеры}             & Алгебра                                               & \( \sigma \)-алгебра                             \\
                                                                 & \footnotesize (algebra)                               & \footnotesize (\( \sigma \)-algebra)             \\
  ...
  \begin{itemize}
    ...
    \item \incite[15]{Yoshida1980FuncAnalysis} avoids defining rings of sets, but refers to \( \sigma \)-algebras a \enquote{\( \sigma \)-rings}.

    \item \incite[12]{Birkhoff1967Lattices} and \incite[113]{Gratzer2011Lattices} use \enquote{ring} to refer to sublattices of the power set, i.e. families closed under unions and intersections. Both define \enquote{fields} as rings closed under complements, which, if nonempty, are equivalent to our notion of algebras of subsets due to \fullref{thm:boolean_subalgebra}.

    \item \incite[def. 1.2]{ДьяченкоУльянов1998ТеорияМеры} use \enquote{кольцо} (\enquote{ring}) to refer to families closed under symmetric differences and intersections, and \enquote{algebra} for a ring with a top element. Again, due to \fullref{thm:boolean_subalgebra}, this notion of algebras coincides with our usage.

    \item \incite[def. 1.2.13]{Богачёв2003ТеорияМерыТом1} uses \enquote{кольцо} (\enquote{ring}) to refer to families closed under binary unions, binary intersections and set differences. The author defines algebras and \( \sigma \)-algebras prior to rings and rarely mentions rings later in the book.
  \end{itemize}
\end{remark}
