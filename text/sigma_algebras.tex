...
\begin{comments}
  ...
  \item The simplified condition \fullref{thm:boolean_subalgebra/binary} is often stated, in the context of \hyperref[def:algebra_of_subsets]{algebras of subsets}, so that \( Y \) must contain \( \top \) (e.g. \incite[def. 1.3]{Rudin1987RealAndComplexAnalysis}, \incite[\S 5.25]{Schechter1997AnalysisHandbook}, \incite[3]{Bobrowski2005FunctionalAnalysis} and \incite[def. 2.1]{Боровков1999Вероятности}), or alternatively so that \( Y \) must contain \( \bot \) (e.g. \incite[def. 1.4.1]{Tao2011MeasureTheory}) or even both (e.g. \incite[def. 1.1]{ДимитровЯнев2007Статистика})
\end{comments}
\begin{proof}
