...
\begin{definition}\label{def:system_of_linear_equations}\mimprovised
  ...
  \begin{thmenum}
    ...
    \thmitem{def:system_of_linear_equations/solution_space} We call the \hyperref[def:equation/solution]{solution set} of a linear system a \term{solution space} --- as we shall see in \cref{thm:linear_system_solution_space}, it is in fact an \hyperref[def:affine_subspace]{affine subspace} of \( R^m \).
  \end{thmenum}
\end{definition}
