...
\end{theorem}
\begin{comments}
  \item The names of Kroneker and Capelli are associated with this theorem in Russophone literature --- for example \incite[\S 7.8]{Тыртышников2007ЛинейнаяАлгебра}, \incite[thm. 2.3.1]{Винберг2014КурсАлгебры}, \incite[thm. IV.4.4]{Фаддеев1984ЛекцииПоАлгебре} and \incite[thm. 2.2.2]{Кострикин2000АлгебраЧасть1}.
\end{comments}
\begin{proof}
