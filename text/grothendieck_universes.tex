            ...
            \parens[\Big]
              {
                \underbrace
                  {
                    \ref{eq:def:function/predicate}[\xi] \wedge \ref{eq:def:function/predicate_dom}[\xi, \tau] \wedge \ref{eq:def:function/predicate_ran}[\xi, \upsilon]
...
\begin{definition}\label{def:axiom_of_universes}\mcite[24]{MacLane1998}
  ...
  \begin{equation}\label{eq:def:axiom_of_universes}
    \begin{aligned}
      \qforall \xi \qexists \upsilon \parens[\Big]{ \ref{eq:def:grothendieck_universe/predicate}[\upsilon] \synwedge \xi \in \upsilon }.
    \end{aligned}
  \end{equation}
