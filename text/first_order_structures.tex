...
\begin{definition}\label{def:fol_quotient_structure}\mcite[62]{Мальцев1970АлгебраическиеСистемы}
  ...
  \begin{thmenum}[resume=def:fol_quotient_structure]
    \thmitem{def:fol_quotient_structure/projection}\mimprovised The projection \( \pi: X \to Y \) is a \hyperref[def:fol_homomorphism]{homomorphism}. Furthermore, we show in \cref{thm:def:fol_quotient_structure/projection} that it is an \hyperref[def:fol_epimorphism]{epimorphism}.
