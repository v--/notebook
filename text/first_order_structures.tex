...
\begin{proposition}\label{thm:def:fol_substructure}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:def:fol_substructure/homomorphism_preimage} Similarly, for every homomorphism \( h: \mscrX \to \mscrY \) and every substructure \( \mscrY' = (Y, J') \) \hi{of \( \mscrY \)}, the set-theoretic preimage \( h^{-1}(Y') \) determines a substructure of \( \mscrX \).
  \end{thmenum}
\end{proposition}
\begin{proof}
