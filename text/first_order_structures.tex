...
\begin{proposition}\label{thm:fol_lattice_of_substructures}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:fol_lattice_of_substructures/meet} The \hyperref[def:lattice/meet]{meet} of a family of substructures is their \hyperref[def:fol_intersection_substructure]{intersection}.
  \end{thmenum}
\end{proposition}
\begin{proof}
...
\begin{proof}
  ...
  \SubProofOf{thm:lattice_theorem_for_substructures/isomorphism} Clearly \( \Phi \) is injective, and it preserves and reflects order. \Cref{thm:def:order_function/preserving_is_reflecting} implies that it is an order embedding. \Cref{thm:def:complete_lattice/embedding} implies that it is an embedding of complete lattices.
