...
\begin{concept}\label{con:additive_semigroup}\mimprovised
  ...
  \incite[228]{Rotman2017AdvancedModernAlgebraPart2},
  \incite[119]{Knapp2016BasicAlgebra},
  \incite[20]{Yoshida1980FunctionalAnalysis},
  \incite[\S 8.3]{Schechter1997AnalysisHandbook},
  \incite[107]{АлександровМаркушевичХинчинИПр1951ЭнциклопедияТом1},
  \incite[33]{Зорич2019АнализЧасть1},
  \incite[14]{Винберг2014КурсАлгебры},
  \incite{Шафаревич1999ОсновныеПонятияАлгебры},
  \incite[22]{Фаддеев1984ЛекцииПоАлгебре},
  \incite[138]{Кострикин2000АлгебраЧасть1},
  \incite[89]{ЦаленкоШульгейфер1974ОсновыТеорииКатегорий},
...
\begin{remark}\label{rem:additive_function_terminology}
  ...
  \incite[13]{Malliavin1995IntegrationAndProbability},
  \incite[21]{Schervish1995TheoryOfStatistics},
  \incite[25]{Folland1999RealAnalysis},
  \incite[7]{Cohn2013MeasureTheory},
  \incite[30]{Halmos1976MeasureTheory},
  \incite[6]{Tao2011MeasureTheory},
  \incite[21]{Schervish1995TheoryOfStatistics},
  \incite[71]{Yoshida1980FunctionalAnalysis},
  \incite[51]{КанторовичАкилов1984ФункциональныйАнализ},
  \incite[86]{Вулих1973ВещественныйАнализ} and
  \incite[thm. VI.2.3]{Натансон1974ВещественныйАнализ},
  \incite[15]{Боровков1999ТеорияВероятностей},
  \incite[def. 1.3.1]{Богачёв2003ОсновыТеорииМерыТом1},
  \incite[def. II.1.2]{Ширяев2007ВероятностьТом1},
  \incite[21]{ДимитровЯнев2007ВероятностиИСтатистика}.
