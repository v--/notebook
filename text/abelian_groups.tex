...
\begin{comments}
  ...
  \item The corresponding universal property easily follows from \fullref{thm:free_semimodule_universal_property} by noting that, as shown in \fullref{thm:abelian_group_is_module}, abelian groups are semimodules over \( \BbbZ \).
\end{comments}
