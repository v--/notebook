...
\begin{remark}\label{rem:additive_function_terminology}
  ...
  \begin{itemize}
    ...
    \item \incite[exer. 5.2.15]{Carothers2000RealAnalysis} uses \enquote{additive function} for real-valued functions on \( \BbbR \) satisfying \eqref{eq:def:additive_function}.
...
\begin{remark}\label{rem:zero_of_function_terminology}
  ...
  \incite[594]{Rotman2017AlgebraVol2}
