...
\begin{example}\label{ex:thm:fundamental_theorem_of_finitely_generated_abelian_groups}
  ...
  \begin{thmenum}
    ...
    \end{equation*}
    from \fullref{thm:klein_four_group_presentation}, is evidently abelian. We will keep the multiplicative notation for this example (and generally for \( V_4 \)).
    ...
    This is, up to the naming of the generators, the group \( C_2 \times C_2 \) as originally defined in \fullref{def:klein_four_group}.
  \end{thmenum}
\end{example}
