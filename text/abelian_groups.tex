...
\begin{remark}\label{rem:additive_function_terminology}
  ...
  \begin{itemize}
    \item \usecite*[additivity]{\textru{аддитивность}}[342]{ЛюстерникСоболев1965ФункциональныйАнализ} for \eqref{eq:def:additive_function}.

    \item \usecite{additive map}[\S 8.3]{Schechter1997AnalysisHandbook} for functions between monoids satisfying \eqref{eq:def:additive_function}. Earlier, in \cite[\S 7.1]{Schechter1997AnalysisHandbook}, he uses \enquote{subadditive (function)} for real-valued functions on vector spaces satisfying \eqref{eq:def:additive_function/sub}.

    \item \textcite[exerc. 2.7.38]{FriedbergInselSpence2018LinearAlgebra} and \textcite[122]{ЛюстерникСоболев1965ФункциональныйАнализ} use \enquote{additive} for a function between vector spaces satisfying \eqref{eq:def:additive_function}.
...
\begin{remark}\label{rem:multiplicative_function_terminology}
  ...
  \begin{itemize}
    ...
    \item Multiplicative complex-valued functions, as used in \incite[141]{Jacobson1985BasicAlgebraI}.

    \item Completely multiplicative arithmetic functions, as used in \incite[33]{Apostol1976AnalyticNumberTheory},
