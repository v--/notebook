...
\begin{concept}\label{con:additive_semigroup}\mimprovised
  ...
  \incite[228]{Rotman2017AlgebraVol2},
  \incite[119]{Knapp2016BasicAlgebra},
  \incite[20]{Yoshida1980FuncAnalysis},
  ...
  \incite[138]{Кострикин2000АлгебраТом1},
...
\begin{remark}\label{rem:additive_function_terminology}
  ...
  \begin{itemize}
    ...
    \item \incite[exer. 2.7.38]{FriedbergInselSpence2018LinearAlgebra} use \enquote{additive} for a function between vector spaces satisfying \eqref{eq:def:additive_function}.

    \item \incite[exer. 2.7.38]{FriedbergInselSpence2018LinearAlgebra} and \incite[122]{ЛюстерникСоболев1965ФункАнализ} use \enquote{additive} for a function between vector spaces satisfying \eqref{eq:def:additive_function}. Later \cite[342]{ЛюстерникСоболев1965ФункАнализ}
    ...
    \item \incite[def. 6.1.6(a)]{Tao2022AnalysisPart2} uses \enquote{additivity} in relation to linear maps between finite-dimensional real vector spaces (i.e. similarly to our usage in \fullref{def:linear_function}).

    \item \incite[def. 3.1]{Axler2024LinearAlgebra} uses \enquote{additivity} in relation to linear maps between real or complex vector spaces (i.e. similarly to our usage in \fullref{def:linear_function}).
    ...
    \item \incite[25]{Rudin1991FuncAnalysis} and \incite[15]{Yoshida1980FuncAnalysis} use \enquote{subadditivity} for real-valued functions on vector spaces satisfying \eqref{eq:def:additive_function/sub} in the context of \hyperref[def:seminorm]{seminorms}.

    \item \incite[exer. 5.2.15]{Carothers2000RealAnalysis} uses \enquote{additive function} for real-valued functions on \( \BbbR \) satisfying \eqref{eq:def:additive_function/additive}.

    \item \incite[80]{Вулих1973РеальныйАнализ} uses \enquote{additive functional} for real-valued linear functionals satisfying \eqref{eq:def:additive_function/additive}.
  ...
  \incite[21]{Schervish1995Statistics},
  \incite[71]{Yoshida1980FuncAnalysis},
...
\begin{remark}\label{rem:multiplicative_function_terminology}
  ...
  \begin{itemize}
    \item The property \eqref{eq:def:multiplicative_function} is referred to as \enquote{multiplicativity} by \incite[342]{ЛюстерникСоболев1965ФункАнализ} and \incite{Кострикин2000АлгебраТом1}.

    \item Multiplicative complex-valued functions, as used by \incite[141]{Jacobson1985AlgebraPart1}.

    \item Completely multiplicative arithmetic functions, as used by \incite[33]{Apostol1976AnalyticNumberTheory},
    \incite[exer. 1.2.4.29]{Knuth1997ArtVol1},
    \incite[def. 37]{Бухштаб1966ТеорияЧисел} and \incite[exer. 4.28]{ГашковЧубариков2005Сложность}.
