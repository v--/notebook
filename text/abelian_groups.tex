...
\begin{definition}\label{def:abelian_group}\mcite[119]{Knapp2016BasicAlgebra}
  \hyperref[def:binary_operation/commutative]{Commutative} \hyperref[def:group]{groups} are will called \term[bg=абелева группа (\cite[page 2 in \textparagraph 20]{НеновБожилов2007}), ru=абелева группа (\cite[sec. 2.6]{Тыртышников2007})]{abelian groups}.
\end{definition}
