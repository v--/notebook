...
\end{algorithm}
\begin{comments}
  \item This algorithm is a special case of the analogous first-order logic algorithm \fullref{alg:fol_formula_dualization}, which can be found as \identifier{math.logic.transformation.dualize_formula} in \cite{notebook:code}.
