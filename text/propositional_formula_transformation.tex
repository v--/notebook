...
\begin{definition}\label{def:substitution_schema}\mimprovised
  ...
  \begin{bnf*}
    \bnfprod{replacement}      {\bnfpn{variable} \bnfsp \bnftsq{\( \synsubst \)} \bnfsp \bnfpn{substitution subject}}, \\
    \bnfprod{replacement list} {\bnfpn{replacement} \bnfor \bnfpn{replacement} \bnfsp \bnftsq{,} \bnfsp \bnfpn{replacement list}}, \\
    \bnfprod{substitution}     {\bnfpn{substitution subject} \bnfsp \bnftsq{\( [ \)} \bnfsp \bnfpn{replacement list} \bnfsp \bnftsq{\( ] \)}}.
  \end{bnf*}

  Here the rules \( \bnfpn{variable} \) and \( \bnfpn{substitution subject} \) must be provided externally. The subjects can be \hyperref[def:propositional_formula]{propositional formulas}, \hyperref[def:lambda_term]{\( \muplambda \)-terms}, or any other syntactic construct where substitution makes sense.
\end{definition}
\begin{comments}
