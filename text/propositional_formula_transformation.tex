...
\end{algorithm}
\begin{comments}
  \item This algorithm can be found as \identifier{math.logic.cnf_and_dnf.formula_to_cnf_or_dnf} in \cite{notebook:code}.
\end{comments}
...
\end{algorithm}
\begin{comments}
  \item This algorithm can be found as \identifier{math.logic.cnf_and_dnf.function_to_dnf} in \cite{notebook:code}.
\end{comments}
\begin{defproof}
