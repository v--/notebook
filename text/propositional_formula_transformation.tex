...
\begin{comments}
  ...
  \item This algorithm is implemented in \cite{notebook:code} as
    \WriteCodeRef{alg:propositional_subformula_substitution}
\end{comments}
...
\begin{comments}
  \item This algorithm is implemented in \cite{notebook:code} as
    \WriteCodeRef{alg:propositional_constant_collapse}
\end{comments}
\begin{defproof}
...
\begin{comments}
  \item In computer programming, this exact problem is solved via the visitor design pattern --- a generic visitor for formulas of first-order logic is implemented in \cite{notebook:code} as
    \WriteCodeRefText{math.logic.formulas.formula_visitor.FormulaVisitor}
\end{comments}
...
\begin{comments}
  ...
  \item This algorithm is implemented in \cite{notebook:code} as
    \WriteCodeRef{alg:propositional_constant_expansion}
\end{comments}
\begin{proof}
...
\begin{comments}
  \item This algorithm is implemented in \cite{notebook:code} as
    \WriteCodeRef{alg:propositional_repeated_negation_collapse}
\end{comments}
...
\begin{comments}
  \item This algorithm is implemented in \cite{notebook:code} as
    \WriteCodeRef{alg:propositional_formula_to_cnf_or_dnf}
\end{comments}
...
\begin{comments}
  \item This algorithm is implemented in \cite{notebook:code} as
    \WriteCodeRef{alg:function_to_dnf}
\end{comments}
\begin{defproof}
