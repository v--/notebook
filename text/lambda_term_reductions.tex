...
\end{algorithm}
\begin{comments}
  \item This algorithm can be found as \identifier{math.lambda_.untyped.beta.to_function} in \cite{notebook:code}.
...
\end{example}
\begin{comments}
  \item Many of these examples are verified programmatically in the module \identifier{math.lambda_.untyped.reduction.test_beta} in \cite{notebook:code}.
\end{comments}
