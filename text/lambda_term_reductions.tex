...
\begin{example}\label{ex:def:beta_eta_reduction}
  ...
  \begin{thmenum}
    ...
    \begin{itemize}
      ...
      \item \incite[\S 3.3.3]{Mimram2020ProgramEqualsProof} uses the identifiers \ManualCodeRef{pair}, \ManualCodeRef{fst} and \ManualCodeRef{snd} to denote the combinators.
