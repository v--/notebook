...
\begin{definition}\label{def:domain_divisibility}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:domain_divisibility/irreducible} We say that the nonzero nonunit element \( x \) is \term[bg=неразложим (\cite[def. II.3]{ГеновМиховскиМоллов1991})]{irreducible} if any of the following conditions hold:
    \begin{thmenum}
...
\end{definition}
\begin{comments}
  \item We should note that literature from the Soviet sphere of influence uses the term \enquote{prime} (\enquote{простой}) for what we call \enquote{irreducible}. This terminology is used by \incite[def. 3.5]{Винберг2014} and \incite[30]{Шафаревич1999} in Russian, as well as \incite[def. VI.5]{ГеновМиховскиМоллов1991} in Bulgarian.

  On the other hand, the distinction between the two terms is made by \incite[111]{Lang2002}, \incite[388]{Knapp2016BasicAlgebra} and \cite[246]{Aluffi2009}. As a term for irreducible elements, \enquote{неприводимый элемент} is used in the Russian translation of \cite{Lang2002}, in \cite[89]{Костиркин1968Ленг}, but no special term is introduced for prime elements.
