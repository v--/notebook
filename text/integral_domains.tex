...
\begin{proposition}\label{thm:def:principal_ideal_domain}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:def:principal_ideal_domain/coprime} \( x \) and \( y \) are \hyperref[def:coprime_elements]{coprime elements} if and only if \( \braket{ x } \) and \( \braket{ y } \) are \hyperref[def:semiring_ideal/coprime]{coprime ideals}.
  \end{thmenum}
\end{proposition}
\begin{proof}
