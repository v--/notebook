...
\begin{concept}\label{con:predicate_logic}
  ...
  \begin{thmenum}
    ...
    For example, when dealing with \hyperref[rem:arbitrary_kind_graph]{graphs}, we may wish to combine in a single formula vertices, inhabiting the sort \( v \), and arcs, inhabiting the sort \( a \). We can then describe complete graphs via the formula
    \begin{equation*}
