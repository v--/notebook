...
\begin{theorem}[Complexification universal property]\label{thm:complexification_universal_property}
  ...
  \Cref{thm:adjunction_from_universal_morphism/unit} implies that \( (\anon*)^\BbbC \) is \hyperref[def:adjoint_functor]{left adjoint} to the \hyperref[def:complexification]{decomplexification} \hyperref[con:forgetful_functor]{forgetful functor}
  \begin{equation*}
