...
\begin{definition}\label{def:antilinear_function}\mimprovised
  ...
  That is, we enhance the homogeneity condition \eqref{eq:def:real_homogeneous_function} from \cref{def:linear_function} with \hyperref[def:complex_numbers]{complex conjugation}.
\end{definition}
