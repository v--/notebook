...
\begin{proposition}\label{thm:quadratic_forms}
  ...
  \hi{Real} quadratic forms are simply quadratic forms over \( \BbbK = \BbbR \). \hi{Complex} quadratic forms, by contrast, differ from the general theory --- see \cref{rem:complex_quadratic_form}.
\end{proposition}
\begin{proof}
