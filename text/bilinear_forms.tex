...
\begin{definition}\label{def:homogeneous_polynomial}\mimprovised
  We say that a \hyperref[def:polynomial_algebra/polynomial]{polynomial} is \term{homogeneous} of degree \( n \) if all of its monomials have degree \( n \).
\end{definition}
...
\begin{definition}\label{def:complexification}\mcite[def. 2.1]{Conrad2020Complexification}
  Let \( V \) be a real vector space. The \term{complexification} \( V^\BbbC \) of \( V \) is the \hyperref[def:first_order_direct_product]{direct sum} \( V \oplus V \) equipped with the canonical inclusion
  \begin{equation*}
    \begin{aligned}
