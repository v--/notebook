...
\begin{example}\label{ex:thm:disjoint_sum_via_bitwise_xor}
  We can regard \fullref{thm:disjoint_sum_via_bitwise_xor} as a syntactic analog of evaluating an \hyperref[def:nonnegative_integer_radix_expansion]{integer radix expansion}.
