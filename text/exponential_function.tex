...
\begin{proposition}\label{thm:complex_quadratic_polynomial_roots}
  The \hyperref[def:polynomial_root]{roots} of the complex \hyperref[def:polynomial_degree_terminology]{quadratic} \hyperref[def:polynomial_algebra]{polynomial} \( p(X) = a X^2 + b X + c \) are
