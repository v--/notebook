...
\end{proposition}
\begin{proof}
  \SubProofOf{thm:def:exponential_function/eulers_identity} By \fullref{eq:thm:trigonometric_function_basic_roots/whole} and \fullref{thm:exponential_trigonometric_identities/eulers_formula}, we have
  \begin{equation*}
