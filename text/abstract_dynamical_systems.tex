...
\begin{example}\label{ex:def:dynamical_system}
  ...
  \begin{thmenum}
    ...
    \thmitem{ex:def:dynamical_system/collatz} \Cref{hyp:collatz_conjecture} naturally induces a discrete-time dynamical system with a discrete space. Both the time and phase space are the set of nonnegative integers.
...
\begin{theorem}[Collatz conjecture equivalences]\label{thm:collatz_conjectures_equivalences}
  The following statements are \hyperref[def:logical_theory/equivalent]{equivalent} to \cref{hyp:collatz_conjecture}:
...
\end{theorem}
\begin{proof}
  \SubProofOf{hyp:collatz_conjecture_equivalences/orbit} This is clearly a restatement of \cref{hyp:collatz_conjecture}.
