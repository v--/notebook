...
\begin{remark}\label{rem:discrete_mathematics}
  ...
  Some modern journals are even named so, like Elsevier's \enquote{Discrete Mathematics} with eISSN \identifier{1872-681X}, \enquote{SIAM Journal of Discrete Mathematics} with eISSN \identifier{1095-7146} and \enquote{Дискретная математика} with eISSN \identifier{2305-3143}.
...
\begin{theorem}[Collatz conjecture equivalences]\label{thm:collatz_conjectures_equivalences}
  The following statements are \hyperref[def:equivalent_sets_of_sentences]{equivalent} to \fullref{hyp:collatz_conjecture}:
