...
\begin{definition}\label{def:module}\mimprovised
  ...
  \begin{thmenum}[series=def:module]
    ...
    \Cref{thm:module_absorption_conditions} implies that the absorption condition \eqref{eq:def:semimodule/operation/absorption} becomes redundant.
  \end{thmenum}
  ...
  \begin{thmenum}
    ...
    \Cref{thm:module_absorption_conditions} implies that the absorption formulas \eqref{eq:def:semimodule/theory/absorption} becomes unnecessary as an axiom because it can be derived from the rest.
...
\begin{proposition}\label{thm:module_absorption_conditions}
