...
\begin{definition}\label{def:module}\mimprovised
  ...
  \begin{thmenum}[series=def:module]
    ...
    Since \( R \) is now a ring, \cref{thm:def:ring/zero_absorbing} implies that the two absorption conditions \eqref{eq:def:semimodule/operation/absorption/scalar} and \eqref{eq:def:semimodule/operation/absorption/vector} become redundant.
  \end{thmenum}
  ...
  \begin{thmenum}
    ...
    The absorption formulas \eqref{eq:def:semimodule/theory/absorption/scalar} and \eqref{eq:def:semimodule/theory/absorption/vector} become unnecessary as axioms because they can be derived from the other axioms.
...
\begin{proposition}\label{thm:kernel_is_submodule}
  The \hyperref[def:module/kernel]{kernel} of an \( R \)-\hyperref[def:module/morphism]{linear map} is an \( R \)-submodule of its domain.
\end{proposition}
\begin{proof}
...
\begin{proposition}\label{thm:module_zero_morphisms}
  Let \( M \) and \( N \) be \( R \)-modules and let \( \varphi: M \to N \) be an \( R \)-\hyperref[def:module/morphism]{linear map}.
