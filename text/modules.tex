...
\begin{definition}\label{def:module}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:module/trivial} The \hyperref[def:trivial_structure]{trivial} \( R \)-module is the \hyperref[rem:pointed_set/trivial]{trivial pointed set} \( \set{ 0 } \). It is isomorphic to \hyperref[thm:substructures_form_complete_lattice/bottom]{initial substructure} of any \( R \)-module.
