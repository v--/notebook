...
\begin{definition}\label{def:module}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:module/bimodule} An \( (R, T) \)-\term[ru=бимодуль (\cite[248]{МальцевЖуравлёв2014})]{bimodule} is simply an \( (R, T) \)-\hyperref[def:semimodule/bisemimodule]{bisemimodule} over a ring.
  \end{thmenum}
\end{definition}
