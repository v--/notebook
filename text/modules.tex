...
\begin{definition}\label{def:module}
  ...
  \begin{thmenum}
    ...
    \thmitem{def:module/category}\mcite[158]{Aluffi2009Algebra} For a fixed semiring \( R \), the first-order theories of left and right \( R \)-modules give rise to \hyperref[def:fol_theory_model_functor/obj]{categories of small models}. We denote them by \( \cat[R]{Mod} \) and \( \cat{Mod}[R] \) respectively. Variations of this notation are discussed in \cref{rem:category_of_modules_notation}.
...
\begin{remark}\label{rem:category_of_modules_notation}
  ...
  \begin{itemize}
    \item To distinguish the categories of left and right \( R \)-modules, it is convenient to write \( \cat[R]{Mod} \) and \( \cat[R]{Mod} \).
