...
\begin{definition}\label{def:vector_space}\mcite[def. III.5.5]{Aluffi2009}
  A \term[ru=линейно пространство (\cite[\textnumero 4.1.3]{ПетровЗяпков2010}), ru=линейное пространство (\cite[sec. 11.1]{Тыртышников2007})]{vector space} is a \hyperref[def:module]{left module} over a \hyperref[def:field]{field}.
