...
\begin{proposition}\label{thm:kernel_is_submodule}
  The \hyperref[def:module/kernel]{kernel} of an \( R \)-\hyperref[def:module/morphism]{module homomorphism} is an \( R \)-\hyperref[def:module/submodule]{submodule} of its domain.
\end{proposition}
\begin{proof}
...
\begin{proof}
  ...
  Now let \( x \in A \cap B \). Then \( x = \Phi(x, 0_M) = \Phi(0_M, x) \). Since \( \Phi \) is injective, this implies that the tuples \( (x, 0_M) \) and \( (0_M, x) \) are equal; thus, \( x = 0_M \).
