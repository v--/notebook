...
\begin{proof}
  ...
  \SubProofOf{thm:module_zero_morphisms/isomorphism} \Cref{thm:homomorphisms_theorem_for_groups} implies that \( \psi \) as defined in \eqref{eq:thm:module_zero_morphisms/isomorphism} is an isomorphism between the additive groups of \( R / \ker \varphi \) and \( \img \varphi \). Furthermore, \( \psi \) is a ring isomorphism because \( \varphi \) is.
\end{proof}
