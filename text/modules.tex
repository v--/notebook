...
\begin{proposition}\label{thm:module_zero_morphisms}
  ...
  \begin{thmenum}
    ...
    \thmitem{thm:homomorphism_theorem_for_modules} The image and coimage of \( \varphi \) are isomorphic via the following map:
    \begin{equation}\label{eq:thm:homomorphism_theorem_for_modules}
      \begin{aligned}
...
\begin{proof}
  ...
  \SubProofOf{thm:homomorphism_theorem_for_modules} \Cref{thm:homomorphism_theorem_for_groups} implies that \( \psi \) as defined in \eqref{eq:thm:homomorphism_theorem_for_modules} is an isomorphism between the additive groups of \( R / \ker \varphi \) and \( \img \varphi \). Furthermore, \( \psi \) is a ring isomorphism because \( \varphi \) is.
\end{proof}
