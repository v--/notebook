...
\begin{definition}\label{def:centered_family}\mcite[123]{Engelking1989Topology}
...
\begin{definition}\label{def:compact_space}\mcite[123]{Engelking1989Topology}
...
\begin{proof}
  ...
  \ImplicationSubProof{def:compact_space/convergent_nets}{def:compact_space/centered_family}\mcite[thm. 3.1.23]{Engelking1989Topology} Assume that every net has a cluster point. Let \( \{ F_k \}_{k \in \mscrK} \) be a central family of closed sets.
...
\begin{theorem}[Tychonoff's product theorem]\label{thm:tychonoffs_product_theorem}\mcite[thm. 3.2.4]{Engelking1989Topology}
...
\begin{theorem}[Weierstrass' extreme value theorem]\label{thm:weierstrass_extreme_value_theorem}\mcite[cor. 3.2.9]{Engelking1989Topology}
...
\begin{definition}\label{def:locally_compact_space}\mcite[148]{Engelking1989Topology}
